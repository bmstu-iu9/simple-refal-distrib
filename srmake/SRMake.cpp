...
static refalrts::FnResult func_Go(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  if( ! refalrts::alloc_chars( context[5], context[6], "RMake", 5 ) )
...
static refalrts::FnResult func_gen_RunSrefCompiler_S2A10L2(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[19];
  refalrts::zeros( context, 19 );
  // </0 & RunSrefCompiler$2=10\2/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & RunSrefCompiler$2=10\2/4 (/7 s.new#1/9 e.new#2/5 )/8 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new#2 as range 5
  do {
    // </0 & RunSrefCompiler$2=10\2/4 (/7 # Output/9 e.Output#11/5 )/8 >/1
    if( ! refalrts::ident_term(  ident_Output, context[9] ) )
      continue;
    // closed e.Output#11 as range 5
    //DEBUG: e.Output#11: 5

    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} </0 & RunSrefCompiler$2=10\2/4 {REMOVED TILE} >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ HalfReuse: ' '/7 HalfReuse: '\"'/9 AsIs: e.Output#11/5 HalfReuse: '\"'/8 } Tile{ ]] }
    refalrts::reinit_char( context[7], ' ' );
  ...
  do {
    // </0 & RunSrefCompiler$2=10\2/4 (/7 s.new#3/9 (/14 e.new#4/12 )/15 e.new#5/10 )/8 >/1
    context[10] = context[5];
    context[11] = context[6];
    context[12] = 0;
    context[13] = 0;
    ...
    // </0 & RunSrefCompiler$2=10\2/4 (/7 # Source/9 (/14 s.Dialect#11/18 e.Source#11/16 )/15 e.Output#11/10 )/8 >/1
    context[16] = context[12];
    context[17] = context[13];
    if( ! refalrts::ident_term(  ident_Source, context[9] ) )
      continue;
    ...
    if( ! refalrts::svar_left( context[18], context[16], context[17] ) )
      continue;
    // closed e.Source#11 as range 16
    //DEBUG: e.Output#11: 10
    //DEBUG: s.Dialect#11: 18
    //DEBUG: e.Source#11: 16

    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} (/7 # Source/9 (/14 s.Dialect#11/18 {REMOVED TILE} )/15 e.Output#11/10 )/8 {REMOVED TILE}
    //RESULT: Tile{ [[ HalfReuse: ' '/0 HalfReuse: '\"'/4 } Tile{ AsIs: e.Source#11/16 } Tile{ HalfReuse: '\"'/1 ]] }
  ...
  // </0 & RunSrefCompiler$2=10\2/4 (/7 # Include/9 e.Include#11/5 )/8 >/1
  if( ! refalrts::ident_term(  ident_Include, context[9] ) )
    return refalrts::cRecognitionImpossible;
  // closed e.Include#11 as range 5
  //DEBUG: e.Include#11: 5

  refalrts::reset_allocator();
  //TRASH: {REMOVED TILE} </0 & RunSrefCompiler$2=10\2/4 (/7 # Include/9 e.Include#11/5 )/8 >/1 {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ ]] }
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
  refalrts::Iter res = arg_end->next;
...
static refalrts::FnResult func_RunSrefCompiler(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  if( ! refalrts::alloc_closure_head( context[8] ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_name( context[9], ref_gen_RunSrefCompiler_S2A1.ref.function ) )
    return refalrts::cNoMemory;
