...
static refalrts::FnResult func_gen_LoadFile_A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoLoadFile/4 AsIs: t.File#2/5 HalfReuse: </1 } & Get/7 t.File#2/5/8 >/10 >/11 Tile{ ]] }
...
static refalrts::FnResult func_LoadFile(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & LoadFile=1/4 } </5 & Open-Auto/6 'r'/7 Tile{ AsIs: e.FileName#1/2 } >/8 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
...
static refalrts::FnResult func_DoLoadFile(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Close/4 AsIs: t.File#1/5 HalfReuse: >/9 } Tile{ ]] }
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } (/12 Tile{ AsIs: e.Line#1/10 } Tile{ HalfReuse: )/9 } Tile{ AsIs: </0 Reuse: & Close/4 AsIs: t.File#1/5 } Tile{ AsIs: >/1 ]] }
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } (/7 Tile{ AsIs: e.Line#1/2 } )/8 Tile{ AsIs: </0 AsIs: & DoLoadFile/4 AsIs: t.File#1/5 } </9 & Get/10 t.File#1/5/11 >/13 Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_SaveFile(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </9 & SaveFile-Handle/10 Tile{ AsIs: </0 Reuse: & Open-Auto/4 HalfReuse: 'w'/7 AsIs: e.FileName#1/5 HalfReuse: >/8 AsIs: e.Lines#1/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[9]);
...
static refalrts::FnResult func_AppendFile(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </9 & SaveFile-Handle/10 Tile{ AsIs: </0 Reuse: & Open-Auto/4 HalfReuse: 'a'/7 AsIs: e.FileName#1/5 HalfReuse: >/8 AsIs: e.Lines#1/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[9]);
  refalrts::alloc_name(vm, context[10], functions[efunc_SaveFilem_Handle]);
  refalrts::update_name(context[4], functions[efunc_Openm_Auto]);
...
static refalrts::FnResult func_SaveFilem_Handle(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@1/4 AsIs: s.FileHandle#1/5 AsIs: e.Lines#1/2 AsIs: >/1 } </6 & Close/7 s.FileHandle#1/5/8 >/9 Tile{ ]] }
...
static refalrts::FnResult func_LoadBytes(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoLoadBytes/4 } </5 & Open-Auto/6 (/7"rb"/8 )/10 Tile{ AsIs: e.FileName#1/2 } >/11 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::alloc_name(vm, context[6], functions[efunc_Openm_Auto]);
  refalrts::alloc_open_bracket(vm, context[7]);
...
static refalrts::FnResult func_gen_DoLoadBytes_B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Close/4 AsIs: s.FileHandle#1/5 AsIs: >/1 ]] }
    refalrts::update_name(context[4], functions[efunc_Close]);
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    return refalrts::cSuccess;
...
static refalrts::FnResult func_DoLoadBytes(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoLoadBytes:1/4 AsIs: s.FileHandle#1/5 HalfReuse: </1 } & ReadBytes/6 s.FileHandle#1/5/7 4096/8 >/9 >/10 Tile{ ]] }
...
static refalrts::FnResult func_SaveBytes(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </9 & SaveBytes-Handle/10 </11 & Open-Auto/12 (/13 Tile{ HalfReuse: 'w'/0 HalfReuse: 'b'/4 HalfReuse: )/7 AsIs: e.FileName#1/5 HalfReuse: >/8 AsIs: e.Bytes#1/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[9]);
...
static refalrts::FnResult func_AppendBytes(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </9 & SaveBytes-Handle/10 </11 & Open-Auto/12 (/13 Tile{ HalfReuse: 'a'/0 HalfReuse: 'b'/4 HalfReuse: )/7 AsIs: e.FileName#1/5 HalfReuse: >/8 AsIs: e.Bytes#1/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[9]);
  refalrts::alloc_name(vm, context[10], functions[efunc_SaveBytesm_Handle]);
  refalrts::alloc_open_call(vm, context[11]);
  refalrts::alloc_name(vm, context[12], functions[efunc_Openm_Auto]);
...
static refalrts::FnResult func_SaveBytesm_Handle(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & WriteBytes/4 AsIs: s.FileHandle#1/5 AsIs: e.Bytes#1/2 AsIs: >/1 } </6 & Close/7 s.FileHandle#1/5/8 >/9 Tile{ ]] }
  refalrts::alloc_open_call(vm, context[6]);
  refalrts::alloc_name(vm, context[7], functions[efunc_Close]);
  refalrts::copy_stvar(vm, context[8], context[5]);
  refalrts::alloc_close_call(vm, context[9]);
...
static refalrts::FnResult func_TermComparem_T(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new#3 as range 9
    do {
      // </0 & TermCompare-T/4 (/5 e.new#5/11 )/6 (/7 e.new#6/13 )/8 >/1
      context[11] = context[9];
      context[12] = context[10];
      context[13] = 0;
      context[14] = 0;
      ...
      do {
        // </0 & TermCompare-T/4 (/5 t.0#0/19 e.0#0/15 )/6 (/7 t.#0/21 e.#0/17 )/8 >/1
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Lexicon-T-Aux/4 AsIs: (/5 } Tile{ AsIs: )/6 AsIs: (/7 } )/23 </24 & TermCompare-T/25 Tile{ AsIs: t.0#0/19 } Tile{ AsIs: t.#0/21 } >/26 (/27 Tile{ AsIs: e.0#0/15 } )/28 (/29 Tile{ AsIs: e.#0/17 } Tile{ AsIs: )/8 AsIs: >/1 ]] }
      ...
      do {
        // </0 & TermCompare-T/4 (/5 )/6 (/7 e.new#7/15 )/8 >/1
        context[15] = context[13];
        context[16] = context[14];
        ...
        // </0 & TermCompare-T/4 (/5 )/6 (/7 e.Right#1/17 )/8 >/1
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} </0 {REMOVED TILE} >/1 {REMOVED TILE}
        //RESULT: Tile{ [[ } Tile{ HalfReuse: '<'/4 AsIs: (/5 AsIs: )/6 AsIs: (/7 AsIs: e.Right#1/17 AsIs: )/8 } Tile{ ]] }
        refalrts::reinit_char(context[4], '<');
        refalrts::link_brackets( context[7], context[8] );
        refalrts::link_brackets( context[5], context[6] );
        refalrts::Iter trash_prev = arg_begin->prev;
      ...
      do {
        // </0 & TermCompare-T/4 (/5 e.Left#1/15 )/6 (/7 )/8 >/1
        context[15] = context[11];
        context[16] = context[12];
        if( ! refalrts::empty_seq( context[13], context[14] ) )
          continue;
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} </0 {REMOVED TILE} >/1 {REMOVED TILE}
        //RESULT: Tile{ [[ } Tile{ HalfReuse: '>'/4 AsIs: (/5 AsIs: e.Left#1/15 AsIs: )/6 AsIs: (/7 AsIs: )/8 } Tile{ ]] }
        refalrts::reinit_char(context[4], '>');
        refalrts::link_brackets( context[7], context[8] );
        refalrts::link_brackets( context[5], context[6] );
        refalrts::Iter trash_prev = arg_begin->prev;
      ...
      // </0 & TermCompare-T/4 (/5 e.Left#1/15 )/6 (/7 e.Right#1/17 )/8 >/1
      context[15] = context[11];
      context[16] = context[12];
      context[17] = context[13];
      context[18] = context[14];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Lexicon-T@0/4 AsIs: (/5 } )/19 (/20 Tile{ AsIs: e.Left#1/15 } )/21 (/22 Tile{ AsIs: )/6 AsIs: (/7 AsIs: e.Right#1/17 AsIs: )/8 AsIs: >/1 ]] }
...
static refalrts::FnResult func_Lexiconm_Tm_Aux(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    // </0 & Lexicon-T-Aux/4 (/7 e.new#10/26 )/8 (/11 e.new#11/28 )/12 '='/21 t.new#8/22 t.new#9/24 (/19 e.new#12/30 )/20 (/15 e.new#13/32 )/16 >/1
    context[26] = context[5];
    context[27] = context[6];
    context[28] = context[9];
    context[29] = context[10];
    ...
    do {
      // </0 & Lexicon-T-Aux/4 (/7 e.ScannedLeft#1/34 )/8 (/11 e.ScannedRight#1/36 )/12 '='/21 t.NextLeft#1/22 t.NextRight#1/24 (/19 t.0#0/42 e.0#0/38 )/20 (/15 t.#0/44 e.#0/40 )/16 >/1
      ...
      // closed e.ScannedLeft#1 as range 34
      // closed e.ScannedRight#1 as range 36
      ...
      //DEBUG: t.NextLeft#1: 22
      //DEBUG: t.NextRight#1: 24
      //DEBUG: e.ScannedLeft#1: 34
      //DEBUG: e.ScannedRight#1: 36
      //DEBUG: t.0#0: 42
      //DEBUG: e.0#0: 38
      //DEBUG: t.#0: 44
      //DEBUG: e.#0: 40
      ...
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & Lexicon-T-Aux/4 AsIs: (/7 } Tile{ AsIs: e.ScannedLeft#1/34 } Tile{ AsIs: t.NextLeft#1/22 } Tile{ AsIs: )/8 AsIs: (/11 } Tile{ AsIs: e.ScannedRight#1/36 } Tile{ AsIs: t.NextRight#1/24 } Tile{ AsIs: )/12 HalfReuse: </21 } Tile{ HalfReuse: & TermCompare-T/19 AsIs: t.0#0/42 } Tile{ AsIs: t.#0/44 } >/46 (/47 Tile{ AsIs: e.0#0/38 } Tile{ AsIs: )/20 AsIs: (/15 } Tile{ AsIs: e.#0/40 } Tile{ AsIs: )/16 AsIs: >/1 ]] }
    ...
    do {
      // </0 & Lexicon-T-Aux/4 (/7 e.new#16/34 )/8 (/11 e.new#17/36 )/12 '='/21 t.new#14/22 t.new#15/24 (/19 )/20 (/15 e.new#18/38 )/16 >/1
      context[34] = context[26];
      context[35] = context[27];
      context[36] = context[28];
      context[37] = context[29];
      ...
      do {
        // </0 & Lexicon-T-Aux/4 (/7 e.ScannedLeft#1/40 )/8 (/11 e.ScannedRight#1/42 )/12 '='/21 t.NextLeft#1/22 t.NextRight#1/24 (/19 )/20 (/15 )/16 >/1
        ...
        if( ! refalrts::empty_seq( context[38], context[39] ) )
          continue;
        // closed e.ScannedLeft#1 as range 40
        // closed e.ScannedRight#1 as range 42
        //DEBUG: t.NextLeft#1: 22
        //DEBUG: t.NextRight#1: 24
        //DEBUG: e.ScannedLeft#1: 40
        //DEBUG: e.ScannedRight#1: 42

        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} (/7 {REMOVED TILE} )/8 (/11 {REMOVED TILE} )/12 '='/21 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} )/16 >/1 {REMOVED TILE}
        //RESULT: Tile{ [[ HalfReuse: '='/0 HalfReuse: (/4 } Tile{ AsIs: e.ScannedLeft#1/40 } Tile{ AsIs: t.NextLeft#1/22 } Tile{ AsIs: )/20 AsIs: (/15 } Tile{ AsIs: e.ScannedRight#1/42 } Tile{ AsIs: t.NextRight#1/24 HalfReuse: )/19 } Tile{ ]] }
        refalrts::reinit_char(context[0], '=');
        refalrts::reinit_open_bracket(context[4]);
      ...
      // </0 & Lexicon-T-Aux/4 (/7 e.ScannedLeft#1/40 )/8 (/11 e.ScannedRight#1/42 )/12 '='/21 t.NextLeft#1/22 t.NextRight#1/24 (/19 )/20 (/15 e.Right#1/44 )/16 >/1
      context[40] = context[34];
      context[41] = context[35];
      context[42] = context[36];
      context[43] = context[37];
      ...
      //RESULT: Tile{ [[ HalfReuse: '<'/0 HalfReuse: (/4 } Tile{ AsIs: e.ScannedLeft#1/40 } Tile{ AsIs: t.NextLeft#1/22 } Tile{ AsIs: )/20 AsIs: (/15 } Tile{ AsIs: e.ScannedRight#1/42 } Tile{ AsIs: t.NextRight#1/24 } Tile{ AsIs: e.Right#1/44 } Tile{ HalfReuse: )/1 ]] }
      refalrts::reinit_char(context[0], '<');
      refalrts::reinit_open_bracket(context[4]);
      refalrts::reinit_close_bracket(context[1]);
      refalrts::link_brackets( context[15], context[1] );
    ...
    do {
      // </0 & Lexicon-T-Aux/4 (/7 e.ScannedLeft#1/34 )/8 (/11 e.ScannedRight#1/36 )/12 '='/21 t.NextLeft#1/22 t.NextRight#1/24 (/19 e.Left#1/38 )/20 (/15 )/16 >/1
      context[34] = context[26];
      context[35] = context[27];
      context[36] = context[28];
      context[37] = context[29];
      ...
      //RESULT: Tile{ [[ HalfReuse: '>'/0 HalfReuse: (/4 } Tile{ AsIs: e.ScannedLeft#1/34 } Tile{ AsIs: t.NextLeft#1/22 } Tile{ AsIs: e.Left#1/38 } Tile{ AsIs: )/20 AsIs: (/15 } Tile{ AsIs: e.ScannedRight#1/36 } Tile{ AsIs: t.NextRight#1/24 HalfReuse: )/19 } Tile{ ]] }
      refalrts::reinit_char(context[0], '>');
      refalrts::reinit_open_bracket(context[4]);
      refalrts::reinit_close_bracket(context[19]);
      refalrts::link_brackets( context[15], context[19] );
    ...
    // </0 & Lexicon-T-Aux/4 (/7 e.ScannedLeft#1/34 )/8 (/11 e.ScannedRight#1/36 )/12 '='/21 t.NextLeft#1/22 t.NextRight#1/24 (/19 e.Left#1/38 )/20 (/15 e.Right#1/40 )/16 >/1
    context[34] = context[26];
    context[35] = context[27];
    context[36] = context[28];
    context[37] = context[29];
    ...
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Lexicon-T@0/4 AsIs: (/7 } Tile{ AsIs: e.ScannedLeft#1/34 } Tile{ AsIs: t.NextLeft#1/22 } Tile{ AsIs: )/8 AsIs: (/11 } Tile{ AsIs: e.Left#1/38 } Tile{ AsIs: )/12 HalfReuse: (/21 } Tile{ AsIs: e.ScannedRight#1/36 } Tile{ AsIs: t.NextRight#1/24 } Tile{ AsIs: )/20 AsIs: (/15 AsIs: e.Right#1/40 AsIs: )/16 AsIs: >/1 ]] }
    refalrts::update_name(context[4], functions[efunc_gen_Lexiconm_T_Z0]);
...
static refalrts::FnResult func_Sort(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Sort$2=1/4 } </7 & Reduce@1/8 t.Pivot#1/5/9 (/11 (/12 )/13 (/14 Tile{ AsIs: t.Pivot#1/5 } )/15 (/16 )/17 )/18 Tile{ AsIs: e.Items#1/2 } >/19 Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Map_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      // </0 & Map@1/4 s.FileHandle#1/5 (/8 e.#0/12 )/9 e.Tail#1/10 >/1
      context[10] = context[6];
      context[11] = context[7];
      context[12] = 0;
      context[13] = 0;
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 } Tile{ AsIs: e.#0/12 } Tile{ HalfReuse: >/8 } </14 & Map@1/15 Tile{ HalfReuse: s.FileHandle1 #5/9 AsIs: e.Tail#1/10 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[14]);
    ...
    // </0 & Map@1/4 s.FileHandle#1/5 t.Next#1/8 e.Tail#1/10 >/1
    context[10] = context[6];
    context[11] = context[7];
    // closed e.Tail#1 as range 10
    //DEBUG: t.Next#1: 8
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & SaveFile-Handle\1*1/4 AsIs: s.FileHandle#1/5 AsIs: t.Next#1/8 } >/12 </13 & Map@1/14 s.FileHandle#1/5/15 Tile{ AsIs: e.Tail#1/10 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[12]);
    refalrts::alloc_open_call(vm, context[13]);
  ...
  do {
    // </0 & Map@1/4 s.FileHandle#1/5 >/1
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    //DEBUG: s.FileHandle#1: 5

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Map@1/4 s.FileHandle#1/5 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & Map@1/4 s.FileHandle#1/5 e.items#0/2 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@0/4 } [*]/6 & SaveFile-Handle\1@0/7 Tile{ AsIs: s.FileHandle#1/5 } {*}/8 Tile{ AsIs: e.items#0/2 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Reduce_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      // </0 & Reduce@1/4 t.Pivot#1/5 (/7 (/19 e.1#0/17 )/20 (/23 e.3#0/21 )/24 (/27 e.5#0/25 )/28 )/8 t.Next#1/11 e.Tail#1/13 >/1
      context[13] = context[9];
      context[14] = context[10];
      context[15] = 0;
      context[16] = 0;
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Reduce$1=1@1/4 AsIs: t.Pivot#1/5 AsIs: (/7 } Tile{ AsIs: e.Tail#1/13 } )/29 </30 & Sort$2=1\1:1/31 Tile{ AsIs: (/19 AsIs: e.1#0/17 AsIs: )/20 } t.Next#1/11/32 Tile{ AsIs: (/23 AsIs: e.3#0/21 AsIs: )/24 AsIs: (/27 AsIs: e.5#0/25 AsIs: )/28 HalfReuse: </8 } & TermCompare/34 Tile{ AsIs: t.Next#1/11 } t.Pivot#1/5/35 >/37 >/38 Tile{ AsIs: >/1 ]] }
    ...
    // </0 & Reduce@1/4 t.Pivot#1/5 t.Acc#1/7 t.Next#1/11 e.Tail#1/13 >/1
    context[13] = context[9];
    context[14] = context[10];
    // closed e.Tail#1 as range 13
    //DEBUG: t.Pivot#1: 5
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </15 & Reduce$1=1@1/16 t.Pivot#1/5/17 (/19 Tile{ AsIs: e.Tail#1/13 } )/20 Tile{ AsIs: </0 Reuse: & Sort$2=1\1*1/4 AsIs: t.Pivot#1/5 AsIs: t.Acc#1/7 AsIs: t.Next#1/11 } >/21 Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[15]);
  ...
  do {
    // </0 & Reduce@1/4 t.Pivot#1/5 t.Acc#1/7 >/1
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    //DEBUG: t.Pivot#1: 5
    //DEBUG: t.Acc#1: 7
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Reduce@1/4 t.Pivot#1/5 {REMOVED TILE} >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: t.Acc#1/7 } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & Reduce@1/4 t.Pivot#1/5 t.accum#0/7 e.items#0/2 >/1
  // closed e.items#0 as range 2
  //DEBUG: t.Pivot#1: 5
  //DEBUG: t.accum#0: 7
  //DEBUG: e.items#0: 2
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Reduce@0/4 } [*]/9 & Sort$2=1\1@0/10 Tile{ AsIs: t.Pivot#1/5 } {*}/11 Tile{ AsIs: t.accum#0/7 AsIs: e.items#0/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Reduce_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </11 & Reduce$1=1@2/12 (/13 Tile{ AsIs: e.Tail#1/7 } )/14 Tile{ AsIs: </0 Reuse: & Min$1:1/4 AsIs: t.Acc#1/5 AsIs: t.Next#1/9 } </15 & TermCompare/16 t.Acc#1/5/17 t.Next#1/9/19 >/21 >/22 Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[11]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </7 Tile{ HalfReuse: & Reduce@0/0 Reuse: & Min@0/4 AsIs: t.accum#0/5 AsIs: e.items#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[7]);
...
static refalrts::FnResult func_gen_Reduce_Z3(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </11 & Reduce$1=1@3/12 (/13 Tile{ AsIs: e.Tail#1/7 } )/14 Tile{ AsIs: </0 Reuse: & Max$1:1/4 AsIs: t.Acc#1/5 AsIs: t.Next#1/9 } </15 & TermCompare/16 t.Acc#1/5/17 t.Next#1/9/19 >/21 >/22 Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[11]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </7 Tile{ HalfReuse: & Reduce@0/0 Reuse: & Max@0/4 AsIs: t.accum#0/5 AsIs: e.items#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[7]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Reduce_Z0]);
...
static refalrts::FnResult func_gen_SwDoArgList_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } (/7 Tile{ AsIs: e.Arg#1/5 } )/8 Tile{ AsIs: </0 Reuse: & DoArgList/4 } 1/9 Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_bracket(vm, context[7]);
    refalrts::alloc_close_bracket(vm, context[8]);
  ...
  // </0 & SwDoArgList@1/4 e.dyn#0/2 >/1
  // closed e.dyn#0 as range 2
  //DEBUG: e.dyn#0: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & SwDoArgList@0/0 HalfReuse: 1/4 AsIs: e.dyn#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
...
static refalrts::FnResult func_gen_Reduce_S1A1Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // closed e.new#3 as range 2
  do {
    // </0 & Reduce$1=1@1/4 t.Pivot#1/5 (/9 e.Tail0#1/11 )/10 t.Acc#2/15 >/1
    context[11] = context[7];
    context[12] = context[8];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} (/9 {REMOVED TILE} )/10 {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Reduce@1/4 AsIs: t.Pivot#1/5 } Tile{ AsIs: t.Acc#2/15 } Tile{ AsIs: e.Tail0#1/11 } Tile{ AsIs: >/1 ]] }
  ...
  // </0 & Reduce$1=1@1/4 t.Pivot#1/5 (/9 e.Tail0#1/7 )/10 e.dyn#0/2 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Reduce$1=1@0/4 } [*]/11 & Sort$2=1\1@0/12 Tile{ AsIs: t.Pivot#1/5 } {*}/13 Tile{ AsIs: (/9 AsIs: e.Tail0#1/7 AsIs: )/10 AsIs: e.dyn#0/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Reduce_S1A1Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </9 Tile{ HalfReuse: & Reduce$1=1@0/0 Reuse: & Min@0/4 AsIs: (/7 AsIs: e.Tail0#1/5 AsIs: )/8 AsIs: e.dyn#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[9]);
...
static refalrts::FnResult func_gen_Reduce_S1A1Z3(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </9 Tile{ HalfReuse: & Reduce$1=1@0/0 Reuse: & Max@0/4 AsIs: (/7 AsIs: e.Tail0#1/5 AsIs: )/8 AsIs: e.dyn#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[9]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Reduce_S1A1Z0]);
  refalrts::update_name(context[4], functions[efunc_gen_Max_Z0]);
  refalrts::push_stack( vm, context[1] );
