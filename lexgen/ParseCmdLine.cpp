...
#define cookie_ns cookie_ns_1893147208_2822672673
#define COOKIE1_ 1893147208U
#define COOKIE2_ 2822672673U
...
enum efunc {
  ...
  efunc_HelpOnError = 23,
  efunc_FormatError = 24,
  efunc_gen_ParseCommandLine_B1S2B1 = 25,
  efunc_SkipVersion = 26,
  efunc_gen_ParseCommandLine_B1S4C1 = 27,
  efunc_Exit = 28,
  efunc_Prout = 29,
  efunc_gen_Map_Z1 = 30,
  efunc_Help = 31,
  efunc_PrintVersion = 32,
  efunc_gen_ParseCommandLine_L1 = 33,
  efunc_gen_ParseCommandLine_B1 = 34,
  efunc_GetOpt = 35,
  efunc_gen_ParseCommandLine_A1 = 36,
  efunc_Symb = 37,
  efunc_gen_ParseCommandLine_B1S6L1D3 = 38,
};
...
static refalrts::FnResult func_gen_u_u_Mum_Aux_S13B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::alloc_number(vm, context[9], 2822672673UL);
    refalrts::update_name(context[4], functions[efunc_u_u_FindMuPtr]);
    refalrts::reinit_number(context[5], 1893147208UL);
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
  ...
  refalrts::update_name(context[4], functions[efunc_u_u_FindMuPtr]);
  refalrts::reinit_number(context[5], 1893147208UL);
  refalrts::reinit_number(context[7], 2822672673UL);
  refalrts::push_stack( vm, context[1] );
  refalrts::push_stack( vm, context[0] );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
