...
static refalrts::FnResult func_gen_Flexm_Check_L1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  if( ! refalrts::empty_seq( context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  do {
    // </0 & Flex-Check\1/4 (/5 # Subexpr/9 t.Pos/10 e.Name/7 t.Regexp/12 )/6 >/1
    context[7] = 0;
    context[8] = 0;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Flex-Check\1/4 (/5 {REMOVED TILE} {REMOVED TILE} t.Regexp/12 )/6 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ HalfReuse: (/9 AsIs: t.Pos/10 } Tile{ AsIs: e.Name/7 } Tile{ HalfReuse: )/1 ]] }
  ...
  // </0 & Flex-Check\1/4 t.OtherItem/5 >/1
  //DEBUG: t.OtherItem: 5

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} </0 & Flex-Check\1/4 t.OtherItem/5 >/1 {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ ]] }
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
  refalrts::Iter res = arg_end->next;
...
static refalrts::FnResult func_Flexm_Check(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 & CheckUniqueNames/6 </7 Tile{ HalfReuse: & Map/0 Reuse: & Flex-Check\1/4 AsIs: e.AST/2 AsIs: >/1 } >/8 Tile{ ]] }
  refalrts::alloc_open_call(vm, context[5]);
...
static refalrts::FnResult func_CheckUniqueNames(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & CheckUniqueNames/4 e.new/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  // closed e.new as range 2
  do {
    // </0 & CheckUniqueNames/4 e.Names-B/7 (/13 t.Pos1/15 e.Name/11 )/14 e.Names-M/17 (/23 t.Pos2/27 e.Name/25 )/24 e.Names-E/19 >/1
    context[5] = context[2];
    context[6] = context[3];
    context[7] = 0;
    context[8] = 0;
    ...
    do {
      ...
      do {
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} e.Names-B/7 {REMOVED TILE} t.Pos1/15 e.Name/11 {REMOVED TILE} e.Names-M/17 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} e.Names-E/19 {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & ErrorAt/4 } Tile{ AsIs: t.Pos2/27 } Tile{ HalfReuse: 'R'/23 } Tile{ HalfReuse: 'e'/14 } Tile{ HalfReuse: 'd'/24 } Tile{ HalfReuse: 'e'/13 }"fined subexpr name "/29 Tile{ AsIs: e.Name/25 } Tile{ AsIs: >/1 ]] }
  ...
  // </0 & CheckUniqueNames/4 e.Names/2 >/1
  // closed e.Names as range 2
  //DEBUG: e.Names: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} </0 & CheckUniqueNames/4 e.Names/2 >/1 {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ ]] }
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
  refalrts::Iter res = arg_end->next;
