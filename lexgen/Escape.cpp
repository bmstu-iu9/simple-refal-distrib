...
static refalrts::FnResult func_DoUnEscapeStringm_SR(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    // ( e.idx ) '\\x' e.idx
    // </0 & DoUnEscapeString-SR/4 (/7 e.Scanned#1/5 )/8 '\\'/9 'x'/10 e.HexAndTail#1/2 >/1
    context[17] = context[2];
    context[18] = context[3];
    context[9] = refalrts::char_left( '\\', context[17], context[18] );
    if( ! context[9] )
      continue;
    context[10] = refalrts::char_left( 'x', context[17], context[18] );
    if( ! context[10] )
      continue;
    // closed e.Scanned#1 as range 5
    // closed e.HexAndTail#1 as range 17(2)
    //DEBUG: e.Scanned#1: 5
    //DEBUG: e.HexAndTail#1: 2

    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoUnEscapeString-SR-Hex/4 AsIs: (/7 AsIs: e.Scanned#1/5 AsIs: )/8 HalfReuse: (/9 HalfReuse: </10 } & HexDigits/11 >/12 )/13 (/14 )/15 Tile{ AsIs: e.HexAndTail#1/17(2) } Tile{ AsIs: >/1 ]] }
    if( ! refalrts::alloc_name( context[11], ref_HexDigits.ref.function ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_close_call( context[12] ) )
      return refalrts::cNoMemory;
  ...
  do {
    // ( e.idx ) '\\d' e.idx
    // </0 & DoUnEscapeString-SR/4 (/7 e.Scanned#1/5 )/8 '\\'/9 'd'/10 e.DecAndTail#1/2 >/1
    context[17] = context[2];
    context[18] = context[3];
    context[9] = refalrts::char_left( '\\', context[17], context[18] );
    if( ! context[9] )
    ...
    if( ! context[10] )
      continue;
    // closed e.Scanned#1 as range 5
    // closed e.DecAndTail#1 as range 17(2)
    //DEBUG: e.Scanned#1: 5
    //DEBUG: e.DecAndTail#1: 2

    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoUnEscapeString-SR-DecOct/4 AsIs: (/7 AsIs: e.Scanned#1/5 AsIs: )/8 HalfReuse: (/9 HalfReuse: 10/10 } </11 & DecDigits/12 >/13 )/14 (/15 )/16 Tile{ AsIs: e.DecAndTail#1/17(2) } Tile{ AsIs: >/1 ]] }
    if( ! refalrts::alloc_open_call( context[11] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[12], ref_DecDigits.ref.function ) )
      return refalrts::cNoMemory;
    ...
    refalrts::reinit_open_bracket( context[9] );
    refalrts::reinit_number( context[10], 10UL );
    refalrts::push_stack( context[1] );
    refalrts::push_stack( context[0] );
  ...
  do {
    // ( e.idx ) '\\' e.idx
    // </0 & DoUnEscapeString-SR/4 (/7 e.Scanned#1/5 )/8 '\\'/9 e.EscapedAndTail#1/2 >/1
    context[17] = context[2];
    context[18] = context[3];
    context[9] = refalrts::char_left( '\\', context[17], context[18] );
    if( ! context[9] )
      continue;
    // closed e.Scanned#1 as range 5
    // closed e.EscapedAndTail#1 as range 17(2)
    //DEBUG: e.Scanned#1: 5
    //DEBUG: e.EscapedAndTail#1: 2

    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoUnEscapeString-SR-Escape/4 AsIs: (/7 AsIs: e.Scanned#1/5 AsIs: )/8 HalfReuse: (/9 } </10 & OctDigits/11 >/12 )/13 Tile{ AsIs: e.EscapedAndTail#1/17(2) } Tile{ AsIs: >/1 ]] }
    if( ! refalrts::alloc_open_call( context[10] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[11], ref_OctDigits.ref.function ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_close_call( context[12] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_close_bracket( context[13] ) )
  ...
  do {
    // ( e.idx ) s.idx e.idx
    // </0 & DoUnEscapeString-SR/4 (/7 e.Scanned#1/5 )/8 s.SimpleChar#1/9 e.Tail#1/2 >/1
    // closed e.Scanned#1 as range 5
    context[17] = context[2];
    context[18] = context[3];
    if( ! refalrts::svar_left( context[9], context[17], context[18] ) )
      continue;
    // closed e.Tail#1 as range 17(2)
    //DEBUG: e.Scanned#1: 5
    //DEBUG: s.SimpleChar#1: 9
    //DEBUG: e.Tail#1: 2

    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} s.SimpleChar#1/9 {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoUnEscapeString-SR/4 AsIs: (/7 AsIs: e.Scanned#1/5 HalfReuse: s.SimpleChar1 #9/8 } )/10 Tile{ AsIs: e.Tail#1/17(2) } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_DoUnEscapeStringm_SRm_Hex(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // </0 & DoUnEscapeString-SR-Hex/4 (/7 e.Scanned#1/5 )/8 (/11 e.ValidDigits-B#1/18 s.Digit#1/20 e.ValidDigits-E#1/9 )/12 (/15 e.ScannedNumber#1/13 )/16 s.Digit#1/17 e.Tail#1/2 >/1
    // closed e.Scanned#1 as range 5
    ...
    do {
      ...
      if( ! refalrts::repeated_stvar_left( context[20], context[17], context[26], context[27] ) )
        continue;
      // closed e.ValidDigits-E#1 as range 26(9)
      //DEBUG: e.Scanned#1: 5
      //DEBUG: e.ScannedNumber#1: 13
      //DEBUG: s.Digit#1: 17
      //DEBUG: e.Tail#1: 2
      //DEBUG: e.ValidDigits-B#1: 18
      //DEBUG: e.ValidDigits-E#1: 9

      refalrts::reset_allocator();
      //TRASH: {REMOVED TILE} s.Digit#1/17 {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoUnEscapeString-SR-Hex/4 AsIs: (/7 AsIs: e.Scanned#1/5 AsIs: )/8 AsIs: (/11 AsIs: e.ValidDigits-B#1/18 AsIs: s.Digit#1/20 AsIs: e.ValidDigits-E#1/26(9) AsIs: )/12 AsIs: (/15 AsIs: e.ScannedNumber#1/13 HalfReuse: s.Digit1 #20/16 } )/21 Tile{ AsIs: e.Tail#1/22(2) } Tile{ AsIs: >/1 ]] }
      if( ! refalrts::alloc_close_bracket( context[21] ) )
        return refalrts::cNoMemory;
      refalrts::reinit_svar( context[16], context[20] );
      refalrts::push_stack( context[1] );
      refalrts::push_stack( context[0] );
      ...
      return refalrts::cSuccess;
    } while ( refalrts::open_evar_advance( context[18], context[19], context[24], context[25] ) );
  } while ( 0 );
  refalrts::stop_sentence();
...
static refalrts::FnResult func_Prefix3(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // </0 & Prefix3/4 s.1#1/5 s.2#1/6 s.3#1/7 s.4#1/8 e.Tail#1/2 >/1
    context[9] = context[2];
    context[10] = context[3];
    if( ! refalrts::svar_left( context[5], context[9], context[10] ) )
      continue;
    if( ! refalrts::svar_left( context[6], context[9], context[10] ) )
      continue;
    if( ! refalrts::svar_left( context[7], context[9], context[10] ) )
      continue;
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.4#1/8 e.Tail#1/9(2) {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: s.1#1/5 AsIs: s.2#1/6 AsIs: s.3#1/7 } Tile{ HalfReuse: '.'/0 HalfReuse: '.'/4 } Tile{ HalfReuse: '.'/1 ]] }
...
static refalrts::FnResult func_DoUnEscapeStringm_SRm_DecOct(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // </0 & DoUnEscapeString-SR-DecOct/4 (/7 e.Scanned#1/5 )/8 (/11 s.Base#1/17 e.ValidDigits#1/9 )/12 (/15 s.D1#1/18 s.D2#1/19 s.D3#1/20 )/16 e.Tail#1/2 >/1
    // closed e.Scanned#1 as range 5
    // closed e.ValidDigits#1 as range 9
    // closed e.Tail#1 as range 2
    context[23] = context[13];
    context[24] = context[14];
    if( ! refalrts::svar_left( context[18], context[23], context[24] ) )
      continue;
    if( ! refalrts::svar_left( context[19], context[23], context[24] ) )
      continue;
    if( ! refalrts::svar_left( context[20], context[23], context[24] ) )
      continue;
    ...
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoUnEscapeString-SR/4 AsIs: (/7 AsIs: e.Scanned#1/5 HalfReuse: </8 HalfReuse: & CharFromNum/11 AsIs: s.Base#1/17 } Tile{ AsIs: s.D1#1/18 AsIs: s.D2#1/19 AsIs: s.D3#1/20 } Tile{ HalfReuse: >/15 } Tile{ AsIs: )/16 AsIs: e.Tail#1/2 AsIs: >/1 ]] }
    refalrts::update_name( context[4], ref_DoUnEscapeStringm_SR.ref.function );
    refalrts::reinit_open_call( context[8] );
    refalrts::reinit_name( context[11], ref_CharFromNum.ref.function );
  ...
  do {
    ...
    // </0 & DoUnEscapeString-SR-DecOct/4 (/7 e.Scanned#1/5 )/8 (/11 s.Base#1/17 e.ValidDigits-B#1/19 s.Digit#1/21 e.ValidDigits-E#1/9 )/12 (/15 e.ScannedNumber#1/13 )/16 s.Digit#1/18 e.Tail#1/2 >/1
    // closed e.Scanned#1 as range 5
    // closed e.ScannedNumber#1 as range 13
    ...
    do {
      ...
      if( ! refalrts::repeated_stvar_left( context[21], context[18], context[27], context[28] ) )
        continue;
      // closed e.ValidDigits-E#1 as range 27(9)
      //DEBUG: s.Base#1: 17
      //DEBUG: e.Scanned#1: 5
      //DEBUG: e.ScannedNumber#1: 13
      //DEBUG: s.Digit#1: 18
      //DEBUG: e.Tail#1: 2
      //DEBUG: e.ValidDigits-B#1: 19
      //DEBUG: e.ValidDigits-E#1: 9

      refalrts::reset_allocator();
      //TRASH: {REMOVED TILE} s.Digit#1/18 {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoUnEscapeString-SR-DecOct/4 AsIs: (/7 AsIs: e.Scanned#1/5 AsIs: )/8 AsIs: (/11 AsIs: s.Base#1/17 AsIs: e.ValidDigits-B#1/19 AsIs: s.Digit#1/21 AsIs: e.ValidDigits-E#1/27(9) AsIs: )/12 AsIs: (/15 AsIs: e.ScannedNumber#1/13 HalfReuse: s.Digit1 #21/16 } )/22 Tile{ AsIs: e.Tail#1/23(2) } Tile{ AsIs: >/1 ]] }
      ...
      refalrts::splice_to_freelist_open( context[16], res );
      return refalrts::cSuccess;
    } while ( refalrts::open_evar_advance( context[19], context[20], context[25], context[26] ) );
  } while ( 0 );
  refalrts::stop_sentence();
...
static refalrts::FnResult func_gen_DoUnEscapeStringm_SRm_Escape_S2L1(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // </0 & DoUnEscapeString-SR-Escape$2\1/4 (/7 e.Scanned#1/5 )/8 (/11 e.Tail#1/9 )/12 s.Next#1/13 # Success/14 s.Char#2/15 >/1
    ...
    context[16] = context[2];
    context[17] = context[3];
    if( ! refalrts::svar_left( context[15], context[16], context[17] ) )
      continue;
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} s.Next#1/13 # Success/14 s.Char#2/15 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoUnEscapeString-SR/4 AsIs: (/7 AsIs: e.Scanned#1/5 HalfReuse: s.Char2 #15/8 HalfReuse: )/11 AsIs: e.Tail#1/9 HalfReuse: >/12 } Tile{ ]] }
    refalrts::update_name( context[4], ref_DoUnEscapeStringm_SR.ref.function );
  ...
  // </0 & DoUnEscapeString-SR-Escape$2\1/4 (/7 e.Scanned#1/5 )/8 (/11 e.Tail#1/9 )/12 s.Next#1/13 # Fails/14 >/1
  ...
  refalrts::reset_allocator();
  //TRASH: {REMOVED TILE} e.Scanned#1/5 )/8 (/11 e.Tail#1/9 )/12 s.Next#1/13 # Fails/14 {REMOVED TILE}
...
static refalrts::FnResult func_DoUnEscapeStringm_SRm_Escape(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // </0 & DoUnEscapeString-SR-Escape/4 (/7 e.Scanned#1/5 )/8 (/11 e.Octs-B#1/14 s.Oct#1/16 e.Octs-E#1/9 )/12 s.Oct#1/13 e.Tail#1/2 >/1
    // closed e.Scanned#1 as range 5
    context[22] = context[2];
    context[23] = context[3];
    ...
    do {
      context[26] = context[24];
      context[27] = context[25];
      if( ! refalrts::repeated_stvar_left( context[16], context[13], context[26], context[27] ) )
        continue;
      // closed e.Octs-E#1 as range 26(9)
      //DEBUG: e.Scanned#1: 5
      //DEBUG: s.Oct#1: 13
      //DEBUG: e.Tail#1: 2
      //DEBUG: e.Octs-B#1: 14
      ...
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoUnEscapeString-SR-DecOct/4 AsIs: (/7 AsIs: e.Scanned#1/5 AsIs: )/8 AsIs: (/11 } 8/17 Tile{ AsIs: e.Octs-B#1/14 } Tile{ AsIs: s.Oct#1/16 AsIs: e.Octs-E#1/26(9) AsIs: )/12 } (/18 Tile{ AsIs: s.Oct#1/13 } )/19 Tile{ AsIs: e.Tail#1/22(2) } Tile{ AsIs: >/1 ]] }
      if( ! refalrts::alloc_number( context[17], 8UL ) )
        return refalrts::cNoMemory;
  ...
  do {
    // ( e.idx ) ( e.idx ) s.idx e.idx
    // </0 & DoUnEscapeString-SR-Escape/4 (/7 e.Scanned#1/5 )/8 (/11 e.Octs#1/9 )/12 s.Next#1/13 e.Tail#1/2 >/1
    // closed e.Scanned#1 as range 5
    ...
    //RESULT: Tile{ [[ } </14 & Fetch/15 </16 & SingularEscape/17 s.Next#1/13/18 >/19 </20 Tile{ HalfReuse: & @create_closure@/0 Reuse: & DoUnEscapeString-SR-Escape$2\1/4 AsIs: (/7 AsIs: e.Scanned#1/5 AsIs: )/8 AsIs: (/11 } Tile{ AsIs: e.Tail#1/22(2) } Tile{ AsIs: )/12 AsIs: s.Next#1/13 } >/21 Tile{ AsIs: >/1 ]] }
    ...
    if( ! refalrts::alloc_open_call( context[16] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[17], ref_SingularEscape.ref.function ) )
      return refalrts::cNoMemory;
