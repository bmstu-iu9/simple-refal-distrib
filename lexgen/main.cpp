...
#define cookie_ns cookie_ns_2431795232_3508540871
#define COOKIE1_ 2431795232U
#define COOKIE2_ 3508540871U
...
enum efunc {
  ...
  efunc_ArgList = 28,
  efunc_gen_Go_A1 = 29,
  efunc_gen_Transform_A2 = 30,
  efunc_GetTranslator = 31,
  efunc_gen_Transform_A1 = 32,
  efunc_SplitSource = 33,
  efunc_ErrorAt = 34,
  efunc_gen_SplitSource_S1A1 = 35,
  efunc_Lenw = 36,
  efunc_gen_SplitSource_S2A1 = 37,
  efunc_GetDFATranslator = 38,
  efunc_GetFlexTranslator = 39,
  efunc_DFAm_Tokens = 40,
  efunc_FillSourceToTokens = 41,
  efunc_DFAm_Parse = 42,
  efunc_DFAm_Compile = 43,
  efunc_GenerateFromDFA = 44,
  efunc_Flexm_Check = 45,
  efunc_Flexm_Tokens = 46,
  efunc_Flexm_Parse = 47,
  efunc_gen_GetFlexTranslator_L1 = 48,
  efunc_Flexm_Desugar = 49,
  efunc_Flexm_Compile = 50,
  efunc_gen_Map_Z1 = 51,
  efunc_FillSourceToToken = 52,
};
...
static refalrts::FnResult func_gen_u_u_Mum_Aux_S13B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::alloc_number(vm, context[9], 3508540871UL);
    refalrts::update_name(context[4], functions[efunc_u_u_FindMuPtr]);
    refalrts::reinit_number(context[5], 2431795232UL);
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
  ...
  refalrts::update_name(context[4], functions[efunc_u_u_FindMuPtr]);
  refalrts::reinit_number(context[5], 2431795232UL);
  refalrts::reinit_number(context[7], 3508540871UL);
  refalrts::push_stack( vm, context[1] );
  refalrts::push_stack( vm, context[0] );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
...
static refalrts::FnResult func_gen_Map_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} </0 & Map@1/4 e.Source#1/2 (/7 )/8 >/1 {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ ]] }
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
  refalrts::Iter res = arg_end->next;
