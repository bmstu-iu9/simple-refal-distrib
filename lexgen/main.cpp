...
static refalrts::FnResult func_Map(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      //RESULT: Tile{ [[ } </17 & Apply@4/18 t./15/19 e.0/13/21 Tile{ AsIs: t.Next/9 } >/23 Tile{ AsIs: </0 AsIs: & Map/4 AsIs: (/5 AsIs: t./15 AsIs: e.0/13 AsIs: )/6 } Tile{ AsIs: e.Tail/11 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Go_B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Go:1/4 s.new1/5 e.new2/2 >/1
  if( ! refalrts::svar_left( context[5], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  // closed e.new2 as range 2
  do {
    // </0 & Go:1/4 # InPlace/5 e.FileName/6 >/1
    context[6] = context[2];
    context[7] = context[3];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & SaveFile/4 HalfReuse: (/5 AsIs: e.FileName/6 HalfReuse: )/1 } </8 & Transform/9 (/10 e.FileName/6/11 )/13 </14 & LoadFile/15 e.FileName/6/16 >/18 >/19 >/20 Tile{ ]] }
  ...
  // </0 & Go:1/4 # From/5 (/8 e.From/6 )/9 # To/10 (/13 e.To/11 )/14 >/1
  ...
  if( ! refalrts::empty_seq( context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  // closed e.From as range 6
  // closed e.To as range 11
  //DEBUG: e.From: 6
  //DEBUG: e.To: 11

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </15 & SaveFile/16 (/17 Tile{ AsIs: e.To/11 } )/18 (/19"/* Automatically generated file, don\'t edit! */"/20 )/22 (/23"/* Edit file \'"/24 e.From/6/26"\' */"/28 )/30 (/31 )/32 (/33 Tile{ HalfReuse: )/0 HalfReuse: </4 HalfReuse: & Transform/5 AsIs: (/8 AsIs: e.From/6 AsIs: )/9 HalfReuse: </10 HalfReuse: & LoadFile/13 } e.From/6/34 >/36 Tile{ HalfReuse: >/14 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[15]);
...
static refalrts::FnResult func_gen_Go_A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & Go=1/4 (/7 e.ProgName/5 )/8 e.Options/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} e.ProgName/5 {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Go:1/4 HalfReuse: </7 } Tile{ HalfReuse: & ParseCommandLine/8 AsIs: e.Options/2 AsIs: >/1 } >/9 Tile{ ]] }
  refalrts::alloc_close_call(vm, context[9]);
...
static refalrts::FnResult func_gen_Transform_A2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Transform=2/4 (/7 e.new1/5 )/8 (/11 e.new2/9 )/12 (/15 e.new3/13 )/16 s.new4/17 t.new5/18 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  if( ! refalrts::empty_seq( context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  do {
    // </0 & Transform=2/4 (/7 e.LinesBefore/20 )/8 (/11 e.GenMode/22 )/12 (/15 e.Description/24 )/16 s.Length/17 s.Fn/18 >/1
    ...
    if( ! refalrts::svar_term( context[18], context[18] ) )
      continue;
    // closed e.LinesBefore as range 20
    // closed e.GenMode as range 22
    // closed e.Description as range 24
    //DEBUG: s.Fn: 18
    //DEBUG: s.Length: 17
    //DEBUG: e.LinesBefore: 20
    //DEBUG: e.GenMode: 22
    //DEBUG: e.Description: 24

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.Length/17 s.Fn/18 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: e.LinesBefore/20 } (/26"/*GE"/27 Tile{ HalfReuse: 'N'/8 HalfReuse: ':'/11 AsIs: e.GenMode/22 AsIs: )/12 } e.Description/24/29 (/31"GEN:END*/"/32 )/34 Tile{ AsIs: </0 Reuse: & __Meta_Mu/4 HalfReuse: s.Fn18 /7 } Tile{ HalfReuse: s.Length17 /15 AsIs: e.Description/24 HalfReuse: & $table/16 } Tile{ AsIs: >/1 ]] }
  ...
  do {
    // </0 & Transform=2/4 (/7 e.LinesBefore/20 )/8 (/11 e.GenMode/22 )/12 (/15 e.Description/24 )/16 s.Length/17 (/18 t./28 e.0/26 )/19 >/1
    context[20] = context[5];
    context[21] = context[6];
    context[22] = context[9];
    context[23] = context[10];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.Length/17 {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: e.LinesBefore/20 } Tile{ AsIs: (/7 } Tile{ HalfReuse: '/'/4 }"*GE"/30 Tile{ HalfReuse: 'N'/8 HalfReuse: ':'/11 AsIs: e.GenMode/22 AsIs: )/12 } Tile{ AsIs: e.Description/24 } Tile{ AsIs: (/15 }"GEN:END*/"/32 Tile{ AsIs: )/16 } Tile{ AsIs: </0 } Tile{ HalfReuse: & Apply/18 AsIs: t./28 AsIs: e.0/26 HalfReuse: s.Length17 /19 } e.Description/24/34 Tile{ AsIs: >/1 ]] }
  ...
  // </0 & Transform=2/4 (/7 e.LinesBefore/5 )/8 (/11 e.GenMode/9 )/12 (/15 e.Description/13 )/16 s.Length/17 t.Translator/18 >/1
  // closed e.LinesBefore as range 5
  // closed e.GenMode as range 9
  // closed e.Description as range 13
  //DEBUG: t.Translator: 18
  //DEBUG: s.Length: 17
  //DEBUG: e.LinesBefore: 5
  //DEBUG: e.GenMode: 9
  //DEBUG: e.Description: 13
  ...
  //RESULT: Tile{ [[ } Tile{ AsIs: e.LinesBefore/5 } Tile{ AsIs: (/15 }"/*GE"/20 Tile{ HalfReuse: 'N'/8 HalfReuse: ':'/11 AsIs: e.GenMode/9 AsIs: )/12 } Tile{ AsIs: e.Description/13 } Tile{ AsIs: (/7 }"GEN:END*/"/22 Tile{ AsIs: )/16 } Tile{ AsIs: </0 Reuse: & Apply@0/4 } Tile{ AsIs: t.Translator/18 } Tile{ AsIs: s.Length/17 } e.Description/13/24 Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Transform_A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Transform=1/4 (/7 e.new1/5 )/8 s.new2/9 (/12 e.new3/10 )/13 (/16 e.new4/14 )/17 e.new5/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  do {
    // </0 & Transform=1/4 (/7 e.new8/18 )/8 s.new6/9 (/12 e.new9/20 )/13 (/16 e.new10/22 s.new11/29 s.new12/28 s.new13/27 s.new14/26 )/17 e.new7/24 >/1
    ...
    do {
      // </0 & Transform=1/4 (/7 e.Source/30 )/8 s.Length/9 (/12 e.LinesBefore/32 )/13 (/16 'T'/38 'O'/39 'K'/29 'E'/28 'N'/27 'S'/26 )/17 e.Description/36 >/1
      ...
      if( ! refalrts::empty_seq( context[34], context[35] ) )
        continue;
      // closed e.Source as range 30
      // closed e.LinesBefore as range 32
      // closed e.Description as range 36
      //DEBUG: s.Length: 9
      //DEBUG: e.Source: 30
      //DEBUG: e.LinesBefore: 32
      //DEBUG: e.Description: 36

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: e.LinesBefore/32 } Tile{ AsIs: (/12 }"/*GE"/40 Tile{ HalfReuse: 'N'/13 HalfReuse: ':'/16 AsIs: 'T'/38 AsIs: 'O'/39 AsIs: 'K'/29 AsIs: 'E'/28 AsIs: 'N'/27 AsIs: 'S'/26 AsIs: )/17 AsIs: e.Description/36 HalfReuse: (/1 }"GEN:END*/"/42 )/44 Tile{ AsIs: </0 Reuse: & Fetch@1/4 AsIs: (/7 } </45 Tile{ HalfReuse: & DFA-Tokens/8 AsIs: s.Length/9 } e.Description/36/46 >/48 )/49 Tile{ AsIs: e.Source/30 } >/50 Tile{ ]] }
    ...
    // </0 & Transform=1/4 (/7 e.Source/30 )/8 s.Length/9 (/12 e.LinesBefore/32 )/13 (/16 'F'/29 'L'/28 'E'/27 'X'/26 )/17 e.Description/34 >/1
    context[30] = context[18];
    context[31] = context[19];
    context[32] = context[20];
    context[33] = context[21];
    ...
    // closed e.Source as range 30
    // closed e.LinesBefore as range 32
    // closed e.Description as range 34
    //DEBUG: s.Length: 9
    //DEBUG: e.Source: 30
    //DEBUG: e.LinesBefore: 32
    //DEBUG: e.Description: 34

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: e.LinesBefore/32 } Tile{ AsIs: (/12 }"/*GE"/36 Tile{ HalfReuse: 'N'/13 HalfReuse: ':'/16 AsIs: 'F'/29 AsIs: 'L'/28 AsIs: 'E'/27 AsIs: 'X'/26 AsIs: )/17 AsIs: e.Description/34 HalfReuse: (/1 }"GEN:END*/"/38 )/40 Tile{ AsIs: </0 Reuse: & Fetch@2/4 AsIs: (/7 } </41 Tile{ HalfReuse: & Flex-Tokens/8 AsIs: s.Length/9 } e.Description/34/42 >/44 )/45 Tile{ AsIs: e.Source/30 } >/46 Tile{ ]] }
  ...
  // </0 & Transform=1/4 (/7 e.Source/5 )/8 s.Length/9 (/12 e.LinesBefore/10 )/13 (/16 e.GenMode/14 )/17 e.Description/2 >/1
  // closed e.Source as range 5
  // closed e.LinesBefore as range 10
  // closed e.GenMode as range 14
  // closed e.Description as range 2
  //DEBUG: s.Length: 9
  //DEBUG: e.Source: 5
  //DEBUG: e.LinesBefore: 10
  //DEBUG: e.GenMode: 14
  //DEBUG: e.Description: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </18 & Transform=2/19 Tile{ AsIs: (/12 AsIs: e.LinesBefore/10 AsIs: )/13 AsIs: (/16 AsIs: e.GenMode/14 AsIs: )/17 } (/20 Tile{ AsIs: e.Description/2 } )/21 Tile{ AsIs: s.Length/9 } </22 Tile{ HalfReuse: & ErrorAt/0 HalfReuse: (/4 HalfReuse: s.Length9 /7 AsIs: e.Source/5 AsIs: )/8 }"Unknown generation mode "/23 e.GenMode/14/25 >/27 Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_Transform(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & Transform/4 (/7 e.Source/5 )/8 e.Lines/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </9 & Transform=1/10 (/11 e.Source/5/12 )/14 Tile{ AsIs: </0 Reuse: & SplitSource/4 AsIs: (/7 AsIs: e.Source/5 AsIs: )/8 AsIs: e.Lines/2 AsIs: >/1 } >/15 Tile{ ]] }
...
static refalrts::FnResult func_gen_SplitSource_S1A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[15];
  refalrts::zeros( context, 15 );
  // </0 & SplitSource$1=1/4 (/7 e.GenMode/5 )/8 (/11 e.Description/9 )/12 s.Length/13 e.LinesBefore$a/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  if( ! context[11] )
    return refalrts::cRecognitionImpossible;
  refalrts::bracket_pointers(context[11], context[12]);
  // closed e.GenMode as range 5
  // closed e.Description as range 9
  if( ! refalrts::svar_left( context[13], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  // closed e.LinesBefore$a as range 2
  //DEBUG: e.GenMode: 5
  //DEBUG: e.Description: 9
  //DEBUG: s.Length: 13
  //DEBUG: e.LinesBefore$a: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 } & Add/14 Tile{ HalfReuse: 1/12 AsIs: s.Length/13 } Tile{ AsIs: >/1 } Tile{ AsIs: (/11 } Tile{ AsIs: e.LinesBefore$a/2 } Tile{ HalfReuse: )/4 AsIs: (/7 AsIs: e.GenMode/5 AsIs: )/8 } Tile{ AsIs: e.Description/9 } Tile{ ]] }
...
static refalrts::FnResult func_gen_SplitSource_S2A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & SplitSource$2=1/4 (/7 e.Source/5 )/8 s.CommentPos/9 e.LinesBefore$a/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  // closed e.LinesBefore$a as range 2
  //DEBUG: e.Source: 5
  //DEBUG: s.CommentPos: 9
  //DEBUG: e.LinesBefore$a: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} e.LinesBefore$a/2 {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & ErrorAt/4 AsIs: (/7 } Tile{ AsIs: s.CommentPos/9 } Tile{ AsIs: e.Source/5 } Tile{ AsIs: )/8 }"End of description not found"/10 Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_SplitSource(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & SplitSource/4 (/7 e.new1/5 )/8 e.new2/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new2 as range 2
  do {
    // </0 & SplitSource/4 (/7 e.Source/9 )/8 e.LinesBefore/13 (/19 '/'/21 '*'/22 'G'/23 'E'/24 'N'/25 ':'/26 e.GenMode/17 )/20 e.Description/27 (/33 'G'/35 'E'/36 'N'/37 ':'/38 'E'/39 'N'/40 'D'/41 '*'/42 '/'/43 )/34 e.Skipped/29 >/1
    context[9] = context[5];
    context[10] = context[6];
    context[11] = context[2];
    context[12] = context[3];
    // closed e.Source as range 9
    context[13] = 0;
    context[14] = 0;
    ...
    do {
      ...
      do {
        ...
        if( ! refalrts::empty_seq( context[31], context[32] ) )
          continue;
        // closed e.Skipped as range 29
        //DEBUG: e.Source: 9
        //DEBUG: e.LinesBefore: 13
        //DEBUG: e.GenMode: 17
        //DEBUG: e.Description: 27
        //DEBUG: e.Skipped: 29

        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} e.Source/9 )/8 {REMOVED TILE} (/19 '/'/21 '*'/22 'G'/23 'E'/24 'N'/25 ':'/26 {REMOVED TILE} {REMOVED TILE} 'N'/37 ':'/38 'E'/39 'N'/40 {REMOVED TILE} '*'/42 '/'/43 {REMOVED TILE} e.Skipped/29 {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & SplitSource$1=1/4 AsIs: (/7 } Tile{ AsIs: e.GenMode/17 } Tile{ AsIs: )/34 } Tile{ HalfReuse: (/20 AsIs: e.Description/27 HalfReuse: )/33 HalfReuse: </35 HalfReuse: & Lenw/36 } Tile{ AsIs: e.LinesBefore/13 } Tile{ HalfReuse: >/41 } Tile{ AsIs: >/1 ]] }
  ...
  do {
    // </0 & SplitSource/4 (/7 e.Source/9 )/8 e.LinesBefore/13 (/19 '/'/21 '*'/22 'G'/23 'E'/24 'N'/25 ':'/26 e.GenMode/17 )/20 e.DescriptionAndTail/15 >/1
    context[9] = context[5];
    context[10] = context[6];
    context[11] = context[2];
    context[12] = context[3];
    ...
    do {
      ...
      if( ! context[26] )
        continue;
      // closed e.GenMode as range 17
      // closed e.DescriptionAndTail as range 15
      //DEBUG: e.Source: 9
      //DEBUG: e.LinesBefore: 13
      //DEBUG: e.GenMode: 17
      //DEBUG: e.DescriptionAndTail: 15

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} e.DescriptionAndTail/15 {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & SplitSource$2=1/4 AsIs: (/7 } Tile{ AsIs: e.Source/9 } )/27 </28 Tile{ HalfReuse: & Lenw/8 AsIs: e.LinesBefore/13 AsIs: (/19 AsIs: '/'/21 AsIs: '*'/22 AsIs: 'G'/23 AsIs: 'E'/24 AsIs: 'N'/25 AsIs: ':'/26 AsIs: e.GenMode/17 AsIs: )/20 } >/29 Tile{ AsIs: >/1 ]] }
  ...
  // </0 & SplitSource/4 (/7 e.Source/5 )/8 e.Lines/2 >/1
  // closed e.Source as range 5
  // closed e.Lines as range 2
  //DEBUG: e.Source: 5
  //DEBUG: e.Lines: 2
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} e.Lines/2 {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & ErrorAt/4 AsIs: (/7 } 1/9 Tile{ AsIs: e.Source/5 } Tile{ AsIs: )/8 }"Lexer description not found"/10 Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_GetTranslator(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & GetTranslator/4 s.new1/5 (/8 e.new2/6 )/9 e.new3/2 >/1
  if( ! refalrts::svar_left( context[5], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  context[6] = 0;
  context[7] = 0;
  ...
  // closed e.new3 as range 2
  do {
    // </0 & GetTranslator/4 s.new4/5 (/8 e.new10/10 )/9 e.new5/12 s.new6/17 s.new7/16 s.new8/15 s.new9/14 >/1
    context[10] = context[6];
    context[11] = context[7];
    ...
    do {
      // </0 & GetTranslator/4 s.Length/5 (/8 e.Source/18 )/9 'T'/22 'O'/23 'K'/17 'E'/16 'N'/15 'S'/14 >/1
      ...
      if( ! refalrts::empty_seq( context[20], context[21] ) )
        continue;
      // closed e.Source as range 18
      //DEBUG: s.Length: 5
      //DEBUG: e.Source: 18

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.Length/5 {REMOVED TILE} 'O'/23 'K'/17 'E'/16 'N'/15 'S'/14 >/1 {REMOVED TILE}
      //RESULT: Tile{ [[ HalfReuse: [*]/0 Reuse: & Pipe$2\1@1/4 } Tile{ AsIs: (/8 AsIs: e.Source/18 AsIs: )/9 HalfReuse: {*}/22 } Tile{ ]] }
      refalrts::reinit_closure_head(context[0]);
    ...
    // </0 & GetTranslator/4 s.Length/5 (/8 e.Source/18 )/9 'F'/17 'L'/16 'E'/15 'X'/14 >/1
    context[18] = context[10];
    context[19] = context[11];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} s.Length/5 {REMOVED TILE} 'L'/16 'E'/15 'X'/14 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ HalfReuse: [*]/0 Reuse: & Pipe$2\1@2/4 } Tile{ AsIs: (/8 AsIs: e.Source/18 AsIs: )/9 HalfReuse: {*}/17 } Tile{ ]] }
    refalrts::reinit_closure_head(context[0]);
  ...
  // </0 & GetTranslator/4 s.Length/5 (/8 e.Source/6 )/9 e.OtherGenMode/2 >/1
  // closed e.Source as range 6
  // closed e.OtherGenMode as range 2
  //DEBUG: s.Length: 5
  //DEBUG: e.Source: 6
  //DEBUG: e.OtherGenMode: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & ErrorAt/4 } Tile{ AsIs: (/8 } Tile{ AsIs: s.Length/5 } Tile{ AsIs: e.Source/6 } )/10"Unknown generation mode"/11 Tile{ HalfReuse: ' '/9 AsIs: e.OtherGenMode/2 AsIs: >/1 ]] }
  refalrts::alloc_close_bracket(vm, context[10]);
...
static refalrts::FnResult func_GetDFATranslator(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[7];
  refalrts::zeros( context, 7 );
  // </0 & GetDFATranslator/4 e.Source/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.Source as range 2
  //DEBUG: e.Source: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ HalfReuse: [*]/0 Reuse: & Pipe$2\1@1/4 } (/5 Tile{ AsIs: e.Source/2 } )/6 Tile{ HalfReuse: {*}/1 ]] }
  refalrts::alloc_open_bracket(vm, context[5]);
  refalrts::alloc_close_bracket(vm, context[6]);
  refalrts::reinit_closure_head(context[0]);
  refalrts::update_name(context[4], functions[efunc_gen_Pipe_S2L1Z1]);
...
static refalrts::FnResult func_GetFlexTranslator(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[7];
  refalrts::zeros( context, 7 );
  // </0 & GetFlexTranslator/4 e.Source/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ HalfReuse: [*]/0 Reuse: & Pipe$2\1@2/4 } (/5 Tile{ AsIs: e.Source/2 } )/6 Tile{ HalfReuse: {*}/1 ]] }
  refalrts::alloc_open_bracket(vm, context[5]);
  refalrts::alloc_close_bracket(vm, context[6]);
  refalrts::reinit_closure_head(context[0]);
  refalrts::update_name(context[4], functions[efunc_gen_Pipe_S2L1Z2]);
...
static refalrts::FnResult func_Flexm_Compile(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[5];
  refalrts::zeros( context, 5 );
  // </0 & Flex-Compile/4 e.AnyInput/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.AnyInput as range 2
  //DEBUG: e.AnyInput: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} </0 & Flex-Compile/4 e.AnyInput/2 >/1 {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ ]] }
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
  refalrts::Iter res = arg_end->next;
...
static refalrts::FnResult func_FillSourceToTokens(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[9];
  refalrts::zeros( context, 9 );
  // </0 & FillSourceToTokens/4 (/7 e.Source/5 )/8 e.Tokens/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@1/4 AsIs: (/7 AsIs: e.Source/5 AsIs: )/8 AsIs: e.Tokens/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_FillSourceToToken(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[15];
  refalrts::zeros( context, 15 );
  // </0 & FillSourceToToken/4 e.new/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & FillSourceToToken/4 e.new1/2 (/7 s.new2/9 s.new3/10 e.new4/5 )/8 >/1
  context[5] = 0;
  context[6] = 0;
  ...
  do {
    // </0 & FillSourceToToken/4 e.Source/11 (/7 # TError/9 s.LineNumber/10 e.Text/13 )/8 >/1
    context[11] = context[2];
    context[12] = context[3];
    ...
    if( ! refalrts::ident_term( identifiers[ident_TError], context[9] ) )
      continue;
    // closed e.Source as range 11
    // closed e.Text as range 13
    ...
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & ErrorAt/4 } Tile{ HalfReuse: (/9 AsIs: s.LineNumber/10 } Tile{ AsIs: e.Source/11 } Tile{ AsIs: )/8 } Tile{ AsIs: e.Text/13 } Tile{ AsIs: >/1 ]] }
    refalrts::update_name(context[4], functions[efunc_ErrorAt]);
  ...
  // </0 & FillSourceToToken/4 e.Source/2 (/7 s.TokType/9 s.LineNumber/10 e.Info/5 )/8 >/1
  // closed e.Source as range 2
  ...
  //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: s.TokType/9 } Tile{ HalfReuse: (/0 } Tile{ AsIs: s.LineNumber/10 } Tile{ AsIs: e.Source/2 } Tile{ AsIs: )/8 } Tile{ AsIs: e.Info/5 } Tile{ HalfReuse: )/1 ]] }
...
static refalrts::FnResult func_gen_Apply_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Apply@5/4 } Tile{ AsIs: t.Closure/13 } Tile{ AsIs: e.Bounded/11 } Tile{ AsIs: t.Acc/7 AsIs: t.Next/9 AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Pipe_S2L1Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Pipe$2\1@1/4 (/7 e.new1/5 )/8 e.new2/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new2 as range 2
  do {
    // </0 & Pipe$2\1@1/4 (/7 e.Source/9 )/8 e.Arg/11 >/1
    context[9] = context[5];
    context[10] = context[6];
    context[11] = context[2];
    context[12] = context[3];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@1/4 AsIs: (/7 } </13 Tile{ HalfReuse: & DFA-Tokens/8 AsIs: e.Arg/11 AsIs: >/1 } )/14 Tile{ AsIs: e.Source/9 } >/15 Tile{ ]] }
    refalrts::alloc_open_call(vm, context[13]);
    refalrts::alloc_close_bracket(vm, context[14]);
    refalrts::alloc_close_call(vm, context[15]);
    refalrts::update_name(context[4], functions[efunc_gen_Fetch_Z1]);
  ...
  // </0 & Pipe$2\1@1/4 (/7 e.Source/5 )/8 e.dyn/2 >/1
  // closed e.Source as range 5
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </9 & Pipe$2\1@0/10 & DFA-Tokens@0/11 (/12 Tile{ HalfReuse: (/0 Reuse: & FillSourceToTokens@0/4 AsIs: (/7 AsIs: e.Source/5 AsIs: )/8 } )/13 & DFA-Parse@0/14 & DFA-Compile@0/15 & GenerateFromDFA@0/16 )/17 Tile{ AsIs: e.dyn/2 } Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[9]);
...
static refalrts::FnResult func_gen_Pipe_S2L1Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Pipe$2\1@2/4 (/7 e.new1/5 )/8 e.new2/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new2 as range 2
  do {
    // </0 & Pipe$2\1@2/4 (/7 e.Source/9 )/8 e.Arg/11 >/1
    context[9] = context[5];
    context[10] = context[6];
    context[11] = context[2];
    context[12] = context[3];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@2/4 AsIs: (/7 } </13 Tile{ HalfReuse: & Flex-Tokens/8 AsIs: e.Arg/11 AsIs: >/1 } )/14 Tile{ AsIs: e.Source/9 } >/15 Tile{ ]] }
    refalrts::alloc_open_call(vm, context[13]);
    refalrts::alloc_close_bracket(vm, context[14]);
    refalrts::alloc_close_call(vm, context[15]);
    refalrts::update_name(context[4], functions[efunc_gen_Fetch_Z2]);
  ...
  // </0 & Pipe$2\1@2/4 (/7 e.Source/5 )/8 e.dyn/2 >/1
  // closed e.Source as range 5
  // closed e.dyn as range 2
  //DEBUG: e.Source: 5
  //DEBUG: e.dyn: 2
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </9 & Pipe$2\1@0/10 & Flex-Tokens@0/11 (/12 Tile{ HalfReuse: (/0 Reuse: & FillSourceToTokens@0/4 AsIs: (/7 AsIs: e.Source/5 AsIs: )/8 } )/13 & Flex-Parse@0/14 & GetFlexTranslator\1@0/15 & Flex-Desugar@0/16 & Flex-Compile@0/17 )/18 Tile{ AsIs: e.dyn/2 } Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[9]);
  refalrts::alloc_name(vm, context[10], functions[efunc_gen_Pipe_S2L1Z0]);
...
static refalrts::FnResult func_gen_Map_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      // </0 & Map@1/4 (/7 e.new10/15 )/8 (/13 s.new6/21 s.new7/22 e.new8/19 )/14 e.new9/17 >/1
      ...
      do {
        // </0 & Map@1/4 (/7 e.Source/23 )/8 (/13 # TError/21 s.LineNumber/22 e.1/25 )/14 e.Tail/27 >/1
        context[23] = context[15];
        ...
        //RESULT: Tile{ [[ } </29 Tile{ HalfReuse: & ErrorAt/13 HalfReuse: (/21 AsIs: s.LineNumber/22 } e.Source/23/30 Tile{ AsIs: )/14 } Tile{ AsIs: e.1/25 } >/32 Tile{ AsIs: </0 AsIs: & Map@1/4 AsIs: (/7 AsIs: e.Source/23 AsIs: )/8 } Tile{ AsIs: e.Tail/27 } Tile{ AsIs: >/1 ]] }
      ...
      // </0 & Map@1/4 (/7 e.Source/23 )/8 (/13 s.TokType/21 s.LineNumber/22 e.1/25 )/14 e.Tail/27 >/1
      context[23] = context[15];
      context[24] = context[16];
      context[25] = context[19];
      context[26] = context[20];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: (/13 AsIs: s.TokType/21 } (/29 Tile{ AsIs: s.LineNumber/22 } e.Source/23/30 )/32 Tile{ AsIs: e.1/25 } Tile{ AsIs: )/14 } Tile{ AsIs: </0 AsIs: & Map@1/4 AsIs: (/7 AsIs: e.Source/23 AsIs: )/8 } Tile{ AsIs: e.Tail/27 } Tile{ AsIs: >/1 ]] }
    ...
    // </0 & Map@1/4 (/7 e.Source/15 )/8 t.Next/13 e.Tail/17 >/1
    context[15] = context[9];
    context[16] = context[10];
    context[17] = context[11];
    context[18] = context[12];
    // closed e.Source as range 15
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </19 & FillSourceToToken*2/20 e.Source/15/21 Tile{ AsIs: t.Next/13 } >/23 Tile{ AsIs: </0 AsIs: & Map@1/4 AsIs: (/7 AsIs: e.Source/15 AsIs: )/8 } Tile{ AsIs: e.Tail/17 } Tile{ AsIs: >/1 ]] }
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Map@1/4 (/7 e.Source/9 )/8 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & Map@1/4 (/7 e.Source/5 )/8 e.items/2 >/1
  // closed e.Source as range 5
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </9 Tile{ HalfReuse: & Map@0/0 HalfReuse: (/4 HalfReuse: & FillSourceToToken@0/7 AsIs: e.Source/5 AsIs: )/8 AsIs: e.items/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[9]);
...
static refalrts::FnResult func_gen_Apply_Z4(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Apply@4/4 t.new1/5 e.new2/2 t.new3/7 >/1
  context[6] = refalrts::tvar_left( context[5], context[2], context[3] );
  if( ! context[6] )
    return refalrts::cRecognitionImpossible;
  ...
  // closed e.new2 as range 2
  do {
    // </0 & Apply@4/4 s.Fn/5 e.X/9 t.X/7 >/1
    context[9] = context[2];
    context[10] = context[3];
    if( ! refalrts::svar_term( context[5], context[5] ) )
      continue;
  ...
  do {
    // </0 & Apply@4/4 (/5 t.Closure/13 e.Bounded/11 )/6 e.X/9 t.X/7 >/1
    context[9] = context[2];
    context[10] = context[3];
    context[11] = 0;
    context[12] = 0;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} (/5 {REMOVED TILE} {REMOVED TILE} )/6 {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 AsIs: & Apply@4/4 } Tile{ AsIs: t.Closure/13 } Tile{ AsIs: e.Bounded/11 } Tile{ AsIs: e.X/9 } Tile{ AsIs: t.X/7 AsIs: >/1 ]] }
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
  ...
  // </0 & Apply@4/4 t.dyn0/5 e.X/2 t.X/7 >/1
...
static refalrts::FnResult func_gen_Apply_Z5(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Apply@5/4 t.new1/5 e.new2/2 t.new3/9 t.new4/7 >/1
  context[6] = refalrts::tvar_left( context[5], context[2], context[3] );
  if( ! context[6] )
    return refalrts::cRecognitionImpossible;
  context[8] = refalrts::tvar_right( context[7], context[2], context[3] );
  ...
  // closed e.new2 as range 2
  do {
    // </0 & Apply@5/4 s.Fn/5 e.X/11 t.X/9 t.X0/7 >/1
    context[11] = context[2];
    context[12] = context[3];
    if( ! refalrts::svar_term( context[5], context[5] ) )
      continue;
  ...
  do {
    // </0 & Apply@5/4 (/5 t.Closure/15 e.Bounded/13 )/6 e.X/11 t.X/9 t.X0/7 >/1
    context[11] = context[2];
    context[12] = context[3];
    context[13] = 0;
    context[14] = 0;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} (/5 {REMOVED TILE} {REMOVED TILE} )/6 {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 AsIs: & Apply@5/4 } Tile{ AsIs: t.Closure/15 } Tile{ AsIs: e.Bounded/13 } Tile{ AsIs: e.X/11 } Tile{ AsIs: t.X/9 AsIs: t.X0/7 AsIs: >/1 ]] }
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
  ...
  // </0 & Apply@5/4 t.dyn0/5 e.X/2 t.X/9 t.X0/7 >/1
  // closed e.X as range 2
  //DEBUG: t.dyn0: 5
  //DEBUG: t.X: 9
  //DEBUG: t.X0: 7
...
static refalrts::FnResult func_gen_Fetch_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Fetch@1/4 (/7 e.new1/5 )/8 e.new2/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new2 as range 2
  do {
    // </0 & Fetch@1/4 (/7 e.Argument/9 )/8 e.Source/11 >/1
    context[9] = context[5];
    context[10] = context[6];
    context[11] = context[2];
    context[12] = context[3];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@3/4 HalfReuse: </7 } & Map@1/13 (/14 Tile{ AsIs: e.Source/11 } Tile{ AsIs: )/8 } Tile{ AsIs: e.Argument/9 } >/15 Tile{ AsIs: >/1 ]] }
  ...
  // </0 & Fetch@1/4 (/7 e.arg/5 )/8 e.Source/2 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@0/4 } Tile{ AsIs: e.arg/5 } [*]/9 & Pipe$2\1@0/10 Tile{ AsIs: (/7 } & FillSourceToTokens@0/11 (/12 Tile{ AsIs: e.Source/2 } Tile{ AsIs: )/8 } )/13 (/14 & DFA-Parse@0/15 & DFA-Compile@0/16 & GenerateFromDFA@0/17 )/18 {*}/19 Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Fetch_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Fetch@2/4 (/7 e.new1/5 )/8 e.new2/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new2 as range 2
  do {
    // </0 & Fetch@2/4 (/7 e.Argument/9 )/8 e.Source/11 >/1
    context[9] = context[5];
    context[10] = context[6];
    context[11] = context[2];
    context[12] = context[3];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@4/4 HalfReuse: </7 } & Map@1/13 (/14 Tile{ AsIs: e.Source/11 } Tile{ AsIs: )/8 } Tile{ AsIs: e.Argument/9 } >/15 Tile{ AsIs: >/1 ]] }
    refalrts::alloc_name(vm, context[13], functions[efunc_gen_Map_Z1]);
    refalrts::alloc_open_bracket(vm, context[14]);
    refalrts::alloc_close_call(vm, context[15]);
  ...
  // </0 & Fetch@2/4 (/7 e.arg/5 )/8 e.Source/2 >/1
  // closed e.arg as range 5
  // closed e.Source as range 2
  //DEBUG: e.arg: 5
  //DEBUG: e.Source: 2
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@0/4 } Tile{ AsIs: e.arg/5 } [*]/9 & Pipe$2\1@0/10 Tile{ AsIs: (/7 } & FillSourceToTokens@0/11 (/12 Tile{ AsIs: e.Source/2 } Tile{ AsIs: )/8 } )/13 (/14 & Flex-Parse@0/15 & GetFlexTranslator\1@0/16 & Flex-Desugar@0/17 & Flex-Compile@0/18 )/19 {*}/20 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_closure_head(vm, context[9]);
  refalrts::alloc_name(vm, context[10], functions[efunc_gen_Pipe_S2L1Z0]);
  refalrts::alloc_name(vm, context[11], functions[efunc_gen_FillSourceToTokens_Z0]);
  refalrts::alloc_open_bracket(vm, context[12]);
...
static refalrts::FnResult func_gen_Fetch_Z3(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </7 & Fetch@5/8 Tile{ AsIs: </0 Reuse: & DFA-Parse/4 AsIs: e.Argument/5 AsIs: >/1 } >/9 Tile{ ]] }
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@0/4 AsIs: e.arg/2 HalfReuse: [*]/1 } & Pipe$2\1@0/5 & DFA-Parse@0/6 (/7 & DFA-Compile@0/8 & GenerateFromDFA@0/9 )/10 {*}/11 >/12 Tile{ ]] }
...
static refalrts::FnResult func_gen_Fetch_Z4(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </7 & Fetch@6/8 Tile{ AsIs: </0 Reuse: & Flex-Parse/4 AsIs: e.Argument/5 AsIs: >/1 } >/9 Tile{ ]] }
    refalrts::alloc_open_call(vm, context[7]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@0/4 AsIs: e.arg/2 HalfReuse: [*]/1 } & Pipe$2\1@0/5 & Flex-Parse@0/6 (/7 & GetFlexTranslator\1@0/8 & Flex-Desugar@0/9 & Flex-Compile@0/10 )/11 {*}/12 >/13 Tile{ ]] }
  refalrts::alloc_name(vm, context[5], functions[efunc_gen_Pipe_S2L1Z0]);
...
static refalrts::FnResult func_gen_Fetch_Z5(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </7 & Fetch@7/8 Tile{ AsIs: </0 Reuse: & DFA-Compile/4 AsIs: e.Argument/5 AsIs: >/1 } >/9 Tile{ ]] }
    refalrts::alloc_open_call(vm, context[7]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@0/4 AsIs: e.arg/2 HalfReuse: [*]/1 } & Pipe$2\1@0/5 & DFA-Compile@0/6 (/7 & GenerateFromDFA@0/8 )/9 {*}/10 >/11 Tile{ ]] }
  refalrts::alloc_name(vm, context[5], functions[efunc_gen_Pipe_S2L1Z0]);
...
static refalrts::FnResult func_gen_Fetch_Z6(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </7 & Fetch@8/8 Tile{ AsIs: </0 Reuse: & Flex-Check/4 AsIs: e.Argument/5 AsIs: >/1 } e.Argument/5/9 >/11 Tile{ ]] }
    refalrts::alloc_open_call(vm, context[7]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@0/4 AsIs: e.arg/2 HalfReuse: [*]/1 } & Pipe$2\1@0/5 & GetFlexTranslator\1@0/6 (/7 & Flex-Desugar@0/8 & Flex-Compile@0/9 )/10 {*}/11 >/12 Tile{ ]] }
  refalrts::alloc_name(vm, context[5], functions[efunc_gen_Pipe_S2L1Z0]);
...
static refalrts::FnResult func_gen_Fetch_Z7(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & GenerateFromDFA/4 AsIs: e.Argument/5 AsIs: >/1 ]] }
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@0/4 AsIs: e.arg/2 HalfReuse: & GenerateFromDFA@0/1 } >/5 Tile{ ]] }
...
static refalrts::FnResult func_gen_Fetch_Z8(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </7 & Fetch@9/8 Tile{ AsIs: </0 Reuse: & Flex-Desugar/4 AsIs: e.Argument/5 AsIs: >/1 } >/9 Tile{ ]] }
    refalrts::alloc_open_call(vm, context[7]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@0/4 AsIs: e.arg/2 HalfReuse: [*]/1 } & Pipe$2\1@0/5 & Flex-Desugar@0/6 (/7 & Flex-Compile@0/8 )/9 {*}/10 >/11 Tile{ ]] }
  refalrts::alloc_name(vm, context[5], functions[efunc_gen_Pipe_S2L1Z0]);
...
static refalrts::FnResult func_gen_Fetch_Z9(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Fetch@9/4 e.Argument/5 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & Fetch@9/4 e.arg/2 >/1
  // closed e.arg as range 2
  //DEBUG: e.arg: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@0/4 AsIs: e.arg/2 HalfReuse: & Flex-Compile@0/1 } >/5 Tile{ ]] }
  refalrts::alloc_close_call(vm, context[5]);
  refalrts::update_name(context[4], functions[efunc_gen_Fetch_Z0]);
