...
#define cookie_ns cookie_ns_2177271638_1497331417
#define COOKIE1_ 2177271638U
#define COOKIE2_ 1497331417U
...
static refalrts::FnResult func_PrintVersion(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & PrintVersion/4 e.Product/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.Product as range 2
  //DEBUG: e.Product: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Prout/4 AsIs: e.Product/2 HalfReuse: ','/1 }" a part of Refal-5-lambda compiler toolkit, version 3.3.1"/5 >/7 </8 & Prout/9"Copyright (c) 2008-2016, Alexander Konovalov, 2016-2021, BMSTU IU9 Department"/10 >/12 </13 & Prout/14"All rights reserved.\n"/15 >/17 Tile{ ]] }
  refalrts::alloc_chars(vm, context[5], context[6], " a part of Refal-5-lambda compiler toolkit, version 3.3.1", 57);
  refalrts::alloc_close_call(vm, context[7]);
  refalrts::alloc_open_call(vm, context[8]);
  refalrts::alloc_name(vm, context[9], functions[efunc_Prout]);
  refalrts::alloc_chars(vm, context[10], context[11], "Copyright (c) 2008-2016, Alexander Konovalov, 2016-2021, BMSTU IU9 Department", 77);
  refalrts::alloc_close_call(vm, context[12]);
  refalrts::alloc_open_call(vm, context[13]);
  refalrts::alloc_name(vm, context[14], functions[efunc_Prout]);
  refalrts::alloc_chars(vm, context[15], context[16], "All rights reserved.\n", 21);
