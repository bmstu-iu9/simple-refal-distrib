...
#define cookie_ns cookie_ns_3411521141_3047673054
...
static refalrts::ExternalReference ref_Evm_met("Ev-met", 3411521141U, 3047673054U);
static refalrts::ExternalReference ref_Mod("Mod", 0U, 0U);
static refalrts::ExternalReference ref_Mu("Mu", 3411521141U, 3047673054U);
static refalrts::ExternalReference ref_gen_Mu_C1C0("Mu?1?0", 3411521141U, 3047673054U);
...
static refalrts::ExternalReference ref_Residue("Residue", 3411521141U, 3047673054U);
static refalrts::ExternalReference ref_gen_Residue_C1C0("Residue?1?0", 3411521141U, 3047673054U);
static refalrts::ExternalReference ref_Sub("Sub", 0U, 0U);
static refalrts::ExternalReference ref_Type("Type", 0U, 0U);
static refalrts::ExternalReference ref_Up("Up", 3411521141U, 3047673054U);
static refalrts::ExternalReference ref_u_u_FindMuPtr("__FindMuPtr", 0U, 0U);
static refalrts::ExternalReference ref_u_u_Mum_Aux("__Mu-Aux", 3411521141U, 3047673054U);
static refalrts::ExternalReference ref_gen_u_u_Mum_Aux_S13B1("__Mu-Aux$13:1", 3411521141U, 3047673054U);
...
static refalrts::NativeReference nat_ref_Mu("Mu", 3411521141U, 3047673054U, func_Mu);
...
static refalrts::NativeReference nat_ref_gen_Mu_C1C0("Mu?1?0", 3411521141U, 3047673054U, func_gen_Mu_C1C0);
...
static refalrts::FnResult func_gen_u_u_Mum_Aux_S13B1(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    if( ! refalrts::alloc_number( context[9], 3047673054UL ) )
      return refalrts::cNoMemory;
    refalrts::update_name( context[4], ref_u_u_FindMuPtr.ref.function );
    refalrts::reinit_number( context[5], 3411521141UL );
    refalrts::push_stack( context[1] );
    refalrts::push_stack( context[0] );
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
  ...
  refalrts::update_name( context[4], ref_u_u_FindMuPtr.ref.function );
  refalrts::reinit_number( context[5], 3411521141UL );
  refalrts::reinit_number( context[7], 3047673054UL );
  refalrts::push_stack( context[1] );
  refalrts::push_stack( context[0] );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
...
static refalrts::NativeReference nat_ref_gen_u_u_Mum_Aux_S13B1("__Mu-Aux$13:1", 3411521141U, 3047673054U, func_gen_u_u_Mum_Aux_S13B1);
...
static refalrts::NativeReference nat_ref_u_u_Mum_Aux("__Mu-Aux", 3411521141U, 3047673054U, func_u_u_Mum_Aux);
...
static refalrts::NativeReference nat_ref_Residue("Residue", 3411521141U, 3047673054U, func_Residue);
...
static refalrts::NativeReference nat_ref_gen_Residue_C1C0("Residue?1?0", 3411521141U, 3047673054U, func_gen_Residue_C1C0);
...
static refalrts::FnResult func_PrintVersion(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Prout/4 AsIs: e.Product#1/2 HalfReuse: ','/1 }" a part of Refal-5-lambda compiler toolkit, version 2.0.5"/5 >/7 </8 & Prout/9"Copyright (c) 2008-2016, Alexander Konovalov, 2016-2018, BMSTU IU9 Department"/10 >/12 </13 & Prout/14"All rights reserved.\n"/15 >/17 Tile{ ]] }
  if( ! refalrts::alloc_chars( context[5], context[6], " a part of Refal-5-lambda compiler toolkit, version 2.0.5", 57 ) )
    return refalrts::cNoMemory;
