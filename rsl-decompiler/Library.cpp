...
#define cookie_ns cookie_ns_2428742722_1109477042
#define COOKIE1_ 2428742722U
#define COOKIE2_ 1109477042U

enum efunc {
  efunc_u_u_Metau_Mu = 0,
  efunc_gen_Add_S2C1 = 1,
  efunc_Add = 2,
  efunc_u_u_Stepm_Drop = 3,
  efunc_Addm_Digits = 4,
  efunc_u_u_Stepm_Start = 5,
  efunc_NormArithmArg = 6,
  efunc_Addm_Normed = 7,
  efunc_u_u_Stepm_End = 8,
  efunc_gen_NormArithmArg_S1C1 = 9,
  efunc_gen_NormArithmArg_S2C1 = 10,
  efunc_gen_NormArithmArg_S2C2 = 11,
  efunc_gen_NormArithmArg_S3C1 = 12,
  efunc_gen_NormArithmArg_S3C2 = 13,
  efunc_gen_NormArithmArg_S4C1 = 14,
  efunc_gen_NormArithmArg_S4C2 = 15,
  efunc_gen_NormArithmArg_S5C1 = 16,
  efunc_gen_NormArithmArg_S5C2 = 17,
  efunc_NormNumber = 18,
  efunc_Type = 19,
  efunc_gen_NormNumber_S7C1 = 20,
  efunc_gen_NormNumber_S8C1 = 21,
  efunc_gen_NormNumber_S9C1 = 22,
  efunc_AllDigits = 23,
  efunc_AllDigitsm_SwFirst = 24,
  efunc_Addm_Nat = 25,
  efunc_Subm_Nat = 26,
  efunc_gen_Addm_Nat_S1B1 = 27,
  efunc_Arg = 28,
  efunc_Br = 29,
  efunc_Buried = 30,
  efunc_Card = 31,
  ...
  efunc_Dg = 37,
  efunc_Dgall = 38,
  efunc_gen_Div_S1A1 = 39,
  efunc_gen_Div_S2C1 = 40,
  efunc_gen_Div_S2C2 = 41,
  efunc_Div = 42,
  efunc_Divmodm_Digits = 43,
  efunc_Divmodm_Normed = 44,
  efunc_gen_Divmod_S2C1 = 45,
  efunc_gen_Divmod_S2C2 = 46,
  efunc_Divmod = 47,
  efunc_Divmodm_Nat = 48,
  efunc_gen_Divmodm_Nat_S1A1 = 49,
  efunc_gen_Divmodm_Nat_S2A5 = 50,
  efunc_gen_Divmodm_Nat_S2A5B1 = 51,
  efunc_gen_Divmodm_Nat_S2A4 = 52,
  efunc_Divmodm_Shl = 53,
  efunc_gen_Divmodm_Nat_S2A3 = 54,
  efunc_Divmodm_Natm_Normed = 55,
  efunc_gen_Divmodm_Nat_S2A2 = 56,
  efunc_gen_Divmodm_Nat_S2A1 = 57,
  efunc_gen_Divmodm_Nat_S2A1B1 = 58,
  efunc_Divmodm_Align = 59,
  efunc_gen_Divmodm_Align_S2A1 = 60,
  efunc_LeadingZeros = 61,
  efunc_Divmodm_CalcDigits = 62,
  efunc_gen_Divmodm_CalcDigits_B1 = 63,
  efunc_gen_Divmodm_CalcDigits_A1 = 64,
  efunc_gen_Divmodm_CalcDigits_B1D2 = 65,
  efunc_Divmodm_GetNextDigit = 66,
  efunc_gen_Divmodm_GetNextDigit_S2A1 = 67,
  efunc_Divmodm_AdjustDigit = 68,
  efunc_Subm_Normed = 69,
  efunc_Mulm_Natm_Line = 70,
  efunc_Divmodm_GuessDigit = 71,
  efunc_Subm_Digits = 72,
  efunc_Explode = 73,
  efunc_First = 74,
  efunc_Get = 75,
  efunc_Autoopen = 76,
  efunc_ZeroHandle = 77,
  efunc_gen_Implode_S1B1 = 78,
  efunc_DoImplode = 79,
  efunc_Implode = 80,
  efunc_gen_DoImplode_S4C1 = 81,
  efunc_gen_DoImplode_S5C1 = 82,
  efunc_Implodeu_Ext = 83,
  efunc_Last = 84,
  efunc_Lenw = 85,
  efunc_Lower = 86,
  efunc_gen_Mod_S1A1 = 87,
  efunc_gen_Mod_S2C1 = 88,
  efunc_gen_Mod_S2C2 = 89,
  efunc_Mod = 90,
  efunc_gen_Mul_S2C1 = 91,
  efunc_Mul = 92,
  efunc_Mulm_Digits = 93,
  efunc_Mulm_Normed = 94,
  efunc_Mulm_Nat = 95,
  efunc_gen_Mulm_Natm_Line_S2B1 = 96,
  efunc_Numb = 97,
  efunc_Neg = 98,
  efunc_Numbm_Aux = 99,
  efunc_DoNumb = 100,
  efunc_DoNumbm_AddDigit = 101,
  efunc_Open = 102,
  efunc_Ord = 103,
  efunc_Print = 104,
  efunc_Putm_Aux = 105,
  efunc_Prout = 106,
  efunc_Putoutm_Aux = 107,
  efunc_Proud = 108,
  efunc_Trout = 109,
  efunc_Put = 110,
  efunc_Putout = 111,
  ...
  efunc_Rp = 113,
  efunc_Step = 114,
  efunc_gen_Sub_S2C1 = 115,
  efunc_Sub = 116,
  efunc_gen_Subm_Nat_B1 = 117,
  efunc_Subm_Natm_Nat = 118,
  efunc_Comparem_Nat = 119,
  efunc_DoSubm_Natm_Nat = 120,
  efunc_gen_DoSubm_Natm_Nat_S1B2 = 121,
  efunc_gen_DoSubm_Natm_Nat_S1B1 = 122,
  efunc_gen_Symb_B1 = 123,
  efunc_Symbm_Nat = 124,
  efunc_gen_Symb_A1 = 125,
  efunc_gen_Symb_B1D4 = 126,
  efunc_Symb = 127,
  efunc_gen_Symbm_Nat_S2A2 = 128,
  efunc_gen_Symbm_Nat_S2A1 = 129,
  efunc_StrFromMacroDigit = 130,
  efunc_Time = 131,
  efunc_Upper = 132,
  efunc_Sysfun = 133,
  efunc_Sysfunm_Xxin = 134,
  efunc_Sysfunm_Xxout = 135,
  efunc_gen_Sysfunm_Xxin_B1S1A1 = 136,
  efunc_Xxinm_Scan = 137,
  efunc_gen_Sysfunm_Xxin_B1 = 138,
  efunc_Openm_Auto = 139,
  efunc_ExistFile = 140,
  efunc_gen_Xxinm_Scan_S14B1 = 141,
  efunc_Sysfunm_Xxinm_ERROR = 142,
  efunc_gen_Xxinm_Scan_S38B1 = 143,
  efunc_HexDigit = 144,
  efunc_Close = 145,
  efunc_Quote = 146,
  efunc_Xxoutm_Wrap = 147,
  efunc_Xxoutm_Scan = 148,
  efunc_gen_Xxoutm_Wrap_B1 = 149,
  efunc_Writem_Aux = 150,
  efunc_gen_Xxoutm_Scan_S1A1 = 151,
  efunc_gen_Xxoutm_Scan_S2A1 = 152,
  efunc_gen_Xxoutm_Scan_S4A1 = 153,
  efunc_gen_Xxoutm_Scan_S6A1 = 154,
  efunc_gen_Xxoutm_Scan_S7A1 = 155,
  efunc_Xxoutm_Chars = 156,
  efunc_gen_Xxoutm_Chars_S7A1 = 157,
  efunc_Hex = 158,
  efunc_gen_Xxoutm_Chars_S1C1 = 159,
  efunc_Freeze = 160,
  efunc_Freezer = 161,
  efunc_Dn = 162,
  efunc_GetEnv = 163,
  efunc_System = 164,
  efunc_Exit = 165,
  efunc_GetCurrentDirectory = 166,
  efunc_RemoveFile = 167,
  efunc_Explodeu_Ext = 168,
  efunc_TimeElapsed = 169,
  efunc_gen_Compare_S2C1 = 170,
  efunc_Compare = 171,
  efunc_Comparem_Digits = 172,
  efunc_Comparem_Normed = 173,
  efunc_Comparem_Align = 174,
  efunc_Comparem_ByDigits = 175,
  efunc_DeSysfun = 176,
  efunc_XMLParse = 177,
  efunc_Random = 178,
  efunc_RandomDigit = 179,
  efunc_Write = 180,
  efunc_ListOfBuiltin = 181,
  efunc_SizeOf = 182,
  efunc_GetPID = 183,
  efunc_GetPPID = 184,
  efunc_gen_Openm_Auto_A1 = 185,
  efunc_GetFreeHandle = 186,
  efunc_SymbCompare = 187,
  efunc_WriteBytes = 188,
  efunc_ReadBytes = 189,
  efunc_FTell = 190,
  efunc_FSeek = 191,
  efunc_RenameFile = 192,
  efunc_Modulem_Load = 193,
  efunc_Modulem_Unload = 194,
  efunc_Modulem_Mu = 195,
  efunc_Modulem_LookupFunction = 196,
  efunc_Modulem_FunctionPtr = 197,
  efunc_Platform = 198,
  efunc_DirectorySeparators = 199,
  efunc_gen_DirectorySeparator_A1 = 200,
  efunc_DirectorySeparator = 201,
  efunc_gen_IsDirectorySeparator_B1 = 202,
  efunc_IsDirectorySeparator = 203,
  efunc_PathSeparator = 204,
  efunc_INIT = 205,
  efunc_FINAL = 206,
  efunc_gen_Addm_Nat_S1B1Z0 = 207,
  efunc_gen_Cp_B1Z0 = 208,
  efunc_gen_Dg_B1Z0 = 209,
  efunc_gen_Divmodm_Nat_S1A1Z0 = 210,
  efunc_gen_Divmodm_Nat_S2A5Z0 = 211,
  efunc_gen_Divmodm_Nat_S2A4Z0 = 212,
  efunc_gen_Divmodm_Nat_S2A3Z0 = 213,
  efunc_gen_Divmodm_Nat_S2A2Z0 = 214,
  efunc_gen_Divmodm_Nat_S2A1Z0 = 215,
  efunc_gen_Divmodm_CalcDigits_B1Z0 = 216,
  efunc_gen_Divmodm_CalcDigits_A1Z0 = 217,
  efunc_gen_Divmodm_GetNextDigit_S2A1Z0 = 218,
  efunc_gen_Implode_S1B1Z0 = 219,
  efunc_gen_Mulm_Natm_Line_S2B1Z0 = 220,
  efunc_gen_Rp_B1Z0 = 221,
  efunc_gen_Subm_Nat_B1Z0 = 222,
  efunc_gen_DoSubm_Natm_Nat_S1B2Z0 = 223,
  efunc_gen_Symb_B1Z0 = 224,
  efunc_gen_Symb_A1Z0 = 225,
  efunc_gen_Symbm_Nat_S2A2Z0 = 226,
  efunc_gen_Sysfunm_Xxin_B1Z0 = 227,
  efunc_gen_Xxinm_Scan_S14B1Z0 = 228,
  efunc_gen_Xxinm_Scan_S38B1Z0 = 229,
  efunc_gen_Xxoutm_Wrap_B1Z0 = 230,
  efunc_gen_Xxoutm_Scan_S4A1Z0 = 231,
  efunc_gen_Xxoutm_Chars_S7A1Z0 = 232,
  efunc_gen_Openm_Auto_A1Z0 = 233,
  efunc_gen_IsDirectorySeparator_B1Z0 = 234,
};
...
static refalrts::FnResult func_Add(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //RESULT: Tile{ [[ } </9 & __Step-Drop/10 >/11 Tile{ AsIs: </0 Reuse: & Add-Digits/4 AsIs: s.First#1/7 AsIs: s.Second#1/8 AsIs: >/1 ]] }
...
static refalrts::FnResult func_Divmod(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </9 & __Step-Drop/10 >/11 Tile{ AsIs: </0 Reuse: & Divmod-Digits/4 AsIs: s.First#1/7 AsIs: s.Second#1/8 AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[9]);
    refalrts::alloc_name(vm, context[10], functions[efunc_u_u_Stepm_Drop]);
    refalrts::alloc_close_call(vm, context[11]);
    refalrts::update_name(context[4], functions[efunc_Divmodm_Digits]);
...
static refalrts::NativeReference nat_ref_gen_Divmodm_CalcDigits_B1("Divmod-CalcDigits:1", COOKIE1_, COOKIE2_, func_gen_Divmodm_CalcDigits_B1);
...
static refalrts::FnResult func_Mul(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </9 & __Step-Drop/10 >/11 Tile{ AsIs: </0 Reuse: & Mul-Digits/4 AsIs: s.First#1/7 AsIs: s.Second#1/8 AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[9]);
    refalrts::alloc_name(vm, context[10], functions[efunc_u_u_Stepm_Drop]);
    refalrts::alloc_close_call(vm, context[11]);
...
static refalrts::FnResult func_Numbm_Aux(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 & DoNumb/6 (/7 Tile{ HalfReuse: 0/0 HalfReuse: )/4 AsIs: e.String#1/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
...
static refalrts::FnResult func_DoNumb(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & DoNumb/4 (/7 e.new#1/5 )/8 e.new#2/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new#2 as range 2
  do {
    // </0 & DoNumb/4 (/7 e.new#5/9 )/8 s.new#3/13 e.new#4/11 >/1
    context[9] = context[5];
    context[10] = context[6];
    context[11] = context[2];
    context[12] = context[3];
    ...
    // closed e.new#4 as range 11
    do {
      // </0 & DoNumb/4 (/7 e.Value#1/14 )/8 '0'/13 e.Rest#1/16 >/1
      context[14] = context[9];
      context[15] = context[10];
      context[16] = context[11];
      context[17] = context[12];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </18 Tile{ HalfReuse: & DoNumb/0 HalfReuse: </4 HalfReuse: & DoNumb-AddDigit/7 AsIs: e.Value#1/14 HalfReuse: 0/8 HalfReuse: >/13 AsIs: e.Rest#1/16 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[18]);
      refalrts::reinit_name(context[0], functions[efunc_DoNumb]);
      refalrts::reinit_open_call(context[4]);
      refalrts::reinit_name(context[7], functions[efunc_DoNumbm_AddDigit]);
    ...
    do {
      // </0 & DoNumb/4 (/7 e.Value#1/14 )/8 '1'/13 e.Rest#1/16 >/1
      context[14] = context[9];
      context[15] = context[10];
      context[16] = context[11];
      context[17] = context[12];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </18 Tile{ HalfReuse: & DoNumb/0 HalfReuse: </4 HalfReuse: & DoNumb-AddDigit/7 AsIs: e.Value#1/14 HalfReuse: 1/8 HalfReuse: >/13 AsIs: e.Rest#1/16 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[18]);
      refalrts::reinit_name(context[0], functions[efunc_DoNumb]);
      refalrts::reinit_open_call(context[4]);
      refalrts::reinit_name(context[7], functions[efunc_DoNumbm_AddDigit]);
    ...
    do {
      // </0 & DoNumb/4 (/7 e.Value#1/14 )/8 '2'/13 e.Rest#1/16 >/1
      context[14] = context[9];
      context[15] = context[10];
      context[16] = context[11];
      context[17] = context[12];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </18 Tile{ HalfReuse: & DoNumb/0 HalfReuse: </4 HalfReuse: & DoNumb-AddDigit/7 AsIs: e.Value#1/14 HalfReuse: 2/8 HalfReuse: >/13 AsIs: e.Rest#1/16 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[18]);
      refalrts::reinit_name(context[0], functions[efunc_DoNumb]);
      refalrts::reinit_open_call(context[4]);
      refalrts::reinit_name(context[7], functions[efunc_DoNumbm_AddDigit]);
    ...
    do {
      // </0 & DoNumb/4 (/7 e.Value#1/14 )/8 '3'/13 e.Rest#1/16 >/1
      context[14] = context[9];
      context[15] = context[10];
      context[16] = context[11];
      context[17] = context[12];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </18 Tile{ HalfReuse: & DoNumb/0 HalfReuse: </4 HalfReuse: & DoNumb-AddDigit/7 AsIs: e.Value#1/14 HalfReuse: 3/8 HalfReuse: >/13 AsIs: e.Rest#1/16 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[18]);
      refalrts::reinit_name(context[0], functions[efunc_DoNumb]);
      refalrts::reinit_open_call(context[4]);
      refalrts::reinit_name(context[7], functions[efunc_DoNumbm_AddDigit]);
    ...
    do {
      // </0 & DoNumb/4 (/7 e.Value#1/14 )/8 '4'/13 e.Rest#1/16 >/1
      context[14] = context[9];
      context[15] = context[10];
      context[16] = context[11];
      context[17] = context[12];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </18 Tile{ HalfReuse: & DoNumb/0 HalfReuse: </4 HalfReuse: & DoNumb-AddDigit/7 AsIs: e.Value#1/14 HalfReuse: 4/8 HalfReuse: >/13 AsIs: e.Rest#1/16 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[18]);
      refalrts::reinit_name(context[0], functions[efunc_DoNumb]);
      refalrts::reinit_open_call(context[4]);
      refalrts::reinit_name(context[7], functions[efunc_DoNumbm_AddDigit]);
    ...
    do {
      // </0 & DoNumb/4 (/7 e.Value#1/14 )/8 '5'/13 e.Rest#1/16 >/1
      context[14] = context[9];
      context[15] = context[10];
      context[16] = context[11];
      context[17] = context[12];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </18 Tile{ HalfReuse: & DoNumb/0 HalfReuse: </4 HalfReuse: & DoNumb-AddDigit/7 AsIs: e.Value#1/14 HalfReuse: 5/8 HalfReuse: >/13 AsIs: e.Rest#1/16 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[18]);
      refalrts::reinit_name(context[0], functions[efunc_DoNumb]);
      refalrts::reinit_open_call(context[4]);
      refalrts::reinit_name(context[7], functions[efunc_DoNumbm_AddDigit]);
    ...
    do {
      // </0 & DoNumb/4 (/7 e.Value#1/14 )/8 '6'/13 e.Rest#1/16 >/1
      context[14] = context[9];
      context[15] = context[10];
      context[16] = context[11];
      context[17] = context[12];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </18 Tile{ HalfReuse: & DoNumb/0 HalfReuse: </4 HalfReuse: & DoNumb-AddDigit/7 AsIs: e.Value#1/14 HalfReuse: 6/8 HalfReuse: >/13 AsIs: e.Rest#1/16 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[18]);
      refalrts::reinit_name(context[0], functions[efunc_DoNumb]);
      refalrts::reinit_open_call(context[4]);
      refalrts::reinit_name(context[7], functions[efunc_DoNumbm_AddDigit]);
    ...
    do {
      // </0 & DoNumb/4 (/7 e.Value#1/14 )/8 '7'/13 e.Rest#1/16 >/1
      context[14] = context[9];
      context[15] = context[10];
      context[16] = context[11];
      context[17] = context[12];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </18 Tile{ HalfReuse: & DoNumb/0 HalfReuse: </4 HalfReuse: & DoNumb-AddDigit/7 AsIs: e.Value#1/14 HalfReuse: 7/8 HalfReuse: >/13 AsIs: e.Rest#1/16 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[18]);
      refalrts::reinit_name(context[0], functions[efunc_DoNumb]);
      refalrts::reinit_open_call(context[4]);
      refalrts::reinit_name(context[7], functions[efunc_DoNumbm_AddDigit]);
    ...
    do {
      // </0 & DoNumb/4 (/7 e.Value#1/14 )/8 '8'/13 e.Rest#1/16 >/1
      context[14] = context[9];
      context[15] = context[10];
      context[16] = context[11];
      context[17] = context[12];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </18 Tile{ HalfReuse: & DoNumb/0 HalfReuse: </4 HalfReuse: & DoNumb-AddDigit/7 AsIs: e.Value#1/14 HalfReuse: 8/8 HalfReuse: >/13 AsIs: e.Rest#1/16 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[18]);
      refalrts::reinit_name(context[0], functions[efunc_DoNumb]);
      refalrts::reinit_open_call(context[4]);
      refalrts::reinit_name(context[7], functions[efunc_DoNumbm_AddDigit]);
    ...
    // </0 & DoNumb/4 (/7 e.Value#1/14 )/8 '9'/13 e.Rest#1/16 >/1
    context[14] = context[9];
    context[15] = context[10];
    context[16] = context[11];
    context[17] = context[12];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </18 Tile{ HalfReuse: & DoNumb/0 HalfReuse: </4 HalfReuse: & DoNumb-AddDigit/7 AsIs: e.Value#1/14 HalfReuse: 9/8 HalfReuse: >/13 AsIs: e.Rest#1/16 AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[18]);
    refalrts::reinit_name(context[0], functions[efunc_DoNumb]);
    refalrts::reinit_open_call(context[4]);
    refalrts::reinit_name(context[7], functions[efunc_DoNumbm_AddDigit]);
    refalrts::reinit_number(context[8], 9UL);
    refalrts::reinit_close_call(context[13]);
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[18] );
    refalrts::push_stack( vm, context[13] );
  ...
  // </0 & DoNumb/4 (/7 e.Value#1/5 )/8 e.Rest#1/2 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} </0 & DoNumb/4 (/7 {REMOVED TILE} )/8 e.Rest#1/2 >/1 {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ AsIs: e.Value#1/5 } Tile{ ]] }
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
  refalrts::Iter res = arg_end->next;
  res = refalrts::splice_evar( res, context[5], context[6] );
...
static refalrts::FnResult func_DoNumbm_AddDigit(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[14];
  refalrts::zeros( context, 14 );
  // </0 & DoNumb-AddDigit/4 e.Value#1/2 s.Digit#1/5 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  if( ! refalrts::svar_right( context[5], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  // closed e.Value#1 as range 2
  //DEBUG: s.Digit#1: 5
  //DEBUG: e.Value#1: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } (/6 Tile{ AsIs: </0 Reuse: & Add-Nat/4 } (/7 </8 & Mul-Nat-Line/9 Tile{ AsIs: e.Value#1/2 } 10/10 >/11 )/12 Tile{ AsIs: s.Digit#1/5 AsIs: >/1 } )/13 Tile{ ]] }
...
static refalrts::FnResult func_Print(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 & __Step-Drop/6 >/7 </8 Tile{ HalfReuse: & Put-Aux/0 HalfReuse: # stdout/4 AsIs: e.AnyExpression#1/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
...
static refalrts::FnResult func_Prout(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 & __Step-Drop/6 >/7 </8 Tile{ HalfReuse: & Putout-Aux/0 HalfReuse: # stdout/4 AsIs: e.AnyExpression#1/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::alloc_name(vm, context[6], functions[efunc_u_u_Stepm_Drop]);
  refalrts::alloc_close_call(vm, context[7]);
  refalrts::alloc_open_call(vm, context[8]);
...
static refalrts::FnResult func_Sub(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </9 & __Step-Drop/10 >/11 Tile{ AsIs: </0 Reuse: & Sub-Digits/4 AsIs: s.First#1/7 AsIs: s.Second#1/8 AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[9]);
    refalrts::alloc_name(vm, context[10], functions[efunc_u_u_Stepm_Drop]);
    refalrts::alloc_close_call(vm, context[11]);
    refalrts::update_name(context[4], functions[efunc_Subm_Digits]);
...
static refalrts::NativeReference nat_ref_gen_Symb_B1("Symb:1", COOKIE1_, COOKIE2_, func_gen_Symb_B1);
...
static refalrts::NativeReference nat_ref_gen_Symb_A1("Symb=1", COOKIE1_, COOKIE2_, func_gen_Symb_A1);
...
static refalrts::FnResult func_gen_Symbm_Nat_S2A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Symb-Nat$2=2/4 AsIs: (/7 AsIs: e.Div#2/5 AsIs: )/8 } </10 & Last/11 9/12"000000000"/13 </15 & StrFromMacroDigit/16 Tile{ AsIs: s.Mod#2/9 AsIs: >/1 } >/17 >/18 Tile{ ]] }
  refalrts::alloc_open_call(vm, context[10]);
  ...
  refalrts::alloc_open_call(vm, context[15]);
  refalrts::alloc_name(vm, context[16], functions[efunc_StrFromMacroDigit]);
  refalrts::alloc_close_call(vm, context[17]);
  refalrts::alloc_close_call(vm, context[18]);
...
static refalrts::FnResult func_Symbm_Nat(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & StrFromMacroDigit/4 AsIs: s.Number#1/7 AsIs: >/1 ]] }
    refalrts::update_name(context[4], functions[efunc_StrFromMacroDigit]);
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    return refalrts::cSuccess;
  } while ( 0 );
...
static refalrts::FnResult func_gen_Sysfunm_Xxin_B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ HalfReuse: </1 } & Sysfun-Xxin:1$1=1/12 Tile{ AsIs: </0 Reuse: & Open-Auto/4 HalfReuse: 'r'/7 AsIs: e.FileName#1/10 HalfReuse: >/8 HalfReuse: >/9 } Tile{ ]] }
  ...
  do {
    ...
    do {
      ...
      do {
        ...
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Close/4 AsIs: s.FileNo#1/5 HalfReuse: >/6 } Tile{ AsIs: e.Scanned#1/22 } Tile{ ]] }
...
static refalrts::FnResult func_Sysfunm_Xxout(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </10 & Xxout-Wrap/11 </12 Tile{ HalfReuse: & Open-Auto/0 HalfReuse: 'w'/4 AsIs: e.FileName#1/2 HalfReuse: >/7 AsIs: s.Width#1/9 } </13 & Xxout-Scan/14 </15 & Type/16 Tile{ AsIs: e.Expression#1/5 } >/17 Tile{ HalfReuse: >/8 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[10]);
  ...
  refalrts::alloc_close_call(vm, context[17]);
  refalrts::reinit_name(context[0], functions[efunc_Openm_Auto]);
...
static refalrts::FnResult func_gen_Xxoutm_Wrap_B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Write-Aux/4 AsIs: s.FileNo#1/5 } Tile{ AsIs: e.Line#2/11 } Tile{ HalfReuse: >/9 } </13 & Close/14 Tile{ HalfReuse: s.FileNo1 #5/10 AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[13]);
...
static refalrts::FnResult func_Xxoutm_Wrap(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Xxout-Wrap:1/4 AsIs: s.FileNo#1/5 AsIs: s.Width#1/6 } </7 & First/8 s.Width#1/6/9 Tile{ AsIs: e.Text#1/2 } >/10 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[7]);
  ...
  do {
    ...
    do {
      ...
      do {
        ...
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & StrFromMacroDigit/4 HalfReuse: s.Number1 #9/5 } >/15 ' '/16 </17 & Xxout-Scan/18 </19 & Type/20 Tile{ AsIs: e.Tail#1/13 } >/21 Tile{ AsIs: >/1 ]] }
        refalrts::alloc_close_call(vm, context[15]);
...
static refalrts::FnResult func_Explodeu_Ext(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </6 & __Step-Drop/7 >/8 Tile{ AsIs: </0 Reuse: & Explode/4 AsIs: s.Compound#1/5 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[6]);
...
static refalrts::FnResult func_Compare(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </9 & __Step-Drop/10 >/11 Tile{ AsIs: </0 Reuse: & Compare-Digits/4 AsIs: s.First#1/7 AsIs: s.Second#1/8 AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[9]);
    refalrts::alloc_name(vm, context[10], functions[efunc_u_u_Stepm_Drop]);
    refalrts::alloc_close_call(vm, context[11]);
...
static refalrts::FnResult func_GetPPID(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  const refalrts::RefalIdentifier *identifiers;
  refalrts::load_constants(arg_begin, &functions, &identifiers);
#line 3169 "Library.ref"
  return cookie_ns::return_pid(
    vm, refalrts::api::get_ppid(), arg_begin, arg_end
  );
#line 17462 "Library.cpp"
}
...
static refalrts::FnResult func_gen_Openm_Auto_A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[13];
  refalrts::zeros( context, 13 );
  // </0 & Open-Auto=1/4 t.Mode#1/5 s.FileNameChar#1/7 (/10 e.FileName#1/8 )/11 s.FreeHandle#2/12 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
...
static refalrts::FnResult func_Openm_Auto(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[13];
  refalrts::zeros( context, 13 );
  // </0 & Open-Auto/4 t.Mode#1/5 s.FileNameChar#1/7 e.FileName#1/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Open-Auto=1/4 AsIs: t.Mode#1/5 AsIs: s.FileNameChar#1/7 } (/8 Tile{ AsIs: e.FileName#1/2 } )/9 </10 & GetFreeHandle/11 >/12 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_bracket(vm, context[8]);
  refalrts::alloc_close_bracket(vm, context[9]);
  refalrts::alloc_open_call(vm, context[10]);
...
static refalrts::FnResult func_StrFromMacroDigit(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  (void) vm;
  refalrts::RefalFunction **functions;
  const refalrts::RefalIdentifier *identifiers;
  refalrts::load_constants(arg_begin, &functions, &identifiers);
#line 3237 "Library.ref"
  refalrts::Iter content_b = 0;
  refalrts::Iter content_e = 0;
  refalrts::Iter pfunc_name =
    refalrts::call_left(content_b, content_e, arg_begin, arg_end);
  ...
  return refalrts::cSuccess;
#line 17663 "Library.cpp"
}

static refalrts::NativeReference nat_ref_StrFromMacroDigit("StrFromMacroDigit", COOKIE1_, COOKIE2_, func_StrFromMacroDigit);

#line 3292 "Library.ref"
namespace cookie_ns {

bool compare(refalrts::Iter left, refalrts::Iter right);

} // namespace cookie_ns
#line 17674 "Library.cpp"
...
#line 18383 "Library.cpp"
#line 4015 "Library.ref"
namespace cookie_ns {
...
#line 4207 "Library.ref"
  ...
  refalrts::splice_to_freelist(vm, arg_begin, arg_end);
  return refalrts::cSuccess;
#line 18783 "Library.cpp"
}

static refalrts::NativeReference nat_ref_INIT("INIT", COOKIE1_, COOKIE2_, func_INIT);
...
#line 4230 "Library.ref"
  ...
  refalrts::splice_to_freelist(vm, arg_begin, arg_end);
  return refalrts::cSuccess;
#line 18815 "Library.cpp"
}

static refalrts::NativeReference nat_ref_FINAL("FINAL", COOKIE1_, COOKIE2_, func_FINAL);
