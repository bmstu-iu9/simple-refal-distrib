...
#define cookie_ns cookie_ns_1141272082_3112575370
#define COOKIE1_ 1141272082U
#define COOKIE2_ 3112575370U
...
enum efunc {
  ...
  efunc_FindFileEx = 3,
  efunc_Map = 4,
  efunc_gen_CreateFileList_L1 = 5,
  efunc_DoCreateFileList = 6,
  efunc_FindImports = 7,
  efunc_gen_DoCreateFileList_S3A1 = 8,
  efunc_gen_FindImports_S4A2 = 9,
  efunc_FindImportsm_Aux = 10,
  efunc_gen_FindImports_S4A1 = 11,
  efunc_gen_PreludePseudoIncludeLine_S1B1 = 12,
  efunc_Configm_GetPrelude = 13,
  efunc_Inc = 14,
  efunc_Trim = 15,
  efunc_gen_FindImportsm_Aux_A4L1S2A1 = 16,
  efunc_UpdatePrefix = 17,
  efunc_gen_FindImportsm_Aux_A4L1S3A1 = 18,
  efunc_Configm_AddReference = 19,
  efunc_FindIncludeEx = 20,
  efunc_UnEscapeString = 21,
  efunc_gen_FindImportsm_Aux_A4 = 22,
  efunc_MapAccum = 23,
  efunc_gen_FindImportsm_Aux_A4L1 = 24,
  efunc_PreludePseudoIncludeLine = 25,
  efunc_gen_FindImportsm_Aux_A3 = 26,
  efunc_LoadFile = 27,
  efunc_gen_FindImportsm_Aux_A2 = 28,
  efunc_gen_FindImportsm_Aux_A2B1 = 29,
  efunc_ExistFile = 30,
  efunc_CommentForDialect = 31,
  efunc_gen_FindImportsm_Aux_A1 = 32,
  efunc_FindFiles = 33,
  efunc_GetFolders = 34,
  efunc_gen_FindFileEx_B1 = 35,
  efunc_Configm_GetTargetMode = 36,
  efunc_gen_FindFileEx_A1 = 37,
  efunc_gen_GetFolders_L1 = 38,
  efunc_Configm_GetFolders = 39,
  efunc_gen_UpdatePrefix_B1S1A1 = 40,
  efunc_Configm_SetPrefix = 41,
  efunc_Configm_GetPrefix = 42,
  efunc_gen_UpdatePrefix_B1 = 43,
  efunc_FormatEscapeError = 44,
  efunc_FindInclude = 45,
  efunc_gen_FindIncludeEx_S2B1 = 46,
  efunc_UnEscapeStringm_SR = 47,
  efunc_UnEscapeStringm_R5 = 48,
  efunc_DoUnEscapeStringm_R5 = 49,
  efunc_gen_DoUnEscapeStringm_R5_S1C1 = 50,
  efunc_gen_DoUnEscapeStringm_R5_S2C1 = 51,
  efunc_HexDigit = 52,
  efunc_gen_DoUnEscapeStringm_R5_S2C2 = 53,
  efunc_Add = 54,
  efunc_Chr = 55,
  efunc_Mul = 56,
  efunc_Prefix3 = 57,
...
enum ident {
  ...
  ident_NotSet = 17,
  ident_Fails = 18,
  ident_BadEscapeCode = 19,
  ident_BadEscapeSymbol = 20,
  ident_EOLAfterSlash = 21,
  ident_Fail = 22,
  ident_Mu = 23,
  ident_Up = 24,
  ident_Evm_met = 25,
  ...
  ident_CreateFileList = 28,
  ident_DoCreateFileList = 29,
  ident_FindImports = 30,
  ident_CommentForDialect = 31,
  ident_PreludePseudoIncludeLine = 32,
  ident_FindImportsm_Aux = 33,
  ident_FindFileEx = 34,
  ident_GetFolders = 35,
  ident_UpdatePrefix = 36,
  ident_FindIncludeEx = 37,
  ident_UnEscapeString = 38,
  ident_FormatEscapeError = 39,
  ident_UnEscapeStringm_R5 = 40,
  ident_DoUnEscapeStringm_R5 = 41,
  ident_HexDigit = 42,
  ident_Prefix3 = 43,
};
