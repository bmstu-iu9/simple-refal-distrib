...
#define cookie_ns cookie_ns_1481707840_21094182
#define COOKIE1_ 1481707840U
#define COOKIE2_ 21094182U
...
enum ident {
  ...
  ident_CppCompilerExeSuf = 25,
  ident_CppCompilerLibSuf = 26,
  ident_Success = 27,
  ident_Search = 28,
  ident_REF5RSL = 29,
  ident_Fails = 30,
  ident_ManySourceFiles = 31,
  ident_TargetModeAlreadySet = 32,
};
...
static refalrts::FnResult func_gen_u_u_Mum_Aux_S13B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::alloc_number(vm, context[9], 21094182UL);
    refalrts::update_name(context[4], functions[efunc_u_u_FindMuPtr]);
    refalrts::reinit_number(context[5], 1481707840UL);
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
  ...
  refalrts::update_name(context[4], functions[efunc_u_u_FindMuPtr]);
  refalrts::reinit_number(context[5], 1481707840UL);
  refalrts::reinit_number(context[7], 21094182UL);
  refalrts::push_stack( vm, context[1] );
  refalrts::push_stack( vm, context[0] );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
...
static refalrts::FnResult func_Configm_Create(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  //RESULT: Tile{ [[ HalfReuse: [/0 Reuse: & Config/4 HalfReuse: (/1 } # CppCompilerExe/5 )/6 (/7 # CppCompilerLib/8 )/9 (/10 # Folders/11 )/12 (/13 # SrefCompiler/14 (/15"rlc-core"/16 )/18 )/19 (/20 # TargetFileName/21 # DefaultTarget/22 )/23 (/24 # SourceFile/25 # NotSet/26 )/27 (/28 # Prefix/29 # NotSet/30 )/31 (/32 # References/33 )/34 (/35 # TargetMode/36 # DefaultEXE/37 )/38 (/39 # Prelude/40 )/41 (/42 # Runtime/43 )/44 (/45 # Incorporateds/46 )/47 (/48 # KeepRasls/49 # False/50 )/51 (/52 # TempDir/53 )/54 (/55 # OverwriteExistRasls/56 # False/57 )/58 (/59 # CppCompilerExeSuf/60 )/61 (/62 # CppCompilerLibSuf/63 )/64 ]/65 Tile{ ]] }
