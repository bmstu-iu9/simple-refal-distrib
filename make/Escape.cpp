...
#define cookie_ns cookie_ns_195990246_3697842978
#define COOKIE1_ 195990246U
#define COOKIE2_ 3697842978U
...
enum efunc {
  ...
  efunc_Mod = 15,
  efunc_Div = 16,
  efunc_TermCompare = 17,
  efunc_Ord = 18,
  efunc_gen_EscapeChar_S7B1 = 19,
  efunc_gen_Map_Z1 = 20,
  efunc_Mul = 21,
  efunc_gen_Reduce_Z1 = 22,
  efunc_gen_Map_Z2 = 23,
  efunc_Chr = 24,
  efunc_gen_DigitFromChar_B1 = 25,
  ...
  efunc_gen_DoUnEscapeStringm_SRm_Escape_S2B1 = 36,
  efunc_Mu = 37,
  efunc_Up = 38,
  efunc_Evm_met = 39,
  efunc_Residue = 40,
  efunc_u_u_Metau_Residue = 41,
  efunc_MapAccum = 42,
  efunc_UnBracket = 43,
  ...
  efunc_Dec = 46,
  efunc_EscapeChar = 47,
  efunc_EscapeString = 48,
  efunc_DigitFromChar = 49,
  efunc_UnEscapeStringm_SR = 50,
  efunc_gen_EscapeChar_D7 = 51,
  efunc_gen_Map_Z0 = 52,
  efunc_gen_CharFromNum_L1D1 = 53,
  efunc_gen_CharFromNum_L1 = 54,
  efunc_gen_Reduce_Z0 = 55,
};
...
enum ident {
  ...
  ident_OctDigit = 23,
  ident_EscapeChar = 24,
  ident_EscapeString = 25,
  ident_CharFromNum = 26,
  ident_DigitFromChar = 27,
  ident_UnEscapeStringm_SR = 28,
  ident_OctDigits = 29,
  ident_DecDigits = 30,
  ident_HexDigits = 31,
...
static refalrts::NativeReference nat_ref_gen_DoUnEscapeStringm_SRm_Escape_S2B1("DoUnEscapeString-SR-Escape$2:1", COOKIE1_, COOKIE2_, func_gen_DoUnEscapeStringm_SRm_Escape_S2B1);
...
static refalrts::FnResult func_gen_Map_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & DigitFromChar/4 AsIs: e.items#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Map_Z0]);
  refalrts::update_name(context[4], functions[efunc_DigitFromChar]);
  refalrts::push_stack( vm, context[1] );
...
static refalrts::FnResult func_gen_Reduce_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & Reduce@1/4 s.new#1/5 e.new#2/2 >/1
  if( ! refalrts::svar_left( context[5], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  // closed e.new#2 as range 2
  do {
    // </0 & Reduce@1/4 s.new#3/5 t.new#4/8 e.new#5/6 >/1
    context[6] = context[2];
    context[7] = context[3];
    ...
    do {
      // </0 & Reduce@1/4 s.new#6/5 t.new#7/8 t.new#8/12 e.new#9/10 >/1
      context[10] = context[6];
      ...
      do {
        // </0 & Reduce@1/4 s.Base#1/5 s.Accum#2/8 s.Next#2/12 e.Tail#1/14 >/1
        context[14] = context[10];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 AsIs: & Reduce@1/4 AsIs: s.Base#1/5 } </16 & Add/17 </18 & Mul/19 Tile{ AsIs: s.Accum#2/8 } s.Base#1/5/20 >/21 Tile{ AsIs: s.Next#2/12 } >/22 Tile{ AsIs: e.Tail#1/14 } Tile{ AsIs: >/1 ]] }
      ...
      // </0 & Reduce@1/4 s.Base#1/5 t.Acc#1/8 t.Next#1/12 e.Tail#1/14 >/1
      context[14] = context[10];
      context[15] = context[11];
      // closed e.Tail#1 as range 14
      //DEBUG: t.Acc#1: 8
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </16 & Reduce@1/17 s.Base#1/5/18 Tile{ AsIs: </0 Reuse: & CharFromNum\1*1/4 AsIs: s.Base#1/5 AsIs: t.Acc#1/8 AsIs: t.Next#1/12 } >/19 Tile{ AsIs: e.Tail#1/14 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[16]);
    ...
    // </0 & Reduce@1/4 s.Base#1/5 t.Acc#1/8 >/1
  ...
  // </0 & Reduce@1/4 s.Base#1/5 e.accum-and-items#0/2 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Reduce@0/4 } [*]/6 & CharFromNum\1/7 Tile{ AsIs: s.Base#1/5 } {*}/8 Tile{ AsIs: e.accum-and-items#0/2 } Tile{ AsIs: >/1 ]] }
  refalrts::alloc_closure_head(vm, context[6]);
  refalrts::alloc_name(vm, context[7], functions[efunc_gen_CharFromNum_L1]);
