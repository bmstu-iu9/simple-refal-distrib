...
static refalrts::FnResult func_FlatResult(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    // e.idx
    // </0 & FlatResult/4 e.Range-B#1/7 (/13 # CallBrackets/15 e.SubRange-E#1/11 )/14 e.Range-E#1/9 >/1
    context[5] = context[2];
    context[6] = context[3];
    context[7] = 0;
    context[8] = 0;
    ...
    do {
      ...
      if( ! context[15] )
        continue;
      // closed e.SubRange-E#1 as range 11
      // closed e.Range-E#1 as range 9
      //DEBUG: e.Range-B#1: 7
      //DEBUG: e.SubRange-E#1: 11
      //DEBUG: e.Range-E#1: 9

      refalrts::reset_allocator();
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & FlatResult/4 AsIs: e.Range-B#1/7 HalfReuse: >/13 HalfReuse: (/15 } # TkOpenCall/16 )/17 </18 & FlatResult/19 Tile{ AsIs: e.SubRange-E#1/11 } >/20 (/21 # TkCloseCall/22 )/23 </24 Tile{ HalfReuse: & FlatResult/14 AsIs: e.Range-E#1/9 AsIs: >/1 ]] }
  ...
  do {
    // e.idx
    // </0 & FlatResult/4 e.Range-B#1/7 (/13 # Brackets/15 e.SubRange-E#1/11 )/14 e.Range-E#1/9 >/1
    context[5] = context[2];
    context[6] = context[3];
    context[7] = 0;
    context[8] = 0;
    ...
    do {
      ...
      refalrts::reset_allocator();
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & FlatResult/4 AsIs: e.Range-B#1/7 HalfReuse: >/13 HalfReuse: (/15 } # TkOpenBracket/16 )/17 </18 & FlatResult/19 Tile{ AsIs: e.SubRange-E#1/11 } >/20 (/21 # TkCloseBracket/22 )/23 </24 Tile{ HalfReuse: & FlatResult/14 AsIs: e.Range-E#1/9 AsIs: >/1 ]] }
  ...
  do {
    // e.idx
    // </0 & FlatResult/4 e.Range-B#1/7 (/13 # ADT-Brackets/15 (/18 e.Name#1/16 )/19 e.SubRange-E#1/11 )/14 e.Range-E#1/9 >/1
    context[5] = context[2];
    context[6] = context[3];
    context[7] = 0;
    context[8] = 0;
    ...
    do {
      ...
      refalrts::reset_allocator();
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: e.Range-B#1/7 } (/20 # TkOpenADT/21 Tile{ HalfReuse: )/13 HalfReuse: (/15 HalfReuse: # TkName/18 AsIs: e.Name#1/16 AsIs: )/19 } Tile{ AsIs: </0 AsIs: & FlatResult/4 } Tile{ AsIs: e.SubRange-E#1/11 } >/22 (/23 # TkCloseADT/24 )/25 </26 Tile{ HalfReuse: & FlatResult/14 AsIs: e.Range-E#1/9 AsIs: >/1 ]] }
      if( ! refalrts::alloc_open_bracket( context[20] ) )
        return refalrts::cNoMemory;
      if( ! refalrts::alloc_ident( context[21], ident_TkOpenADT ) )
        return refalrts::cNoMemory;
      if( ! refalrts::alloc_close_call( context[22] ) )
        return refalrts::cNoMemory;
      if( ! refalrts::alloc_open_bracket( context[23] ) )
        return refalrts::cNoMemory;
      if( ! refalrts::alloc_ident( context[24], ident_TkCloseADT ) )
        return refalrts::cNoMemory;
      if( ! refalrts::alloc_close_bracket( context[25] ) )
        return refalrts::cNoMemory;
      ...
      refalrts::reinit_open_bracket( context[15] );
      refalrts::reinit_ident( context[18], ident_TkName );
      refalrts::reinit_name( context[14], ref_FlatResult.ref.function );
      refalrts::push_stack( context[1] );
...
static refalrts::FnResult func_gen_GenResultm_Aux_L1(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    // ( # Tile e.idx )
    // </0 & GenResult-Aux\1/4 (/7 # Tile/11 e.Tile#2/9 )/8 >/1
    context[9] = context[5];
    context[10] = context[6];
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} </0 & GenResult-Aux\1/4 (/7 # Tile/11 e.Tile#2/9 )/8 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  do {
    ...
    // </0 & GenResult-Aux\1/4 (/7 # TkVariableCopy/11 't'/12 e.Index#2/9 s.Level#2/15 s.SampleOffset#2/14 s.Offset#2/13 )/8 >/1
    context[9] = context[5];
    context[10] = context[6];
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} </0 & GenResult-Aux\1/4 {REMOVED TILE} e.Index#2/9 s.Level#2/15 s.SampleOffset#2/14 {REMOVED TILE}
  ...
  do {
    ...
    // </0 & GenResult-Aux\1/4 (/7 # TkVariableCopy/11 s.Mode#2/12 e.Index#2/9 s.Level#2/15 s.SampleOffset#2/14 s.Offset#2/13 )/8 >/1
    context[9] = context[5];
    context[10] = context[6];
    context[11] = refalrts::ident_left(  ident_TkVariableCopy, context[9], context[10] );
    if( ! context[11] )
  ...
  do {
    ...
    // </0 & GenResult-Aux\1/4 (/7 # TkString/11 e.String#2/9 s.Offset#2/12 )/8 >/1
    context[9] = context[5];
    context[10] = context[6];
  ...
  // ( e.idx )
  // </0 & GenResult-Aux\1/4 (/7 e.Elem#2/9 )/8 >/1
  context[9] = context[5];
  context[10] = context[6];
...
static refalrts::FnResult func_gen_GenResultm_Aux_L2S1L1(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    // ( # AsIs t.idx )
    // </0 & GenResult-Aux\2$1\1/4 (/7 # AsIs/9 t.Item#3/12 )/8 >/1
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} </0 & GenResult-Aux\2$1\1/4 (/7 # AsIs/9 t.Item#3/12 )/8 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  do {
    ...
    // </0 & GenResult-Aux\2$1\1/4 (/7 # HalfReuse/9 (/14 # TkVariable/16 's'/17 e.Index#3/12 s.SampleOffset#3/19 s.Offset#3/18 )/15 )/8 >/1
    context[10] = context[5];
    context[11] = context[6];
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} </0 & GenResult-Aux\2$1\1/4 {REMOVED TILE} e.Index#3/12 s.SampleOffset#3/19 s.Offset#3/18 )/15 )/8 >/1 {REMOVED TILE}
  ...
  do {
    // ( # HalfReuse ( e.idx ) )
    // </0 & GenResult-Aux\2$1\1/4 (/7 # HalfReuse/9 (/14 e.Elem#3/12 )/15 )/8 >/1
    context[10] = context[5];
    context[11] = context[6];
    if( ! refalrts::ident_term(  ident_HalfReuse, context[9] ) )
      continue;
  ...
  do {
    // ( # Reuse ( e.idx ) )
    // </0 & GenResult-Aux\2$1\1/4 (/7 # Reuse/9 (/14 e.Elem#3/12 )/15 )/8 >/1
    context[10] = context[5];
    context[11] = context[6];
...
static refalrts::FnResult func_gen_GenPushLink_L1(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // </0 & GenPushLink\1/4 (/7 e.Stack#2/14 )/8 (/11 # TkOpenCall/13 s.Offset#2/18 )/12 >/1
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} </0 & GenPushLink\1/4 {REMOVED TILE} # TkOpenCall/13 s.Offset#2/18 )/12 >/1 {REMOVED TILE}
  ...
  do {
    ...
    // </0 & GenPushLink\1/4 (/7 e.Stack#2/14 )/8 (/11 # TkOpenADT/13 s.Offset#2/18 )/12 >/1
    context[14] = context[5];
    context[15] = context[6];
    context[16] = context[9];
    context[17] = context[10];
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} </0 & GenPushLink\1/4 {REMOVED TILE} # TkOpenADT/13 s.Offset#2/18 )/12 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: e.Stack#2/14 HalfReuse: s.Offset2 #18/8 HalfReuse: )/11 } Tile{ ]] }
    refalrts::reinit_svar( context[8], context[18] );
    refalrts::reinit_close_bracket( context[11] );
    refalrts::link_brackets( context[7], context[11] );
  ...
  do {
    ...
    // </0 & GenPushLink\1/4 (/7 e.Stack#2/14 )/8 (/11 # TkOpenBracket/13 s.Offset#2/18 )/12 >/1
    context[14] = context[5];
    context[15] = context[6];
    context[16] = context[9];
    context[17] = context[10];
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} </0 & GenPushLink\1/4 {REMOVED TILE} # TkOpenBracket/13 s.Offset#2/18 )/12 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: e.Stack#2/14 HalfReuse: s.Offset2 #18/8 HalfReuse: )/11 } Tile{ ]] }
    refalrts::reinit_svar( context[8], context[18] );
    refalrts::reinit_close_bracket( context[11] );
    refalrts::link_brackets( context[7], context[11] );
  ...
  do {
    ...
    // </0 & GenPushLink\1/4 (/7 e.Stack#2/14 s.OpenOffset#2/19 )/8 (/11 # TkCloseCall/13 s.Offset#2/18 )/12 >/1
    context[14] = context[5];
    context[15] = context[6];
    context[16] = context[9];
    context[17] = context[10];
  ...
  do {
    ...
    // </0 & GenPushLink\1/4 (/7 e.Stack#2/14 s.OpenOffset#2/19 )/8 (/11 # TkCloseADT/13 s.Offset#2/18 )/12 >/1
    context[14] = context[5];
    context[15] = context[6];
    context[16] = context[9];
    context[17] = context[10];
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} & GenPushLink\1/4 (/7 {REMOVED TILE} s.OpenOffset#2/19 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  ...
  do {
    ...
    // </0 & GenPushLink\1/4 (/7 e.Stack#2/14 s.OpenOffset#2/19 )/8 (/11 # TkCloseBracket/13 s.Offset#2/18 )/12 >/1
    context[14] = context[5];
    context[15] = context[6];
    context[16] = context[9];
    context[17] = context[10];
  ...
  // ( e.idx ) ( s.idx e.idx )
  // </0 & GenPushLink\1/4 (/7 e.Stack#2/14 )/8 (/11 s.tag#2/13 e.Info#2/16 )/12 >/1
  context[14] = context[5];
  context[15] = context[6];
  context[16] = context[9];
  context[17] = context[10];
  ...
  refalrts::reset_allocator();
  //TRASH: {REMOVED TILE} </0 & GenPushLink\1/4 {REMOVED TILE} (/11 s.tag#2/13 e.Info#2/16 )/12 >/1 {REMOVED TILE}
...
static refalrts::FnResult func_ModifyResult(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    // ( # Tile e.idx ) e.idx
    // </0 & ModifyResult/4 (/9 # Tile/11 e.Tile#1/7 )/10 e.Result#1/5 >/1
    context[5] = context[2];
    context[6] = context[3];
    context[7] = 0;
    context[8] = 0;
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & ModifyTile/4 } Tile{ AsIs: e.Tile#1/7 } Tile{ HalfReuse: >/9 HalfReuse: </11 } Tile{ HalfReuse: & ModifyResult/10 AsIs: e.Result#1/5 AsIs: >/1 ]] }
    refalrts::update_name( context[4], ref_ModifyTile.ref.function );
    refalrts::reinit_close_call( context[9] );
    refalrts::reinit_open_call( context[11] );
    refalrts::reinit_name( context[10], ref_ModifyResult.ref.function );
    refalrts::push_stack( context[1] );
  ...
  do {
    // ( s.idx e.idx ) e.idx
    // </0 & ModifyResult/4 (/9 s.tag#1/11 e.info#1/7 )/10 e.Result#1/5 >/1
    context[5] = context[2];
    context[6] = context[3];
    context[7] = 0;
    context[8] = 0;
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: (/9 AsIs: s.tag#1/11 AsIs: e.info#1/7 AsIs: )/10 } Tile{ AsIs: </0 AsIs: & ModifyResult/4 } Tile{ AsIs: e.Result#1/5 } Tile{ AsIs: >/1 ]] }
    refalrts::push_stack( context[1] );
    refalrts::push_stack( context[0] );
...
static refalrts::FnResult func_ModifyTile(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    // ( # RIGHT-EDGE ) e.idx
    // </0 & ModifyTile/4 (/9 # RIGHT-EDGE/11 )/10 e.Range#1/5 >/1
    context[5] = context[2];
    context[6] = context[3];
    context[7] = 0;
    context[8] = 0;
    ...
    if( ! context[9] )
      continue;
    refalrts::bracket_pointers(context[9], context[10]);
    context[11] = refalrts::ident_left(  ident_RIGHTm_EDGE, context[7], context[8] );
    if( ! context[11] )
      continue;
    if( ! refalrts::empty_seq( context[7], context[8] ) )
      continue;
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} </0 & ModifyTile/4 (/9 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ HalfReuse: </11 HalfReuse: & ModifyTile/10 AsIs: e.Range#1/5 AsIs: >/1 ]] }
    refalrts::reinit_open_call( context[11] );
    refalrts::reinit_name( context[10], ref_ModifyTile.ref.function );
    refalrts::push_stack( context[1] );
    refalrts::push_stack( context[11] );
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
  ...
  do {
    // ( # LEFT-EDGE ) e.idx
    // </0 & ModifyTile/4 (/9 # LEFT-EDGE/11 )/10 e.Range#1/5 >/1
    context[5] = context[2];
    context[6] = context[3];
    context[7] = 0;
    context[8] = 0;
    ...
    if( ! context[9] )
      continue;
    refalrts::bracket_pointers(context[9], context[10]);
    context[11] = refalrts::ident_left(  ident_LEFTm_EDGE, context[7], context[8] );
    if( ! context[11] )
      continue;
    if( ! refalrts::empty_seq( context[7], context[8] ) )
      continue;
  ...
  do {
    // ( # AsIs t.idx ) e.idx
    // </0 & ModifyTile/4 (/9 # AsIs/11 t.Item#1/12 )/10 e.Range#1/5 >/1
    context[5] = context[2];
    context[6] = context[3];
    context[7] = 0;
    context[8] = 0;
    ...
    if( ! context[9] )
      continue;
    refalrts::bracket_pointers(context[9], context[10]);
    context[11] = refalrts::ident_left(  ident_AsIs, context[7], context[8] );
    if( ! context[11] )
      continue;
    // closed e.Range#1 as range 5
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} {REMOVED TILE} & ModifyTile/4 (/9 # AsIs/11 {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: t.Item#1/12 } Tile{ AsIs: </0 } Tile{ HalfReuse: & ModifyTile/10 AsIs: e.Range#1/5 AsIs: >/1 ]] }
    refalrts::reinit_name( context[10], ref_ModifyTile.ref.function );
    refalrts::push_stack( context[1] );
    refalrts::push_stack( context[0] );
    refalrts::Iter trash_prev = arg_begin->prev;
  ...
  do {
    ...
    // </0 & ModifyTile/4 (/9 # HalfReuse/11 t.Item#1/12 )/10 e.Range#1/5 >/1
    context[5] = context[2];
    context[6] = context[3];
    context[7] = 0;
    context[8] = 0;
    ...
    if( ! context[9] )
      continue;
    refalrts::bracket_pointers(context[9], context[10]);
    context[11] = refalrts::ident_left(  ident_HalfReuse, context[7], context[8] );
    if( ! context[11] )
      continue;
    // closed e.Range#1 as range 5
    context[13] = refalrts::tvar_left( context[12], context[7], context[8] );
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} {REMOVED TILE} & ModifyTile/4 (/9 # HalfReuse/11 {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: t.Item#1/12 } Tile{ AsIs: </0 } Tile{ HalfReuse: & ModifyTile/10 AsIs: e.Range#1/5 AsIs: >/1 ]] }
    refalrts::reinit_name( context[10], ref_ModifyTile.ref.function );
    refalrts::push_stack( context[1] );
    refalrts::push_stack( context[0] );
  ...
  do {
    // ( # Reuse t.idx ) e.idx
    // </0 & ModifyTile/4 (/9 # Reuse/11 t.Item#1/12 )/10 e.Range#1/5 >/1
    context[5] = context[2];
    context[6] = context[3];
    context[7] = 0;
    context[8] = 0;
    ...
    if( ! context[9] )
      continue;
    refalrts::bracket_pointers(context[9], context[10]);
    context[11] = refalrts::ident_left(  ident_Reuse, context[7], context[8] );
    if( ! context[11] )
      continue;
    // closed e.Range#1 as range 5
    context[13] = refalrts::tvar_left( context[12], context[7], context[8] );
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} {REMOVED TILE} & ModifyTile/4 (/9 # Reuse/11 {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: t.Item#1/12 } Tile{ AsIs: </0 } Tile{ HalfReuse: & ModifyTile/10 AsIs: e.Range#1/5 AsIs: >/1 ]] }
    refalrts::reinit_name( context[10], ref_ModifyTile.ref.function );
    refalrts::push_stack( context[1] );
    refalrts::push_stack( context[0] );
...
static refalrts::FnResult func_GenSplices(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdSetRes/4 } Tile{ HalfReuse: </22 HalfReuse: & CalcRes/24 AsIs: e.RightTile#1/20 HalfReuse: >/23 HalfReuse: )/1 } </25 & Map/26 & GenSplices$1\1/27 </28 & CollectTiles/29 Tile{ AsIs: e.Result#1/18 } >/30 >/31 </32 & GenTrash/33 (/34 Tile{ AsIs: e.LeftTile#1/16 } Tile{ HalfReuse: )/7 AsIs: e.Trash#1/14 HalfReuse: >/8 AsIs: (/11 Reuse: # CmdNextStep/13 } Tile{ AsIs: )/12 } Tile{ ]] }
    if( ! refalrts::alloc_open_call( context[25] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[26], ref_Map.ref.function ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[27], ref_gen_GenSplices_S1L1.ref.function ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_open_call( context[28] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[29], ref_CollectTiles.ref.function ) )
      return refalrts::cNoMemory;
    ...
    if( ! refalrts::alloc_open_call( context[32] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[33], ref_GenTrash.ref.function ) )
      return refalrts::cNoMemory;
  ...
  refalrts::reset_allocator();
  //TRASH: {REMOVED TILE} </0 & GenSplices/4 {REMOVED TILE} (/11 # Tile/13 e.OneTile#1/16 )/12 >/1 {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ AsIs: (/7 Reuse: # CmdNextStep/20 AsIs: )/8 } Tile{ ]] }
  refalrts::update_ident( context[20], ident_CmdNextStep );
  refalrts::link_brackets( context[7], context[8] );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
  refalrts::Iter res = arg_end->next;
...
static refalrts::FnResult func_gen_AddOffsets_L1(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator();
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: s.Offset#2/13 AsIs: (/11 AsIs: # Tile/14 } </19 & Map/20 </21 Tile{ HalfReuse: & @create_closure@/0 Reuse: & AddOffsets\1$1\1/4 AsIs: (/7 AsIs: e.PatternVars#1/15 AsIs: )/8 } >/22 Tile{ AsIs: e.Tile#2/17 } Tile{ HalfReuse: >/12 HalfReuse: )/1 ]] }
