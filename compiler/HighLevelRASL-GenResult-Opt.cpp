...
static refalrts::FnResult func_gen_GenResultm_Opt_A2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & GenResult-Opt=2/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & GenResult-Opt=2/4 (/7 e.new#1/5 )/8 s.new#2/9 e.new#3/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new#3 as range 2
  do {
    // </0 & GenResult-Opt=2/4 (/7 e.new#7/10 )/8 s.new#4/9 e.new#5/12 (/16 # Tile/18 e.new#6/14 )/17 >/1
    ...
    do {
      // </0 & GenResult-Opt=2/4 (/7 e.new#12/19 )/8 s.new#8/9 (/27 # Tile/29 e.new#9/25 )/28 e.new#10/21 (/16 # Tile/18 e.new#11/23 )/17 >/1
      ...
      do {
        // </0 & GenResult-Opt=2/4 (/7 e.new#18/30 )/8 s.new#13/9 (/27 # Tile/29 e.new#15/32 )/28 e.new#14/34 (/16 # Tile/18 t.new#16/38 e.new#17/36 )/17 >/1
        ...
        do {
          // </0 & GenResult-Opt=2/4 (/7 e.Trash#2/40 )/8 s.ContextOffset#3/9 (/27 # Tile/29 e.3#0/42 )/28 e.1#0/44 (/16 # Tile/18 (/38 # RIGHT-EDGE/48 )/39 )/17 >/1
          ...
          //RESULT: Tile{ [[ } Tile{ AsIs: s.ContextOffset#3/9 } (/49 # CmdResetAllocator/50 Tile{ AsIs: )/8 } Tile{ AsIs: </0 Reuse: & GenResult-Aux=1@1/4 AsIs: (/7 } </51 & TextFromExpr/52 Tile{ AsIs: e.Trash#2/40 } >/53 )/54 (/55 </56 & TextFromExpr/57 Tile{ AsIs: (/27 AsIs: # Tile/29 AsIs: e.3#0/42 AsIs: )/28 AsIs: e.1#0/44 AsIs: (/16 AsIs: # Tile/18 AsIs: (/38 AsIs: # RIGHT-EDGE/48 AsIs: )/39 AsIs: )/17 AsIs: >/1 } )/58 (/59 </60 & Map@4/61 (/62 # Tile/63 e.3#0/42/64 )/66 e.1#0/44/67 (/69 # Tile/70 (/71 # RIGHT-EDGE/72 )/73 )/74 >/75 )/76 (/77 </78 & Map@1/79 (/80 # Tile/81 e.3#0/42/82 )/84 e.1#0/44/85 (/87 # Tile/88 (/89 # RIGHT-EDGE/90 )/91 )/92 >/93 )/94 (/95 </96 & GenPushLink/97 </98 & Map@2/99 (/100 # Tile/101 e.3#0/42/102 )/104 e.1#0/44/105 (/107 # Tile/108 (/109 # RIGHT-EDGE/110 )/111 )/112 >/113 >/114 )/115 (/116 </117 & Map@3/118 </119 & CollectTiles/120 e.1#0/44/121 >/123 >/124 )/125 </126 & GenTrash/127 (/128 e.3#0/42/129 )/131 e.Trash#2/40/132 >/134 >/135 (/136 # CmdNextStep/137 )/138 Tile{ ]] }
        ...
        // </0 & GenResult-Opt=2/4 (/7 e.Trash#2/40 )/8 s.ContextOffset#3/9 (/27 # Tile/29 e.3#0/42 )/28 e.1#0/44 (/16 # Tile/18 t.3#0/38 e.5#0/46 )/17 >/1
        context[40] = context[30];
        context[41] = context[31];
        context[42] = context[32];
        context[43] = context[33];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ } Tile{ AsIs: s.ContextOffset#3/9 } (/48 # CmdResetAllocator/49 Tile{ AsIs: )/8 } Tile{ AsIs: </0 Reuse: & GenResult-Aux=1@2/4 AsIs: (/7 } </50 & TextFromExpr/51 Tile{ AsIs: e.Trash#2/40 } >/52 )/53 (/54 </55 & TextFromExpr/56 Tile{ AsIs: (/27 AsIs: # Tile/29 AsIs: e.3#0/42 AsIs: )/28 AsIs: e.1#0/44 AsIs: (/16 AsIs: # Tile/18 AsIs: t.3#0/38 AsIs: e.5#0/46 AsIs: )/17 AsIs: >/1 } )/57 (/58 </59 & Map@4/60 (/61 # Tile/62 e.3#0/42/63 )/65 e.1#0/44/66 (/68 # Tile/69 t.3#0/38/70 e.5#0/46/72 )/74 >/75 )/76 (/77 </78 & Map@1/79 (/80 # Tile/81 e.3#0/42/82 )/84 e.1#0/44/85 (/87 # Tile/88 t.3#0/38/89 e.5#0/46/91 )/93 >/94 )/95 (/96 </97 & GenPushLink/98 </99 & Map@2/100 (/101 # Tile/102 e.3#0/42/103 )/105 e.1#0/44/106 (/108 # Tile/109 t.3#0/38/110 e.5#0/46/112 )/114 >/115 >/116 )/117 (/118 </119 & BeginOffset/120 t.3#0/38/121 >/123 )/124 (/125 </126 & Map@3/127 </128 & CollectTiles/129 e.1#0/44/130 >/132 >/133 )/134 </135 & GenTrash/136 (/137 e.3#0/42/138 )/140 e.Trash#2/40/141 >/143 >/144 (/145 # CmdNextStep/146 )/147 Tile{ ]] }
      ...
      // </0 & GenResult-Opt=2/4 (/7 e.Trash#2/30 )/8 s.ContextOffset#3/9 (/27 # Tile/29 e.3#0/32 )/28 e.1#0/34 (/16 # Tile/18 e.4#0/36 )/17 >/1
      context[30] = context[19];
      context[31] = context[20];
      context[32] = context[25];
      context[33] = context[26];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: s.ContextOffset#3/9 } (/38 # CmdResetAllocator/39 Tile{ AsIs: )/8 } Tile{ AsIs: </0 Reuse: & GenResult-Aux=1@2/4 AsIs: (/7 } </40 & TextFromExpr/41 Tile{ AsIs: e.Trash#2/30 } >/42 )/43 (/44 </45 & TextFromExpr/46 Tile{ AsIs: (/27 AsIs: # Tile/29 AsIs: e.3#0/32 AsIs: )/28 AsIs: e.1#0/34 AsIs: (/16 AsIs: # Tile/18 AsIs: e.4#0/36 AsIs: )/17 AsIs: >/1 } )/47 (/48 </49 & Map@4/50 (/51 # Tile/52 e.3#0/32/53 )/55 e.1#0/34/56 (/58 # Tile/59 e.4#0/36/60 )/62 >/63 )/64 (/65 </66 & Map@1/67 (/68 # Tile/69 e.3#0/32/70 )/72 e.1#0/34/73 (/75 # Tile/76 e.4#0/36/77 )/79 >/80 )/81 (/82 </83 & GenPushLink/84 </85 & Map@2/86 (/87 # Tile/88 e.3#0/32/89 )/91 e.1#0/34/92 (/94 # Tile/95 e.4#0/36/96 )/98 >/99 >/100 )/101 (/102 </103 & CalcRes*2/104 e.4#0/36/105 >/107 )/108 (/109 </110 & Map@3/111 </112 & CollectTiles/113 e.1#0/34/114 >/116 >/117 )/118 </119 & GenTrash/120 (/121 e.3#0/32/122 )/124 e.Trash#2/30/125 >/127 >/128 (/129 # CmdNextStep/130 )/131 Tile{ ]] }
    ...
    // </0 & GenResult-Opt=2/4 (/7 # RemovedTile/23 )/8 s.ContextOffset#3/9 (/16 # Tile/18 e.2#0/21 )/17 >/1
    context[19] = context[10];
    context[20] = context[11];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: s.ContextOffset#3/9 } (/24 # CmdResetAllocator/25 )/26 </27 & GenResult-Aux=1@3/28 (/29 Tile{ AsIs: </0 Reuse: & TextFromExpr/4 HalfReuse: # RemovedTile/7 HalfReuse: >/23 AsIs: )/8 } (/30 </31 & TextFromExpr/32 Tile{ AsIs: (/16 AsIs: # Tile/18 AsIs: e.2#0/21 AsIs: )/17 AsIs: >/1 } )/33 (/34 </35 & Map@4/36 (/37 # Tile/38 e.2#0/21/39 )/41 >/42 )/43 (/44 </45 & Map@1/46 (/47 # Tile/48 e.2#0/21/49 )/51 >/52 )/53 </54 & GenPushLink/55 </56 & Map@2/57 (/58 # Tile/59 e.2#0/21/60 )/62 >/63 >/64 >/65 (/66 # CmdNextStep/67 )/68 Tile{ ]] }
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ AsIs: s.ContextOffset#3/9 } (/10 # CmdResetAllocator/11 )/12 </13 & GenResult-Aux=1@4/14 (/15 </16 & TextFromExpr/17 e.Trash#2/5/18 >/20 )/21 (/22 </23 & TextFromExpr/24 Tile{ AsIs: e.MarkedResult#3/2 } >/25 )/26 (/27 </28 & Map@4/29 e.MarkedResult#3/2/30 >/32 )/33 (/34 </35 & Map@1/36 e.MarkedResult#3/2/37 >/39 )/40 (/41 </42 & GenPushLink/43 </44 & Map@2/45 e.MarkedResult#3/2/46 >/48 >/49 )/50 Tile{ AsIs: </0 Reuse: & GenSplices*2/4 AsIs: (/7 AsIs: e.Trash#2/5 AsIs: )/8 } e.MarkedResult#3/2/51 >/53 >/54 (/55 # CmdNextStep/56 Tile{ HalfReuse: )/1 ]] }
...
static refalrts::FnResult func_gen_GenResultm_Opt_A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 } Tile{ HalfReuse: & GenResult-Opt=2/16 AsIs: (/11 AsIs: e.Trash#2/9 AsIs: )/12 HalfReuse: </7 } & MapAccum@1/18 (/19 Tile{ AsIs: e.PatternVars#1/13 } Tile{ HalfReuse: )/4 AsIs: s.ContextOffset#1/17 HalfReuse: </15 } & CollectStrings/20 Tile{ AsIs: e.MarkedResult#2/5 } >/21 Tile{ HalfReuse: >/8 AsIs: >/1 ]] }
...
static refalrts::FnResult func_GenResultm_Aux(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & GenResult-Aux/4 (/7 e.new#1/5 )/8 (/11 e.new#2/9 )/12 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  do {
    // </0 & GenResult-Aux/4 (/7 e.new#3/13 )/8 (/11 e.new#4/15 (/19 # Tile/21 e.new#5/17 )/20 )/12 >/1
    ...
    do {
      // </0 & GenResult-Aux/4 (/7 e.new#6/22 )/8 (/11 (/30 # Tile/32 e.new#7/28 )/31 e.new#8/24 (/19 # Tile/21 e.new#9/26 )/20 )/12 >/1
      context[22] = context[13];
      context[23] = context[14];
      context[24] = context[15];
      ...
      do {
        // </0 & GenResult-Aux/4 (/7 e.new#10/33 )/8 (/11 (/30 # Tile/32 e.new#12/35 )/31 e.new#11/37 (/19 # Tile/21 t.new#13/41 e.new#14/39 )/20 )/12 >/1
        ...
        // closed e.new#11 as range 37
        context[42] = refalrts::tvar_left( context[41], context[39], context[40] );
        if( ! context[42] )
          continue;
        // closed e.new#14 as range 39
        do {
          // </0 & GenResult-Aux/4 (/7 e.Trash#1/43 )/8 (/11 (/30 # Tile/32 e.3#0/45 )/31 e.1#0/47 (/19 # Tile/21 (/41 # RIGHT-EDGE/51 )/42 )/20 )/12 >/1
          context[43] = context[33];
          context[44] = context[34];
          context[45] = context[35];
          context[46] = context[36];
          ...
          if( ! refalrts::empty_seq( context[39], context[40] ) )
            continue;
          // closed e.Trash#1 as range 43
          // closed e.3#0 as range 45
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & GenResult-Aux=1@1/4 AsIs: (/7 } </52 & TextFromExpr/53 Tile{ AsIs: e.Trash#1/43 } >/54 )/55 (/56 </57 & TextFromExpr/58 (/59 # Tile/60 e.3#0/45/61 )/63 e.1#0/47/64 (/66 # Tile/67 (/68 # RIGHT-EDGE/69 )/70 )/71 >/72 )/73 (/74 </75 & Map@4/76 (/77 # Tile/78 e.3#0/45/79 )/81 e.1#0/47/82 (/84 # Tile/85 (/86 # RIGHT-EDGE/87 )/88 )/89 >/90 )/91 (/92 </93 & Map@1/94 (/95 # Tile/96 e.3#0/45/97 )/99 e.1#0/47/100 (/102 # Tile/103 (/104 # RIGHT-EDGE/105 )/106 )/107 >/108 )/109 (/110 </111 & GenPushLink/112 Tile{ HalfReuse: </8 HalfReuse: & Map@2/11 AsIs: (/30 AsIs: # Tile/32 AsIs: e.3#0/45 AsIs: )/31 AsIs: e.1#0/47 AsIs: (/19 AsIs: # Tile/21 AsIs: (/41 AsIs: # RIGHT-EDGE/51 AsIs: )/42 AsIs: )/20 HalfReuse: >/12 AsIs: >/1 } )/113 (/114 </115 & Map@3/116 </117 & CollectTiles/118 e.1#0/47/119 >/121 >/122 )/123 </124 & GenTrash/125 (/126 e.3#0/45/127 )/129 e.Trash#1/43/130 >/132 >/133 Tile{ ]] }
        ...
        // </0 & GenResult-Aux/4 (/7 e.Trash#1/43 )/8 (/11 (/30 # Tile/32 e.3#0/45 )/31 e.1#0/47 (/19 # Tile/21 t.#0/41 e.#0/49 )/20 )/12 >/1
        context[43] = context[33];
        context[44] = context[34];
        context[45] = context[35];
        context[46] = context[36];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & GenResult-Aux=1@2/4 AsIs: (/7 } </51 & TextFromExpr/52 Tile{ AsIs: e.Trash#1/43 } >/53 )/54 (/55 </56 & TextFromExpr/57 (/58 # Tile/59 e.3#0/45/60 )/62 e.1#0/47/63 (/65 # Tile/66 t.#0/41/67 e.#0/49/69 )/71 >/72 )/73 (/74 </75 & Map@4/76 (/77 # Tile/78 e.3#0/45/79 )/81 e.1#0/47/82 (/84 # Tile/85 t.#0/41/86 e.#0/49/88 )/90 >/91 )/92 (/93 </94 & Map@1/95 (/96 # Tile/97 e.3#0/45/98 )/100 e.1#0/47/101 (/103 # Tile/104 t.#0/41/105 e.#0/49/107 )/109 >/110 )/111 (/112 </113 & GenPushLink/114 Tile{ HalfReuse: </8 HalfReuse: & Map@2/11 AsIs: (/30 AsIs: # Tile/32 AsIs: e.3#0/45 AsIs: )/31 AsIs: e.1#0/47 AsIs: (/19 AsIs: # Tile/21 AsIs: t.#0/41 AsIs: e.#0/49 AsIs: )/20 HalfReuse: >/12 AsIs: >/1 } )/115 (/116 </117 & BeginOffset/118 t.#0/41/119 >/121 )/122 (/123 </124 & Map@3/125 </126 & CollectTiles/127 e.1#0/47/128 >/130 >/131 )/132 </133 & GenTrash/134 (/135 e.3#0/45/136 )/138 e.Trash#1/43/139 >/141 >/142 Tile{ ]] }
        refalrts::alloc_open_call(vm, context[51]);
        refalrts::alloc_name(vm, context[52], functions[efunc_TextFromExpr]);
        refalrts::alloc_close_call(vm, context[53]);
        refalrts::alloc_close_bracket(vm, context[54]);
      ...
      // </0 & GenResult-Aux/4 (/7 e.Trash#1/33 )/8 (/11 (/30 # Tile/32 e.3#0/35 )/31 e.1#0/37 (/19 # Tile/21 e.4#0/39 )/20 )/12 >/1
      context[33] = context[22];
      context[34] = context[23];
      context[35] = context[28];
      context[36] = context[29];
      ...
      context[39] = context[26];
      context[40] = context[27];
      // closed e.Trash#1 as range 33
      // closed e.3#0 as range 35
      // closed e.1#0 as range 37
      // closed e.4#0 as range 39
      //DEBUG: e.Trash#1: 33
      //DEBUG: e.3#0: 35
      //DEBUG: e.1#0: 37
      //DEBUG: e.4#0: 39
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & GenResult-Aux=1@2/4 AsIs: (/7 } </41 & TextFromExpr/42 Tile{ AsIs: e.Trash#1/33 } >/43 )/44 (/45 </46 & TextFromExpr/47 (/48 # Tile/49 e.3#0/35/50 )/52 e.1#0/37/53 (/55 # Tile/56 e.4#0/39/57 )/59 >/60 )/61 (/62 </63 & Map@4/64 (/65 # Tile/66 e.3#0/35/67 )/69 e.1#0/37/70 (/72 # Tile/73 e.4#0/39/74 )/76 >/77 )/78 (/79 </80 & Map@1/81 (/82 # Tile/83 e.3#0/35/84 )/86 e.1#0/37/87 (/89 # Tile/90 e.4#0/39/91 )/93 >/94 )/95 (/96 </97 & GenPushLink/98 Tile{ HalfReuse: </8 HalfReuse: & Map@2/11 AsIs: (/30 AsIs: # Tile/32 AsIs: e.3#0/35 AsIs: )/31 AsIs: e.1#0/37 AsIs: (/19 AsIs: # Tile/21 AsIs: e.4#0/39 AsIs: )/20 HalfReuse: >/12 AsIs: >/1 } )/99 (/100 </101 & CalcRes*2/102 e.4#0/39/103 >/105 )/106 (/107 </108 & Map@3/109 </110 & CollectTiles/111 e.1#0/37/112 >/114 >/115 )/116 </117 & GenTrash/118 (/119 e.3#0/35/120 )/122 e.Trash#1/33/123 >/125 >/126 Tile{ ]] }
    ...
    // </0 & GenResult-Aux/4 (/7 # RemovedTile/26 )/8 (/11 (/19 # Tile/21 e.2#0/24 )/20 )/12 >/1
    context[22] = context[13];
    context[23] = context[14];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </27 & GenResult-Aux=1@3/28 (/29 </30 & TextFromExpr/31 # RemovedTile/32 >/33 )/34 (/35 </36 & TextFromExpr/37 (/38 # Tile/39 e.2#0/24/40 )/42 >/43 )/44 (/45 </46 & Map@4/47 (/48 # Tile/49 e.2#0/24/50 )/52 >/53 )/54 (/55 </56 & Map@1/57 (/58 # Tile/59 e.2#0/24/60 )/62 Tile{ HalfReuse: >/0 HalfReuse: )/4 HalfReuse: </7 HalfReuse: & GenPushLink/26 HalfReuse: </8 HalfReuse: & Map@2/11 AsIs: (/19 AsIs: # Tile/21 AsIs: e.2#0/24 AsIs: )/20 HalfReuse: >/12 AsIs: >/1 } >/63 Tile{ ]] }
    refalrts::alloc_open_call(vm, context[27]);
    refalrts::alloc_name(vm, context[28], functions[efunc_gen_GenResultm_Aux_A1Z3]);
    refalrts::alloc_open_bracket(vm, context[29]);
    refalrts::alloc_open_call(vm, context[30]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </13 & GenResult-Aux=1@4/14 (/15 </16 & TextFromExpr/17 e.Trash#1/5/18 >/20 )/21 (/22 </23 & TextFromExpr/24 e.MarkedResult#1/9/25 >/27 )/28 (/29 </30 & Map@4/31 e.MarkedResult#1/9/32 >/34 )/35 (/36 </37 & Map@1/38 e.MarkedResult#1/9/39 >/41 )/42 (/43 </44 & GenPushLink/45 </46 Tile{ HalfReuse: & Map@2/11 AsIs: e.MarkedResult#1/9 HalfReuse: >/12 AsIs: >/1 } )/47 Tile{ AsIs: </0 Reuse: & GenSplices*2/4 AsIs: (/7 AsIs: e.Trash#1/5 AsIs: )/8 } e.MarkedResult#1/9/48 >/50 >/51 Tile{ ]] }
  refalrts::alloc_open_call(vm, context[13]);
  refalrts::alloc_name(vm, context[14], functions[efunc_gen_GenResultm_Aux_A1Z4]);
  refalrts::alloc_open_bracket(vm, context[15]);
  refalrts::alloc_open_call(vm, context[16]);
...
static refalrts::FnResult func_GenResultm_Allocations(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@4/4 AsIs: e.MarkedResult#1/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_GenPushLink(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & GenPushLink=1/4 } </5 & DoMapAccum@1/6 (/7 )/8 (/9 )/10 Tile{ AsIs: e.MarkedResult#1/2 } >/11 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
...
static refalrts::FnResult func_FlatTilesInResult(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@2/4 AsIs: e.Result#1/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_GenSplices(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // closed e.new#3 as range 9
  do {
    // </0 & GenSplices/4 (/7 e.new#6/14 )/8 (/22 # Tile/24 e.new#4/20 )/23 e.new#5/16 (/11 # Tile/13 e.new#7/18 )/12 >/1
    ...
    if( ! context[24] )
      continue;
    // closed e.new#6 as range 14
    // closed e.new#4 as range 20
    // closed e.new#5 as range 16
    // closed e.new#7 as range 18
    do {
      // </0 & GenSplices/4 (/7 e.new#10/25 )/8 (/22 # Tile/24 e.new#9/27 )/23 e.new#8/29 (/11 # Tile/13 t.new#11/33 e.new#12/31 )/12 >/1
      ...
      do {
        // </0 & GenSplices/4 (/7 e.Trash#1/35 )/8 (/22 # Tile/24 e.LeftTile#1/37 )/23 e.Result#1/39 (/11 # Tile/13 (/33 # RIGHT-EDGE/43 )/34 )/12 >/1
        ...
        if( ! refalrts::empty_seq( context[31], context[32] ) )
          continue;
        // closed e.Trash#1 as range 35
        // closed e.LeftTile#1 as range 37
        // closed e.Result#1 as range 39
        //DEBUG: e.Trash#1: 35
        //DEBUG: e.LeftTile#1: 37
        //DEBUG: e.Result#1: 39

        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ } Tile{ AsIs: (/33 Reuse: # CmdSetRes/43 HalfReuse: # RIGHT-EDGE/34 AsIs: )/12 HalfReuse: </1 } Tile{ HalfReuse: & Map@3/7 } Tile{ AsIs: </0 Reuse: & CollectTiles/4 } Tile{ AsIs: e.Result#1/39 } Tile{ HalfReuse: >/11 HalfReuse: >/13 } Tile{ HalfReuse: </8 HalfReuse: & GenTrash/22 HalfReuse: (/24 AsIs: e.LeftTile#1/37 AsIs: )/23 } Tile{ AsIs: e.Trash#1/35 } >/44 Tile{ ]] }
      ...
      // </0 & GenSplices/4 (/7 e.Trash#1/35 )/8 (/22 # Tile/24 e.LeftTile#1/37 )/23 e.Result#1/39 (/11 # Tile/13 t.#0/33 e.#0/41 )/12 >/1
      context[35] = context[25];
      context[36] = context[26];
      context[37] = context[27];
      context[38] = context[28];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} e.#0/41 {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } (/43 # CmdSetRes/44 Tile{ HalfReuse: </11 HalfReuse: & BeginOffset/13 AsIs: t.#0/33 } >/45 Tile{ AsIs: )/12 } Tile{ AsIs: </0 Reuse: & Map@3/4 HalfReuse: </7 } & CollectTiles/46 Tile{ AsIs: e.Result#1/39 } >/47 >/48 Tile{ HalfReuse: </8 HalfReuse: & GenTrash/22 HalfReuse: (/24 AsIs: e.LeftTile#1/37 AsIs: )/23 } Tile{ AsIs: e.Trash#1/35 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[43]);
    ...
    // </0 & GenSplices/4 (/7 e.Trash#1/25 )/8 (/22 # Tile/24 e.LeftTile#1/27 )/23 e.Result#1/29 (/11 # Tile/13 e.RightTile#1/31 )/12 >/1
    context[25] = context[14];
    context[26] = context[15];
    context[27] = context[20];
    context[28] = context[21];
    ...
    context[31] = context[18];
    context[32] = context[19];
    // closed e.Trash#1 as range 25
    // closed e.LeftTile#1 as range 27
    // closed e.Result#1 as range 29
    // closed e.RightTile#1 as range 31
    //DEBUG: e.Trash#1: 25
    //DEBUG: e.LeftTile#1: 27
    //DEBUG: e.Result#1: 29
    //DEBUG: e.RightTile#1: 31

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } (/33 # CmdSetRes/34 Tile{ HalfReuse: </11 HalfReuse: & CalcRes*2/13 AsIs: e.RightTile#1/31 HalfReuse: >/12 HalfReuse: )/1 } Tile{ AsIs: </0 Reuse: & Map@3/4 HalfReuse: </7 } & CollectTiles/35 Tile{ AsIs: e.Result#1/29 } >/36 >/37 Tile{ HalfReuse: </8 HalfReuse: & GenTrash/22 HalfReuse: (/24 AsIs: e.LeftTile#1/27 AsIs: )/23 } Tile{ AsIs: e.Trash#1/25 } >/38 Tile{ ]] }
...
static refalrts::FnResult func_AddOffsets(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & MapAccum@1/4 } Tile{ AsIs: (/8 AsIs: e.PatternVars#1/6 AsIs: )/9 } Tile{ AsIs: s.ContextOffset#1/5 } </10 & CollectStrings/11 Tile{ AsIs: e.MarkedResult#1/2 } >/12 Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_MapAccum_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // closed e.new#3 as range 2
  do {
    // </0 & MapAccum@1/4 (/7 e.PatternVars#1/11 )/8 t.Acc#1/9 e.Tail#1/13 >/1
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoMapAccum@2/4 AsIs: (/7 AsIs: e.PatternVars#1/11 AsIs: )/8 AsIs: t.Acc#1/9 } (/15 )/16 Tile{ AsIs: e.Tail#1/13 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_bracket(vm, context[15]);
    refalrts::alloc_close_bracket(vm, context[16]);
  ...
  // </0 & MapAccum@1/4 (/7 e.PatternVars#1/5 )/8 t.accum#0/9 e.items#0/2 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & MapAccum@0/4 HalfReuse: [*]/7 } & AddOffsets\1@0/11 (/12 Tile{ AsIs: e.PatternVars#1/5 } )/13 Tile{ HalfReuse: {*}/8 AsIs: t.accum#0/9 AsIs: e.items#0/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Map_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@5/4 } Tile{ AsIs: e.0#0/11 } Tile{ HalfReuse: >/7 HalfReuse: </13 } Tile{ HalfReuse: & Map@1/8 AsIs: e.Tail#1/9 AsIs: >/1 ]] }
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & GenResult-ReinitUpdate\1@0/4 AsIs: e.items#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
...
static refalrts::FnResult func_gen_Map_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      do {
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@6/4 } Tile{ AsIs: e.0#0/14 } Tile{ HalfReuse: >/7 HalfReuse: </13 } Tile{ HalfReuse: & Map@2/8 AsIs: e.Tail#1/16 AsIs: >/1 ]] }
      ...
      // </0 & Map@2/4 (/7 s.tag#2/13 e.0#0/14 )/8 e.Tail#1/16 >/1
      context[14] = context[11];
      context[15] = context[12];
      context[16] = context[9];
      context[17] = context[10];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: s.tag#2/13 AsIs: e.0#0/14 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@2/4 } Tile{ AsIs: e.Tail#1/16 } Tile{ AsIs: >/1 ]] }
      refalrts::push_stack( vm, context[1] );
      refalrts::push_stack( vm, context[0] );
      refalrts::link_brackets( context[7], context[8] );
      refalrts::Iter trash_prev = arg_begin->prev;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & FlatTilesInResult\1*2/4 AsIs: t.Next#1/7 } >/11 </12 & Map@2/13 Tile{ AsIs: e.Tail#1/9 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[11]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & FlatTilesInResult\1@0/4 AsIs: e.items#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Map_Z0]);
...
static refalrts::FnResult func_gen_Map_Z3(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new#2 as range 5
    do {
      // </0 & Map@3/4 (/7 e.new#3/11 t.new#4/13 )/8 e.new#5/9 >/1
      context[9] = context[5];
      context[10] = context[6];
      context[11] = 0;
      context[12] = 0;
      ...
      do {
        // </0 & Map@3/4 (/7 t.new#6/13 )/8 e.new#7/15 >/1
        context[15] = context[9];
        context[16] = context[10];
        if( ! refalrts::empty_seq( context[11], context[12] ) )
          continue;
        ...
        do {
          // </0 & Map@3/4 (/7 (/13 # AsIs/21 (/24 # TkVariable/26 'e'/27 e.8#0/22 s.Depth#2/29 s.Offset#2/28 )/25 )/14 )/8 e.Tail#1/17 >/1
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} </0 & Map@3/4 (/7 (/13 # AsIs/21 {REMOVED TILE} e.8#0/22 s.Depth#2/29 {REMOVED TILE}
          //RESULT: Tile{ [[ } Tile{ AsIs: (/24 Reuse: # CmdInsertVar/26 AsIs: 'e'/27 } Tile{ AsIs: s.Offset#2/28 AsIs: )/25 HalfReuse: </14 HalfReuse: & Map@3/8 AsIs: e.Tail#1/17 AsIs: >/1 ]] }
        ...
        // </0 & Map@3/4 (/7 t.#0/13 )/8 e.Tail#1/17 >/1
        context[17] = context[15];
        context[18] = context[16];
        // closed e.Tail#1 as range 17
        //DEBUG: t.#0: 13
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdInsertTile/4 HalfReuse: </7 } & BeginOffset/19 t.#0/13/20 >/22 </23 & EndOffset/24 Tile{ AsIs: t.#0/13 } >/25 )/26 </27 Tile{ HalfReuse: & Map@3/8 AsIs: e.Tail#1/17 AsIs: >/1 ]] }
      ...
      // </0 & Map@3/4 (/7 t.#0/19 e.1#0/15 t.0#0/13 )/8 e.Tail#1/17 >/1
      context[15] = context[11];
      context[16] = context[12];
      ...
      //RESULT: Tile{ [[ } (/21 Tile{ HalfReuse: # CmdInsertTile/0 HalfReuse: </4 HalfReuse: & BeginOffset/7 AsIs: t.#0/19 } >/22 </23 & EndOffset/24 Tile{ AsIs: t.0#0/13 } >/25 )/26 </27 Tile{ HalfReuse: & Map@3/8 AsIs: e.Tail#1/17 AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[21]);
      refalrts::alloc_close_call(vm, context[22]);
      refalrts::alloc_open_call(vm, context[23]);
      refalrts::alloc_name(vm, context[24], functions[efunc_EndOffset]);
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & GenSplices$1\1*3/4 AsIs: t.Next#1/7 } >/11 </12 & Map@3/13 Tile{ AsIs: e.Tail#1/9 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[11]);
    refalrts::alloc_open_call(vm, context[12]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & GenSplices$1\1@0/4 AsIs: e.items#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Map_Z0]);
...
static refalrts::FnResult func_gen_GenResultm_Aux_A1Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & GenResult-Aux=1@1/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & GenResult-Aux=1@1/4 (/7 e.new#1/5 )/8 (/11 e.new#2/9 )/12 (/15 e.new#3/13 )/16 (/19 e.new#4/17 )/20 (/23 e.new#5/21 )/24 (/27 e.new#6/25 )/28 e.new#7/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  do {
    // </0 & GenResult-Aux=1@1/4 (/7 e.Call#0/29 )/8 (/11 e.Call0#0/31 )/12 (/15 e.Call1#0/33 )/16 (/19 e.Call2#0/35 )/20 (/23 e.Call3#0/37 )/24 (/27 e.Call4#0/39 )/28 e.Call5#0/41 >/1
    ...
    // closed e.Call0#0 as range 31
    // closed e.Call1#0 as range 33
    // closed e.Call2#0 as range 35
    // closed e.Call3#0 as range 37
    // closed e.Call4#0 as range 39
    // closed e.Call5#0 as range 41
    //DEBUG: e.Call#0: 29
    //DEBUG: e.Call0#0: 31
    //DEBUG: e.Call1#0: 33
    //DEBUG: e.Call2#0: 35
    ...
    //RESULT: Tile{ [[ } </43 Tile{ HalfReuse: & PatchClosureLogic/16 AsIs: (/19 } # CmdComment/44"TRA"/45 Tile{ HalfReuse: 'S'/0 HalfReuse: 'H'/4 HalfReuse: ':'/7 AsIs: e.Call#0/29 AsIs: )/8 AsIs: (/11 } # CmdComment/47 Tile{ HalfReuse: 'R'/20 HalfReuse: 'E'/23 } Tile{ HalfReuse: 'S'/12 HalfReuse: 'U'/15 }"LT:"/48 Tile{ AsIs: e.Call0#0/31 } Tile{ AsIs: )/28 } Tile{ AsIs: e.Call1#0/33 } Tile{ AsIs: e.Call2#0/35 } Tile{ AsIs: e.Call3#0/37 } Tile{ AsIs: (/27 } # CmdSetRes/50 # RIGHT-EDGE/51 Tile{ AsIs: )/24 } Tile{ AsIs: e.Call4#0/39 } Tile{ AsIs: e.Call5#0/41 } Tile{ AsIs: >/1 ]] }
  ...
  // </0 & GenResult-Aux=1@1/4 (/7 e.Call#0/5 )/8 (/11 e.Call0#0/9 )/12 (/15 e.Call1#0/13 )/16 (/19 e.Call2#0/17 )/20 (/23 e.Call3#0/21 )/24 (/27 e.Call4#0/25 )/28 e.Call5#0/2 >/1
  // closed e.Call#0 as range 5
  // closed e.Call0#0 as range 9
  // closed e.Call1#0 as range 13
  // closed e.Call2#0 as range 17
  // closed e.Call3#0 as range 21
  // closed e.Call4#0 as range 25
  // closed e.Call5#0 as range 2
  //DEBUG: e.Call#0: 5
  //DEBUG: e.Call0#0: 9
  //DEBUG: e.Call1#0: 13
  //DEBUG: e.Call2#0: 17
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </29 Tile{ HalfReuse: & GenResult-Aux=1@0/16 AsIs: (/19 } # CmdComment/30"TRA"/31 Tile{ HalfReuse: 'S'/0 HalfReuse: 'H'/4 HalfReuse: ':'/7 AsIs: e.Call#0/5 AsIs: )/8 AsIs: (/11 } # CmdComment/33 Tile{ HalfReuse: 'R'/20 HalfReuse: 'E'/23 } Tile{ HalfReuse: 'S'/12 HalfReuse: 'U'/15 }"LT:"/34 Tile{ AsIs: e.Call0#0/9 } Tile{ AsIs: )/28 } Tile{ AsIs: e.Call1#0/13 } Tile{ AsIs: e.Call2#0/17 } Tile{ AsIs: e.Call3#0/21 } Tile{ AsIs: (/27 } # CmdSetRes/36 # RIGHT-EDGE/37 Tile{ AsIs: )/24 } Tile{ AsIs: e.Call4#0/25 } Tile{ AsIs: e.Call5#0/2 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_GenResultm_Aux_A1Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & GenResult-Aux=1@2/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & GenResult-Aux=1@2/4 (/7 e.new#1/5 )/8 (/11 e.new#2/9 )/12 (/15 e.new#3/13 )/16 (/19 e.new#4/17 )/20 (/23 e.new#5/21 )/24 (/27 e.new#6/25 )/28 (/31 e.new#7/29 )/32 e.new#8/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  do {
    // </0 & GenResult-Aux=1@2/4 (/7 e.Call#0/33 )/8 (/11 e.Call0#0/35 )/12 (/15 e.Call1#0/37 )/16 (/19 e.Call2#0/39 )/20 (/23 e.Call3#0/41 )/24 (/27 e.Call4#0/43 )/28 (/31 e.Call5#0/45 )/32 e.Call6#0/47 >/1
    ...
    // closed e.Call0#0 as range 35
    // closed e.Call1#0 as range 37
    // closed e.Call2#0 as range 39
    // closed e.Call3#0 as range 41
    // closed e.Call4#0 as range 43
    // closed e.Call5#0 as range 45
    // closed e.Call6#0 as range 47
    //DEBUG: e.Call#0: 33
    //DEBUG: e.Call0#0: 35
    //DEBUG: e.Call1#0: 37
    //DEBUG: e.Call2#0: 39
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </49 Tile{ HalfReuse: & PatchClosureLogic/16 AsIs: (/19 } # CmdComment/50 Tile{ HalfReuse: 'T'/31 }"RA"/51 Tile{ HalfReuse: 'S'/0 HalfReuse: 'H'/4 HalfReuse: ':'/7 AsIs: e.Call#0/33 AsIs: )/8 AsIs: (/11 } # CmdComment/53 Tile{ HalfReuse: 'R'/20 HalfReuse: 'E'/23 } Tile{ HalfReuse: 'S'/12 HalfReuse: 'U'/15 }"LT:"/54 Tile{ AsIs: e.Call0#0/35 } Tile{ AsIs: )/32 } Tile{ AsIs: e.Call1#0/37 } Tile{ AsIs: e.Call2#0/39 } Tile{ AsIs: e.Call3#0/41 } Tile{ HalfReuse: (/24 HalfReuse: # CmdSetRes/27 AsIs: e.Call4#0/43 AsIs: )/28 } Tile{ AsIs: e.Call5#0/45 } Tile{ AsIs: e.Call6#0/47 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[49]);
  ...
  // </0 & GenResult-Aux=1@2/4 (/7 e.Call#0/5 )/8 (/11 e.Call0#0/9 )/12 (/15 e.Call1#0/13 )/16 (/19 e.Call2#0/17 )/20 (/23 e.Call3#0/21 )/24 (/27 e.Call4#0/25 )/28 (/31 e.Call5#0/29 )/32 e.Call6#0/2 >/1
  // closed e.Call#0 as range 5
  // closed e.Call0#0 as range 9
  // closed e.Call1#0 as range 13
  // closed e.Call2#0 as range 17
  // closed e.Call3#0 as range 21
  // closed e.Call4#0 as range 25
  // closed e.Call5#0 as range 29
  // closed e.Call6#0 as range 2
  //DEBUG: e.Call#0: 5
  //DEBUG: e.Call0#0: 9
  //DEBUG: e.Call1#0: 13
  //DEBUG: e.Call2#0: 17
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </33 Tile{ HalfReuse: & GenResult-Aux=1@0/16 AsIs: (/19 } # CmdComment/34 Tile{ HalfReuse: 'T'/31 }"RA"/35 Tile{ HalfReuse: 'S'/0 HalfReuse: 'H'/4 HalfReuse: ':'/7 AsIs: e.Call#0/5 AsIs: )/8 AsIs: (/11 } # CmdComment/37 Tile{ HalfReuse: 'R'/20 HalfReuse: 'E'/23 } Tile{ HalfReuse: 'S'/12 HalfReuse: 'U'/15 }"LT:"/38 Tile{ AsIs: e.Call0#0/9 } Tile{ AsIs: )/32 } Tile{ AsIs: e.Call1#0/13 } Tile{ AsIs: e.Call2#0/17 } Tile{ AsIs: e.Call3#0/21 } Tile{ HalfReuse: (/24 HalfReuse: # CmdSetRes/27 AsIs: e.Call4#0/25 AsIs: )/28 } Tile{ AsIs: e.Call5#0/29 } Tile{ AsIs: e.Call6#0/2 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_GenResultm_Aux_A1Z3(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & GenResult-Aux=1@3/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & GenResult-Aux=1@3/4 (/7 e.new#1/5 )/8 (/11 e.new#2/9 )/12 (/15 e.new#3/13 )/16 (/19 e.new#4/17 )/20 e.new#5/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  do {
    // </0 & GenResult-Aux=1@3/4 (/7 e.Call#0/21 )/8 (/11 e.Call0#0/23 )/12 (/15 e.Call1#0/25 )/16 (/19 e.Call2#0/27 )/20 e.Call3#0/29 >/1
    ...
    // closed e.Call0#0 as range 23
    // closed e.Call1#0 as range 25
    // closed e.Call2#0 as range 27
    // closed e.Call3#0 as range 29
    //DEBUG: e.Call#0: 21
    //DEBUG: e.Call0#0: 23
    //DEBUG: e.Call1#0: 25
    //DEBUG: e.Call2#0: 27
    ...
    //RESULT: Tile{ [[ } </31 Tile{ HalfReuse: & PatchClosureLogic/16 AsIs: (/19 } # CmdComment/32"TRA"/33 Tile{ HalfReuse: 'S'/0 HalfReuse: 'H'/4 HalfReuse: ':'/7 AsIs: e.Call#0/21 AsIs: )/8 AsIs: (/11 } # CmdComment/35 'R'/36 Tile{ HalfReuse: 'E'/12 HalfReuse: 'S'/15 }"ULT:"/37 Tile{ AsIs: e.Call0#0/23 } Tile{ AsIs: )/20 } Tile{ AsIs: e.Call1#0/25 } Tile{ AsIs: e.Call2#0/27 } Tile{ AsIs: e.Call3#0/29 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[31]);
  ...
  // </0 & GenResult-Aux=1@3/4 (/7 e.Call#0/5 )/8 (/11 e.Call0#0/9 )/12 (/15 e.Call1#0/13 )/16 (/19 e.Call2#0/17 )/20 e.Call3#0/2 >/1
  // closed e.Call#0 as range 5
  // closed e.Call0#0 as range 9
  // closed e.Call1#0 as range 13
  // closed e.Call2#0 as range 17
  // closed e.Call3#0 as range 2
  //DEBUG: e.Call#0: 5
  //DEBUG: e.Call0#0: 9
  //DEBUG: e.Call1#0: 13
  //DEBUG: e.Call2#0: 17
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </21 Tile{ HalfReuse: & GenResult-Aux=1@0/16 AsIs: (/19 } # CmdComment/22"TRA"/23 Tile{ HalfReuse: 'S'/0 HalfReuse: 'H'/4 HalfReuse: ':'/7 AsIs: e.Call#0/5 AsIs: )/8 AsIs: (/11 } # CmdComment/25 'R'/26 Tile{ HalfReuse: 'E'/12 HalfReuse: 'S'/15 }"ULT:"/27 Tile{ AsIs: e.Call0#0/9 } Tile{ AsIs: )/20 } Tile{ AsIs: e.Call1#0/13 } Tile{ AsIs: e.Call2#0/17 } Tile{ AsIs: e.Call3#0/2 } Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[21]);
...
static refalrts::FnResult func_gen_GenResultm_Aux_A1Z4(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & GenResult-Aux=1@4/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & GenResult-Aux=1@4/4 (/7 e.new#1/5 )/8 (/11 e.new#2/9 )/12 (/15 e.new#3/13 )/16 (/19 e.new#4/17 )/20 (/23 e.new#5/21 )/24 e.new#6/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  do {
    // </0 & GenResult-Aux=1@4/4 (/7 e.Call#0/25 )/8 (/11 e.Call0#0/27 )/12 (/15 e.Call1#0/29 )/16 (/19 e.Call2#0/31 )/20 (/23 e.Call3#0/33 )/24 e.Call4#0/35 >/1
    ...
    // closed e.Call0#0 as range 27
    // closed e.Call1#0 as range 29
    // closed e.Call2#0 as range 31
    // closed e.Call3#0 as range 33
    // closed e.Call4#0 as range 35
    //DEBUG: e.Call#0: 25
    //DEBUG: e.Call0#0: 27
    //DEBUG: e.Call1#0: 29
    //DEBUG: e.Call2#0: 31
    ...
    //RESULT: Tile{ [[ } </37 Tile{ HalfReuse: & PatchClosureLogic/12 AsIs: (/15 } # CmdComment/38"TRA"/39 Tile{ HalfReuse: 'S'/0 HalfReuse: 'H'/4 HalfReuse: ':'/7 AsIs: e.Call#0/25 AsIs: )/8 AsIs: (/11 } # CmdComment/41 Tile{ HalfReuse: 'R'/20 HalfReuse: 'E'/23 } Tile{ HalfReuse: 'S'/16 HalfReuse: 'U'/19 }"LT:"/42 Tile{ AsIs: e.Call0#0/27 } Tile{ AsIs: )/24 } Tile{ AsIs: e.Call1#0/29 } Tile{ AsIs: e.Call2#0/31 } Tile{ AsIs: e.Call3#0/33 } Tile{ AsIs: e.Call4#0/35 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[37]);
  ...
  // </0 & GenResult-Aux=1@4/4 (/7 e.Call#0/5 )/8 (/11 e.Call0#0/9 )/12 (/15 e.Call1#0/13 )/16 (/19 e.Call2#0/17 )/20 (/23 e.Call3#0/21 )/24 e.Call4#0/2 >/1
  // closed e.Call#0 as range 5
  // closed e.Call0#0 as range 9
  // closed e.Call1#0 as range 13
  // closed e.Call2#0 as range 17
  // closed e.Call3#0 as range 21
  // closed e.Call4#0 as range 2
  //DEBUG: e.Call#0: 5
  //DEBUG: e.Call0#0: 9
  //DEBUG: e.Call1#0: 13
  //DEBUG: e.Call2#0: 17
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </25 Tile{ HalfReuse: & GenResult-Aux=1@0/12 AsIs: (/15 } # CmdComment/26"TRA"/27 Tile{ HalfReuse: 'S'/0 HalfReuse: 'H'/4 HalfReuse: ':'/7 AsIs: e.Call#0/5 AsIs: )/8 AsIs: (/11 } # CmdComment/29 Tile{ HalfReuse: 'R'/20 HalfReuse: 'E'/23 } Tile{ HalfReuse: 'S'/16 HalfReuse: 'U'/19 }"LT:"/30 Tile{ AsIs: e.Call0#0/9 } Tile{ AsIs: )/24 } Tile{ AsIs: e.Call1#0/13 } Tile{ AsIs: e.Call2#0/17 } Tile{ AsIs: e.Call3#0/21 } Tile{ AsIs: e.Call4#0/2 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Map_Z4(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new#2 as range 5
    do {
      // </0 & Map@4/4 (/7 e.new#3/11 )/8 e.new#4/9 >/1
      context[9] = context[5];
      context[10] = context[6];
      context[11] = 0;
      context[12] = 0;
      ...
      do {
        // </0 & Map@4/4 (/7 s.new#5/17 e.new#6/13 )/8 e.new#7/15 >/1
        ...
        do {
          // </0 & Map@4/4 (/7 # Tile/17 e.0#0/18 )/8 e.Tail#1/20 >/1
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} & Map@4/4 (/7 # Tile/17 e.0#0/18 {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 } Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/20 AsIs: >/1 ]] }
        ...
        // </0 & Map@4/4 (/7 s.new#8/17 e.new#9/18 s.new#10/22 )/8 e.new#11/20 >/1
        context[18] = context[13];
        context[19] = context[14];
        context[20] = context[15];
        context[21] = context[16];
        ...
        do {
          // </0 & Map@4/4 (/7 # TkVariableCopy/17 s.new#13/27 e.new#14/23 s.new#15/29 s.new#16/28 s.new#12/22 )/8 e.new#17/25 >/1
          ...
          do {
            // </0 & Map@4/4 (/7 # TkVariableCopy/17 't'/27 e.4#0/30 s.Level#2/29 s.SampleOffset#2/28 s.Offset#2/22 )/8 e.Tail#1/32 >/1
            ...
            //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCopyVar/4 HalfReuse: 'e'/7 HalfReuse: s.Offset2 #22/17 HalfReuse: s.SampleOffset2 #28/27 } )/34 </35 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/32 AsIs: >/1 ]] }
            refalrts::alloc_close_bracket(vm, context[34]);
            refalrts::alloc_open_call(vm, context[35]);
            refalrts::reinit_open_bracket(context[0]);
          ...
          // </0 & Map@4/4 (/7 # TkVariableCopy/17 s.Mode#2/27 e.4#0/30 s.Level#2/29 s.SampleOffset#2/28 s.Offset#2/22 )/8 e.Tail#1/32 >/1
          context[30] = context[23];
          context[31] = context[24];
          context[32] = context[25];
          context[33] = context[26];
          ...
          //RESULT: Tile{ [[ } Tile{ AsIs: (/7 Reuse: # CmdCopyVar/17 AsIs: s.Mode#2/27 } Tile{ AsIs: s.Offset#2/22 } Tile{ AsIs: s.SampleOffset#2/28 } Tile{ HalfReuse: )/4 } Tile{ AsIs: </0 } Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/32 AsIs: >/1 ]] }
        ...
        do {
          // </0 & Map@4/4 (/7 # TkString/17 e.1#0/23 s.Offset#2/22 )/8 e.Tail#1/25 >/1
          context[23] = context[18];
          context[24] = context[19];
          context[25] = context[20];
          context[26] = context[21];
          ...
          //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Allocate/7 HalfReuse: s.Offset2 #22/17 } # ElString/27 Tile{ AsIs: e.1#0/23 } )/28 </29 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/25 AsIs: >/1 ]] }
        ...
        do {
          // </0 & Map@4/4 (/7 # Symbol/17 s.new#13/27 s.new#14/28 s.new#12/22 )/8 e.new#15/25 >/1
          context[23] = context[18];
          context[24] = context[19];
          context[25] = context[20];
          context[26] = context[21];
          ...
          if( ! refalrts::empty_seq( context[23], context[24] ) )
            continue;
          do {
            // </0 & Map@4/4 (/7 # Symbol/17 # Char/27 s.Char#1/28 s.Offset#1/22 )/8 e.Tail#1/29 >/1
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} s.Offset#1/22 {REMOVED TILE}
            //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Allocate/7 HalfReuse: s.Offset1 #22/17 Reuse: # ElChar/27 AsIs: s.Char#1/28 } )/31 </32 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/29 AsIs: >/1 ]] }
            refalrts::alloc_close_bracket(vm, context[31]);
          ...
          // </0 & Map@4/4 (/7 # Symbol/17 # Number/27 s.Number#1/28 s.Offset#1/22 )/8 e.Tail#1/29 >/1
          context[29] = context[25];
          context[30] = context[26];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} s.Offset#1/22 {REMOVED TILE}
          //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Allocate/7 HalfReuse: s.Offset1 #22/17 Reuse: # ElNumber/27 AsIs: s.Number#1/28 } )/31 </32 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/29 AsIs: >/1 ]] }
          refalrts::alloc_close_bracket(vm, context[31]);
          refalrts::alloc_open_call(vm, context[32]);
          refalrts::reinit_open_bracket(context[0]);
          refalrts::reinit_ident(context[4], identifiers[ident_CmdCreateElem]);
        ...
        do {
          // </0 & Map@4/4 (/7 s.new#12/17 s.new#13/22 )/8 e.new#14/23 >/1
          ...
          // closed e.new#14 as range 23
          do {
            // </0 & Map@4/4 (/7 # TkOpenBracket/17 s.Offset#1/22 )/8 e.Tail#1/25 >/1
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} s.Offset#1/22 {REMOVED TILE}
            //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Allocate/7 HalfReuse: s.Offset1 #22/17 } # ElOpenBracket/27 )/28 </29 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/25 AsIs: >/1 ]] }
          ...
          do {
            // </0 & Map@4/4 (/7 # TkCloseBracket/17 s.Offset#1/22 )/8 e.Tail#1/25 >/1
            context[25] = context[23];
            context[26] = context[24];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} s.Offset#1/22 {REMOVED TILE}
            //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Allocate/7 HalfReuse: s.Offset1 #22/17 } # ElCloseBracket/27 )/28 </29 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/25 AsIs: >/1 ]] }
          ...
          do {
            // </0 & Map@4/4 (/7 # TkOpenADT/17 s.Offset#1/22 )/8 e.Tail#1/25 >/1
            context[25] = context[23];
            context[26] = context[24];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} s.Offset#1/22 {REMOVED TILE}
            //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Allocate/7 HalfReuse: s.Offset1 #22/17 } # ElOpenADT/27 )/28 </29 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/25 AsIs: >/1 ]] }
          ...
          do {
            // </0 & Map@4/4 (/7 # TkCloseADT/17 s.Offset#1/22 )/8 e.Tail#1/25 >/1
            context[25] = context[23];
            context[26] = context[24];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} s.Offset#1/22 {REMOVED TILE}
            //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Allocate/7 HalfReuse: s.Offset1 #22/17 } # ElCloseADT/27 )/28 </29 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/25 AsIs: >/1 ]] }
          ...
          do {
            // </0 & Map@4/4 (/7 # TkOpenCall/17 s.Offset#1/22 )/8 e.Tail#1/25 >/1
            context[25] = context[23];
            context[26] = context[24];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} s.Offset#1/22 {REMOVED TILE}
            //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Allocate/7 HalfReuse: s.Offset1 #22/17 } # ElOpenCall/27 )/28 </29 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/25 AsIs: >/1 ]] }
          ...
          // </0 & Map@4/4 (/7 # TkCloseCall/17 s.Offset#1/22 )/8 e.Tail#1/25 >/1
          context[25] = context[23];
          context[26] = context[24];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} s.Offset#1/22 {REMOVED TILE}
          //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Allocate/7 HalfReuse: s.Offset1 #22/17 } # ElCloseCall/27 )/28 </29 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/25 AsIs: >/1 ]] }
        ...
        do {
          // </0 & Map@4/4 (/7 # Symbol/17 s.new#13/27 e.new#14/23 s.new#12/22 )/8 e.new#15/25 >/1
          context[23] = context[18];
          context[24] = context[19];
          context[25] = context[20];
          context[26] = context[21];
          ...
          // closed e.new#14 as range 23
          do {
            // </0 & Map@4/4 (/7 # Symbol/17 # Name/27 e.2#0/28 s.Offset#1/22 )/8 e.Tail#1/30 >/1
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} s.Offset#1/22 {REMOVED TILE}
            //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Allocate/7 HalfReuse: s.Offset1 #22/17 Reuse: # ElName/27 } Tile{ AsIs: e.2#0/28 } )/32 </33 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/30 AsIs: >/1 ]] }
          ...
          // </0 & Map@4/4 (/7 # Symbol/17 # Identifier/27 e.2#0/28 s.Offset#1/22 )/8 e.Tail#1/30 >/1
          context[28] = context[23];
          context[29] = context[24];
          context[30] = context[25];
          context[31] = context[26];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} s.Offset#1/22 {REMOVED TILE}
          //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Allocate/7 HalfReuse: s.Offset1 #22/17 Reuse: # ElIdent/27 } Tile{ AsIs: e.2#0/28 } )/32 </33 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/30 AsIs: >/1 ]] }
          refalrts::alloc_close_bracket(vm, context[32]);
          refalrts::alloc_open_call(vm, context[33]);
          refalrts::reinit_open_bracket(context[0]);
          refalrts::reinit_ident(context[4], identifiers[ident_CmdCreateElem]);
        ...
        // closed e.new#14 as range 23
        do {
          // </0 & Map@4/4 (/7 # TkClosureHead/17 s.Offset#1/22 )/8 e.Tail#1/25 >/1
          context[25] = context[23];
          context[26] = context[24];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} s.Offset#1/22 {REMOVED TILE}
          //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Allocate/7 HalfReuse: s.Offset1 #22/17 } # ElClosureHead/27 )/28 </29 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/25 AsIs: >/1 ]] }
        ...
        // </0 & Map@4/4 (/7 # TkUnwrappedClosure/17 s.Offset#1/22 )/8 e.Tail#1/25 >/1
        context[25] = context[23];
        context[26] = context[24];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} s.Offset#1/22 {REMOVED TILE}
        //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Allocate/7 HalfReuse: s.Offset1 #22/17 } # ElUnwrappedClosure/27 )/28 </29 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/25 AsIs: >/1 ]] }
      ...
      // </0 & Map@4/4 (/7 e.#0/13 )/8 e.Tail#1/15 >/1
      context[13] = context[11];
      context[14] = context[12];
      context[15] = context[9];
      context[16] = context[10];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Allocate/7 } </17 & CreateElemParam*12/18 Tile{ AsIs: e.#0/13 } >/19 )/20 </21 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail#1/15 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[17]);
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & GenResult-Allocations\1*5/4 AsIs: t.Next#1/7 } >/11 </12 & Map@4/13 Tile{ AsIs: e.Tail#1/9 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[11]);
    refalrts::alloc_open_call(vm, context[12]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & GenResult-Allocations\1@0/4 AsIs: e.items#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Map_Z0]);
...
static refalrts::FnResult func_gen_Map_Z5(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      // closed e.new#4 as range 11
      do {
        // </0 & Map@5/4 (/7 s.new#6/13 t.new#7/18 )/8 e.new#8/16 >/1
        context[14] = context[11];
        context[15] = context[12];
        context[16] = context[9];
        context[17] = context[10];
        ...
        if( ! refalrts::empty_seq( context[14], context[15] ) )
          continue;
        do {
          // </0 & Map@5/4 (/7 # AsIs/13 t.0#0/18 )/8 e.Tail#1/20 >/1
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} & Map@5/4 (/7 # AsIs/13 t.0#0/18 {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 } Tile{ HalfReuse: & Map@5/8 AsIs: e.Tail#1/20 AsIs: >/1 ]] }
        ...
        // </0 & Map@5/4 (/7 s.new#9/13 (/18 e.new#10/22 )/19 )/8 e.new#11/20 >/1
        context[20] = context[16];
        context[21] = context[17];
        context[22] = 0;
        context[23] = 0;
        ...
        // closed e.new#11 as range 20
        do {
          // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 e.new#12/24 )/19 )/8 e.new#13/26 >/1
          ...
          do {
            // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 s.new#14/32 e.new#15/28 s.new#16/33 )/19 )/8 e.new#17/30 >/1
            ...
            do {
              // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 s.new#18/32 s.new#20/38 e.new#21/34 s.new#22/39 s.new#19/33 )/19 )/8 e.new#23/36 >/1
              ...
              do {
                // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # TkVariable/32 's'/38 e.6#0/40 s.SampleOffset#3/39 s.Offset#3/33 )/19 )/8 e.Tail#1/42 >/1
                ...
                if( ! refalrts::ident_term( identifiers[ident_TkVariable], context[32] ) )
                  continue;
                // closed e.6#0 as range 40
                // closed e.Tail#1 as range 42
                //DEBUG: s.SampleOffset#3: 39
                //DEBUG: s.Offset#3: 33
                //DEBUG: e.6#0: 40
                //DEBUG: e.Tail#1: 42

                refalrts::reset_allocator(vm);
                //TRASH: {REMOVED TILE} </0 & Map@5/4 {REMOVED TILE} e.6#0/40 s.SampleOffset#3/39 s.Offset#3/33 {REMOVED TILE}
                //RESULT: Tile{ [[ } Tile{ AsIs: (/7 Reuse: # CmdReinitSVar/13 HalfReuse: s.Offset3 #33/18 HalfReuse: s.SampleOffset3 #39/32 HalfReuse: )/38 } Tile{ HalfReuse: </19 HalfReuse: & Map@5/8 AsIs: e.Tail#1/42 AsIs: >/1 ]] }
              ...
              // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # Symbol/32 s.new#25/38 s.new#26/39 s.new#24/33 )/19 )/8 e.new#27/40 >/1
              ...
              if( ! refalrts::empty_seq( context[34], context[35] ) )
                continue;
              // closed e.new#27 as range 40
              do {
                // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # Symbol/32 # Char/38 s.Char#1/39 s.Offset#1/33 )/19 )/8 e.Tail#1/42 >/1
                ...
                refalrts::reset_allocator(vm);
                //TRASH: {REMOVED TILE} </0 {REMOVED TILE} {REMOVED TILE} s.Offset#1/33 {REMOVED TILE}
                //RESULT: Tile{ [[ } Tile{ AsIs: (/7 Reuse: # CmdCreateElem/13 HalfReuse: # Reinit/18 HalfReuse: s.Offset1 #33/32 Reuse: # ElChar/38 AsIs: s.Char#1/39 } Tile{ HalfReuse: )/4 } Tile{ HalfReuse: </19 HalfReuse: & Map@5/8 AsIs: e.Tail#1/42 AsIs: >/1 ]] }
              ...
              // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # Symbol/32 # Number/38 s.Number#1/39 s.Offset#1/33 )/19 )/8 e.Tail#1/42 >/1
              context[42] = context[40];
              context[43] = context[41];
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} </0 {REMOVED TILE} {REMOVED TILE} s.Offset#1/33 {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ AsIs: (/7 Reuse: # CmdCreateElem/13 HalfReuse: # Reinit/18 HalfReuse: s.Offset1 #33/32 Reuse: # ElNumber/38 AsIs: s.Number#1/39 } Tile{ HalfReuse: )/4 } Tile{ HalfReuse: </19 HalfReuse: & Map@5/8 AsIs: e.Tail#1/42 AsIs: >/1 ]] }
              refalrts::update_ident(context[13], identifiers[ident_CmdCreateElem]);
              refalrts::reinit_ident(context[18], identifiers[ident_Reinit]);
              refalrts::reinit_svar( context[32], context[33] );
            ...
            do {
              // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 s.new#18/32 s.new#19/33 )/19 )/8 e.new#20/34 >/1
              ...
              do {
                // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # TkOpenBracket/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
                ...
                //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Reinit/32 AsIs: s.Offset#1/33 HalfReuse: # ElOpenBracket/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
              ...
              do {
                // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # TkCloseBracket/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
                context[36] = context[34];
                context[37] = context[35];
                ...
                refalrts::reset_allocator(vm);
                //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Reinit/32 AsIs: s.Offset#1/33 HalfReuse: # ElCloseBracket/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
                refalrts::reinit_open_bracket(context[13]);
                refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
                refalrts::update_ident(context[32], identifiers[ident_Reinit]);
              ...
              do {
                // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # TkOpenADT/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
                context[36] = context[34];
                context[37] = context[35];
                ...
                refalrts::reset_allocator(vm);
                //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Reinit/32 AsIs: s.Offset#1/33 HalfReuse: # ElOpenADT/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
                refalrts::reinit_open_bracket(context[13]);
                refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
                refalrts::update_ident(context[32], identifiers[ident_Reinit]);
              ...
              do {
                // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # TkCloseADT/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
                context[36] = context[34];
                context[37] = context[35];
                ...
                refalrts::reset_allocator(vm);
                //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Reinit/32 AsIs: s.Offset#1/33 HalfReuse: # ElCloseADT/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
                refalrts::reinit_open_bracket(context[13]);
                refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
                refalrts::update_ident(context[32], identifiers[ident_Reinit]);
              ...
              do {
                // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # TkOpenCall/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
                context[36] = context[34];
                context[37] = context[35];
                ...
                refalrts::reset_allocator(vm);
                //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Reinit/32 AsIs: s.Offset#1/33 HalfReuse: # ElOpenCall/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
                refalrts::reinit_open_bracket(context[13]);
                refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
                refalrts::update_ident(context[32], identifiers[ident_Reinit]);
              ...
              // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # TkCloseCall/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
              context[36] = context[34];
              context[37] = context[35];
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Reinit/32 AsIs: s.Offset#1/33 HalfReuse: # ElCloseCall/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
              refalrts::reinit_open_bracket(context[13]);
              refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
              refalrts::update_ident(context[32], identifiers[ident_Reinit]);
            ...
            do {
              // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # Symbol/32 s.new#19/38 e.new#20/34 s.new#18/33 )/19 )/8 e.new#21/36 >/1
              context[34] = context[28];
              context[35] = context[29];
              context[36] = context[30];
              context[37] = context[31];
              ...
              // closed e.new#20 as range 34
              do {
                // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # Symbol/32 # Name/38 e.1#0/39 s.Offset#1/33 )/19 )/8 e.Tail#1/41 >/1
                ...
                refalrts::reset_allocator(vm);
                //TRASH: {REMOVED TILE} </0 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.Offset#1/33 {REMOVED TILE}
                //RESULT: Tile{ [[ } Tile{ AsIs: (/7 Reuse: # CmdCreateElem/13 HalfReuse: # Reinit/18 HalfReuse: s.Offset1 #33/32 Reuse: # ElName/38 } Tile{ AsIs: e.1#0/39 } Tile{ HalfReuse: )/4 } Tile{ HalfReuse: </19 HalfReuse: & Map@5/8 AsIs: e.Tail#1/41 AsIs: >/1 ]] }
                refalrts::update_ident(context[13], identifiers[ident_CmdCreateElem]);
                refalrts::reinit_ident(context[18], identifiers[ident_Reinit]);
                refalrts::reinit_svar( context[32], context[33] );
              ...
              // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # Symbol/32 # Identifier/38 e.1#0/39 s.Offset#1/33 )/19 )/8 e.Tail#1/41 >/1
              context[39] = context[34];
              context[40] = context[35];
              context[41] = context[36];
              context[42] = context[37];
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} </0 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.Offset#1/33 {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ AsIs: (/7 Reuse: # CmdCreateElem/13 HalfReuse: # Reinit/18 HalfReuse: s.Offset1 #33/32 Reuse: # ElIdent/38 } Tile{ AsIs: e.1#0/39 } Tile{ HalfReuse: )/4 } Tile{ HalfReuse: </19 HalfReuse: & Map@5/8 AsIs: e.Tail#1/41 AsIs: >/1 ]] }
              refalrts::update_ident(context[13], identifiers[ident_CmdCreateElem]);
              refalrts::reinit_ident(context[18], identifiers[ident_Reinit]);
              refalrts::reinit_svar( context[32], context[33] );
            ...
            // closed e.new#20 as range 34
            do {
              // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # TkClosureHead/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
              context[36] = context[34];
              context[37] = context[35];
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Reinit/32 AsIs: s.Offset#1/33 HalfReuse: # ElClosureHead/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
              refalrts::reinit_open_bracket(context[13]);
              refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
              refalrts::update_ident(context[32], identifiers[ident_Reinit]);
            ...
            // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 # TkUnwrappedClosure/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
            context[36] = context[34];
            context[37] = context[35];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Reinit/32 AsIs: s.Offset#1/33 HalfReuse: # ElUnwrappedClosure/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
            refalrts::reinit_open_bracket(context[13]);
            refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
            refalrts::update_ident(context[32], identifiers[ident_Reinit]);
          ...
          // </0 & Map@5/4 (/7 # HalfReuse/13 (/18 e.2#0/28 )/19 )/8 e.Tail#1/30 >/1
          context[28] = context[24];
          context[29] = context[25];
          context[30] = context[26];
          context[31] = context[27];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Reinit/7 HalfReuse: </13 HalfReuse: & CreateElemParam*12/18 AsIs: e.2#0/28 HalfReuse: >/19 AsIs: )/8 } </32 & Map@5/33 Tile{ AsIs: e.Tail#1/30 } Tile{ AsIs: >/1 ]] }
          refalrts::alloc_open_call(vm, context[32]);
        ...
        // </0 & Map@5/4 (/7 # Reuse/13 (/18 e.new#12/24 )/19 )/8 e.new#13/26 >/1
        context[24] = context[22];
        context[25] = context[23];
        context[26] = context[20];
        context[27] = context[21];
        ...
        // closed e.new#13 as range 26
        do {
          // </0 & Map@5/4 (/7 # Reuse/13 (/18 s.new#14/32 e.new#15/28 s.new#16/33 )/19 )/8 e.new#17/30 >/1
          context[28] = context[24];
          context[29] = context[25];
          context[30] = context[26];
          context[31] = context[27];
          ...
          // closed e.new#15 as range 28
          do {
            // </0 & Map@5/4 (/7 # Reuse/13 (/18 # Symbol/32 s.new#19/38 s.new#20/39 s.new#18/33 )/19 )/8 e.new#21/36 >/1
            context[34] = context[28];
            context[35] = context[29];
            context[36] = context[30];
            context[37] = context[31];
            ...
            if( ! refalrts::empty_seq( context[34], context[35] ) )
              continue;
            do {
              // </0 & Map@5/4 (/7 # Reuse/13 (/18 # Symbol/32 # Char/38 s.Char#1/39 s.Offset#1/33 )/19 )/8 e.Tail#1/40 >/1
              context[40] = context[36];
              context[41] = context[37];
              if( ! refalrts::ident_term( identifiers[ident_Char], context[38] ) )
                continue;
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} </0 {REMOVED TILE} {REMOVED TILE} s.Offset#1/33 {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ AsIs: (/7 Reuse: # CmdCreateElem/13 HalfReuse: # Update/18 HalfReuse: s.Offset1 #33/32 Reuse: # ElChar/38 AsIs: s.Char#1/39 } Tile{ HalfReuse: )/4 } Tile{ HalfReuse: </19 HalfReuse: & Map@5/8 AsIs: e.Tail#1/40 AsIs: >/1 ]] }
              refalrts::update_ident(context[13], identifiers[ident_CmdCreateElem]);
            ...
            // </0 & Map@5/4 (/7 # Reuse/13 (/18 # Symbol/32 # Number/38 s.Number#1/39 s.Offset#1/33 )/19 )/8 e.Tail#1/40 >/1
            context[40] = context[36];
            context[41] = context[37];
            if( ! refalrts::ident_term( identifiers[ident_Number], context[38] ) )
              continue;
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} </0 {REMOVED TILE} {REMOVED TILE} s.Offset#1/33 {REMOVED TILE}
            //RESULT: Tile{ [[ } Tile{ AsIs: (/7 Reuse: # CmdCreateElem/13 HalfReuse: # Update/18 HalfReuse: s.Offset1 #33/32 Reuse: # ElNumber/38 AsIs: s.Number#1/39 } Tile{ HalfReuse: )/4 } Tile{ HalfReuse: </19 HalfReuse: & Map@5/8 AsIs: e.Tail#1/40 AsIs: >/1 ]] }
            refalrts::update_ident(context[13], identifiers[ident_CmdCreateElem]);
            refalrts::reinit_ident(context[18], identifiers[ident_Update]);
            refalrts::reinit_svar( context[32], context[33] );
            refalrts::update_ident(context[38], identifiers[ident_ElNumber]);
          ...
          do {
            // </0 & Map@5/4 (/7 # Reuse/13 (/18 s.new#18/32 s.new#19/33 )/19 )/8 e.new#20/34 >/1
            context[34] = context[30];
            context[35] = context[31];
            if( ! refalrts::empty_seq( context[28], context[29] ) )
              continue;
            // closed e.new#20 as range 34
            do {
              // </0 & Map@5/4 (/7 # Reuse/13 (/18 # TkOpenBracket/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
              context[36] = context[34];
              context[37] = context[35];
              if( ! refalrts::ident_term( identifiers[ident_TkOpenBracket], context[32] ) )
                continue;
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Update/32 AsIs: s.Offset#1/33 HalfReuse: # ElOpenBracket/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
              refalrts::reinit_open_bracket(context[13]);
              refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
            ...
            do {
              // </0 & Map@5/4 (/7 # Reuse/13 (/18 # TkCloseBracket/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
              context[36] = context[34];
              context[37] = context[35];
              if( ! refalrts::ident_term( identifiers[ident_TkCloseBracket], context[32] ) )
                continue;
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Update/32 AsIs: s.Offset#1/33 HalfReuse: # ElCloseBracket/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
              refalrts::reinit_open_bracket(context[13]);
              refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
              refalrts::update_ident(context[32], identifiers[ident_Update]);
              refalrts::reinit_ident(context[19], identifiers[ident_ElCloseBracket]);
            ...
            do {
              // </0 & Map@5/4 (/7 # Reuse/13 (/18 # TkOpenADT/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
              context[36] = context[34];
              context[37] = context[35];
              if( ! refalrts::ident_term( identifiers[ident_TkOpenADT], context[32] ) )
                continue;
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Update/32 AsIs: s.Offset#1/33 HalfReuse: # ElOpenADT/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
              refalrts::reinit_open_bracket(context[13]);
              refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
              refalrts::update_ident(context[32], identifiers[ident_Update]);
              refalrts::reinit_ident(context[19], identifiers[ident_ElOpenADT]);
            ...
            do {
              // </0 & Map@5/4 (/7 # Reuse/13 (/18 # TkCloseADT/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
              context[36] = context[34];
              context[37] = context[35];
              if( ! refalrts::ident_term( identifiers[ident_TkCloseADT], context[32] ) )
                continue;
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Update/32 AsIs: s.Offset#1/33 HalfReuse: # ElCloseADT/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
              refalrts::reinit_open_bracket(context[13]);
              refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
              refalrts::update_ident(context[32], identifiers[ident_Update]);
              refalrts::reinit_ident(context[19], identifiers[ident_ElCloseADT]);
            ...
            do {
              // </0 & Map@5/4 (/7 # Reuse/13 (/18 # TkOpenCall/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
              context[36] = context[34];
              context[37] = context[35];
              if( ! refalrts::ident_term( identifiers[ident_TkOpenCall], context[32] ) )
                continue;
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Update/32 AsIs: s.Offset#1/33 HalfReuse: # ElOpenCall/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
              refalrts::reinit_open_bracket(context[13]);
              refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
              refalrts::update_ident(context[32], identifiers[ident_Update]);
              refalrts::reinit_ident(context[19], identifiers[ident_ElOpenCall]);
            ...
            // </0 & Map@5/4 (/7 # Reuse/13 (/18 # TkCloseCall/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
            context[36] = context[34];
            context[37] = context[35];
            if( ! refalrts::ident_term( identifiers[ident_TkCloseCall], context[32] ) )
              continue;
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Update/32 AsIs: s.Offset#1/33 HalfReuse: # ElCloseCall/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
            refalrts::reinit_open_bracket(context[13]);
            refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
            refalrts::update_ident(context[32], identifiers[ident_Update]);
            refalrts::reinit_ident(context[19], identifiers[ident_ElCloseCall]);
          ...
          do {
            // </0 & Map@5/4 (/7 # Reuse/13 (/18 # Symbol/32 s.new#19/38 e.new#20/34 s.new#18/33 )/19 )/8 e.new#21/36 >/1
            context[34] = context[28];
            context[35] = context[29];
            context[36] = context[30];
            context[37] = context[31];
            ...
            // closed e.new#20 as range 34
            do {
              // </0 & Map@5/4 (/7 # Reuse/13 (/18 # Symbol/32 # Name/38 e.1#0/39 s.Offset#1/33 )/19 )/8 e.Tail#1/41 >/1
              context[39] = context[34];
              context[40] = context[35];
              context[41] = context[36];
              context[42] = context[37];
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} </0 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.Offset#1/33 {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ AsIs: (/7 Reuse: # CmdCreateElem/13 HalfReuse: # Update/18 HalfReuse: s.Offset1 #33/32 Reuse: # ElName/38 } Tile{ AsIs: e.1#0/39 } Tile{ HalfReuse: )/4 } Tile{ HalfReuse: </19 HalfReuse: & Map@5/8 AsIs: e.Tail#1/41 AsIs: >/1 ]] }
              refalrts::update_ident(context[13], identifiers[ident_CmdCreateElem]);
              refalrts::reinit_ident(context[18], identifiers[ident_Update]);
              refalrts::reinit_svar( context[32], context[33] );
              refalrts::update_ident(context[38], identifiers[ident_ElName]);
            ...
            // </0 & Map@5/4 (/7 # Reuse/13 (/18 # Symbol/32 # Identifier/38 e.1#0/39 s.Offset#1/33 )/19 )/8 e.Tail#1/41 >/1
            context[39] = context[34];
            context[40] = context[35];
            context[41] = context[36];
            context[42] = context[37];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} </0 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.Offset#1/33 {REMOVED TILE}
            //RESULT: Tile{ [[ } Tile{ AsIs: (/7 Reuse: # CmdCreateElem/13 HalfReuse: # Update/18 HalfReuse: s.Offset1 #33/32 Reuse: # ElIdent/38 } Tile{ AsIs: e.1#0/39 } Tile{ HalfReuse: )/4 } Tile{ HalfReuse: </19 HalfReuse: & Map@5/8 AsIs: e.Tail#1/41 AsIs: >/1 ]] }
            refalrts::update_ident(context[13], identifiers[ident_CmdCreateElem]);
            refalrts::reinit_ident(context[18], identifiers[ident_Update]);
            refalrts::reinit_svar( context[32], context[33] );
            refalrts::update_ident(context[38], identifiers[ident_ElIdent]);
          ...
          // closed e.new#20 as range 34
          do {
            // </0 & Map@5/4 (/7 # Reuse/13 (/18 # TkClosureHead/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
            context[36] = context[34];
            context[37] = context[35];
            if( ! refalrts::ident_term( identifiers[ident_TkClosureHead], context[32] ) )
              continue;
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Update/32 AsIs: s.Offset#1/33 HalfReuse: # ElClosureHead/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
            refalrts::reinit_open_bracket(context[13]);
            refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
            refalrts::update_ident(context[32], identifiers[ident_Update]);
            refalrts::reinit_ident(context[19], identifiers[ident_ElClosureHead]);
          ...
          // </0 & Map@5/4 (/7 # Reuse/13 (/18 # TkUnwrappedClosure/32 s.Offset#1/33 )/19 )/8 e.Tail#1/36 >/1
          context[36] = context[34];
          context[37] = context[35];
          if( ! refalrts::ident_term( identifiers[ident_TkUnwrappedClosure], context[32] ) )
            continue;
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ } Tile{ HalfReuse: (/13 HalfReuse: # CmdCreateElem/18 Reuse: # Update/32 AsIs: s.Offset#1/33 HalfReuse: # ElUnwrappedClosure/19 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.Tail#1/36 } Tile{ AsIs: >/1 ]] }
          refalrts::reinit_open_bracket(context[13]);
          refalrts::reinit_ident(context[18], identifiers[ident_CmdCreateElem]);
          refalrts::update_ident(context[32], identifiers[ident_Update]);
          refalrts::reinit_ident(context[19], identifiers[ident_ElUnwrappedClosure]);
        ...
        // </0 & Map@5/4 (/7 # Reuse/13 (/18 e.2#0/28 )/19 )/8 e.Tail#1/30 >/1
        context[28] = context[24];
        context[29] = context[25];
        context[30] = context[26];
        context[31] = context[27];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCreateElem/4 HalfReuse: # Update/7 HalfReuse: </13 HalfReuse: & CreateElemParam*12/18 AsIs: e.2#0/28 HalfReuse: >/19 AsIs: )/8 } </32 & Map@5/33 Tile{ AsIs: e.Tail#1/30 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_call(vm, context[32]);
        refalrts::alloc_name(vm, context[33], functions[efunc_gen_Map_Z5]);
        refalrts::reinit_open_bracket(context[0]);
        refalrts::reinit_ident(context[4], identifiers[ident_CmdCreateElem]);
      ...
      // </0 & Map@5/4 (/7 s.new#6/13 )/8 e.new#7/14 >/1
      ...
      do {
        // </0 & Map@5/4 (/7 # LEFT-EDGE/13 )/8 e.Tail#1/16 >/1
        ...
        //RESULT: Tile{ [[ } Tile{ HalfReuse: </13 HalfReuse: & Map@5/8 AsIs: e.Tail#1/16 AsIs: >/1 ]] }
        refalrts::reinit_open_call(context[13]);
        refalrts::reinit_name(context[8], functions[efunc_gen_Map_Z5]);
        refalrts::push_stack( vm, context[1] );
        refalrts::push_stack( vm, context[13] );
      ...
      // </0 & Map@5/4 (/7 # RIGHT-EDGE/13 )/8 e.Tail#1/16 >/1
      context[16] = context[14];
      context[17] = context[15];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & GenResult-ReinitUpdate\1$1\1*6/4 AsIs: t.Next#1/7 } >/11 </12 & Map@5/13 Tile{ AsIs: e.Tail#1/9 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[11]);
    refalrts::alloc_open_call(vm, context[12]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & GenResult-ReinitUpdate\1$1\1@0/4 AsIs: e.items#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Map_Z0]);
...
static refalrts::FnResult func_gen_DoMapAccum_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      do {
        // </0 & DoMapAccum@1/4 (/5 e.new#13/26 )/6 (/9 e.new#17/28 )/10 (/15 s.new#14/25 s.new#15/34 )/16 e.new#16/32 >/1
        context[26] = context[21];
        ...
        if( ! refalrts::empty_seq( context[30], context[31] ) )
          continue;
        do {
          // </0 & DoMapAccum@1/4 (/5 e.#0/35 )/6 (/9 e.Scanned#1/37 )/10 (/15 # TkOpenCall/25 s.Offset#2/34 )/16 e.Tail#1/39 >/1
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} )/10 {REMOVED TILE} # TkOpenCall/25 s.Offset#2/34 {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoMapAccum@1/4 AsIs: (/5 AsIs: e.#0/35 HalfReuse: s.Offset2 #34/6 HalfReuse: )/9 } Tile{ AsIs: (/15 } Tile{ AsIs: e.Scanned#1/37 } Tile{ AsIs: )/16 AsIs: e.Tail#1/39 AsIs: >/1 ]] }
        ...
        do {
          // </0 & DoMapAccum@1/4 (/5 e.#0/35 )/6 (/9 e.Scanned#1/37 )/10 (/15 # TkOpenADT/25 s.Offset#2/34 )/16 e.Tail#1/39 >/1
          context[35] = context[26];
          context[36] = context[27];
          context[37] = context[28];
          context[38] = context[29];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} )/10 {REMOVED TILE} # TkOpenADT/25 s.Offset#2/34 {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoMapAccum@1/4 AsIs: (/5 AsIs: e.#0/35 HalfReuse: s.Offset2 #34/6 HalfReuse: )/9 } Tile{ AsIs: (/15 } Tile{ AsIs: e.Scanned#1/37 } Tile{ AsIs: )/16 AsIs: e.Tail#1/39 AsIs: >/1 ]] }
          refalrts::reinit_svar( context[6], context[34] );
          refalrts::reinit_close_bracket(context[9]);
          refalrts::push_stack( vm, context[1] );
        ...
        do {
          // </0 & DoMapAccum@1/4 (/5 e.#0/35 )/6 (/9 e.Scanned#1/37 )/10 (/15 # TkOpenBracket/25 s.Offset#2/34 )/16 e.Tail#1/39 >/1
          context[35] = context[26];
          context[36] = context[27];
          context[37] = context[28];
          context[38] = context[29];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} )/10 {REMOVED TILE} # TkOpenBracket/25 s.Offset#2/34 {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoMapAccum@1/4 AsIs: (/5 AsIs: e.#0/35 HalfReuse: s.Offset2 #34/6 HalfReuse: )/9 } Tile{ AsIs: (/15 } Tile{ AsIs: e.Scanned#1/37 } Tile{ AsIs: )/16 AsIs: e.Tail#1/39 AsIs: >/1 ]] }
          refalrts::reinit_svar( context[6], context[34] );
          refalrts::reinit_close_bracket(context[9]);
          refalrts::push_stack( vm, context[1] );
        ...
        do {
          // </0 & DoMapAccum@1/4 (/5 e.#0/35 )/6 (/9 e.Scanned#1/37 )/10 (/15 # TkClosureHead/25 s.Offset#2/34 )/16 e.Tail#1/39 >/1
          context[35] = context[26];
          context[36] = context[27];
          context[37] = context[28];
          context[38] = context[29];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} )/10 {REMOVED TILE} # TkClosureHead/25 s.Offset#2/34 {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoMapAccum@1/4 AsIs: (/5 AsIs: e.#0/35 HalfReuse: s.Offset2 #34/6 HalfReuse: )/9 } Tile{ AsIs: (/15 } Tile{ AsIs: e.Scanned#1/37 } Tile{ AsIs: )/16 AsIs: e.Tail#1/39 AsIs: >/1 ]] }
          refalrts::reinit_svar( context[6], context[34] );
          refalrts::reinit_close_bracket(context[9]);
          refalrts::push_stack( vm, context[1] );
        ...
        // </0 & DoMapAccum@1/4 (/5 e.new#18/35 s.new#19/41 )/6 (/9 e.new#23/37 )/10 (/15 s.new#20/25 s.new#21/34 )/16 e.new#22/39 >/1
        context[35] = context[26];
        context[36] = context[27];
        context[37] = context[28];
        context[38] = context[29];
        ...
        do {
          // </0 & DoMapAccum@1/4 (/5 e.1#0/42 s.OpenOffset#2/41 )/6 (/9 e.Scanned#1/44 )/10 (/15 # TkCloseCall/25 s.Offset#2/34 )/16 e.Tail#1/46 >/1
          ...
          //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoMapAccum@1/4 AsIs: (/5 } Tile{ AsIs: e.1#0/42 } Tile{ AsIs: )/6 AsIs: (/9 } Tile{ AsIs: e.Scanned#1/44 } (/48 # CmdPushStack/49 Tile{ AsIs: s.OpenOffset#2/41 } Tile{ AsIs: )/10 AsIs: (/15 Reuse: # CmdPushStack/25 AsIs: s.Offset#2/34 AsIs: )/16 } )/50 Tile{ AsIs: e.Tail#1/46 } Tile{ AsIs: >/1 ]] }
          refalrts::alloc_open_bracket(vm, context[48]);
        ...
        do {
          // </0 & DoMapAccum@1/4 (/5 e.1#0/42 s.OpenOffset#2/41 )/6 (/9 e.Scanned#1/44 )/10 (/15 # TkCloseADT/25 s.Offset#2/34 )/16 e.Tail#1/46 >/1
          context[42] = context[35];
          context[43] = context[36];
          context[44] = context[37];
          context[45] = context[38];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} s.OpenOffset#2/41 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoMapAccum@1/4 AsIs: (/5 } Tile{ AsIs: e.1#0/42 } Tile{ AsIs: )/6 AsIs: (/9 AsIs: e.Scanned#1/44 HalfReuse: (/10 HalfReuse: # CmdLinkBrackets/15 HalfReuse: s.OpenOffset2 #41/25 AsIs: s.Offset#2/34 AsIs: )/16 } )/48 Tile{ AsIs: e.Tail#1/46 } Tile{ AsIs: >/1 ]] }
        ...
        do {
          // </0 & DoMapAccum@1/4 (/5 e.1#0/42 s.OpenOffset#2/41 )/6 (/9 e.Scanned#1/44 )/10 (/15 # TkCloseBracket/25 s.Offset#2/34 )/16 e.Tail#1/46 >/1
          context[42] = context[35];
          context[43] = context[36];
          context[44] = context[37];
          context[45] = context[38];
        ...
        // </0 & DoMapAccum@1/4 (/5 e.1#0/42 s.HeadOffset#2/41 )/6 (/9 e.Scanned#1/44 )/10 (/15 # TkUnwrappedClosure/25 s.Offset#2/34 )/16 e.Tail#1/46 >/1
        context[42] = context[35];
        context[43] = context[36];
        context[44] = context[37];
        context[45] = context[38];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} s.HeadOffset#2/41 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoMapAccum@1/4 AsIs: (/5 } Tile{ AsIs: e.1#0/42 } Tile{ AsIs: )/6 AsIs: (/9 AsIs: e.Scanned#1/44 HalfReuse: (/10 HalfReuse: # PatchCreateUnwrappedClosure/15 HalfReuse: s.HeadOffset2 #41/25 AsIs: s.Offset#2/34 AsIs: )/16 } (/48 # CmdWrapClosure/49 s.Offset#2/34/50 )/51 )/52 Tile{ AsIs: e.Tail#1/46 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_bracket(vm, context[48]);
      ...
      // </0 & DoMapAccum@1/4 (/5 e.#0/26 )/6 (/9 e.Scanned#1/28 )/10 (/15 s.tag#2/25 e.1#0/30 )/16 e.Tail#1/32 >/1
      context[26] = context[21];
      context[27] = context[22];
      context[28] = context[17];
      context[29] = context[18];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} (/15 s.tag#2/25 e.1#0/30 )/16 {REMOVED TILE} {REMOVED TILE}
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoMapAccum$1=1@1/4 } Tile{ AsIs: (/9 AsIs: e.Scanned#1/17 AsIs: )/10 } (/21 Tile{ AsIs: e.Tail#1/19 } )/22 </23 & GenPushLink=1\1*9/24 Tile{ AsIs: t.Acc#1/5 } Tile{ AsIs: t.Next#1/15 } >/25 Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_bracket(vm, context[21]);
    refalrts::alloc_close_bracket(vm, context[22]);
    refalrts::alloc_open_call(vm, context[23]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </11 Tile{ HalfReuse: & DoMapAccum@0/0 Reuse: & GenPushLink=1\1@0/4 AsIs: t.acc#0/5 AsIs: (/9 AsIs: e.scanned#0/7 AsIs: )/10 AsIs: e.items#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[11]);
...
static refalrts::FnResult func_gen_Map_Z6(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      // closed e.new#4 as range 11
      do {
        // </0 & Map@6/4 (/7 s.new#6/13 )/8 e.new#7/14 >/1
        context[14] = context[9];
        context[15] = context[10];
        if( ! refalrts::empty_seq( context[11], context[12] ) )
          continue;
        // closed e.new#7 as range 14
        do {
          // </0 & Map@6/4 (/7 # RIGHT-EDGE/13 )/8 e.Tail#1/16 >/1
          context[16] = context[14];
          context[17] = context[15];
          if( ! refalrts::ident_term( identifiers[ident_RIGHTm_EDGE], context[13] ) )
            continue;
          ...
          //RESULT: Tile{ [[ } Tile{ HalfReuse: </13 HalfReuse: & Map@6/8 AsIs: e.Tail#1/16 AsIs: >/1 ]] }
          refalrts::reinit_open_call(context[13]);
        ...
        // </0 & Map@6/4 (/7 # LEFT-EDGE/13 )/8 e.Tail#1/16 >/1
        context[16] = context[14];
        context[17] = context[15];
        if( ! refalrts::ident_term( identifiers[ident_LEFTm_EDGE], context[13] ) )
          continue;
      ...
      // </0 & Map@6/4 (/7 s.new#6/13 t.new#7/18 )/8 e.new#8/16 >/1
      context[14] = context[11];
      context[15] = context[12];
      context[16] = context[9];
      context[17] = context[10];
      ...
      if( ! refalrts::empty_seq( context[14], context[15] ) )
        continue;
      do {
        // </0 & Map@6/4 (/7 # AsIs/13 t.0#0/18 )/8 e.Tail#1/20 >/1
        context[20] = context[16];
        context[21] = context[17];
        if( ! refalrts::ident_term( identifiers[ident_AsIs], context[13] ) )
          continue;
        ...
        //RESULT: Tile{ [[ } Tile{ AsIs: t.0#0/18 } Tile{ AsIs: </0 } Tile{ HalfReuse: & Map@6/8 AsIs: e.Tail#1/20 AsIs: >/1 ]] }
        refalrts::reinit_name(context[8], functions[efunc_gen_Map_Z6]);
        refalrts::push_stack( vm, context[1] );
        refalrts::push_stack( vm, context[0] );
        refalrts::Iter trash_prev = arg_begin->prev;
      ...
      do {
        // </0 & Map@6/4 (/7 # HalfReuse/13 t.0#0/18 )/8 e.Tail#1/20 >/1
        context[20] = context[16];
        context[21] = context[17];
        if( ! refalrts::ident_term( identifiers[ident_HalfReuse], context[13] ) )
          continue;
      ...
      // </0 & Map@6/4 (/7 # Reuse/13 t.0#0/18 )/8 e.Tail#1/20 >/1
      context[20] = context[16];
      context[21] = context[17];
      if( ! refalrts::ident_term( identifiers[ident_Reuse], context[13] ) )
        continue;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & FlatTilesInResult\1$1\1*5/4 AsIs: t.Next#1/7 } >/11 </12 & Map@6/13 Tile{ AsIs: e.Tail#1/9 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[11]);
    refalrts::alloc_open_call(vm, context[12]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & FlatTilesInResult\1$1\1@0/4 AsIs: e.items#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Map_Z0]);
...
static refalrts::FnResult func_gen_GetSampleOffset_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[31];
  refalrts::zeros( context, 31 );
  // </0 & GetSampleOffset@1/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & GetSampleOffset@1/4 (/7 e.new#1/5 )/8 e.new#2/2 s.new#3/9 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new#2 as range 2
  do {
    // </0 & GetSampleOffset@1/4 (/7 e.PatternVars-B#1/14 (/20 's'/22 (/25 e.Index#3/27 s.Level#3/29 )/26 e.Offsets#1/18 s.SampleOffset#1/30 )/21 e.PatternVars-E#1/16 )/8 e.Index#3/12 s.Level#3/9 >/1
    context[10] = context[5];
    context[11] = context[6];
    context[12] = context[2];
    context[13] = context[3];
    ...
    do {
      ...
      context[22] = refalrts::char_left( 's', context[18], context[19] );
      if( ! context[22] )
        continue;
      context[23] = 0;
      context[24] = 0;
      ...
      if( ! refalrts::repeated_evar_left( vm, context[27], context[28], context[12], context[13], context[23], context[24] ) )
        continue;
      if( ! refalrts::repeated_stvar_left( vm, context[29], context[9], context[23], context[24] ) )
        continue;
      if( ! refalrts::empty_seq( context[23], context[24] ) )
        continue;
      // closed e.PatternVars-E#1 as range 16
      if( ! refalrts::svar_right( context[30], context[18], context[19] ) )
        continue;
      // closed e.Offsets#1 as range 18
      //DEBUG: s.Level#3: 9
      //DEBUG: e.Index#3: 12
      //DEBUG: e.PatternVars-B#1: 14
      //DEBUG: e.PatternVars-E#1: 16
      //DEBUG: s.SampleOffset#1: 30
      //DEBUG: e.Offsets#1: 18

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} </0 & GetSampleOffset@1/4 (/7 e.PatternVars-B#1/14 (/20 's'/22 (/25 e.Index#3/27 s.Level#3/29 )/26 e.Offsets#1/18 s.SampleOffset#1/30 )/21 e.PatternVars-E#1/16 {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ HalfReuse: 's'/8 AsIs: e.Index#3/12 AsIs: s.Level#3/9 HalfReuse: s.SampleOffset1 #30/1 ]] }
  ...
  // </0 & GetSampleOffset@1/4 (/7 e.dyn#0/5 )/8 e.Index#3/2 s.Level#3/9 >/1
  // closed e.dyn#0 as range 5
  // closed e.Index#3 as range 2
  //DEBUG: s.Level#3: 9
  //DEBUG: e.dyn#0: 5
  //DEBUG: e.Index#3: 2
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & GetSampleOffset@0/4 } Tile{ AsIs: e.dyn#0/5 } Tile{ AsIs: (/7 } Tile{ HalfReuse: 's'/8 AsIs: e.Index#3/2 AsIs: s.Level#3/9 HalfReuse: )/1 } >/10 Tile{ ]] }
...
static refalrts::FnResult func_gen_Map_Z7(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new#4 as range 11
    do {
      // </0 & Map@7/4 (/7 e.PatternVars#1/15 )/8 (/13 # HalfReuse/21 (/24 # TkVariable/26 's'/27 e.6#0/22 s.Level#3/29 s.Offset#3/28 )/25 )/14 e.Tail#1/17 >/1
      context[15] = context[9];
      context[16] = context[10];
      context[17] = context[11];
      context[18] = context[12];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: (/13 AsIs: # HalfReuse/21 AsIs: (/24 AsIs: # TkVariable/26 HalfReuse: </27 } & GetSampleOffset@1/30 (/31 e.PatternVars#1/15/32 )/34 Tile{ AsIs: e.6#0/22 } Tile{ AsIs: s.Level#3/29 } >/35 Tile{ AsIs: s.Offset#3/28 AsIs: )/25 AsIs: )/14 } Tile{ AsIs: </0 AsIs: & Map@7/4 AsIs: (/7 AsIs: e.PatternVars#1/15 AsIs: )/8 } Tile{ AsIs: e.Tail#1/17 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_name(vm, context[30], functions[efunc_gen_GetSampleOffset_Z1]);
    ...
    // </0 & Map@7/4 (/7 e.PatternVars#1/15 )/8 t.Next#1/13 e.Tail#1/17 >/1
    context[15] = context[9];
    context[16] = context[10];
    context[17] = context[11];
    context[18] = context[12];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: t.Next#1/13 } Tile{ AsIs: </0 AsIs: & Map@7/4 AsIs: (/7 AsIs: e.PatternVars#1/15 AsIs: )/8 } Tile{ AsIs: e.Tail#1/17 } Tile{ AsIs: >/1 ]] }
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    refalrts::link_brackets( context[7], context[8] );
    refalrts::Iter trash_prev = arg_begin->prev;
  ...
  do {
    // </0 & Map@7/4 (/7 e.PatternVars#1/9 )/8 >/1
    context[9] = context[5];
    context[10] = context[6];
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Map@7/4 (/7 e.PatternVars#1/9 )/8 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & Map@7/4 (/7 e.PatternVars#1/5 )/8 e.items#0/2 >/1
  // closed e.PatternVars#1 as range 5
  // closed e.items#0 as range 2
  //DEBUG: e.PatternVars#1: 5
  //DEBUG: e.items#0: 2
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </9 & Map@0/10 Tile{ HalfReuse: [*]/0 Reuse: & AddOffsets\1$1\1@0/4 AsIs: (/7 AsIs: e.PatternVars#1/5 AsIs: )/8 } {*}/11 Tile{ AsIs: e.items#0/2 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_GetSampleOffset_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[31];
  refalrts::zeros( context, 31 );
  // </0 & GetSampleOffset@2/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & GetSampleOffset@2/4 (/7 e.new#1/5 )/8 e.new#2/2 s.new#3/9 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new#2 as range 2
  do {
    // </0 & GetSampleOffset@2/4 (/7 e.PatternVars-B#1/14 (/20 't'/22 (/25 e.Index#2/27 s.Level#2/29 )/26 e.Offsets#1/18 s.SampleOffset#1/30 )/21 e.PatternVars-E#1/16 )/8 e.Index#2/12 s.Level#2/9 >/1
    context[10] = context[5];
    context[11] = context[6];
    context[12] = context[2];
    context[13] = context[3];
    ...
    do {
      ...
      if( ! context[20] )
        continue;
      refalrts::bracket_pointers(context[20], context[21]);
      context[22] = refalrts::char_left( 't', context[18], context[19] );
      if( ! context[22] )
        continue;
      context[23] = 0;
      context[24] = 0;
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} </0 & GetSampleOffset@2/4 (/7 e.PatternVars-B#1/14 (/20 't'/22 (/25 e.Index#2/27 s.Level#2/29 )/26 e.Offsets#1/18 s.SampleOffset#1/30 )/21 e.PatternVars-E#1/16 {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ HalfReuse: 't'/8 AsIs: e.Index#2/12 AsIs: s.Level#2/9 HalfReuse: s.SampleOffset1 #30/1 ]] }
  ...
  // </0 & GetSampleOffset@2/4 (/7 e.dyn#0/5 )/8 e.Index#2/2 s.Level#2/9 >/1
  // closed e.dyn#0 as range 5
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & GetSampleOffset@0/4 } Tile{ AsIs: e.dyn#0/5 } Tile{ AsIs: (/7 } Tile{ HalfReuse: 't'/8 AsIs: e.Index#2/2 AsIs: s.Level#2/9 HalfReuse: )/1 } >/10 Tile{ ]] }
  refalrts::alloc_close_call(vm, context[10]);
  refalrts::update_name(context[4], functions[efunc_gen_GetSampleOffset_Z0]);
  refalrts::reinit_char(context[8], 't');
  refalrts::reinit_close_bracket(context[1]);
...
static refalrts::FnResult func_gen_GetSampleOffset_Z3(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[31];
  refalrts::zeros( context, 31 );
  // </0 & GetSampleOffset@3/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & GetSampleOffset@3/4 (/7 e.new#1/5 )/8 e.new#2/2 s.new#3/9 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new#2 as range 2
  do {
    // </0 & GetSampleOffset@3/4 (/7 e.PatternVars-B#1/14 (/20 'e'/22 (/25 e.Index#2/27 s.Level#2/29 )/26 e.Offsets#1/18 s.SampleOffset#1/30 )/21 e.PatternVars-E#1/16 )/8 e.Index#2/12 s.Level#2/9 >/1
    context[10] = context[5];
    context[11] = context[6];
    context[12] = context[2];
    context[13] = context[3];
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} </0 & GetSampleOffset@3/4 (/7 e.PatternVars-B#1/14 (/20 'e'/22 (/25 e.Index#2/27 s.Level#2/29 )/26 e.Offsets#1/18 s.SampleOffset#1/30 )/21 e.PatternVars-E#1/16 {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ HalfReuse: 'e'/8 AsIs: e.Index#2/12 AsIs: s.Level#2/9 HalfReuse: s.SampleOffset1 #30/1 ]] }
  ...
  // </0 & GetSampleOffset@3/4 (/7 e.dyn#0/5 )/8 e.Index#2/2 s.Level#2/9 >/1
  // closed e.dyn#0 as range 5
  // closed e.Index#2 as range 2
  //DEBUG: s.Level#2: 9
  //DEBUG: e.dyn#0: 5
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & GetSampleOffset@0/4 } Tile{ AsIs: e.dyn#0/5 } Tile{ AsIs: (/7 } Tile{ HalfReuse: 'e'/8 AsIs: e.Index#2/2 AsIs: s.Level#2/9 HalfReuse: )/1 } >/10 Tile{ ]] }
  refalrts::alloc_close_call(vm, context[10]);
  refalrts::update_name(context[4], functions[efunc_gen_GetSampleOffset_Z0]);
  refalrts::reinit_char(context[8], 'e');
  refalrts::reinit_close_bracket(context[1]);
...
static refalrts::FnResult func_gen_DoMapAccum_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      // </0 & DoMapAccum@2/4 (/7 e.new#14/23 )/8 s.new#10/9 (/13 e.new#15/25 )/14 (/21 s.new#11/31 e.new#12/29 )/22 e.new#13/27 >/1
      ...
      do {
        // </0 & DoMapAccum@2/4 (/7 e.PatternVars#1/32 )/8 s.Offset#2/9 (/13 e.Scanned#1/34 )/14 (/21 # Tile/31 e.0#0/36 )/22 e.Tail#1/38 >/1
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoMapAccum$1=1@2/4 AsIs: (/7 AsIs: e.PatternVars#1/32 AsIs: )/8 } Tile{ AsIs: (/13 AsIs: e.Scanned#1/34 AsIs: )/14 AsIs: (/21 } Tile{ AsIs: e.Tail#1/38 } )/40 Tile{ AsIs: s.Offset#2/9 } (/41 # Tile/42 </43 & Map@7/44 (/45 e.PatternVars#1/32/46 Tile{ HalfReuse: )/31 AsIs: e.0#0/36 HalfReuse: >/22 } )/48 Tile{ AsIs: >/1 ]] }
        refalrts::alloc_close_bracket(vm, context[40]);
        refalrts::alloc_open_bracket(vm, context[41]);
      ...
      do {
        // </0 & DoMapAccum@2/4 (/7 e.new#21/32 )/8 s.new#16/9 (/13 e.new#22/34 )/14 (/21 # TkVariable/31 s.new#17/40 e.new#18/36 s.new#19/41 )/22 e.new#20/38 >/1
        context[32] = context[23];
        context[33] = context[24];
        context[34] = context[25];
        context[35] = context[26];
        ...
        if( ! refalrts::svar_left( context[40], context[36], context[37] ) )
          continue;
        if( ! refalrts::svar_right( context[41], context[36], context[37] ) )
          continue;
        // closed e.new#18 as range 36
        do {
          // </0 & DoMapAccum@2/4 (/7 e.PatternVars#1/42 )/8 s.Offset#2/9 (/13 e.Scanned#1/44 )/14 (/21 # TkVariable/31 's'/40 e.2#0/46 s.Level#2/41 )/22 e.Tail#1/48 >/1
          context[42] = context[32];
          context[43] = context[33];
          context[44] = context[34];
          context[45] = context[35];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoMapAccum$1=1@2/4 AsIs: (/7 AsIs: e.PatternVars#1/42 AsIs: )/8 } Tile{ AsIs: (/13 AsIs: e.Scanned#1/44 AsIs: )/14 AsIs: (/21 } Tile{ AsIs: e.Tail#1/48 } )/50 </51 & Add/52 Tile{ AsIs: s.Offset#2/9 } 1/53 >/54 (/55 Tile{ Reuse: # TkVariableCopy/31 } </56 & GetSampleOffset@1/57 (/58 e.PatternVars#1/42/59 Tile{ HalfReuse: )/40 AsIs: e.2#0/46 AsIs: s.Level#2/41 HalfReuse: >/22 } s.Offset#2/9/61 )/62 Tile{ AsIs: >/1 ]] }
          refalrts::alloc_close_bracket(vm, context[50]);
          refalrts::alloc_open_call(vm, context[51]);
          ...
          refalrts::alloc_open_bracket(vm, context[55]);
          refalrts::alloc_open_call(vm, context[56]);
          refalrts::alloc_name(vm, context[57], functions[efunc_gen_GetSampleOffset_Z1]);
          refalrts::alloc_open_bracket(vm, context[58]);
          refalrts::copy_evar(vm, context[59], context[60], context[42], context[43]);
          refalrts::copy_stvar(vm, context[61], context[9]);
          refalrts::alloc_close_bracket(vm, context[62]);
          refalrts::update_name(context[4], functions[efunc_gen_DoMapAccum_S1A1Z2]);
          refalrts::update_ident(context[31], identifiers[ident_TkVariableCopy]);
          ...
          refalrts::push_stack( vm, context[54] );
          refalrts::push_stack( vm, context[51] );
          refalrts::link_brackets( context[21], context[50] );
          refalrts::link_brackets( context[13], context[14] );
          refalrts::link_brackets( context[7], context[8] );
          refalrts::Iter trash_prev = arg_begin->prev;
          refalrts::use(trash_prev);
        ...
        do {
          // </0 & DoMapAccum@2/4 (/7 e.PatternVars#1/42 )/8 s.Offset#2/9 (/13 e.Scanned#1/44 )/14 (/21 # TkVariable/31 't'/40 e.2#0/46 s.Level#2/41 )/22 e.Tail#1/48 >/1
          context[42] = context[32];
          context[43] = context[33];
          context[44] = context[34];
          context[45] = context[35];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoMapAccum$1=1@2/4 AsIs: (/7 AsIs: e.PatternVars#1/42 AsIs: )/8 } Tile{ AsIs: (/13 AsIs: e.Scanned#1/44 AsIs: )/14 AsIs: (/21 } Tile{ AsIs: e.Tail#1/48 } )/50 </51 & Add/52 Tile{ AsIs: s.Offset#2/9 } 2/53 >/54 (/55 Tile{ Reuse: # TkVariableCopy/31 } </56 & GetSampleOffset@2/57 (/58 e.PatternVars#1/42/59 Tile{ HalfReuse: )/40 AsIs: e.2#0/46 AsIs: s.Level#2/41 HalfReuse: >/22 } s.Offset#2/9/61 )/62 Tile{ AsIs: >/1 ]] }
          refalrts::alloc_close_bracket(vm, context[50]);
          refalrts::alloc_open_call(vm, context[51]);
          refalrts::alloc_name(vm, context[52], functions[efunc_Add]);
          ...
          refalrts::alloc_open_bracket(vm, context[55]);
          refalrts::alloc_open_call(vm, context[56]);
          refalrts::alloc_name(vm, context[57], functions[efunc_gen_GetSampleOffset_Z2]);
          refalrts::alloc_open_bracket(vm, context[58]);
          refalrts::copy_evar(vm, context[59], context[60], context[42], context[43]);
          refalrts::copy_stvar(vm, context[61], context[9]);
          refalrts::alloc_close_bracket(vm, context[62]);
        ...
        // </0 & DoMapAccum@2/4 (/7 e.PatternVars#1/42 )/8 s.Offset#2/9 (/13 e.Scanned#1/44 )/14 (/21 # TkVariable/31 'e'/40 e.2#0/46 s.Level#2/41 )/22 e.Tail#1/48 >/1
        context[42] = context[32];
        context[43] = context[33];
        context[44] = context[34];
        context[45] = context[35];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoMapAccum$1=1@2/4 AsIs: (/7 AsIs: e.PatternVars#1/42 AsIs: )/8 } Tile{ AsIs: (/13 AsIs: e.Scanned#1/44 AsIs: )/14 AsIs: (/21 } Tile{ AsIs: e.Tail#1/48 } )/50 </51 & Add/52 Tile{ AsIs: s.Offset#2/9 } 2/53 >/54 (/55 Tile{ Reuse: # TkVariableCopy/31 } </56 & GetSampleOffset@3/57 (/58 e.PatternVars#1/42/59 Tile{ HalfReuse: )/40 AsIs: e.2#0/46 AsIs: s.Level#2/41 HalfReuse: >/22 } s.Offset#2/9/61 )/62 Tile{ AsIs: >/1 ]] }
        refalrts::alloc_close_bracket(vm, context[50]);
        refalrts::alloc_open_call(vm, context[51]);
        refalrts::alloc_name(vm, context[52], functions[efunc_Add]);
        refalrts::alloc_number(vm, context[53], 2UL);
        ...
        refalrts::alloc_open_bracket(vm, context[55]);
        refalrts::alloc_open_call(vm, context[56]);
        refalrts::alloc_name(vm, context[57], functions[efunc_gen_GetSampleOffset_Z3]);
        refalrts::alloc_open_bracket(vm, context[58]);
        refalrts::copy_evar(vm, context[59], context[60], context[42], context[43]);
        refalrts::copy_stvar(vm, context[61], context[9]);
        refalrts::alloc_close_bracket(vm, context[62]);
      ...
      do {
        // </0 & DoMapAccum@2/4 (/7 e.PatternVars#1/32 )/8 s.Offset#2/9 (/13 e.Scanned#1/34 )/14 (/21 # TkString/31 e.0#0/36 )/22 e.Tail#1/38 >/1
        context[32] = context[23];
        context[33] = context[24];
        context[34] = context[25];
        context[35] = context[26];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoMapAccum$1=1@2/4 AsIs: (/7 AsIs: e.PatternVars#1/32 AsIs: )/8 } Tile{ AsIs: (/13 AsIs: e.Scanned#1/34 AsIs: )/14 AsIs: (/21 } Tile{ AsIs: e.Tail#1/38 } )/40 </41 & Inc2/42 Tile{ AsIs: s.Offset#2/9 } >/43 (/44 Tile{ AsIs: # TkString/31 AsIs: e.0#0/36 HalfReuse: s.Offset2 #9/22 } )/45 Tile{ AsIs: >/1 ]] }
        refalrts::alloc_close_bracket(vm, context[40]);
        refalrts::alloc_open_call(vm, context[41]);
      ...
      // </0 & DoMapAccum@2/4 (/7 e.PatternVars#1/32 )/8 s.Offset#2/9 (/13 e.Scanned#1/34 )/14 (/21 s.Tag#2/31 e.0#0/36 )/22 e.Tail#1/38 >/1
      context[32] = context[23];
      context[33] = context[24];
      context[34] = context[25];
      context[35] = context[26];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoMapAccum$1=1@2/4 AsIs: (/7 AsIs: e.PatternVars#1/32 AsIs: )/8 } Tile{ AsIs: (/13 AsIs: e.Scanned#1/34 AsIs: )/14 AsIs: (/21 } Tile{ AsIs: e.Tail#1/38 } )/40 </41 & Add/42 1/43 Tile{ AsIs: s.Offset#2/9 } >/44 (/45 Tile{ AsIs: s.Tag#2/31 AsIs: e.0#0/36 HalfReuse: s.Offset2 #9/22 } )/46 Tile{ AsIs: >/1 ]] }
      refalrts::alloc_close_bracket(vm, context[40]);
      refalrts::alloc_open_call(vm, context[41]);
    ...
    // </0 & DoMapAccum@2/4 (/7 e.PatternVars#1/23 )/8 t.Acc#1/9 (/13 e.Scanned#1/25 )/14 t.Next#1/21 e.Tail#1/27 >/1
    context[23] = context[15];
    context[24] = context[16];
    context[25] = context[17];
    context[26] = context[18];
    context[27] = context[19];
    context[28] = context[20];
    // closed e.PatternVars#1 as range 23
    // closed e.Scanned#1 as range 25
    // closed e.Tail#1 as range 27
    //DEBUG: t.Acc#1: 9
    //DEBUG: t.Next#1: 21
    //DEBUG: e.PatternVars#1: 23
    //DEBUG: e.Scanned#1: 25
    //DEBUG: e.Tail#1: 27

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoMapAccum$1=1@2/4 AsIs: (/7 AsIs: e.PatternVars#1/23 AsIs: )/8 } Tile{ AsIs: (/13 AsIs: e.Scanned#1/25 AsIs: )/14 } (/29 Tile{ AsIs: e.Tail#1/27 } )/30 </31 & AddOffsets\1*6/32 (/33 e.PatternVars#1/23/34 )/36 Tile{ AsIs: t.Acc#1/9 } Tile{ AsIs: t.Next#1/21 } >/37 Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_bracket(vm, context[29]);
    refalrts::alloc_close_bracket(vm, context[30]);
    refalrts::alloc_open_call(vm, context[31]);
  ...
  do {
    // </0 & DoMapAccum@2/4 (/7 e.PatternVars#1/15 )/8 t.Acc#1/9 (/13 e.Scanned#1/17 )/14 >/1
    context[15] = context[5];
    context[16] = context[6];
    context[17] = context[11];
    context[18] = context[12];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & DoMapAccum@2/4 (/7 e.PatternVars#1/15 )/8 {REMOVED TILE} (/13 {REMOVED TILE} )/14 >/1 {REMOVED TILE}
  ...
  // </0 & DoMapAccum@2/4 (/7 e.PatternVars#1/5 )/8 t.acc#0/9 (/13 e.scanned#0/11 )/14 e.items#0/2 >/1
  // closed e.PatternVars#1 as range 5
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoMapAccum@0/4 HalfReuse: [*]/7 } & AddOffsets\1@0/15 (/16 Tile{ AsIs: e.PatternVars#1/5 } )/17 Tile{ HalfReuse: {*}/8 AsIs: t.acc#0/9 AsIs: (/13 AsIs: e.scanned#0/11 AsIs: )/14 AsIs: e.items#0/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_DoMapAccum_S1A1Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </13 Tile{ HalfReuse: & DoMapAccum$1=1@0/0 Reuse: & GenPushLink=1\1@0/4 AsIs: (/7 AsIs: e.Scanned0#1/5 AsIs: )/8 AsIs: (/11 AsIs: e.Tail0#1/9 AsIs: )/12 AsIs: e.dyn#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[13]);
...
static refalrts::FnResult func_gen_DoMapAccum_S1A1Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // closed e.new#4 as range 2
  do {
    // </0 & DoMapAccum$1=1@2/4 (/7 e.PatternVars#1/17 )/8 (/11 e.Scanned0#1/19 )/12 (/15 e.Tail0#1/21 )/16 t.Acc#2/25 e.StepScanned#2/23 >/1
    ...
    // closed e.PatternVars#1 as range 17
    ...
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoMapAccum@2/4 AsIs: (/7 AsIs: e.PatternVars#1/17 AsIs: )/8 } Tile{ AsIs: t.Acc#2/25 } Tile{ AsIs: (/15 } Tile{ AsIs: e.Scanned0#1/19 } Tile{ AsIs: e.StepScanned#2/23 } Tile{ AsIs: )/16 } Tile{ AsIs: e.Tail0#1/21 } Tile{ AsIs: >/1 ]] }
    refalrts::update_name(context[4], functions[efunc_gen_DoMapAccum_Z2]);
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    refalrts::link_brackets( context[15], context[16] );
  ...
  // </0 & DoMapAccum$1=1@2/4 (/7 e.PatternVars#1/5 )/8 (/11 e.Scanned0#1/9 )/12 (/15 e.Tail0#1/13 )/16 e.dyn#0/2 >/1
  // closed e.PatternVars#1 as range 5
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoMapAccum$1=1@0/4 HalfReuse: [*]/7 } & AddOffsets\1@0/17 (/18 Tile{ AsIs: e.PatternVars#1/5 } )/19 Tile{ HalfReuse: {*}/8 AsIs: (/11 AsIs: e.Scanned0#1/9 AsIs: )/12 AsIs: (/15 AsIs: e.Tail0#1/13 AsIs: )/16 AsIs: e.dyn#0/2 AsIs: >/1 ]] }
