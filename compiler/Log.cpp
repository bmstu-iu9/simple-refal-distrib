...
static refalrts::FnResult func_Logm_PutLine(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Log-PutLine:1/4 } (/5 Tile{ AsIs: e.Message#1/2 } )/6 </7 & LogHandle:1/8 </9 & G_LogFile/10 >/11 >/12 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_bracket(vm, context[5]);
  refalrts::alloc_close_bracket(vm, context[6]);
...
static refalrts::FnResult func_gen_Logm_AST_B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Log-PutLine:1@3/4 AsIs: (/7 } Tile{ AsIs: e.Message#1/9 } Tile{ AsIs: )/8 HalfReuse: </11 } & LogHandle:1/14 </15 & G_LogFile/16 >/17 >/18 >/19 </20 Tile{ HalfReuse: & Map@1/12 AsIs: s.FileHandle#2/13 HalfReuse: </1 } & Log-TextFromAST/21 Tile{ AsIs: e.AST#1/5 } >/22 >/23 e.AST#1/5/24 Tile{ ]] }
...
static refalrts::FnResult func_Logm_AST(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Log-AST:1/4 AsIs: (/7 } Tile{ AsIs: e.AST#1/2 } Tile{ AsIs: )/8 } (/9 Tile{ AsIs: e.Message#1/5 } )/10 </11 & LogHandle:1/12 </13 & G_LogFile/14 >/15 >/16 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_bracket(vm, context[9]);
  refalrts::alloc_close_bracket(vm, context[10]);
  refalrts::alloc_open_call(vm, context[11]);
...
static refalrts::FnResult func_gen_Logm_HighLevelRASL_B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Log-PutLine:1@4/4 AsIs: (/7 } Tile{ AsIs: e.SrcName#1/9 } Tile{ AsIs: )/8 HalfReuse: </11 } & LogHandle:1/14 </15 & G_LogFile/16 Tile{ AsIs: >/1 } >/17 >/18 </19 Tile{ HalfReuse: & Map@2/12 AsIs: s.FileHandle#2/13 } Tile{ AsIs: e.RASL#1/5 } >/20 e.RASL#1/5/21 Tile{ ]] }
  refalrts::alloc_name(vm, context[14], functions[efunc_gen_LogHandle_B1]);
  refalrts::alloc_open_call(vm, context[15]);
  refalrts::alloc_name(vm, context[16], functions[efunc_Gu_LogFile]);
  refalrts::alloc_close_call(vm, context[17]);
...
static refalrts::FnResult func_Logm_HighLevelRASL(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Log-HighLevelRASL:1/4 AsIs: (/7 } Tile{ AsIs: e.RASL#1/2 } Tile{ AsIs: )/8 } (/9 Tile{ AsIs: e.SrcName#1/5 } )/10 </11 & LogHandle:1/12 </13 & G_LogFile/14 >/15 >/16 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_bracket(vm, context[9]);
  refalrts::alloc_close_bracket(vm, context[10]);
  refalrts::alloc_open_call(vm, context[11]);
  refalrts::alloc_name(vm, context[12], functions[efunc_gen_LogHandle_B1]);
...
static refalrts::FnResult func_PutProgramElement(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      do {
        // </0 & PutProgramElement/4 s.new#13/9 (/7 # Function/10 s.new#14/13 (/18 e.new#16/20 )/19 e.new#15/22 )/8 >/1
        ...
        do {
          // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # Function/10 # GN-Local/13 (/18 e.Name#1/24 )/19 e.Commands#1/26 )/8 >/1
          ...
          // closed e.Commands#1 as range 26
          //DEBUG: s.FileHandle#1: 9
          //DEBUG: e.Name#1: 24
          //DEBUG: e.Commands#1: 26

          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: </13 HalfReuse: & DisplayName/18 AsIs: e.Name#1/24 HalfReuse: >/19 }" {"/28 >/30 </31 & Map@3/32 s.FileHandle#1/9/33 Tile{ AsIs: e.Commands#1/26 } >/34 </35 & Putout/36 s.FileHandle#1/9/37"  }"/38 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
        ...
        do {
          // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # Function/10 # GN-Entry/13 (/18 e.Name#1/24 )/19 e.Commands#1/26 )/8 >/1
          context[24] = context[20];
          context[25] = context[21];
          context[26] = context[22];
          context[27] = context[23];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: '$'/13 HalfReuse: 'E'/18 }"NT"/28 Tile{ HalfReuse: 'R'/19 }"Y "/30 </32 & DisplayName/33 Tile{ AsIs: e.Name#1/24 } >/34" {"/35 >/37 </38 & Map@3/39 s.FileHandle#1/9/40 Tile{ AsIs: e.Commands#1/26 } >/41 </42 & Putout/43 s.FileHandle#1/9/44"  }"/45 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
        ...
        // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # Function/10 s.ScopeClass#1/13 (/18 e.Name#1/24 )/19 e.Commands#1/26 )/8 >/1
        context[24] = context[20];
        context[25] = context[21];
        context[26] = context[22];
        context[27] = context[23];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: </7 HalfReuse: & FnName*2/10 AsIs: s.ScopeClass#1/13 } Tile{ AsIs: e.Name#1/24 } Tile{ HalfReuse: >/18 } Tile{ HalfReuse: ' '/19 } '{'/28 >/29 </30 & Map@3/31 s.FileHandle#1/9/32 Tile{ AsIs: e.Commands#1/26 } >/33 </34 & Putout/35 s.FileHandle#1/9/36"  }"/37 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
      ...
      do {
        // </0 & PutProgramElement/4 s.new#13/9 (/7 # CmdNativeFunction/10 s.new#14/13 (/18 e.new#17/20 )/19 t.new#15/24 e.new#16/22 )/8 >/1
        context[20] = context[16];
        context[21] = context[17];
        context[22] = context[14];
        context[23] = context[15];
        ...
        do {
          // </0 & PutProgramElement/4 s.new#18/9 (/7 # CmdNativeFunction/10 # GN-Local/13 (/18 e.new#21/26 )/19 t.new#19/24 e.new#20/28 )/8 >/1
          ...
          do {
            // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 # GN-Local/13 (/18 e.Name#1/30 )/19 s.LineNumber#1/24 e.Code#1/32 )/8 >/1
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: </13 HalfReuse: & DisplayName/18 AsIs: e.Name#1/30 HalfReuse: >/19 }" :: native {"/34 >/36 </37 & Putout/38 s.FileHandle#1/9/39"  #line "/40 </42 & Symb/43 Tile{ AsIs: s.LineNumber#1/24 } >/44 >/45 </46 & Putout/47 s.FileHandle#1/9/48"    ======================================"/49 >/51 </52 & Map@4/53 s.FileHandle#1/9/54 Tile{ AsIs: e.Code#1/32 } >/55 </56 & Putout/57 s.FileHandle#1/9/58"    ======================================"/59 >/61 </62 & Putout/63 s.FileHandle#1/9/64"  }"/65 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
          ...
          do {
            // </0 & PutProgramElement/4 s.new#22/9 (/7 # CmdNativeFunction/10 # GN-Local/13 (/18 e.new#27/30 )/19 (/24 s.new#23/36 t.new#24/37 e.new#25/34 )/25 e.new#26/32 )/8 >/1
            context[30] = context[26];
            context[31] = context[27];
            context[32] = context[28];
            context[33] = context[29];
            ...
            do {
              // </0 & PutProgramElement/4 s.new#28/9 (/7 # CmdNativeFunction/10 # GN-Local/13 (/18 e.new#33/39 )/19 (/24 s.new#29/36 s.new#30/37 e.new#31/41 )/25 e.new#32/43 )/8 >/1
              ...
              do {
                // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 # GN-Local/13 (/18 e.Name#1/45 )/19 (/24 # FileLine/36 s.Line#1/37 e.1#0/47 )/25 e.Code#1/49 )/8 >/1
                ...
                // closed e.1#0 as range 47
                // closed e.Code#1 as range 49
                //DEBUG: s.FileHandle#1: 9
                //DEBUG: s.Line#1: 37
                //DEBUG: e.Name#1: 45
                //DEBUG: e.1#0: 47
                ...
                refalrts::reset_allocator(vm);
                //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: </13 HalfReuse: & DisplayName/18 AsIs: e.Name#1/45 HalfReuse: >/19 HalfReuse: ' '/24 HalfReuse: ':'/36 }": n"/51 Tile{ HalfReuse: 'a'/25 }"tive {"/53 >/55 </56 & Putout/57 s.FileHandle#1/9/58"  #line "/59 </61 & Symb/62 Tile{ AsIs: s.Line#1/37 } >/63" \""/64 </66 & EscapeString/67 Tile{ AsIs: e.1#0/47 } >/68 '\"'/69 >/70 </71 & Putout/72 s.FileHandle#1/9/73"    ======================================"/74 >/76 </77 & Map@4/78 s.FileHandle#1/9/79 Tile{ AsIs: e.Code#1/49 } >/80 </81 & Putout/82 s.FileHandle#1/9/83"    ======================================"/84 >/86 </87 & Putout/88 s.FileHandle#1/9/89"  }"/90 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
              ...
              // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 # GN-Local/13 (/18 e.Name#1/45 )/19 (/24 # RowCol/36 s.Row#1/37 s.Col#1/51 )/25 e.Code#1/49 )/8 >/1
              context[45] = context[39];
              context[46] = context[40];
              context[47] = context[41];
              context[48] = context[42];
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: </13 HalfReuse: & DisplayName/18 AsIs: e.Name#1/45 HalfReuse: >/19 HalfReuse: ' '/24 HalfReuse: ':'/36 }": native {"/52 >/54 </55 & Putout/56 s.FileHandle#1/9/57"  #line "/58 </60 & Symb/61 Tile{ AsIs: s.Row#1/37 } >/62 ':'/63 </64 & Symb/65 Tile{ AsIs: s.Col#1/51 HalfReuse: >/25 } >/66 </67 & Putout/68 s.FileHandle#1/9/69"    ======================================"/70 >/72 </73 & Map@4/74 s.FileHandle#1/9/75 Tile{ AsIs: e.Code#1/49 } >/76 </77 & Putout/78 s.FileHandle#1/9/79"    ======================================"/80 >/82 </83 & Putout/84 s.FileHandle#1/9/85"  }"/86 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
            ...
            // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 # GN-Local/13 (/18 e.Name#1/39 )/19 (/24 # FileRowCol/36 (/37 s.Row#1/47 s.Col#1/48 )/38 e.1#0/41 )/25 e.Code#1/43 )/8 >/1
            context[39] = context[30];
            context[40] = context[31];
            context[41] = context[34];
            context[42] = context[35];
            ...
            // closed e.1#0 as range 41
            // closed e.Code#1 as range 43
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: </13 HalfReuse: & DisplayName/18 AsIs: e.Name#1/39 HalfReuse: >/19 HalfReuse: ' '/24 HalfReuse: ':'/36 HalfReuse: ':'/37 }" native {"/49 >/51 </52 & Putout/53 s.FileHandle#1/9/54"  #line "/55 </57 & Symb/58 Tile{ AsIs: s.Row#1/47 } >/59 ':'/60 </61 & Symb/62 Tile{ AsIs: s.Col#1/48 } >/63" \""/64 </66 Tile{ HalfReuse: & EscapeString/38 AsIs: e.1#0/41 HalfReuse: >/25 } '\"'/67 >/68 </69 & Putout/70 s.FileHandle#1/9/71"    ======================================"/72 >/74 </75 & Map@4/76 s.FileHandle#1/9/77 Tile{ AsIs: e.Code#1/43 } >/78 </79 & Putout/80 s.FileHandle#1/9/81"    ======================================"/82 >/84 </85 & Putout/86 s.FileHandle#1/9/87"  }"/88 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
          ...
          // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 # GN-Local/13 (/18 e.Name#1/30 )/19 t.SrcPos#1/24 e.Code#1/32 )/8 >/1
          context[30] = context[26];
          context[31] = context[27];
          context[32] = context[28];
          context[33] = context[29];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: </13 HalfReuse: & DisplayName/18 AsIs: e.Name#1/30 HalfReuse: >/19 }" :: native {"/34 >/36 </37 & Putout/38 s.FileHandle#1/9/39"  "/40 </42 & SrcPos*4/43 Tile{ AsIs: t.SrcPos#1/24 } >/44 >/45 </46 & Putout/47 s.FileHandle#1/9/48"    ======================================"/49 >/51 </52 & Map@4/53 s.FileHandle#1/9/54 Tile{ AsIs: e.Code#1/32 } >/55 </56 & Putout/57 s.FileHandle#1/9/58"    ======================================"/59 >/61 </62 & Putout/63 s.FileHandle#1/9/64"  }"/65 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
          refalrts::alloc_chars(vm, context[34], context[35], " :: native {", 12);
          refalrts::alloc_close_call(vm, context[36]);
          refalrts::alloc_open_call(vm, context[37]);
          refalrts::alloc_name(vm, context[38], functions[efunc_Putout]);
        ...
        do {
          // </0 & PutProgramElement/4 s.new#18/9 (/7 # CmdNativeFunction/10 # GN-Entry/13 (/18 e.new#21/26 )/19 t.new#19/24 e.new#20/28 )/8 >/1
          context[26] = context[20];
          context[27] = context[21];
          context[28] = context[22];
          context[29] = context[23];
          ...
          // closed e.new#20 as range 28
          do {
            // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 # GN-Entry/13 (/18 e.Name#1/30 )/19 s.LineNumber#1/24 e.Code#1/32 )/8 >/1
            context[30] = context[26];
            context[31] = context[27];
            context[32] = context[28];
            context[33] = context[29];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: '$'/13 HalfReuse: 'E'/18 }"NTRY "/34 </36 & DisplayName/37 Tile{ AsIs: e.Name#1/30 } >/38" :: native {"/39 >/41 </42 & Putout/43 s.FileHandle#1/9/44"  #line "/45 </47 Tile{ HalfReuse: & Symb/19 AsIs: s.LineNumber#1/24 } >/48 >/49 </50 & Putout/51 s.FileHandle#1/9/52"    ======================================"/53 >/55 </56 & Map@4/57 s.FileHandle#1/9/58 Tile{ AsIs: e.Code#1/32 } >/59 </60 & Putout/61 s.FileHandle#1/9/62"    ======================================"/63 >/65 </66 & Putout/67 s.FileHandle#1/9/68"  }"/69 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
          ...
          do {
            // </0 & PutProgramElement/4 s.new#22/9 (/7 # CmdNativeFunction/10 # GN-Entry/13 (/18 e.new#27/30 )/19 (/24 s.new#23/36 t.new#24/37 e.new#25/34 )/25 e.new#26/32 )/8 >/1
            context[30] = context[26];
            context[31] = context[27];
            context[32] = context[28];
            context[33] = context[29];
            ...
            // closed e.new#25 as range 34
            do {
              // </0 & PutProgramElement/4 s.new#28/9 (/7 # CmdNativeFunction/10 # GN-Entry/13 (/18 e.new#33/39 )/19 (/24 s.new#29/36 s.new#30/37 e.new#31/41 )/25 e.new#32/43 )/8 >/1
              context[39] = context[30];
              context[40] = context[31];
              context[41] = context[34];
              context[42] = context[35];
              ...
              // closed e.new#32 as range 43
              do {
                // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 # GN-Entry/13 (/18 e.Name#1/45 )/19 (/24 # FileLine/36 s.Line#1/37 e.1#0/47 )/25 e.Code#1/49 )/8 >/1
                context[45] = context[39];
                context[46] = context[40];
                context[47] = context[41];
                context[48] = context[42];
                ...
                refalrts::reset_allocator(vm);
                //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: '$'/13 HalfReuse: 'E'/18 } Tile{ HalfReuse: 'N'/25 }"TRY "/51 </53 & DisplayName/54 Tile{ AsIs: e.Name#1/45 } >/55" :: native {"/56 >/58 </59 & Putout/60 s.FileHandle#1/9/61"  #line"/62 Tile{ HalfReuse: ' '/19 HalfReuse: </24 HalfReuse: & Symb/36 AsIs: s.Line#1/37 } >/64" \""/65 </67 & EscapeString/68 Tile{ AsIs: e.1#0/47 } >/69 '\"'/70 >/71 </72 & Putout/73 s.FileHandle#1/9/74"    ======================================"/75 >/77 </78 & Map@4/79 s.FileHandle#1/9/80 Tile{ AsIs: e.Code#1/49 } >/81 </82 & Putout/83 s.FileHandle#1/9/84"    ======================================"/85 >/87 </88 & Putout/89 s.FileHandle#1/9/90"  }"/91 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
              ...
              // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 # GN-Entry/13 (/18 e.Name#1/45 )/19 (/24 # RowCol/36 s.Row#1/37 s.Col#1/51 )/25 e.Code#1/49 )/8 >/1
              context[45] = context[39];
              context[46] = context[40];
              context[47] = context[41];
              context[48] = context[42];
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: '$'/13 HalfReuse: 'E'/18 }"NTRY "/52 </54 & DisplayName/55 Tile{ AsIs: e.Name#1/45 } >/56" :: native {"/57 >/59 </60 & Putout/61 s.FileHandle#1/9/62"  #line"/63 Tile{ HalfReuse: ' '/19 HalfReuse: </24 HalfReuse: & Symb/36 AsIs: s.Row#1/37 } >/65 ':'/66 </67 & Symb/68 Tile{ AsIs: s.Col#1/51 HalfReuse: >/25 } >/69 </70 & Putout/71 s.FileHandle#1/9/72"    ======================================"/73 >/75 </76 & Map@4/77 s.FileHandle#1/9/78 Tile{ AsIs: e.Code#1/49 } >/79 </80 & Putout/81 s.FileHandle#1/9/82"    ======================================"/83 >/85 </86 & Putout/87 s.FileHandle#1/9/88"  }"/89 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
            ...
            // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 # GN-Entry/13 (/18 e.Name#1/39 )/19 (/24 # FileRowCol/36 (/37 s.Row#1/47 s.Col#1/48 )/38 e.1#0/41 )/25 e.Code#1/43 )/8 >/1
            context[39] = context[30];
            context[40] = context[31];
            context[41] = context[34];
            context[42] = context[35];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: '$'/13 HalfReuse: 'E'/18 }"NTRY "/49 </51 & DisplayName/52 Tile{ AsIs: e.Name#1/39 } >/53" :: native {"/54 >/56 </57 & Putout/58 s.FileHandle#1/9/59"  #lin"/60 Tile{ HalfReuse: 'e'/19 HalfReuse: ' '/24 HalfReuse: </36 HalfReuse: & Symb/37 AsIs: s.Row#1/47 } >/62 ':'/63 </64 & Symb/65 Tile{ AsIs: s.Col#1/48 } >/66" \""/67 </69 Tile{ HalfReuse: & EscapeString/38 AsIs: e.1#0/41 HalfReuse: >/25 } '\"'/70 >/71 </72 & Putout/73 s.FileHandle#1/9/74"    ======================================"/75 >/77 </78 & Map@4/79 s.FileHandle#1/9/80 Tile{ AsIs: e.Code#1/43 } >/81 </82 & Putout/83 s.FileHandle#1/9/84"    ======================================"/85 >/87 </88 & Putout/89 s.FileHandle#1/9/90"  }"/91 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
          ...
          // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 # GN-Entry/13 (/18 e.Name#1/30 )/19 t.SrcPos#1/24 e.Code#1/32 )/8 >/1
          context[30] = context[26];
          context[31] = context[27];
          context[32] = context[28];
          context[33] = context[29];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: '$'/13 HalfReuse: 'E'/18 }"NTRY "/34 </36 & DisplayName/37 Tile{ AsIs: e.Name#1/30 } >/38" :: native {"/39 >/41 </42 & Putout/43 s.FileHandle#1/9/44"  "/45 </47 Tile{ HalfReuse: & SrcPos*4/19 AsIs: t.SrcPos#1/24 } >/48 >/49 </50 & Putout/51 s.FileHandle#1/9/52"    ======================================"/53 >/55 </56 & Map@4/57 s.FileHandle#1/9/58 Tile{ AsIs: e.Code#1/32 } >/59 </60 & Putout/61 s.FileHandle#1/9/62"    ======================================"/63 >/65 </66 & Putout/67 s.FileHandle#1/9/68"  }"/69 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
          refalrts::alloc_chars(vm, context[34], context[35], "NTRY ", 5);
          refalrts::alloc_open_call(vm, context[36]);
          refalrts::alloc_name(vm, context[37], functions[efunc_DisplayName]);
          refalrts::alloc_close_call(vm, context[38]);
        ...
        do {
          // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 s.ScopeClass#1/13 (/18 e.Name#1/26 )/19 s.LineNumber#1/24 e.Code#1/28 )/8 >/1
          context[26] = context[20];
          context[27] = context[21];
          context[28] = context[22];
          context[29] = context[23];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: </7 HalfReuse: & FnName*2/10 AsIs: s.ScopeClass#1/13 } Tile{ AsIs: e.Name#1/26 } >/30 ' '/31 Tile{ HalfReuse: ':'/18 }": native {"/32 >/34 </35 & Putout/36 s.FileHandle#1/9/37"  #line "/38 </40 Tile{ HalfReuse: & Symb/19 AsIs: s.LineNumber#1/24 } >/41 >/42 </43 & Putout/44 s.FileHandle#1/9/45"    ======================================"/46 >/48 </49 & Map@4/50 s.FileHandle#1/9/51 Tile{ AsIs: e.Code#1/28 } >/52 </53 & Putout/54 s.FileHandle#1/9/55"    ======================================"/56 >/58 </59 & Putout/60 s.FileHandle#1/9/61"  }"/62 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
          refalrts::alloc_close_call(vm, context[30]);
        ...
        do {
          // </0 & PutProgramElement/4 s.new#18/9 (/7 # CmdNativeFunction/10 s.new#19/13 (/18 e.new#24/26 )/19 (/24 s.new#20/32 t.new#21/33 e.new#22/30 )/25 e.new#23/28 )/8 >/1
          context[26] = context[20];
          context[27] = context[21];
          context[28] = context[22];
          context[29] = context[23];
          ...
          do {
            // </0 & PutProgramElement/4 s.new#25/9 (/7 # CmdNativeFunction/10 s.new#26/13 (/18 e.new#31/35 )/19 (/24 s.new#27/32 s.new#28/33 e.new#29/37 )/25 e.new#30/39 )/8 >/1
            ...
            if( ! refalrts::svar_term( context[33], context[33] ) )
              continue;
            // closed e.new#31 as range 35
            // closed e.new#29 as range 37
            // closed e.new#30 as range 39
            do {
              // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 s.ScopeClass#1/13 (/18 e.Name#1/41 )/19 (/24 # FileLine/32 s.Line#1/33 e.1#0/43 )/25 e.Code#1/45 )/8 >/1
              ...
              // closed e.1#0 as range 43
              // closed e.Code#1 as range 45
              //DEBUG: s.FileHandle#1: 9
              //DEBUG: s.ScopeClass#1: 13
              //DEBUG: s.Line#1: 33
              //DEBUG: e.Name#1: 41
              ...
              //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: </7 HalfReuse: & FnName*2/10 AsIs: s.ScopeClass#1/13 } Tile{ AsIs: e.Name#1/41 } Tile{ HalfReuse: >/25 } Tile{ HalfReuse: ' '/18 }":: native {"/47 >/49 </50 & Putout/51 s.FileHandle#1/9/52"  #line"/53 Tile{ HalfReuse: ' '/19 HalfReuse: </24 HalfReuse: & Symb/32 AsIs: s.Line#1/33 } >/55" \""/56 </58 & EscapeString/59 Tile{ AsIs: e.1#0/43 } >/60 '\"'/61 >/62 </63 & Putout/64 s.FileHandle#1/9/65"    ======================================"/66 >/68 </69 & Map@4/70 s.FileHandle#1/9/71 Tile{ AsIs: e.Code#1/45 } >/72 </73 & Putout/74 s.FileHandle#1/9/75"    ======================================"/76 >/78 </79 & Putout/80 s.FileHandle#1/9/81"  }"/82 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
            ...
            // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 s.ScopeClass#1/13 (/18 e.Name#1/41 )/19 (/24 # RowCol/32 s.Row#1/33 s.Col#1/47 )/25 e.Code#1/45 )/8 >/1
            context[41] = context[35];
            context[42] = context[36];
            context[43] = context[37];
            context[44] = context[38];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: </7 HalfReuse: & FnName*2/10 AsIs: s.ScopeClass#1/13 } Tile{ AsIs: e.Name#1/41 } >/48 ' '/49 Tile{ HalfReuse: ':'/18 }": native {"/50 >/52 </53 & Putout/54 s.FileHandle#1/9/55"  #line"/56 Tile{ HalfReuse: ' '/19 HalfReuse: </24 HalfReuse: & Symb/32 AsIs: s.Row#1/33 } >/58 ':'/59 </60 & Symb/61 Tile{ AsIs: s.Col#1/47 HalfReuse: >/25 } >/62 </63 & Putout/64 s.FileHandle#1/9/65"    ======================================"/66 >/68 </69 & Map@4/70 s.FileHandle#1/9/71 Tile{ AsIs: e.Code#1/45 } >/72 </73 & Putout/74 s.FileHandle#1/9/75"    ======================================"/76 >/78 </79 & Putout/80 s.FileHandle#1/9/81"  }"/82 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
            refalrts::alloc_close_call(vm, context[48]);
          ...
          // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 s.ScopeClass#1/13 (/18 e.Name#1/35 )/19 (/24 # FileRowCol/32 (/33 s.Row#1/43 s.Col#1/44 )/34 e.1#0/37 )/25 e.Code#1/39 )/8 >/1
          context[35] = context[26];
          context[36] = context[27];
          context[37] = context[30];
          context[38] = context[31];
          ...
          // closed e.1#0 as range 37
          // closed e.Code#1 as range 39
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: </7 HalfReuse: & FnName*2/10 AsIs: s.ScopeClass#1/13 } Tile{ AsIs: e.Name#1/35 } >/45" :"/46 Tile{ HalfReuse: ':'/18 }" native {"/48 >/50 </51 & Putout/52 s.FileHandle#1/9/53"  #lin"/54 Tile{ HalfReuse: 'e'/19 HalfReuse: ' '/24 HalfReuse: </32 HalfReuse: & Symb/33 AsIs: s.Row#1/43 } >/56 ':'/57 </58 & Symb/59 Tile{ AsIs: s.Col#1/44 } >/60" \""/61 </63 Tile{ HalfReuse: & EscapeString/34 AsIs: e.1#0/37 HalfReuse: >/25 } '\"'/64 >/65 </66 & Putout/67 s.FileHandle#1/9/68"    ======================================"/69 >/71 </72 & Map@4/73 s.FileHandle#1/9/74 Tile{ AsIs: e.Code#1/39 } >/75 </76 & Putout/77 s.FileHandle#1/9/78"    ======================================"/79 >/81 </82 & Putout/83 s.FileHandle#1/9/84"  }"/85 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
          refalrts::alloc_close_call(vm, context[45]);
        ...
        // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdNativeFunction/10 s.ScopeClass#1/13 (/18 e.Name#1/26 )/19 t.SrcPos#1/24 e.Code#1/28 )/8 >/1
        context[26] = context[20];
        context[27] = context[21];
        context[28] = context[22];
        context[29] = context[23];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: </7 HalfReuse: & FnName*2/10 AsIs: s.ScopeClass#1/13 } Tile{ AsIs: e.Name#1/26 } >/30 ' '/31 Tile{ HalfReuse: ':'/18 }": native {"/32 >/34 </35 & Putout/36 s.FileHandle#1/9/37"  "/38 </40 Tile{ HalfReuse: & SrcPos*4/19 AsIs: t.SrcPos#1/24 } >/41 >/42 </43 & Putout/44 s.FileHandle#1/9/45"    ======================================"/46 >/48 </49 & Map@4/50 s.FileHandle#1/9/51 Tile{ AsIs: e.Code#1/28 } >/52 </53 & Putout/54 s.FileHandle#1/9/55"    ======================================"/56 >/58 </59 & Putout/60 s.FileHandle#1/9/61"  }"/62 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
        refalrts::alloc_close_call(vm, context[30]);
        refalrts::alloc_char(vm, context[31], ' ');
        refalrts::alloc_chars(vm, context[32], context[33], ": native {", 10);
        refalrts::alloc_close_call(vm, context[34]);
      ...
      // </0 & PutProgramElement/4 s.new#13/9 (/7 # CmdMetatable/10 s.new#14/13 (/18 e.new#16/20 )/19 e.new#15/22 )/8 >/1
      context[20] = context[16];
      context[21] = context[17];
      context[22] = context[14];
      context[23] = context[15];
      ...
      // closed e.new#15 as range 22
      do {
        // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdMetatable/10 # GN-Local/13 (/18 e.Name#1/24 )/19 e.Metatable#1/26 )/8 >/1
        context[24] = context[20];
        context[25] = context[21];
        context[26] = context[22];
        context[27] = context[23];
        if( ! refalrts::ident_term( identifiers[ident_GNm_Local], context[13] ) )
          continue;
        // closed e.Name#1 as range 24
        // closed e.Metatable#1 as range 26
        //DEBUG: s.FileHandle#1: 9
        //DEBUG: e.Name#1: 24
        //DEBUG: e.Metatable#1: 26

        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: </13 HalfReuse: & DisplayName/18 AsIs: e.Name#1/24 HalfReuse: >/19 }" :: metatable {"/28 >/30 </31 & Map@5/32 s.FileHandle#1/9/33 Tile{ AsIs: e.Metatable#1/26 } >/34 </35 & Putout/36 s.FileHandle#1/9/37"  }"/38 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
      ...
      do {
        // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdMetatable/10 # GN-Entry/13 (/18 e.Name#1/24 )/19 e.Metatable#1/26 )/8 >/1
        context[24] = context[20];
        context[25] = context[21];
        context[26] = context[22];
        context[27] = context[23];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: '$'/13 HalfReuse: 'E'/18 }"NT"/28 Tile{ HalfReuse: 'R'/19 }"Y "/30 </32 & DisplayName/33 Tile{ AsIs: e.Name#1/24 } >/34" :: metatable {"/35 >/37 </38 & Map@5/39 s.FileHandle#1/9/40 Tile{ AsIs: e.Metatable#1/26 } >/41 </42 & Putout/43 s.FileHandle#1/9/44"  }"/45 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
        refalrts::alloc_chars(vm, context[28], context[29], "NT", 2);
        refalrts::alloc_chars(vm, context[30], context[31], "Y ", 2);
        refalrts::alloc_open_call(vm, context[32]);
        refalrts::alloc_name(vm, context[33], functions[efunc_DisplayName]);
      ...
      // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdMetatable/10 s.ScopeClass#1/13 (/18 e.Name#1/24 )/19 e.Metatable#1/26 )/8 >/1
      context[24] = context[20];
      context[25] = context[21];
      context[26] = context[22];
      context[27] = context[23];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: </7 HalfReuse: & FnName*2/10 AsIs: s.ScopeClass#1/13 } Tile{ AsIs: e.Name#1/24 } Tile{ HalfReuse: >/18 } Tile{ HalfReuse: ' '/19 }":: metatable {"/28 >/30 </31 & Map@5/32 s.FileHandle#1/9/33 Tile{ AsIs: e.Metatable#1/26 } >/34 </35 & Putout/36 s.FileHandle#1/9/37"  }"/38 Tile{ HalfReuse: '\n'/8 AsIs: >/1 ]] }
    ...
    do {
      // </0 & PutProgramElement/4 s.new#8/9 (/7 # CmdEnum/10 s.new#9/13 e.new#10/14 )/8 >/1
      context[14] = context[11];
      context[15] = context[12];
      ...
      do {
        // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdEnum/10 # GN-Local/13 e.Name#1/16 )/8 >/1
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: </13 } & DisplayName/18 Tile{ AsIs: e.Name#1/16 } >/19" :: enu"/20 Tile{ HalfReuse: 'm'/8 AsIs: >/1 ]] }
      ...
      do {
        // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdEnum/10 # GN-Entry/13 e.Name#1/16 )/8 >/1
        context[16] = context[14];
        context[17] = context[15];
        if( ! refalrts::ident_term( identifiers[ident_GNm_Entry], context[13] ) )
          continue;
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: '$'/13 }"ENTRY "/18 </20 & DisplayName/21 Tile{ AsIs: e.Name#1/16 } >/22" :: enu"/23 Tile{ HalfReuse: 'm'/8 AsIs: >/1 ]] }
      ...
      // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdEnum/10 s.ScopeClass#1/13 e.Name#1/16 )/8 >/1
      context[16] = context[14];
      context[17] = context[15];
      // closed e.Name#1 as range 16
      //DEBUG: s.FileHandle#1: 9
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: </7 HalfReuse: & FnName*2/10 AsIs: s.ScopeClass#1/13 AsIs: e.Name#1/16 HalfReuse: >/8 HalfReuse: ' '/1 }":: enum"/18 >/20 Tile{ ]] }
    ...
    do {
      // </0 & PutProgramElement/4 s.new#8/9 (/7 # CmdSwap/10 s.new#9/13 e.new#10/14 )/8 >/1
      context[14] = context[11];
      context[15] = context[12];
      ...
      // closed e.new#10 as range 14
      do {
        // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdSwap/10 # GN-Local/13 e.Name#1/16 )/8 >/1
        context[16] = context[14];
        context[17] = context[15];
        if( ! refalrts::ident_term( identifiers[ident_GNm_Local], context[13] ) )
          continue;
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: </13 } & DisplayName/18 Tile{ AsIs: e.Name#1/16 } >/19" :: swa"/20 Tile{ HalfReuse: 'p'/8 AsIs: >/1 ]] }
        refalrts::alloc_name(vm, context[18], functions[efunc_DisplayName]);
        refalrts::alloc_close_call(vm, context[19]);
      ...
      do {
        // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdSwap/10 # GN-Entry/13 e.Name#1/16 )/8 >/1
        context[16] = context[14];
        context[17] = context[15];
        if( ! refalrts::ident_term( identifiers[ident_GNm_Entry], context[13] ) )
          continue;
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: '$'/13 }"ENTRY "/18 </20 & DisplayName/21 Tile{ AsIs: e.Name#1/16 } >/22" :: swa"/23 Tile{ HalfReuse: 'p'/8 AsIs: >/1 ]] }
        refalrts::alloc_chars(vm, context[18], context[19], "ENTRY ", 6);
        refalrts::alloc_open_call(vm, context[20]);
        refalrts::alloc_name(vm, context[21], functions[efunc_DisplayName]);
        refalrts::alloc_close_call(vm, context[22]);
      ...
      // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdSwap/10 s.ScopeClass#1/13 e.Name#1/16 )/8 >/1
      context[16] = context[14];
      context[17] = context[15];
      // closed e.Name#1 as range 16
      //DEBUG: s.FileHandle#1: 9
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: </7 HalfReuse: & FnName*2/10 AsIs: s.ScopeClass#1/13 AsIs: e.Name#1/16 HalfReuse: >/8 HalfReuse: ' '/1 }":: swap"/18 >/20 Tile{ ]] }
    ...
    do {
      // </0 & PutProgramElement/4 s.new#8/9 (/7 # CmdConditionFunc/10 s.new#9/13 e.new#10/14 )/8 >/1
      context[14] = context[11];
      context[15] = context[12];
      ...
      // closed e.new#10 as range 14
      do {
        // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdConditionFunc/10 # GN-Local/13 e.Name#1/16 )/8 >/1
        context[16] = context[14];
        context[17] = context[15];
        if( ! refalrts::ident_term( identifiers[ident_GNm_Local], context[13] ) )
          continue;
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: </13 } & DisplayName/18 Tile{ AsIs: e.Name#1/16 } >/19" :: conditio"/20 Tile{ HalfReuse: 'n'/8 AsIs: >/1 ]] }
        refalrts::alloc_name(vm, context[18], functions[efunc_DisplayName]);
        refalrts::alloc_close_call(vm, context[19]);
      ...
      do {
        // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdConditionFunc/10 # GN-Entry/13 e.Name#1/16 )/8 >/1
        context[16] = context[14];
        context[17] = context[15];
        if( ! refalrts::ident_term( identifiers[ident_GNm_Entry], context[13] ) )
          continue;
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: '$'/13 }"ENTRY "/18 </20 & DisplayName/21 Tile{ AsIs: e.Name#1/16 } >/22" :: conditio"/23 Tile{ HalfReuse: 'n'/8 AsIs: >/1 ]] }
        refalrts::alloc_chars(vm, context[18], context[19], "ENTRY ", 6);
        refalrts::alloc_open_call(vm, context[20]);
        refalrts::alloc_name(vm, context[21], functions[efunc_DisplayName]);
        refalrts::alloc_close_call(vm, context[22]);
      ...
      // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdConditionFunc/10 s.ScopeClass#1/13 e.Name#1/16 )/8 >/1
      context[16] = context[14];
      context[17] = context[15];
      // closed e.Name#1 as range 16
      //DEBUG: s.FileHandle#1: 9
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: </7 HalfReuse: & FnName*2/10 AsIs: s.ScopeClass#1/13 AsIs: e.Name#1/16 HalfReuse: >/8 HalfReuse: ' '/1 }":: condition"/18 >/20 Tile{ ]] }
    ...
    // </0 & PutProgramElement/4 s.new#8/9 (/7 # CmdDeclaration/10 s.new#9/13 e.new#10/14 )/8 >/1
    context[14] = context[11];
    context[15] = context[12];
    ...
    // closed e.new#10 as range 14
    do {
      // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdDeclaration/10 # GN-Local/13 e.Name#1/16 )/8 >/1
      context[16] = context[14];
      context[17] = context[15];
      if( ! refalrts::ident_term( identifiers[ident_GNm_Local], context[13] ) )
        continue;
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: </13 } & DisplayName/18 Tile{ AsIs: e.Name#1/16 } >/19" :: exter"/20 Tile{ HalfReuse: 'n'/8 AsIs: >/1 ]] }
      refalrts::alloc_name(vm, context[18], functions[efunc_DisplayName]);
      refalrts::alloc_close_call(vm, context[19]);
    ...
    do {
      // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdDeclaration/10 # GN-Entry/13 e.Name#1/16 )/8 >/1
      context[16] = context[14];
      context[17] = context[15];
      if( ! refalrts::ident_term( identifiers[ident_GNm_Entry], context[13] ) )
        continue;
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: ' '/7 HalfReuse: ' '/10 HalfReuse: '$'/13 }"ENTRY "/18 </20 & DisplayName/21 Tile{ AsIs: e.Name#1/16 } >/22" :: exter"/23 Tile{ HalfReuse: 'n'/8 AsIs: >/1 ]] }
      refalrts::alloc_chars(vm, context[18], context[19], "ENTRY ", 6);
      refalrts::alloc_open_call(vm, context[20]);
      refalrts::alloc_name(vm, context[21], functions[efunc_DisplayName]);
      refalrts::alloc_close_call(vm, context[22]);
    ...
    // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdDeclaration/10 s.ScopeClass#1/13 e.Name#1/16 )/8 >/1
    context[16] = context[14];
    context[17] = context[15];
    // closed e.Name#1 as range 16
    //DEBUG: s.FileHandle#1: 9
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: </7 HalfReuse: & FnName*2/10 AsIs: s.ScopeClass#1/13 AsIs: e.Name#1/16 HalfReuse: >/8 HalfReuse: ' '/1 }":: extern"/18 >/20 Tile{ ]] }
  ...
  do {
    // </0 & PutProgramElement/4 s.new#8/9 (/7 # CmdEmitNativeCode/10 t.new#9/11 e.new#10/13 )/8 >/1
    context[13] = context[5];
    context[14] = context[6];
    ...
    do {
      // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdEmitNativeCode/10 s.LineNumber#1/11 e.Code#1/15 )/8 >/1
      context[15] = context[13];
      context[16] = context[14];
      if( ! refalrts::svar_term( context[11], context[11] ) )
        continue;
      // closed e.Code#1 as range 15
      //DEBUG: s.LineNumber#1: 11
      //DEBUG: s.FileHandle#1: 9
      //DEBUG: e.Code#1: 15

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: 'N'/7 HalfReuse: 'a'/10 }"tive code:"/17 >/19 </20 & Putout/21 s.FileHandle#1/9/22"  #line "/23 </25 & Symb/26 Tile{ AsIs: s.LineNumber#1/11 } >/27 >/28 </29 & Putout/30 s.FileHandle#1/9/31"    ======================================"/32 >/34 </35 & Map@4/36 s.FileHandle#1/9/37 Tile{ AsIs: e.Code#1/15 } >/38 </39 & Putout/40 s.FileHandle#1/9/41"    ======================================"/42 >/44 </45 & Putout/46 Tile{ HalfReuse: s.FileHandle1 #9/8 AsIs: >/1 ]] }
    ...
    do {
      // </0 & PutProgramElement/4 s.new#11/9 (/7 # CmdEmitNativeCode/10 (/11 s.new#12/19 t.new#13/20 e.new#14/17 )/12 e.new#15/15 )/8 >/1
      context[15] = context[13];
      context[16] = context[14];
      context[17] = 0;
      context[18] = 0;
      ...
      do {
        // </0 & PutProgramElement/4 s.new#16/9 (/7 # CmdEmitNativeCode/10 (/11 s.new#17/19 s.new#18/20 e.new#19/22 )/12 e.new#20/24 )/8 >/1
        ...
        do {
          // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdEmitNativeCode/10 (/11 # FileLine/19 s.Line#1/20 e.1#0/26 )/12 e.Code#1/28 )/8 >/1
          context[26] = context[22];
          context[27] = context[23];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: 'N'/7 HalfReuse: 'a'/10 HalfReuse: 't'/11 HalfReuse: 'i'/19 }"ve "/30 Tile{ HalfReuse: 'c'/12 }"ode:"/32 >/34 </35 & Putout/36 s.FileHandle#1/9/37"  #line "/38 </40 & Symb/41 Tile{ AsIs: s.Line#1/20 } >/42" \""/43 </45 & EscapeString/46 Tile{ AsIs: e.1#0/26 } >/47 '\"'/48 >/49 </50 & Putout/51 s.FileHandle#1/9/52"    ======================================"/53 >/55 </56 & Map@4/57 s.FileHandle#1/9/58 Tile{ AsIs: e.Code#1/28 } >/59 </60 & Putout/61 s.FileHandle#1/9/62"    ======================================"/63 >/65 </66 & Putout/67 Tile{ HalfReuse: s.FileHandle1 #9/8 AsIs: >/1 ]] }
        ...
        // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdEmitNativeCode/10 (/11 # RowCol/19 s.Row#1/20 s.Col#1/30 )/12 e.Code#1/28 )/8 >/1
        context[26] = context[22];
        context[27] = context[23];
        context[28] = context[24];
        context[29] = context[25];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: 'N'/7 HalfReuse: 'a'/10 HalfReuse: 't'/11 HalfReuse: 'i'/19 }"ve code:"/31 >/33 </34 & Putout/35 s.FileHandle#1/9/36"  #line "/37 </39 & Symb/40 Tile{ AsIs: s.Row#1/20 } >/41 ':'/42 </43 & Symb/44 Tile{ AsIs: s.Col#1/30 HalfReuse: >/12 } >/45 </46 & Putout/47 s.FileHandle#1/9/48"    ======================================"/49 >/51 </52 & Map@4/53 s.FileHandle#1/9/54 Tile{ AsIs: e.Code#1/28 } >/55 </56 & Putout/57 s.FileHandle#1/9/58"    ======================================"/59 >/61 </62 & Putout/63 Tile{ HalfReuse: s.FileHandle1 #9/8 AsIs: >/1 ]] }
      ...
      // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdEmitNativeCode/10 (/11 # FileRowCol/19 (/20 s.Row#1/28 s.Col#1/29 )/21 e.1#0/22 )/12 e.Code#1/24 )/8 >/1
      context[22] = context[17];
      context[23] = context[18];
      context[24] = context[15];
      context[25] = context[16];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: 'N'/7 HalfReuse: 'a'/10 HalfReuse: 't'/11 HalfReuse: 'i'/19 HalfReuse: 'v'/20 }"e code:"/30 >/32 </33 & Putout/34 s.FileHandle#1/9/35"  #line "/36 </38 & Symb/39 Tile{ AsIs: s.Row#1/28 } >/40 ':'/41 </42 & Symb/43 Tile{ AsIs: s.Col#1/29 } >/44" \""/45 </47 Tile{ HalfReuse: & EscapeString/21 AsIs: e.1#0/22 HalfReuse: >/12 } '\"'/48 >/49 </50 & Putout/51 s.FileHandle#1/9/52"    ======================================"/53 >/55 </56 & Map@4/57 s.FileHandle#1/9/58 Tile{ AsIs: e.Code#1/24 } >/59 </60 & Putout/61 s.FileHandle#1/9/62"    ======================================"/63 >/65 </66 & Putout/67 Tile{ HalfReuse: s.FileHandle1 #9/8 AsIs: >/1 ]] }
    ...
    // </0 & PutProgramElement/4 s.FileHandle#1/9 (/7 # CmdEmitNativeCode/10 t.SrcPos#1/11 e.Code#1/15 )/8 >/1
    context[15] = context[13];
    context[16] = context[14];
    // closed e.Code#1 as range 15
    //DEBUG: t.SrcPos#1: 11
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: 'N'/7 HalfReuse: 'a'/10 }"tive code:"/17 >/19 </20 & Putout/21 s.FileHandle#1/9/22"  "/23 </25 & SrcPos*4/26 Tile{ AsIs: t.SrcPos#1/11 } >/27 >/28 </29 & Putout/30 s.FileHandle#1/9/31"    ======================================"/32 >/34 </35 & Map@4/36 s.FileHandle#1/9/37 Tile{ AsIs: e.Code#1/15 } >/38 </39 & Putout/40 s.FileHandle#1/9/41"    ======================================"/42 >/44 </45 & Putout/46 Tile{ HalfReuse: s.FileHandle1 #9/8 AsIs: >/1 ]] }
    refalrts::alloc_chars(vm, context[17], context[18], "tive code:", 10);
    refalrts::alloc_close_call(vm, context[19]);
    refalrts::alloc_open_call(vm, context[20]);
    refalrts::alloc_name(vm, context[21], functions[efunc_Putout]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/9 HalfReuse: '$'/7 HalfReuse: 'S'/10 HalfReuse: 'P'/11 } 'E'/15 Tile{ HalfReuse: 'C'/12 } Tile{ HalfReuse: ' '/8 } </16 & DisplayName/17 Tile{ AsIs: e.Name#1/13 } >/18 >/19 </20 & Map@6/21 s.FileHandle#1/9/22 Tile{ AsIs: e.Pattern#1/5 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_PutRASLFunction(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & PutRASLFunction/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & PutRASLFunction/4 s.new#1/5 s.new#2/6 (/9 e.new#3/7 )/10 e.new#4/2 >/1
  if( ! refalrts::svar_left( context[5], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  ...
  // closed e.new#4 as range 2
  do {
    // </0 & PutRASLFunction/4 s.FileHandle#1/5 # GN-Local/6 (/9 e.Name#1/11 )/10 e.Commands#1/13 >/1
    context[11] = context[7];
    context[12] = context[8];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 HalfReuse: ' '/6 HalfReuse: ' '/9 } </15 & DisplayName/16 Tile{ AsIs: e.Name#1/11 } >/17" {"/18 >/20 </21 & Map@3/22 Tile{ HalfReuse: s.FileHandle1 #5/10 AsIs: e.Commands#1/13 AsIs: >/1 } </23 & Putout/24 s.FileHandle#1/5/25"  }\n"/26 >/28 Tile{ ]] }
    refalrts::alloc_open_call(vm, context[15]);
    refalrts::alloc_name(vm, context[16], functions[efunc_DisplayName]);
    refalrts::alloc_close_call(vm, context[17]);
  ...
  do {
    // </0 & PutRASLFunction/4 s.FileHandle#1/5 # GN-Entry/6 (/9 e.Name#1/11 )/10 e.Commands#1/13 >/1
    context[11] = context[7];
    context[12] = context[8];
    context[13] = context[2];
    context[14] = context[3];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 HalfReuse: ' '/6 HalfReuse: ' '/9 }"$ENTRY "/15 </17 & DisplayName/18 Tile{ AsIs: e.Name#1/11 } >/19" {"/20 >/22 </23 & Map@3/24 Tile{ HalfReuse: s.FileHandle1 #5/10 AsIs: e.Commands#1/13 AsIs: >/1 } </25 & Putout/26 s.FileHandle#1/5/27"  }\n"/28 >/30 Tile{ ]] }
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 } </11 & FnName*2/12 Tile{ AsIs: s.ScopeClass#1/6 } Tile{ AsIs: e.Name#1/7 } Tile{ HalfReuse: >/9 }" {"/13 >/15 </16 & Map@3/17 Tile{ HalfReuse: s.FileHandle1 #5/10 AsIs: e.Commands#1/2 AsIs: >/1 } </18 & Putout/19 s.FileHandle#1/5/20"  }\n"/21 >/23 Tile{ ]] }
  refalrts::alloc_open_call(vm, context[11]);
...
static refalrts::FnResult func_gen_PutRASLCommands_L1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </19 Tile{ HalfReuse: & Putout/7 HalfReuse: s.FileHandle1 #13/14 } e.Indent#1/15/20"(CmdSentence"/22 >/24 Tile{ AsIs: </0 Reuse: & Map@7/4 AsIs: s.FileHandle#1/13 AsIs: (/11 AsIs: e.Indent#1/15 AsIs: )/12 } Tile{ AsIs: e.SubCommands#2/17 } >/25 </26 & Putout/27 s.FileHandle#1/13/28 e.Indent#1/15/29")  // CmdSentenc"/31 Tile{ HalfReuse: 'e'/8 AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[19]);
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </22 & Putout/23 s.FileHandle#1/13/24 e.Indent#1/15/25"(CmdOpenELoop e."/27 </29 & Symb/30 Tile{ AsIs: s.VarNumber#2/21 } >/31" <- "/32 Tile{ HalfReuse: '['/7 HalfReuse: </14 HalfReuse: & Symb/19 AsIs: s.BracketNum#2/20 } >/34 ']'/35 >/36 Tile{ AsIs: </0 Reuse: & Map@7/4 AsIs: s.FileHandle#1/13 AsIs: (/11 AsIs: e.Indent#1/15 AsIs: )/12 } Tile{ AsIs: e.SubCommands#2/17 } >/37 </38 & Putout/39 s.FileHandle#1/13/40 e.Indent#1/15/41")  // CmdOpenELoo"/43 Tile{ HalfReuse: 'p'/8 AsIs: >/1 ]] }
...
static refalrts::FnResult func_PutRASLCommands(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@8/4 AsIs: s.FileHandle#1/5 AsIs: (/8 AsIs: e.Indent#1/6 AsIs: )/9 AsIs: e.Commands#1/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_PutCode(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & PutCode/4 s.new#1/5 t.new#2/6 e.new#3/2 >/1
  if( ! refalrts::svar_left( context[5], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  ...
  // closed e.new#3 as range 2
  do {
    // </0 & PutCode/4 s.FileHandle#1/5 s.LineNumber#1/6 e.Code#1/8 >/1
    context[8] = context[2];
    context[9] = context[3];
    if( ! refalrts::svar_term( context[6], context[6] ) )
      continue;
    // closed e.Code#1 as range 8
    //DEBUG: s.LineNumber#1: 6
    //DEBUG: s.FileHandle#1: 5
    //DEBUG: e.Code#1: 8

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 }"  #line "/10 </12 & Symb/13 Tile{ AsIs: s.LineNumber#1/6 } >/14 >/15 </16 & Putout/17 s.FileHandle#1/5/18"    ======================================"/19 >/21 </22 & Map@4/23 s.FileHandle#1/5/24 Tile{ AsIs: e.Code#1/8 } >/25 </26 & Putout/27 s.FileHandle#1/5/28"    ======================================"/29 Tile{ AsIs: >/1 ]] }
  ...
  do {
    // </0 & PutCode/4 s.new#4/5 (/6 s.new#5/12 t.new#6/13 e.new#7/10 )/7 e.new#8/8 >/1
    context[8] = context[2];
    context[9] = context[3];
    context[10] = 0;
    context[11] = 0;
    ...
    do {
      // </0 & PutCode/4 s.new#9/5 (/6 s.new#10/12 s.new#11/13 e.new#12/15 )/7 e.new#13/17 >/1
      ...
      do {
        // </0 & PutCode/4 s.FileHandle#1/5 (/6 # FileLine/12 s.Line#1/13 e.1#0/19 )/7 e.Code#1/21 >/1
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 HalfReuse: ' '/6 HalfReuse: ' '/12 }"#line "/23 </25 & Symb/26 Tile{ AsIs: s.Line#1/13 } >/27" \""/28 </30 & EscapeString/31 Tile{ AsIs: e.1#0/19 } >/32 '\"'/33 >/34 </35 & Putout/36 s.FileHandle#1/5/37"    ======================================"/38 >/40 </41 & Map@4/42 Tile{ HalfReuse: s.FileHandle1 #5/7 AsIs: e.Code#1/21 AsIs: >/1 } </43 & Putout/44 s.FileHandle#1/5/45"    ======================================"/46 >/48 Tile{ ]] }
      ...
      // </0 & PutCode/4 s.FileHandle#1/5 (/6 # RowCol/12 s.Row#1/13 s.Col#1/23 )/7 e.Code#1/21 >/1
      context[19] = context[15];
      context[20] = context[16];
      context[21] = context[17];
      context[22] = context[18];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 HalfReuse: ' '/6 HalfReuse: ' '/12 }"#line "/24 </26 & Symb/27 Tile{ AsIs: s.Row#1/13 } >/28 ':'/29 </30 & Symb/31 Tile{ AsIs: s.Col#1/23 } >/32 >/33 </34 & Putout/35 s.FileHandle#1/5/36"    ======================================"/37 >/39 </40 & Map@4/41 Tile{ HalfReuse: s.FileHandle1 #5/7 AsIs: e.Code#1/21 AsIs: >/1 } </42 & Putout/43 s.FileHandle#1/5/44"    ======================================"/45 >/47 Tile{ ]] }
    ...
    // </0 & PutCode/4 s.FileHandle#1/5 (/6 # FileRowCol/12 (/13 s.Row#1/21 s.Col#1/22 )/14 e.1#0/15 )/7 e.Code#1/17 >/1
    context[15] = context[10];
    context[16] = context[11];
    context[17] = context[8];
    context[18] = context[9];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 HalfReuse: ' '/6 HalfReuse: ' '/12 HalfReuse: '#'/13 }"line "/23 </25 & Symb/26 Tile{ AsIs: s.Row#1/21 } >/27 ':'/28 </29 & Symb/30 Tile{ AsIs: s.Col#1/22 HalfReuse: >/14 }" \""/31 </33 & EscapeString/34 Tile{ AsIs: e.1#0/15 } >/35 '\"'/36 >/37 </38 & Putout/39 s.FileHandle#1/5/40"    ======================================"/41 >/43 </44 & Map@4/45 Tile{ HalfReuse: s.FileHandle1 #5/7 AsIs: e.Code#1/17 AsIs: >/1 } </46 & Putout/47 s.FileHandle#1/5/48"    ======================================"/49 >/51 Tile{ ]] }
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 }"  "/8 </10 & SrcPos*4/11 Tile{ AsIs: t.SrcPos#1/6 } >/12 >/13 </14 & Putout/15 s.FileHandle#1/5/16"    ======================================"/17 >/19 </20 & Map@4/21 s.FileHandle#1/5/22 Tile{ AsIs: e.Code#1/2 } >/23 </24 & Putout/25 s.FileHandle#1/5/26"    ======================================"/27 Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Logm_PutLine_B1Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[13];
  refalrts::zeros( context, 13 );
  // </0 & Log-PutLine:1@1/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  do {
    // </0 & Log-PutLine:1@1/4 s.FileHandle#2/7 >/1
    context[5] = context[2];
    context[6] = context[3];
    if( ! refalrts::svar_left( context[7], context[5], context[6] ) )
      continue;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/7 HalfReuse: </1 } & Time/8 >/9": Compilation starts"/10 >/12 Tile{ ]] }
  ...
  // </0 & Log-PutLine:1@1/4 e.dyn#0/2 >/1
  // closed e.dyn#0 as range 2
  //DEBUG: e.dyn#0: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 & Log-PutLine:1@0/6 (/7"Compilation start"/8 Tile{ HalfReuse: 's'/0 HalfReuse: )/4 AsIs: e.dyn#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
...
static refalrts::FnResult func_gen_Logm_PutLine_B1Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[13];
  refalrts::zeros( context, 13 );
  // </0 & Log-PutLine:1@2/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  do {
    // </0 & Log-PutLine:1@2/4 s.FileHandle#2/7 >/1
    context[5] = context[2];
    context[6] = context[3];
    if( ! refalrts::svar_left( context[7], context[5], context[6] ) )
      continue;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/7 HalfReuse: </1 } & Time/8 >/9": Compilation ends"/10 >/12 Tile{ ]] }
    refalrts::alloc_name(vm, context[8], functions[efunc_Time]);
    refalrts::alloc_close_call(vm, context[9]);
  ...
  // </0 & Log-PutLine:1@2/4 e.dyn#0/2 >/1
  // closed e.dyn#0 as range 2
  //DEBUG: e.dyn#0: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 & Log-PutLine:1@0/6 (/7"Compilation end"/8 Tile{ HalfReuse: 's'/0 HalfReuse: )/4 AsIs: e.dyn#0/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::alloc_name(vm, context[6], functions[efunc_gen_Logm_PutLine_B1Z0]);
  refalrts::alloc_open_bracket(vm, context[7]);
...
static refalrts::FnResult func_gen_Logm_PutLine_B1Z3(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & Log-PutLine:1@3/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & Log-PutLine:1@3/4 (/7 e.new#1/5 )/8 e.new#2/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new#2 as range 2
  do {
    // </0 & Log-PutLine:1@3/4 (/7 e.Message0#1/9 )/8 >/1
    context[9] = context[5];
    context[10] = context[6];
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    // closed e.Message0#1 as range 9
    //DEBUG: e.Message0#1: 9

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Log-PutLine:1@3/4 (/7 e.Message0#1/9 )/8 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  do {
    // </0 & Log-PutLine:1@3/4 (/7 e.Message0#1/9 )/8 s.FileHandle#2/13 >/1
    context[9] = context[5];
    context[10] = context[6];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.FileHandle#2/13 {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 HalfReuse: s.FileHandle2 #13/7 } </14 Tile{ HalfReuse: & Time/8 } >/15": AST of file "/16 Tile{ AsIs: e.Message0#1/9 } ':'/18 Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[14]);
    refalrts::alloc_close_call(vm, context[15]);
  ...
  // </0 & Log-PutLine:1@3/4 (/7 e.Message0#1/5 )/8 e.dyn#0/2 >/1
  // closed e.Message0#1 as range 5
  // closed e.dyn#0 as range 2
  //DEBUG: e.Message0#1: 5
  //DEBUG: e.dyn#0: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Log-PutLine:1@0/4 AsIs: (/7 }"AST of file "/9 Tile{ AsIs: e.Message0#1/5 } ':'/11 Tile{ AsIs: )/8 AsIs: e.dyn#0/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Map_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      // </0 & Map@1/4 s.new#6/5 (/8 e.new#7/12 )/9 e.new#8/10 >/1
      context[10] = context[6];
      context[11] = context[7];
      context[12] = 0;
      context[13] = 0;
      ...
      do {
        // </0 & Map@1/4 s.FileHandle#2/5 (/8 )/9 e.Tail#1/14 >/1
        context[14] = context[10];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: >/8 HalfReuse: </9 } & Map@1/16 s.FileHandle#2/5/17 Tile{ AsIs: e.Tail#1/14 } Tile{ AsIs: >/1 ]] }
      ...
      // </0 & Map@1/4 s.FileHandle#2/5 (/8 e.#0/14 )/9 e.Tail#1/16 >/1
      context[14] = context[12];
      context[15] = context[13];
      context[16] = context[10];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 } ' '/18 Tile{ AsIs: e.#0/14 } >/19 </20 & Map@1/21 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/16 AsIs: >/1 ]] }
      refalrts::alloc_char(vm, context[18], ' ');
      refalrts::alloc_close_call(vm, context[19]);
      refalrts::alloc_open_call(vm, context[20]);
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Log-AST:1$2\1*2/4 AsIs: s.FileHandle#2/5 AsIs: t.Next#1/8 } >/12 </13 & Map@1/14 s.FileHandle#2/5/15 Tile{ AsIs: e.Tail#1/10 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[12]);
    refalrts::alloc_open_call(vm, context[13]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@0/4 } [*]/6 & Log-AST:1$2\1@0/7 Tile{ AsIs: s.FileHandle#2/5 } {*}/8 Tile{ AsIs: e.items#0/2 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Logm_PutLine_B1Z4(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[19];
  refalrts::zeros( context, 19 );
  // </0 & Log-PutLine:1@4/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & Log-PutLine:1@4/4 (/7 e.new#1/5 )/8 e.new#2/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new#2 as range 2
  do {
    // </0 & Log-PutLine:1@4/4 (/7 e.SrcName#1/9 )/8 >/1
    context[9] = context[5];
    context[10] = context[6];
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Log-PutLine:1@4/4 (/7 e.SrcName#1/9 )/8 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  do {
    // </0 & Log-PutLine:1@4/4 (/7 e.SrcName#1/9 )/8 s.FileHandle#2/13 >/1
    context[9] = context[5];
    context[10] = context[6];
    context[11] = context[2];
    context[12] = context[3];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.FileHandle#2/13 {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 HalfReuse: s.FileHandle2 #13/7 } </14 Tile{ HalfReuse: & Time/8 } >/15": HighLevelRASL code of file "/16 Tile{ AsIs: e.SrcName#1/9 } ':'/18 Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_call(vm, context[14]);
    refalrts::alloc_close_call(vm, context[15]);
  ...
  // </0 & Log-PutLine:1@4/4 (/7 e.SrcName#1/5 )/8 e.dyn#0/2 >/1
  // closed e.SrcName#1 as range 5
  // closed e.dyn#0 as range 2
  //DEBUG: e.SrcName#1: 5
  //DEBUG: e.dyn#0: 2
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Log-PutLine:1@0/4 AsIs: (/7 }"HighLevelRASL code of file "/9 Tile{ AsIs: e.SrcName#1/5 } ':'/11 Tile{ AsIs: )/8 AsIs: e.dyn#0/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Map_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new#5 as range 6
    do {
      // </0 & Map@2/4 s.new#6/5 (/8 s.new#7/14 e.new#8/12 )/9 e.new#9/10 >/1
      context[10] = context[6];
      context[11] = context[7];
      context[12] = 0;
      context[13] = 0;
      ...
      do {
        // </0 & Map@2/4 s.new#10/5 (/8 s.new#11/14 s.new#12/19 e.new#13/15 )/9 e.new#14/17 >/1
        context[15] = context[12];
        ...
        do {
          // </0 & Map@2/4 s.new#15/5 (/8 s.new#16/14 s.new#17/19 (/26 e.new#18/24 )/27 e.new#19/20 )/9 e.new#20/22 >/1
          ...
          // closed e.new#20 as range 22
          do {
            // </0 & Map@2/4 s.new#21/5 (/8 # Function/14 s.new#22/19 (/26 e.new#24/28 )/27 e.new#23/30 )/9 e.new#25/32 >/1
            context[28] = context[24];
            context[29] = context[25];
            ...
            do {
              // </0 & Map@2/4 s.FileHandle#2/5 (/8 # Function/14 # GN-Local/19 (/26 e.3#0/34 )/27 e.2#0/36 )/9 e.Tail#1/38 >/1
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: </19 HalfReuse: & DisplayName/26 AsIs: e.3#0/34 HalfReuse: >/27 }" {"/40 >/42 </43 & Map@3/44 s.FileHandle#2/5/45 Tile{ AsIs: e.2#0/36 } >/46 </47 & Putout/48 s.FileHandle#2/5/49"  }\n"/50 >/52 </53 & Map@2/54 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/38 AsIs: >/1 ]] }
              refalrts::alloc_chars(vm, context[40], context[41], " {", 2);
              refalrts::alloc_close_call(vm, context[42]);
              refalrts::alloc_open_call(vm, context[43]);
            ...
            do {
              // </0 & Map@2/4 s.FileHandle#2/5 (/8 # Function/14 # GN-Entry/19 (/26 e.3#0/34 )/27 e.2#0/36 )/9 e.Tail#1/38 >/1
              context[34] = context[28];
              context[35] = context[29];
              context[36] = context[30];
              context[37] = context[31];
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: '$'/19 HalfReuse: 'E'/26 }"NT"/40 Tile{ HalfReuse: 'R'/27 }"Y "/42 </44 & DisplayName/45 Tile{ AsIs: e.3#0/34 } >/46" {"/47 >/49 </50 & Map@3/51 s.FileHandle#2/5/52 Tile{ AsIs: e.2#0/36 } >/53 </54 & Putout/55 s.FileHandle#2/5/56"  }\n"/57 >/59 </60 & Map@2/61 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/38 AsIs: >/1 ]] }
            ...
            // </0 & Map@2/4 s.FileHandle#2/5 (/8 # Function/14 s.ScopeClass#1/19 (/26 e.3#0/34 )/27 e.2#0/36 )/9 e.Tail#1/38 >/1
            context[34] = context[28];
            context[35] = context[29];
            context[36] = context[30];
            context[37] = context[31];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: </8 HalfReuse: & FnName*2/14 AsIs: s.ScopeClass#1/19 } Tile{ AsIs: e.3#0/34 } Tile{ HalfReuse: >/26 } Tile{ HalfReuse: ' '/27 } '{'/40 >/41 </42 & Map@3/43 s.FileHandle#2/5/44 Tile{ AsIs: e.2#0/36 } >/45 </46 & Putout/47 s.FileHandle#2/5/48"  }\n"/49 >/51 </52 & Map@2/53 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/38 AsIs: >/1 ]] }
          ...
          do {
            // </0 & Map@2/4 s.new#21/5 (/8 # CmdNativeFunction/14 s.new#22/19 (/26 e.new#25/28 )/27 t.new#23/34 e.new#24/30 )/9 e.new#26/32 >/1
            context[28] = context[24];
            context[29] = context[25];
            context[30] = context[20];
            context[31] = context[21];
            ...
            if( ! refalrts::ident_term( identifiers[ident_CmdNativeFunction], context[14] ) )
              continue;
            // closed e.new#25 as range 28
            // closed e.new#26 as range 32
            context[35] = refalrts::tvar_left( context[34], context[30], context[31] );
            if( ! context[35] )
              continue;
            // closed e.new#24 as range 30
            do {
              // </0 & Map@2/4 s.new#27/5 (/8 # CmdNativeFunction/14 # GN-Local/19 (/26 e.new#30/36 )/27 t.new#28/34 e.new#29/38 )/9 e.new#31/40 >/1
              ...
              if( ! refalrts::ident_term( identifiers[ident_GNm_Local], context[19] ) )
                continue;
              // closed e.new#30 as range 36
              // closed e.new#29 as range 38
              // closed e.new#31 as range 40
              do {
                // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 # GN-Local/19 (/26 e.3#0/42 )/27 s.LineNumber#1/34 e.4#0/44 )/9 e.Tail#1/46 >/1
                context[42] = context[36];
                context[43] = context[37];
                context[44] = context[38];
                context[45] = context[39];
                ...
                refalrts::reset_allocator(vm);
                //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: </19 HalfReuse: & DisplayName/26 AsIs: e.3#0/42 HalfReuse: >/27 }" :: native {"/48 >/50 </51 & Putout/52 s.FileHandle#2/5/53"  #line "/54 </56 & Symb/57 Tile{ AsIs: s.LineNumber#1/34 } >/58 >/59 </60 & Putout/61 s.FileHandle#2/5/62"    ======================================"/63 >/65 </66 & Map@4/67 s.FileHandle#2/5/68 Tile{ AsIs: e.4#0/44 } >/69 </70 & Putout/71 s.FileHandle#2/5/72"    ======================================"/73 >/75 </76 & Putout/77 s.FileHandle#2/5/78"  }\n"/79 >/81 </82 & Map@2/83 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/46 AsIs: >/1 ]] }
              ...
              do {
                // </0 & Map@2/4 s.new#32/5 (/8 # CmdNativeFunction/14 # GN-Local/19 (/26 e.new#37/42 )/27 (/34 s.new#33/50 t.new#34/51 e.new#35/48 )/35 e.new#36/44 )/9 e.new#38/46 >/1
                context[42] = context[36];
                context[43] = context[37];
                context[44] = context[38];
                context[45] = context[39];
                ...
                // closed e.new#36 as range 44
                // closed e.new#38 as range 46
                ...
                do {
                  // </0 & Map@2/4 s.new#39/5 (/8 # CmdNativeFunction/14 # GN-Local/19 (/26 e.new#44/53 )/27 (/34 s.new#40/50 s.new#41/51 e.new#42/55 )/35 e.new#43/57 )/9 e.new#45/59 >/1
                  ...
                  if( ! refalrts::svar_term( context[51], context[51] ) )
                    continue;
                  // closed e.new#44 as range 53
                  // closed e.new#42 as range 55
                  // closed e.new#43 as range 57
                  // closed e.new#45 as range 59
                  do {
                    // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 # GN-Local/19 (/26 e.3#0/61 )/27 (/34 # FileLine/50 s.Line#1/51 e.1#0/63 )/35 e.4#0/65 )/9 e.Tail#1/67 >/1
                    ...
                    if( ! refalrts::ident_term( identifiers[ident_FileLine], context[50] ) )
                      continue;
                    // closed e.3#0 as range 61
                    // closed e.1#0 as range 63
                    // closed e.4#0 as range 65
                    ...
                    refalrts::reset_allocator(vm);
                    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: </19 HalfReuse: & DisplayName/26 AsIs: e.3#0/61 HalfReuse: >/27 HalfReuse: ' '/34 HalfReuse: ':'/50 }": n"/69 Tile{ HalfReuse: 'a'/35 }"tive {"/71 >/73 </74 & Putout/75 s.FileHandle#2/5/76"  #line "/77 </79 & Symb/80 Tile{ AsIs: s.Line#1/51 } >/81" \""/82 </84 & EscapeString/85 Tile{ AsIs: e.1#0/63 } >/86 '\"'/87 >/88 </89 & Putout/90 s.FileHandle#2/5/91"    ======================================"/92 >/94 </95 & Map@4/96 s.FileHandle#2/5/97 Tile{ AsIs: e.4#0/65 } >/98 </99 & Putout/100 s.FileHandle#2/5/101"    ======================================"/102 >/104 </105 & Putout/106 s.FileHandle#2/5/107"  }\n"/108 >/110 </111 & Map@2/112 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/67 AsIs: >/1 ]] }
                  ...
                  // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 # GN-Local/19 (/26 e.3#0/61 )/27 (/34 # RowCol/50 s.Row#1/51 s.Col#1/69 )/35 e.4#0/65 )/9 e.Tail#1/67 >/1
                  context[61] = context[53];
                  context[62] = context[54];
                  context[63] = context[55];
                  context[64] = context[56];
                  ...
                  refalrts::reset_allocator(vm);
                  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: </19 HalfReuse: & DisplayName/26 AsIs: e.3#0/61 HalfReuse: >/27 HalfReuse: ' '/34 HalfReuse: ':'/50 }": native {"/70 >/72 </73 & Putout/74 s.FileHandle#2/5/75"  #line "/76 </78 & Symb/79 Tile{ AsIs: s.Row#1/51 } >/80 ':'/81 </82 & Symb/83 Tile{ AsIs: s.Col#1/69 HalfReuse: >/35 } >/84 </85 & Putout/86 s.FileHandle#2/5/87"    ======================================"/88 >/90 </91 & Map@4/92 s.FileHandle#2/5/93 Tile{ AsIs: e.4#0/65 } >/94 </95 & Putout/96 s.FileHandle#2/5/97"    ======================================"/98 >/100 </101 & Putout/102 s.FileHandle#2/5/103"  }\n"/104 >/106 </107 & Map@2/108 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/67 AsIs: >/1 ]] }
                ...
                // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 # GN-Local/19 (/26 e.3#0/53 )/27 (/34 # FileRowCol/50 (/51 s.Row#1/63 s.Col#1/64 )/52 e.1#0/55 )/35 e.4#0/57 )/9 e.Tail#1/59 >/1
                context[53] = context[42];
                context[54] = context[43];
                context[55] = context[48];
                context[56] = context[49];
                ...
                refalrts::reset_allocator(vm);
                //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: </19 HalfReuse: & DisplayName/26 AsIs: e.3#0/53 HalfReuse: >/27 HalfReuse: ' '/34 HalfReuse: ':'/50 HalfReuse: ':'/51 }" native {"/65 >/67 </68 & Putout/69 s.FileHandle#2/5/70"  #line "/71 </73 & Symb/74 Tile{ AsIs: s.Row#1/63 } >/75 ':'/76 </77 & Symb/78 Tile{ AsIs: s.Col#1/64 } >/79" \""/80 </82 Tile{ HalfReuse: & EscapeString/52 AsIs: e.1#0/55 HalfReuse: >/35 } '\"'/83 >/84 </85 & Putout/86 s.FileHandle#2/5/87"    ======================================"/88 >/90 </91 & Map@4/92 s.FileHandle#2/5/93 Tile{ AsIs: e.4#0/57 } >/94 </95 & Putout/96 s.FileHandle#2/5/97"    ======================================"/98 >/100 </101 & Putout/102 s.FileHandle#2/5/103"  }\n"/104 >/106 </107 & Map@2/108 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/59 AsIs: >/1 ]] }
              ...
              // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 # GN-Local/19 (/26 e.3#0/42 )/27 t.2#0/34 e.4#0/44 )/9 e.Tail#1/46 >/1
              context[42] = context[36];
              context[43] = context[37];
              context[44] = context[38];
              context[45] = context[39];
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: </19 HalfReuse: & DisplayName/26 AsIs: e.3#0/42 HalfReuse: >/27 }" :: native {"/48 >/50 </51 & Putout/52 s.FileHandle#2/5/53"  "/54 </56 & SrcPos*4/57 Tile{ AsIs: t.2#0/34 } >/58 >/59 </60 & Putout/61 s.FileHandle#2/5/62"    ======================================"/63 >/65 </66 & Map@4/67 s.FileHandle#2/5/68 Tile{ AsIs: e.4#0/44 } >/69 </70 & Putout/71 s.FileHandle#2/5/72"    ======================================"/73 >/75 </76 & Putout/77 s.FileHandle#2/5/78"  }\n"/79 >/81 </82 & Map@2/83 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/46 AsIs: >/1 ]] }
              refalrts::alloc_chars(vm, context[48], context[49], " :: native {", 12);
              refalrts::alloc_close_call(vm, context[50]);
              refalrts::alloc_open_call(vm, context[51]);
              refalrts::alloc_name(vm, context[52], functions[efunc_Putout]);
            ...
            do {
              // </0 & Map@2/4 s.new#27/5 (/8 # CmdNativeFunction/14 # GN-Entry/19 (/26 e.new#30/36 )/27 t.new#28/34 e.new#29/38 )/9 e.new#31/40 >/1
              context[36] = context[28];
              context[37] = context[29];
              context[38] = context[30];
              context[39] = context[31];
              ...
              // closed e.new#31 as range 40
              do {
                // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 # GN-Entry/19 (/26 e.3#0/42 )/27 s.LineNumber#1/34 e.4#0/44 )/9 e.Tail#1/46 >/1
                context[42] = context[36];
                context[43] = context[37];
                context[44] = context[38];
                context[45] = context[39];
                ...
                refalrts::reset_allocator(vm);
                //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: '$'/19 HalfReuse: 'E'/26 }"NTRY "/48 </50 & DisplayName/51 Tile{ AsIs: e.3#0/42 } >/52" :: native {"/53 >/55 </56 & Putout/57 s.FileHandle#2/5/58"  #line "/59 </61 Tile{ HalfReuse: & Symb/27 AsIs: s.LineNumber#1/34 } >/62 >/63 </64 & Putout/65 s.FileHandle#2/5/66"    ======================================"/67 >/69 </70 & Map@4/71 s.FileHandle#2/5/72 Tile{ AsIs: e.4#0/44 } >/73 </74 & Putout/75 s.FileHandle#2/5/76"    ======================================"/77 >/79 </80 & Putout/81 s.FileHandle#2/5/82"  }\n"/83 >/85 </86 & Map@2/87 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/46 AsIs: >/1 ]] }
              ...
              do {
                // </0 & Map@2/4 s.new#32/5 (/8 # CmdNativeFunction/14 # GN-Entry/19 (/26 e.new#37/42 )/27 (/34 s.new#33/50 t.new#34/51 e.new#35/48 )/35 e.new#36/44 )/9 e.new#38/46 >/1
                context[42] = context[36];
                context[43] = context[37];
                context[44] = context[38];
                context[45] = context[39];
                ...
                // closed e.new#35 as range 48
                do {
                  // </0 & Map@2/4 s.new#39/5 (/8 # CmdNativeFunction/14 # GN-Entry/19 (/26 e.new#44/53 )/27 (/34 s.new#40/50 s.new#41/51 e.new#42/55 )/35 e.new#43/57 )/9 e.new#45/59 >/1
                  context[53] = context[42];
                  context[54] = context[43];
                  context[55] = context[48];
                  context[56] = context[49];
                  ...
                  // closed e.new#45 as range 59
                  do {
                    // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 # GN-Entry/19 (/26 e.3#0/61 )/27 (/34 # FileLine/50 s.Line#1/51 e.1#0/63 )/35 e.4#0/65 )/9 e.Tail#1/67 >/1
                    context[61] = context[53];
                    context[62] = context[54];
                    context[63] = context[55];
                    context[64] = context[56];
                    ...
                    refalrts::reset_allocator(vm);
                    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: '$'/19 HalfReuse: 'E'/26 }"NTRY"/69 Tile{ HalfReuse: ' '/35 } </71 & DisplayName/72 Tile{ AsIs: e.3#0/61 } >/73" :: native {"/74 >/76 </77 & Putout/78 s.FileHandle#2/5/79"  #line"/80 Tile{ HalfReuse: ' '/27 HalfReuse: </34 HalfReuse: & Symb/50 AsIs: s.Line#1/51 } >/82" \""/83 </85 & EscapeString/86 Tile{ AsIs: e.1#0/63 } >/87 '\"'/88 >/89 </90 & Putout/91 s.FileHandle#2/5/92"    ======================================"/93 >/95 </96 & Map@4/97 s.FileHandle#2/5/98 Tile{ AsIs: e.4#0/65 } >/99 </100 & Putout/101 s.FileHandle#2/5/102"    ======================================"/103 >/105 </106 & Putout/107 s.FileHandle#2/5/108"  }\n"/109 >/111 </112 & Map@2/113 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/67 AsIs: >/1 ]] }
                  ...
                  // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 # GN-Entry/19 (/26 e.3#0/61 )/27 (/34 # RowCol/50 s.Row#1/51 s.Col#1/69 )/35 e.4#0/65 )/9 e.Tail#1/67 >/1
                  context[61] = context[53];
                  context[62] = context[54];
                  context[63] = context[55];
                  context[64] = context[56];
                  ...
                  refalrts::reset_allocator(vm);
                  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: '$'/19 HalfReuse: 'E'/26 }"NTRY "/70 </72 & DisplayName/73 Tile{ AsIs: e.3#0/61 } >/74" :: native {"/75 >/77 </78 & Putout/79 s.FileHandle#2/5/80"  #line"/81 Tile{ HalfReuse: ' '/27 HalfReuse: </34 HalfReuse: & Symb/50 AsIs: s.Row#1/51 } >/83 ':'/84 </85 & Symb/86 Tile{ AsIs: s.Col#1/69 HalfReuse: >/35 } >/87 </88 & Putout/89 s.FileHandle#2/5/90"    ======================================"/91 >/93 </94 & Map@4/95 s.FileHandle#2/5/96 Tile{ AsIs: e.4#0/65 } >/97 </98 & Putout/99 s.FileHandle#2/5/100"    ======================================"/101 >/103 </104 & Putout/105 s.FileHandle#2/5/106"  }\n"/107 >/109 </110 & Map@2/111 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/67 AsIs: >/1 ]] }
                ...
                // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 # GN-Entry/19 (/26 e.3#0/53 )/27 (/34 # FileRowCol/50 (/51 s.Row#1/63 s.Col#1/64 )/52 e.1#0/55 )/35 e.4#0/57 )/9 e.Tail#1/59 >/1
                context[53] = context[42];
                context[54] = context[43];
                context[55] = context[48];
                context[56] = context[49];
                ...
                refalrts::reset_allocator(vm);
                //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: '$'/19 HalfReuse: 'E'/26 }"NTRY "/65 </67 & DisplayName/68 Tile{ AsIs: e.3#0/53 } >/69" :: native {"/70 >/72 </73 & Putout/74 s.FileHandle#2/5/75"  #lin"/76 Tile{ HalfReuse: 'e'/27 HalfReuse: ' '/34 HalfReuse: </50 HalfReuse: & Symb/51 AsIs: s.Row#1/63 } >/78 ':'/79 </80 & Symb/81 Tile{ AsIs: s.Col#1/64 } >/82" \""/83 </85 Tile{ HalfReuse: & EscapeString/52 AsIs: e.1#0/55 HalfReuse: >/35 } '\"'/86 >/87 </88 & Putout/89 s.FileHandle#2/5/90"    ======================================"/91 >/93 </94 & Map@4/95 s.FileHandle#2/5/96 Tile{ AsIs: e.4#0/57 } >/97 </98 & Putout/99 s.FileHandle#2/5/100"    ======================================"/101 >/103 </104 & Putout/105 s.FileHandle#2/5/106"  }\n"/107 >/109 </110 & Map@2/111 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/59 AsIs: >/1 ]] }
              ...
              // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 # GN-Entry/19 (/26 e.3#0/42 )/27 t.2#0/34 e.4#0/44 )/9 e.Tail#1/46 >/1
              context[42] = context[36];
              context[43] = context[37];
              context[44] = context[38];
              context[45] = context[39];
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: '$'/19 HalfReuse: 'E'/26 }"NTRY "/48 </50 & DisplayName/51 Tile{ AsIs: e.3#0/42 } >/52" :: native {"/53 >/55 </56 & Putout/57 s.FileHandle#2/5/58"  "/59 </61 Tile{ HalfReuse: & SrcPos*4/27 AsIs: t.2#0/34 } >/62 >/63 </64 & Putout/65 s.FileHandle#2/5/66"    ======================================"/67 >/69 </70 & Map@4/71 s.FileHandle#2/5/72 Tile{ AsIs: e.4#0/44 } >/73 </74 & Putout/75 s.FileHandle#2/5/76"    ======================================"/77 >/79 </80 & Putout/81 s.FileHandle#2/5/82"  }\n"/83 >/85 </86 & Map@2/87 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/46 AsIs: >/1 ]] }
              refalrts::alloc_chars(vm, context[48], context[49], "NTRY ", 5);
              refalrts::alloc_open_call(vm, context[50]);
              refalrts::alloc_name(vm, context[51], functions[efunc_DisplayName]);
              refalrts::alloc_close_call(vm, context[52]);
            ...
            do {
              // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 s.ScopeClass#1/19 (/26 e.3#0/36 )/27 s.LineNumber#1/34 e.4#0/38 )/9 e.Tail#1/40 >/1
              context[36] = context[28];
              context[37] = context[29];
              context[38] = context[30];
              context[39] = context[31];
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: </8 HalfReuse: & FnName*2/14 AsIs: s.ScopeClass#1/19 } Tile{ AsIs: e.3#0/36 } >/42 ' '/43 Tile{ HalfReuse: ':'/26 }": native {"/44 >/46 </47 & Putout/48 s.FileHandle#2/5/49"  #line "/50 </52 Tile{ HalfReuse: & Symb/27 AsIs: s.LineNumber#1/34 } >/53 >/54 </55 & Putout/56 s.FileHandle#2/5/57"    ======================================"/58 >/60 </61 & Map@4/62 s.FileHandle#2/5/63 Tile{ AsIs: e.4#0/38 } >/64 </65 & Putout/66 s.FileHandle#2/5/67"    ======================================"/68 >/70 </71 & Putout/72 s.FileHandle#2/5/73"  }\n"/74 >/76 </77 & Map@2/78 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/40 AsIs: >/1 ]] }
              refalrts::alloc_close_call(vm, context[42]);
            ...
            do {
              // </0 & Map@2/4 s.new#27/5 (/8 # CmdNativeFunction/14 s.new#28/19 (/26 e.new#33/36 )/27 (/34 s.new#29/44 t.new#30/45 e.new#31/42 )/35 e.new#32/38 )/9 e.new#34/40 >/1
              context[36] = context[28];
              context[37] = context[29];
              context[38] = context[30];
              context[39] = context[31];
              ...
              // closed e.new#32 as range 38
              // closed e.new#34 as range 40
              ...
              do {
                // </0 & Map@2/4 s.new#35/5 (/8 # CmdNativeFunction/14 s.new#36/19 (/26 e.new#41/47 )/27 (/34 s.new#37/44 s.new#38/45 e.new#39/49 )/35 e.new#40/51 )/9 e.new#42/53 >/1
                ...
                if( ! refalrts::svar_term( context[45], context[45] ) )
                  continue;
                // closed e.new#41 as range 47
                // closed e.new#39 as range 49
                // closed e.new#40 as range 51
                // closed e.new#42 as range 53
                do {
                  // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 s.ScopeClass#1/19 (/26 e.3#0/55 )/27 (/34 # FileLine/44 s.Line#1/45 e.1#0/57 )/35 e.4#0/59 )/9 e.Tail#1/61 >/1
                  ...
                  if( ! refalrts::ident_term( identifiers[ident_FileLine], context[44] ) )
                    continue;
                  // closed e.3#0 as range 55
                  // closed e.1#0 as range 57
                  ...
                  refalrts::reset_allocator(vm);
                  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: </8 HalfReuse: & FnName*2/14 AsIs: s.ScopeClass#1/19 } Tile{ AsIs: e.3#0/55 } Tile{ HalfReuse: >/26 }" ::"/63 Tile{ HalfReuse: ' '/35 }"native {"/65 >/67 </68 & Putout/69 s.FileHandle#2/5/70"  #line"/71 Tile{ HalfReuse: ' '/27 HalfReuse: </34 HalfReuse: & Symb/44 AsIs: s.Line#1/45 } >/73" \""/74 </76 & EscapeString/77 Tile{ AsIs: e.1#0/57 } >/78 '\"'/79 >/80 </81 & Putout/82 s.FileHandle#2/5/83"    ======================================"/84 >/86 </87 & Map@4/88 s.FileHandle#2/5/89 Tile{ AsIs: e.4#0/59 } >/90 </91 & Putout/92 s.FileHandle#2/5/93"    ======================================"/94 >/96 </97 & Putout/98 s.FileHandle#2/5/99"  }\n"/100 >/102 </103 & Map@2/104 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/61 AsIs: >/1 ]] }
                ...
                // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 s.ScopeClass#1/19 (/26 e.3#0/55 )/27 (/34 # RowCol/44 s.Row#1/45 s.Col#1/63 )/35 e.4#0/59 )/9 e.Tail#1/61 >/1
                context[55] = context[47];
                context[56] = context[48];
                context[57] = context[49];
                context[58] = context[50];
                ...
                refalrts::reset_allocator(vm);
                //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
                //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: </8 HalfReuse: & FnName*2/14 AsIs: s.ScopeClass#1/19 } Tile{ AsIs: e.3#0/55 } >/64 ' '/65 Tile{ HalfReuse: ':'/26 }": native {"/66 >/68 </69 & Putout/70 s.FileHandle#2/5/71"  #line"/72 Tile{ HalfReuse: ' '/27 HalfReuse: </34 HalfReuse: & Symb/44 AsIs: s.Row#1/45 } >/74 ':'/75 </76 & Symb/77 Tile{ AsIs: s.Col#1/63 HalfReuse: >/35 } >/78 </79 & Putout/80 s.FileHandle#2/5/81"    ======================================"/82 >/84 </85 & Map@4/86 s.FileHandle#2/5/87 Tile{ AsIs: e.4#0/59 } >/88 </89 & Putout/90 s.FileHandle#2/5/91"    ======================================"/92 >/94 </95 & Putout/96 s.FileHandle#2/5/97"  }\n"/98 >/100 </101 & Map@2/102 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/61 AsIs: >/1 ]] }
                refalrts::alloc_close_call(vm, context[64]);
              ...
              // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 s.ScopeClass#1/19 (/26 e.3#0/47 )/27 (/34 # FileRowCol/44 (/45 s.Row#1/57 s.Col#1/58 )/46 e.1#0/49 )/35 e.4#0/51 )/9 e.Tail#1/53 >/1
              context[47] = context[36];
              context[48] = context[37];
              context[49] = context[42];
              context[50] = context[43];
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: </8 HalfReuse: & FnName*2/14 AsIs: s.ScopeClass#1/19 } Tile{ AsIs: e.3#0/47 } >/59" :"/60 Tile{ HalfReuse: ':'/26 }" native {"/62 >/64 </65 & Putout/66 s.FileHandle#2/5/67"  #lin"/68 Tile{ HalfReuse: 'e'/27 HalfReuse: ' '/34 HalfReuse: </44 HalfReuse: & Symb/45 AsIs: s.Row#1/57 } >/70 ':'/71 </72 & Symb/73 Tile{ AsIs: s.Col#1/58 } >/74" \""/75 </77 Tile{ HalfReuse: & EscapeString/46 AsIs: e.1#0/49 HalfReuse: >/35 } '\"'/78 >/79 </80 & Putout/81 s.FileHandle#2/5/82"    ======================================"/83 >/85 </86 & Map@4/87 s.FileHandle#2/5/88 Tile{ AsIs: e.4#0/51 } >/89 </90 & Putout/91 s.FileHandle#2/5/92"    ======================================"/93 >/95 </96 & Putout/97 s.FileHandle#2/5/98"  }\n"/99 >/101 </102 & Map@2/103 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/53 AsIs: >/1 ]] }
              refalrts::alloc_close_call(vm, context[59]);
            ...
            // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdNativeFunction/14 s.ScopeClass#1/19 (/26 e.3#0/36 )/27 t.2#0/34 e.4#0/38 )/9 e.Tail#1/40 >/1
            context[36] = context[28];
            context[37] = context[29];
            context[38] = context[30];
            context[39] = context[31];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: </8 HalfReuse: & FnName*2/14 AsIs: s.ScopeClass#1/19 } Tile{ AsIs: e.3#0/36 } >/42 ' '/43 Tile{ HalfReuse: ':'/26 }": native {"/44 >/46 </47 & Putout/48 s.FileHandle#2/5/49"  "/50 </52 Tile{ HalfReuse: & SrcPos*4/27 AsIs: t.2#0/34 } >/53 >/54 </55 & Putout/56 s.FileHandle#2/5/57"    ======================================"/58 >/60 </61 & Map@4/62 s.FileHandle#2/5/63 Tile{ AsIs: e.4#0/38 } >/64 </65 & Putout/66 s.FileHandle#2/5/67"    ======================================"/68 >/70 </71 & Putout/72 s.FileHandle#2/5/73"  }\n"/74 >/76 </77 & Map@2/78 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/40 AsIs: >/1 ]] }
            refalrts::alloc_close_call(vm, context[42]);
            refalrts::alloc_char(vm, context[43], ' ');
            refalrts::alloc_chars(vm, context[44], context[45], ": native {", 10);
            refalrts::alloc_close_call(vm, context[46]);
          ...
          // </0 & Map@2/4 s.new#21/5 (/8 # CmdMetatable/14 s.new#22/19 (/26 e.new#24/28 )/27 e.new#23/30 )/9 e.new#25/32 >/1
          context[28] = context[24];
          context[29] = context[25];
          context[30] = context[20];
          context[31] = context[21];
          ...
          // closed e.new#25 as range 32
          do {
            // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdMetatable/14 # GN-Local/19 (/26 e.3#0/34 )/27 e.2#0/36 )/9 e.Tail#1/38 >/1
            context[34] = context[28];
            context[35] = context[29];
            context[36] = context[30];
            context[37] = context[31];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: </19 HalfReuse: & DisplayName/26 AsIs: e.3#0/34 HalfReuse: >/27 }" :: metatable {"/40 >/42 </43 & Map@5/44 s.FileHandle#2/5/45 Tile{ AsIs: e.2#0/36 } >/46 </47 & Putout/48 s.FileHandle#2/5/49"  }\n"/50 >/52 </53 & Map@2/54 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/38 AsIs: >/1 ]] }
          ...
          do {
            // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdMetatable/14 # GN-Entry/19 (/26 e.3#0/34 )/27 e.2#0/36 )/9 e.Tail#1/38 >/1
            context[34] = context[28];
            context[35] = context[29];
            context[36] = context[30];
            context[37] = context[31];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: '$'/19 HalfReuse: 'E'/26 }"NT"/40 Tile{ HalfReuse: 'R'/27 }"Y "/42 </44 & DisplayName/45 Tile{ AsIs: e.3#0/34 } >/46" :: metatable {"/47 >/49 </50 & Map@5/51 s.FileHandle#2/5/52 Tile{ AsIs: e.2#0/36 } >/53 </54 & Putout/55 s.FileHandle#2/5/56"  }\n"/57 >/59 </60 & Map@2/61 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/38 AsIs: >/1 ]] }
            refalrts::alloc_chars(vm, context[40], context[41], "NT", 2);
            refalrts::alloc_chars(vm, context[42], context[43], "Y ", 2);
            refalrts::alloc_open_call(vm, context[44]);
            refalrts::alloc_name(vm, context[45], functions[efunc_DisplayName]);
          ...
          // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdMetatable/14 s.ScopeClass#1/19 (/26 e.3#0/34 )/27 e.2#0/36 )/9 e.Tail#1/38 >/1
          context[34] = context[28];
          context[35] = context[29];
          context[36] = context[30];
          context[37] = context[31];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: </8 HalfReuse: & FnName*2/14 AsIs: s.ScopeClass#1/19 } Tile{ AsIs: e.3#0/34 } Tile{ HalfReuse: >/26 } Tile{ HalfReuse: ' '/27 }":: metatable {"/40 >/42 </43 & Map@5/44 s.FileHandle#2/5/45 Tile{ AsIs: e.2#0/36 } >/46 </47 & Putout/48 s.FileHandle#2/5/49"  }\n"/50 >/52 </53 & Map@2/54 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/38 AsIs: >/1 ]] }
        ...
        do {
          // </0 & Map@2/4 s.new#15/5 (/8 # CmdEnum/14 s.new#16/19 e.new#17/20 )/9 e.new#18/22 >/1
          context[20] = context[15];
          context[21] = context[16];
          context[22] = context[17];
          context[23] = context[18];
          ...
          do {
            // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdEnum/14 # GN-Local/19 e.1#0/24 )/9 e.Tail#1/26 >/1
            context[24] = context[20];
            context[25] = context[21];
            context[26] = context[22];
            context[27] = context[23];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: </19 } & DisplayName/28 Tile{ AsIs: e.1#0/24 } >/29" :: enum"/30 >/32 </33 & Map@2/34 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/26 AsIs: >/1 ]] }
          ...
          do {
            // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdEnum/14 # GN-Entry/19 e.1#0/24 )/9 e.Tail#1/26 >/1
            context[24] = context[20];
            context[25] = context[21];
            context[26] = context[22];
            context[27] = context[23];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: '$'/19 }"ENTRY "/28 </30 & DisplayName/31 Tile{ AsIs: e.1#0/24 } >/32" :: enum"/33 >/35 </36 & Map@2/37 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/26 AsIs: >/1 ]] }
          ...
          // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdEnum/14 s.ScopeClass#1/19 e.1#0/24 )/9 e.Tail#1/26 >/1
          context[24] = context[20];
          context[25] = context[21];
          context[26] = context[22];
          context[27] = context[23];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: </8 HalfReuse: & FnName*2/14 AsIs: s.ScopeClass#1/19 AsIs: e.1#0/24 HalfReuse: >/9 }" :: enum"/28 >/30 </31 & Map@2/32 s.FileHandle#2/5/33 Tile{ AsIs: e.Tail#1/26 } Tile{ AsIs: >/1 ]] }
        ...
        do {
          // </0 & Map@2/4 s.new#15/5 (/8 # CmdSwap/14 s.new#16/19 e.new#17/20 )/9 e.new#18/22 >/1
          context[20] = context[15];
          context[21] = context[16];
          context[22] = context[17];
          context[23] = context[18];
          ...
          // closed e.new#18 as range 22
          do {
            // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdSwap/14 # GN-Local/19 e.1#0/24 )/9 e.Tail#1/26 >/1
            context[24] = context[20];
            context[25] = context[21];
            context[26] = context[22];
            context[27] = context[23];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: </19 } & DisplayName/28 Tile{ AsIs: e.1#0/24 } >/29" :: swap"/30 >/32 </33 & Map@2/34 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/26 AsIs: >/1 ]] }
            refalrts::alloc_name(vm, context[28], functions[efunc_DisplayName]);
            refalrts::alloc_close_call(vm, context[29]);
          ...
          do {
            // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdSwap/14 # GN-Entry/19 e.1#0/24 )/9 e.Tail#1/26 >/1
            context[24] = context[20];
            context[25] = context[21];
            context[26] = context[22];
            context[27] = context[23];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: '$'/19 }"ENTRY "/28 </30 & DisplayName/31 Tile{ AsIs: e.1#0/24 } >/32" :: swap"/33 >/35 </36 & Map@2/37 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/26 AsIs: >/1 ]] }
            refalrts::alloc_chars(vm, context[28], context[29], "ENTRY ", 6);
            refalrts::alloc_open_call(vm, context[30]);
            refalrts::alloc_name(vm, context[31], functions[efunc_DisplayName]);
            refalrts::alloc_close_call(vm, context[32]);
          ...
          // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdSwap/14 s.ScopeClass#1/19 e.1#0/24 )/9 e.Tail#1/26 >/1
          context[24] = context[20];
          context[25] = context[21];
          context[26] = context[22];
          context[27] = context[23];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: </8 HalfReuse: & FnName*2/14 AsIs: s.ScopeClass#1/19 AsIs: e.1#0/24 HalfReuse: >/9 }" :: swap"/28 >/30 </31 & Map@2/32 s.FileHandle#2/5/33 Tile{ AsIs: e.Tail#1/26 } Tile{ AsIs: >/1 ]] }
        ...
        do {
          // </0 & Map@2/4 s.new#15/5 (/8 # CmdConditionFunc/14 s.new#16/19 e.new#17/20 )/9 e.new#18/22 >/1
          context[20] = context[15];
          context[21] = context[16];
          context[22] = context[17];
          context[23] = context[18];
          ...
          // closed e.new#18 as range 22
          do {
            // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdConditionFunc/14 # GN-Local/19 e.1#0/24 )/9 e.Tail#1/26 >/1
            context[24] = context[20];
            context[25] = context[21];
            context[26] = context[22];
            context[27] = context[23];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: </19 } & DisplayName/28 Tile{ AsIs: e.1#0/24 } >/29" :: condition"/30 >/32 </33 & Map@2/34 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/26 AsIs: >/1 ]] }
            refalrts::alloc_name(vm, context[28], functions[efunc_DisplayName]);
            refalrts::alloc_close_call(vm, context[29]);
          ...
          do {
            // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdConditionFunc/14 # GN-Entry/19 e.1#0/24 )/9 e.Tail#1/26 >/1
            context[24] = context[20];
            context[25] = context[21];
            context[26] = context[22];
            context[27] = context[23];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: '$'/19 }"ENTRY "/28 </30 & DisplayName/31 Tile{ AsIs: e.1#0/24 } >/32" :: condition"/33 >/35 </36 & Map@2/37 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/26 AsIs: >/1 ]] }
            refalrts::alloc_chars(vm, context[28], context[29], "ENTRY ", 6);
            refalrts::alloc_open_call(vm, context[30]);
            refalrts::alloc_name(vm, context[31], functions[efunc_DisplayName]);
            refalrts::alloc_close_call(vm, context[32]);
          ...
          // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdConditionFunc/14 s.ScopeClass#1/19 e.1#0/24 )/9 e.Tail#1/26 >/1
          context[24] = context[20];
          context[25] = context[21];
          context[26] = context[22];
          context[27] = context[23];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: </8 HalfReuse: & FnName*2/14 AsIs: s.ScopeClass#1/19 AsIs: e.1#0/24 HalfReuse: >/9 }" :: condition"/28 >/30 </31 & Map@2/32 s.FileHandle#2/5/33 Tile{ AsIs: e.Tail#1/26 } Tile{ AsIs: >/1 ]] }
        ...
        // </0 & Map@2/4 s.new#15/5 (/8 # CmdDeclaration/14 s.new#16/19 e.new#17/20 )/9 e.new#18/22 >/1
        context[20] = context[15];
        context[21] = context[16];
        context[22] = context[17];
        context[23] = context[18];
        ...
        // closed e.new#18 as range 22
        do {
          // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdDeclaration/14 # GN-Local/19 e.1#0/24 )/9 e.Tail#1/26 >/1
          context[24] = context[20];
          context[25] = context[21];
          context[26] = context[22];
          context[27] = context[23];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: </19 } & DisplayName/28 Tile{ AsIs: e.1#0/24 } >/29" :: extern"/30 >/32 </33 & Map@2/34 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/26 AsIs: >/1 ]] }
          refalrts::alloc_name(vm, context[28], functions[efunc_DisplayName]);
          refalrts::alloc_close_call(vm, context[29]);
        ...
        do {
          // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdDeclaration/14 # GN-Entry/19 e.1#0/24 )/9 e.Tail#1/26 >/1
          context[24] = context[20];
          context[25] = context[21];
          context[26] = context[22];
          context[27] = context[23];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: '$'/19 }"ENTRY "/28 </30 & DisplayName/31 Tile{ AsIs: e.1#0/24 } >/32" :: extern"/33 >/35 </36 & Map@2/37 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/26 AsIs: >/1 ]] }
          refalrts::alloc_chars(vm, context[28], context[29], "ENTRY ", 6);
          refalrts::alloc_open_call(vm, context[30]);
          refalrts::alloc_name(vm, context[31], functions[efunc_DisplayName]);
          refalrts::alloc_close_call(vm, context[32]);
        ...
        // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdDeclaration/14 s.ScopeClass#1/19 e.1#0/24 )/9 e.Tail#1/26 >/1
        context[24] = context[20];
        context[25] = context[21];
        context[26] = context[22];
        context[27] = context[23];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: </8 HalfReuse: & FnName*2/14 AsIs: s.ScopeClass#1/19 AsIs: e.1#0/24 HalfReuse: >/9 }" :: extern"/28 >/30 </31 & Map@2/32 s.FileHandle#2/5/33 Tile{ AsIs: e.Tail#1/26 } Tile{ AsIs: >/1 ]] }
      ...
      do {
        // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdDefineIdent/14 e.0#0/15 )/9 e.Tail#1/17 >/1
        context[15] = context[12];
        context[16] = context[13];
        context[17] = context[10];
        context[18] = context[11];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: '$'/8 HalfReuse: 'L'/14 }"ABEL "/19 </21 & DisplayName/22 Tile{ AsIs: e.0#0/15 } >/23 >/24 </25 & Map@2/26 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/17 AsIs: >/1 ]] }
      ...
      // </0 & Map@2/4 s.new#10/5 (/8 s.new#11/14 t.new#12/19 e.new#13/15 )/9 e.new#14/17 >/1
      context[15] = context[12];
      context[16] = context[13];
      context[17] = context[10];
      context[18] = context[11];
      ...
      // closed e.new#13 as range 15
      do {
        // </0 & Map@2/4 s.new#15/5 (/8 # CmdEmitNativeCode/14 t.new#16/19 e.new#17/21 )/9 e.new#18/23 >/1
        ...
        do {
          // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdEmitNativeCode/14 s.LineNumber#1/19 e.1#0/25 )/9 e.Tail#1/27 >/1
          context[25] = context[21];
          context[26] = context[22];
          context[27] = context[23];
          context[28] = context[24];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: 'N'/8 HalfReuse: 'a'/14 }"tive code:"/29 >/31 </32 & Putout/33 s.FileHandle#2/5/34"  #line "/35 </37 & Symb/38 Tile{ AsIs: s.LineNumber#1/19 } >/39 >/40 </41 & Putout/42 s.FileHandle#2/5/43"    ======================================"/44 >/46 </47 & Map@4/48 s.FileHandle#2/5/49 Tile{ AsIs: e.1#0/25 } >/50 </51 & Putout/52 s.FileHandle#2/5/53"    ======================================"/54 >/56 </57 & Putout/58 s.FileHandle#2/5/59 >/60 </61 & Map@2/62 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/27 AsIs: >/1 ]] }
        ...
        do {
          // </0 & Map@2/4 s.new#19/5 (/8 # CmdEmitNativeCode/14 (/19 s.new#20/31 t.new#21/32 e.new#22/29 )/20 e.new#23/25 )/9 e.new#24/27 >/1
          context[25] = context[21];
          context[26] = context[22];
          context[27] = context[23];
          context[28] = context[24];
          ...
          do {
            // </0 & Map@2/4 s.new#25/5 (/8 # CmdEmitNativeCode/14 (/19 s.new#26/31 s.new#27/32 e.new#28/34 )/20 e.new#29/36 )/9 e.new#30/38 >/1
            ...
            if( ! refalrts::svar_term( context[32], context[32] ) )
              continue;
            // closed e.new#28 as range 34
            // closed e.new#29 as range 36
            // closed e.new#30 as range 38
            do {
              // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdEmitNativeCode/14 (/19 # FileLine/31 s.Line#1/32 e.2#0/40 )/20 e.1#0/42 )/9 e.Tail#1/44 >/1
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: 'N'/8 HalfReuse: 'a'/14 HalfReuse: 't'/19 HalfReuse: 'i'/31 }"ve "/46 Tile{ HalfReuse: 'c'/20 }"ode:"/48 >/50 </51 & Putout/52 s.FileHandle#2/5/53"  #line "/54 </56 & Symb/57 Tile{ AsIs: s.Line#1/32 } >/58" \""/59 </61 & EscapeString/62 Tile{ AsIs: e.2#0/40 } >/63 '\"'/64 >/65 </66 & Putout/67 s.FileHandle#2/5/68"    ======================================"/69 >/71 </72 & Map@4/73 s.FileHandle#2/5/74 Tile{ AsIs: e.1#0/42 } >/75 </76 & Putout/77 s.FileHandle#2/5/78"    ======================================"/79 >/81 </82 & Putout/83 s.FileHandle#2/5/84 >/85 </86 & Map@2/87 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/44 AsIs: >/1 ]] }
            ...
            // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdEmitNativeCode/14 (/19 # RowCol/31 s.Row#1/32 s.Col#1/46 )/20 e.1#0/42 )/9 e.Tail#1/44 >/1
            context[40] = context[34];
            context[41] = context[35];
            context[42] = context[36];
            context[43] = context[37];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: 'N'/8 HalfReuse: 'a'/14 HalfReuse: 't'/19 HalfReuse: 'i'/31 }"ve code:"/47 >/49 </50 & Putout/51 s.FileHandle#2/5/52"  #line "/53 </55 & Symb/56 Tile{ AsIs: s.Row#1/32 } >/57 ':'/58 </59 & Symb/60 Tile{ AsIs: s.Col#1/46 HalfReuse: >/20 } >/61 </62 & Putout/63 s.FileHandle#2/5/64"    ======================================"/65 >/67 </68 & Map@4/69 s.FileHandle#2/5/70 Tile{ AsIs: e.1#0/42 } >/71 </72 & Putout/73 s.FileHandle#2/5/74"    ======================================"/75 >/77 </78 & Putout/79 s.FileHandle#2/5/80 >/81 </82 & Map@2/83 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/44 AsIs: >/1 ]] }
          ...
          // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdEmitNativeCode/14 (/19 # FileRowCol/31 (/32 s.Row#1/42 s.Col#1/43 )/33 e.2#0/34 )/20 e.1#0/36 )/9 e.Tail#1/38 >/1
          context[34] = context[29];
          context[35] = context[30];
          context[36] = context[25];
          context[37] = context[26];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: 'N'/8 HalfReuse: 'a'/14 HalfReuse: 't'/19 HalfReuse: 'i'/31 HalfReuse: 'v'/32 }"e code:"/44 >/46 </47 & Putout/48 s.FileHandle#2/5/49"  #line "/50 </52 & Symb/53 Tile{ AsIs: s.Row#1/42 } >/54 ':'/55 </56 & Symb/57 Tile{ AsIs: s.Col#1/43 } >/58" \""/59 </61 Tile{ HalfReuse: & EscapeString/33 AsIs: e.2#0/34 HalfReuse: >/20 } '\"'/62 >/63 </64 & Putout/65 s.FileHandle#2/5/66"    ======================================"/67 >/69 </70 & Map@4/71 s.FileHandle#2/5/72 Tile{ AsIs: e.1#0/36 } >/73 </74 & Putout/75 s.FileHandle#2/5/76"    ======================================"/77 >/79 </80 & Putout/81 s.FileHandle#2/5/82 >/83 </84 & Map@2/85 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/38 AsIs: >/1 ]] }
        ...
        // </0 & Map@2/4 s.FileHandle#2/5 (/8 # CmdEmitNativeCode/14 t.0#0/19 e.1#0/25 )/9 e.Tail#1/27 >/1
        context[25] = context[21];
        context[26] = context[22];
        context[27] = context[23];
        context[28] = context[24];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: 'N'/8 HalfReuse: 'a'/14 }"tive code:"/29 >/31 </32 & Putout/33 s.FileHandle#2/5/34"  "/35 </37 & SrcPos*4/38 Tile{ AsIs: t.0#0/19 } >/39 >/40 </41 & Putout/42 s.FileHandle#2/5/43"    ======================================"/44 >/46 </47 & Map@4/48 s.FileHandle#2/5/49 Tile{ AsIs: e.1#0/25 } >/50 </51 & Putout/52 s.FileHandle#2/5/53"    ======================================"/54 >/56 </57 & Putout/58 s.FileHandle#2/5/59 >/60 </61 & Map@2/62 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/27 AsIs: >/1 ]] }
        refalrts::alloc_chars(vm, context[29], context[30], "tive code:", 10);
        refalrts::alloc_close_call(vm, context[31]);
        refalrts::alloc_open_call(vm, context[32]);
        refalrts::alloc_name(vm, context[33], functions[efunc_Putout]);
      ...
      // </0 & Map@2/4 s.FileHandle#2/5 (/8 # Spec/14 (/19 e.2#0/25 )/20 e.1#0/21 )/9 e.Tail#1/23 >/1
      context[21] = context[15];
      context[22] = context[16];
      context[23] = context[17];
      context[24] = context[18];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#2/5 HalfReuse: '$'/8 HalfReuse: 'S'/14 HalfReuse: 'P'/19 }"EC"/27 Tile{ HalfReuse: ' '/20 } </29 & DisplayName/30 Tile{ AsIs: e.2#0/25 } >/31 >/32 </33 & Map@6/34 s.FileHandle#2/5/35 Tile{ AsIs: e.1#0/21 } >/36 </37 & Map@2/38 Tile{ HalfReuse: s.FileHandle2 #5/9 AsIs: e.Tail#1/23 AsIs: >/1 ]] }
    ...
    // </0 & Map@2/4 s.FileHandle#2/5 t.Next#1/8 e.Tail#1/10 >/1
    context[10] = context[6];
    context[11] = context[7];
    // closed e.Tail#1 as range 10
    //DEBUG: t.Next#1: 8
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & PutProgramElement*10/4 AsIs: s.FileHandle#2/5 AsIs: t.Next#1/8 } >/12 </13 & Map@2/14 s.FileHandle#2/5/15 Tile{ AsIs: e.Tail#1/10 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[12]);
    refalrts::alloc_open_call(vm, context[13]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@0/4 } (/6 & PutProgramElement@0/7 Tile{ AsIs: s.FileHandle#2/5 } )/8 Tile{ AsIs: e.items#0/2 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Map_Z3(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new#5 as range 6
    do {
      // </0 & Map@3/4 s.new#6/5 (/8 s.new#7/14 e.new#8/12 )/9 e.new#9/10 >/1
      context[10] = context[6];
      context[11] = context[7];
      context[12] = 0;
      context[13] = 0;
      ...
      // closed e.new#8 as range 12
      do {
        // </0 & Map@3/4 s.FileHandle#1/5 (/8 # CmdSentence/14 e.0#0/15 )/9 e.Tail#1/17 >/1
        context[15] = context[12];
        context[16] = context[13];
        context[17] = context[10];
        context[18] = context[11];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 HalfReuse: ' '/8 HalfReuse: ' '/14 }"  (CmdSentence"/19 >/21 </22 & Map@9/23 [*]/24 & PutRASLCommands\1@1/25 s.FileHandle#1/5/26 {*}/27 Tile{ AsIs: e.0#0/15 } >/28 </29 & Putout/30 s.FileHandle#1/5/31"    )  // CmdSentence"/32 >/34 </35 & Map@3/36 Tile{ HalfReuse: s.FileHandle1 #5/9 AsIs: e.Tail#1/17 AsIs: >/1 ]] }
      ...
      do {
        // </0 & Map@3/4 s.FileHandle#1/5 (/8 # CmdOpenELoop/14 # AlgLeft/19 s.BracketNum#2/20 s.VarNumber#2/21 e.3#0/15 )/9 e.Tail#1/17 >/1
        context[15] = context[12];
        context[16] = context[13];
        context[17] = context[10];
        context[18] = context[11];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: ' '/19 }" (CmdOpenELoop e."/22 </24 & Symb/25 Tile{ AsIs: s.VarNumber#2/21 } >/26" <- ["/27 </29 & Symb/30 Tile{ AsIs: s.BracketNum#2/20 } >/31 ']'/32 >/33 </34 & Map@9/35 [*]/36 & PutRASLCommands\1@1/37 s.FileHandle#1/5/38 {*}/39 Tile{ AsIs: e.3#0/15 } >/40 </41 & Putout/42 s.FileHandle#1/5/43"    )  // CmdOpenELoop"/44 >/46 </47 & Map@3/48 Tile{ HalfReuse: s.FileHandle1 #5/9 AsIs: e.Tail#1/17 AsIs: >/1 ]] }
      ...
      do {
        // </0 & Map@3/4 s.FileHandle#1/5 (/8 # CmdComment/14 e.0#0/15 )/9 e.Tail#1/17 >/1
        context[15] = context[12];
        context[16] = context[13];
        context[17] = context[10];
        context[18] = context[11];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 HalfReuse: ' '/8 HalfReuse: ' '/14 }"  // "/19 Tile{ AsIs: e.0#0/15 } >/21 </22 & Map@3/23 Tile{ HalfReuse: s.FileHandle1 #5/9 AsIs: e.Tail#1/17 AsIs: >/1 ]] }
      ...
      // </0 & Map@3/4 s.FileHandle#1/5 (/8 s.Command#2/14 e.0#0/15 )/9 e.Tail#1/17 >/1
      context[15] = context[12];
      context[16] = context[13];
      context[17] = context[10];
      context[18] = context[11];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 HalfReuse: ' '/8 }"   ("/19 Tile{ AsIs: s.Command#2/14 } Tile{ AsIs: e.0#0/15 } ')'/21 >/22 </23 & Map@3/24 Tile{ HalfReuse: s.FileHandle1 #5/9 AsIs: e.Tail#1/17 AsIs: >/1 ]] }
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & PutRASLCommands\1*4/4 AsIs: s.FileHandle#1/5 } (/12"    "/13 )/15 Tile{ AsIs: t.Next#1/8 } >/16 </17 & Map@3/18 s.FileHandle#1/5/19 Tile{ AsIs: e.Tail#1/10 } Tile{ AsIs: >/1 ]] }
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@0/4 } [*]/6 & PutRASLCommands\1@0/7 Tile{ AsIs: s.FileHandle#1/5 } (/8"    "/9 )/11 {*}/12 Tile{ AsIs: e.items#0/2 } Tile{ AsIs: >/1 ]] }
  refalrts::alloc_closure_head(vm, context[6]);
...
static refalrts::FnResult func_gen_Map_Z4(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & Map@4/4 s.FileHandle#1/5 e.items#0/2 >/1
  // closed e.items#0 as range 2
  //DEBUG: s.FileHandle#1: 5
  //DEBUG: e.items#0: 2
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@0/4 } [*]/6 & PutCode\1@0/7 Tile{ AsIs: s.FileHandle#1/5 } {*}/8 Tile{ AsIs: e.items#0/2 } Tile{ AsIs: >/1 ]] }
  refalrts::alloc_closure_head(vm, context[6]);
...
static refalrts::FnResult func_gen_Map_Z5(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new#5 as range 6
    do {
      // </0 & Map@5/4 s.FileHandle#1/5 (/8 (/16 # Symbol/18 # Identifier/19 e.5#0/14 )/17 (/22 # Symbol/24 # Name/25 e.7#0/20 )/23 )/9 e.Tail#1/10 >/1
      context[10] = context[6];
      context[11] = context[7];
      context[12] = 0;
      context[13] = 0;
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 HalfReuse: ' '/8 HalfReuse: ' '/16 HalfReuse: ' '/18 HalfReuse: ' '/19 AsIs: e.5#0/14 HalfReuse: ' '/17 HalfReuse: ':'/22 HalfReuse: ':'/24 HalfReuse: ' '/25 AsIs: e.7#0/20 HalfReuse: >/23 HalfReuse: </9 } & Map@5/26 s.FileHandle#1/5/27 Tile{ AsIs: e.Tail#1/10 } Tile{ AsIs: >/1 ]] }
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & PutProgramElement$3\1*1/4 AsIs: s.FileHandle#1/5 AsIs: t.Next#1/8 } >/12 </13 & Map@5/14 s.FileHandle#1/5/15 Tile{ AsIs: e.Tail#1/10 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[12]);
    refalrts::alloc_open_call(vm, context[13]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@0/4 } [*]/6 & PutProgramElement$3\1@0/7 Tile{ AsIs: s.FileHandle#1/5 } {*}/8 Tile{ AsIs: e.items#0/2 } Tile{ AsIs: >/1 ]] }
  refalrts::alloc_closure_head(vm, context[6]);
...
static refalrts::FnResult func_gen_Map_Z6(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // closed e.new#2 as range 2
  do {
    // </0 & Map@6/4 s.new#3/5 t.new#4/8 e.new#5/6 >/1
    context[6] = context[2];
    context[7] = context[3];
    context[9] = refalrts::tvar_left( context[8], context[6], context[7] );
    if( ! context[9] )
    ...
    // closed e.new#5 as range 6
    do {
      // </0 & Map@6/4 s.new#6/5 (/8 s.new#7/14 e.new#8/12 )/9 e.new#9/10 >/1
      context[10] = context[6];
      context[11] = context[7];
      context[12] = 0;
      context[13] = 0;
      ...
      // closed e.new#8 as range 12
      do {
        // </0 & Map@6/4 s.FileHandle#1/5 (/8 # CmdSentence/14 e.0#0/15 )/9 e.Tail#1/17 >/1
        context[15] = context[12];
        context[16] = context[13];
        context[17] = context[10];
        context[18] = context[11];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 HalfReuse: ' '/8 HalfReuse: ' '/14 }"(CmdSentence"/19 >/21 </22 & Map@3/23 s.FileHandle#1/5/24 Tile{ AsIs: e.0#0/15 } >/25 </26 & Putout/27 s.FileHandle#1/5/28"  )  // CmdSentence"/29 >/31 </32 & Map@6/33 Tile{ HalfReuse: s.FileHandle1 #5/9 AsIs: e.Tail#1/17 AsIs: >/1 ]] }
      ...
      do {
        // </0 & Map@6/4 s.FileHandle#1/5 (/8 # CmdOpenELoop/14 # AlgLeft/19 s.BracketNum#2/20 s.VarNumber#2/21 e.3#0/15 )/9 e.Tail#1/17 >/1
        context[15] = context[12];
        context[16] = context[13];
        context[17] = context[10];
        context[18] = context[11];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 HalfReuse: ' '/8 HalfReuse: ' '/14 HalfReuse: '('/19 }"CmdOpenELoop e."/22 </24 & Symb/25 Tile{ AsIs: s.VarNumber#2/21 } >/26" <- ["/27 </29 & Symb/30 Tile{ AsIs: s.BracketNum#2/20 } >/31 ']'/32 >/33 </34 & Map@3/35 s.FileHandle#1/5/36 Tile{ AsIs: e.3#0/15 } >/37 </38 & Putout/39 s.FileHandle#1/5/40"  )  // CmdOpenELoop"/41 >/43 </44 & Map@6/45 Tile{ HalfReuse: s.FileHandle1 #5/9 AsIs: e.Tail#1/17 AsIs: >/1 ]] }
      ...
      do {
        // </0 & Map@6/4 s.FileHandle#1/5 (/8 # CmdComment/14 e.0#0/15 )/9 e.Tail#1/17 >/1
        context[15] = context[12];
        context[16] = context[13];
        context[17] = context[10];
        context[18] = context[11];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 HalfReuse: ' '/8 HalfReuse: ' '/14 }"// "/19 Tile{ AsIs: e.0#0/15 } >/21 </22 & Map@6/23 Tile{ HalfReuse: s.FileHandle1 #5/9 AsIs: e.Tail#1/17 AsIs: >/1 ]] }
      ...
      // </0 & Map@6/4 s.FileHandle#1/5 (/8 s.Command#2/14 e.0#0/15 )/9 e.Tail#1/17 >/1
      context[15] = context[12];
      context[16] = context[13];
      context[17] = context[10];
      context[18] = context[11];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle#1/5 HalfReuse: ' '/8 }" ("/19 Tile{ AsIs: s.Command#2/14 } Tile{ AsIs: e.0#0/15 } ')'/21 >/22 </23 & Map@6/24 Tile{ HalfReuse: s.FileHandle1 #5/9 AsIs: e.Tail#1/17 AsIs: >/1 ]] }
    ...
    // </0 & Map@6/4 s.FileHandle#1/5 t.Next#1/8 e.Tail#1/10 >/1
    context[10] = context[6];
    context[11] = context[7];
    // closed e.Tail#1 as range 10
    //DEBUG: t.Next#1: 8
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & PutRASLCommands\1*4/4 AsIs: s.FileHandle#1/5 } (/12"  "/13 )/15 Tile{ AsIs: t.Next#1/8 } >/16 </17 & Map@6/18 s.FileHandle#1/5/19 Tile{ AsIs: e.Tail#1/10 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_bracket(vm, context[12]);
    refalrts::alloc_chars(vm, context[13], context[14], "  ", 2);
    refalrts::alloc_close_bracket(vm, context[15]);
    refalrts::alloc_close_call(vm, context[16]);
  ...
  do {
    // </0 & Map@6/4 s.FileHandle#1/5 >/1
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    //DEBUG: s.FileHandle#1: 5

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Map@6/4 s.FileHandle#1/5 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & Map@6/4 s.FileHandle#1/5 e.items#0/2 >/1
  // closed e.items#0 as range 2
  //DEBUG: s.FileHandle#1: 5
  //DEBUG: e.items#0: 2
...
static refalrts::FnResult func_gen_Map_Z7(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & Map@7/4 s.new#1/5 (/8 e.new#2/6 )/9 e.new#3/2 >/1
  if( ! refalrts::svar_left( context[5], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  context[6] = 0;
  context[7] = 0;
  ...
  // closed e.new#3 as range 2
  do {
    // </0 & Map@7/4 s.new#4/5 (/8 e.new#7/10 )/9 t.new#5/14 e.new#6/12 >/1
    context[10] = context[6];
    context[11] = context[7];
    ...
    do {
      // </0 & Map@7/4 s.new#8/5 (/8 e.new#12/16 )/9 (/14 s.new#9/22 e.new#10/20 )/15 e.new#11/18 >/1
      context[16] = context[10];
      context[17] = context[11];
      ...
      do {
        // </0 & Map@7/4 s.FileHandle#1/5 (/8 e.Indent#1/23 )/9 (/14 # CmdSentence/22 e.0#0/25 )/15 e.Tail#1/27 >/1
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ } </29 & Putout/30 s.FileHandle#1/5/31 e.Indent#1/23/32"  (CmdSentence"/34 >/36 </37 & Map@9/38 [*]/39 & PutRASLCommands\1/40 s.FileHandle#1/5/41 (/42 e.Indent#1/23/43"    "/45 Tile{ HalfReuse: )/14 HalfReuse: {*}/22 AsIs: e.0#0/25 HalfReuse: >/15 } </47 & Putout/48 s.FileHandle#1/5/49 e.Indent#1/23/50"  )  // CmdSentence"/52 >/54 Tile{ AsIs: </0 AsIs: & Map@7/4 AsIs: s.FileHandle#1/5 AsIs: (/8 AsIs: e.Indent#1/23 AsIs: )/9 } Tile{ AsIs: e.Tail#1/27 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_call(vm, context[29]);
        refalrts::alloc_name(vm, context[30], functions[efunc_Putout]);
        refalrts::copy_stvar(vm, context[31], context[5]);
      ...
      do {
        // </0 & Map@7/4 s.FileHandle#1/5 (/8 e.Indent#1/23 )/9 (/14 # CmdOpenELoop/22 # AlgLeft/29 s.BracketNum#2/30 s.VarNumber#2/31 e.3#0/25 )/15 e.Tail#1/27 >/1
        context[23] = context[16];
        context[24] = context[17];
        context[25] = context[20];
        context[26] = context[21];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ } </32 & Putout/33 s.FileHandle#1/5/34 e.Indent#1/23/35"  (CmdOpenELoop e."/37 </39 & Symb/40 Tile{ AsIs: s.VarNumber#2/31 } >/41" <- "/42 Tile{ HalfReuse: '['/14 HalfReuse: </22 HalfReuse: & Symb/29 AsIs: s.BracketNum#2/30 } >/44 ']'/45 >/46 </47 & Map@9/48 [*]/49 & PutRASLCommands\1/50 s.FileHandle#1/5/51 (/52 e.Indent#1/23/53"    "/55 Tile{ AsIs: )/15 } {*}/57 Tile{ AsIs: e.3#0/25 } >/58 </59 & Putout/60 s.FileHandle#1/5/61 e.Indent#1/23/62"  )  // CmdOpenELoop"/64 >/66 Tile{ AsIs: </0 AsIs: & Map@7/4 AsIs: s.FileHandle#1/5 AsIs: (/8 AsIs: e.Indent#1/23 AsIs: )/9 } Tile{ AsIs: e.Tail#1/27 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_call(vm, context[32]);
        refalrts::alloc_name(vm, context[33], functions[efunc_Putout]);
        refalrts::copy_stvar(vm, context[34], context[5]);
      ...
      do {
        // </0 & Map@7/4 s.FileHandle#1/5 (/8 e.Indent#1/23 )/9 (/14 # CmdComment/22 e.0#0/25 )/15 e.Tail#1/27 >/1
        context[23] = context[16];
        context[24] = context[17];
        context[25] = context[20];
        context[26] = context[21];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ } </29 & Putout/30 s.FileHandle#1/5/31 e.Indent#1/23/32"  /"/34 Tile{ HalfReuse: '/'/14 HalfReuse: ' '/22 AsIs: e.0#0/25 HalfReuse: >/15 } Tile{ AsIs: </0 AsIs: & Map@7/4 AsIs: s.FileHandle#1/5 AsIs: (/8 AsIs: e.Indent#1/23 AsIs: )/9 } Tile{ AsIs: e.Tail#1/27 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_call(vm, context[29]);
        refalrts::alloc_name(vm, context[30], functions[efunc_Putout]);
        refalrts::copy_stvar(vm, context[31], context[5]);
        refalrts::copy_evar(vm, context[32], context[33], context[23], context[24]);
      ...
      // </0 & Map@7/4 s.FileHandle#1/5 (/8 e.Indent#1/23 )/9 (/14 s.Command#2/22 e.0#0/25 )/15 e.Tail#1/27 >/1
      context[23] = context[16];
      context[24] = context[17];
      context[25] = context[20];
      context[26] = context[21];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </29 & Putout/30 s.FileHandle#1/5/31 e.Indent#1/23/32"  "/34 Tile{ HalfReuse: '('/14 AsIs: s.Command#2/22 AsIs: e.0#0/25 HalfReuse: ')'/15 } >/36 Tile{ AsIs: </0 AsIs: & Map@7/4 AsIs: s.FileHandle#1/5 AsIs: (/8 AsIs: e.Indent#1/23 AsIs: )/9 } Tile{ AsIs: e.Tail#1/27 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[29]);
      refalrts::alloc_name(vm, context[30], functions[efunc_Putout]);
      refalrts::copy_stvar(vm, context[31], context[5]);
      refalrts::copy_evar(vm, context[32], context[33], context[23], context[24]);
    ...
    // </0 & Map@7/4 s.FileHandle#1/5 (/8 e.Indent#1/16 )/9 t.Next#1/14 e.Tail#1/18 >/1
    context[16] = context[10];
    context[17] = context[11];
    context[18] = context[12];
    context[19] = context[13];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & PutRASLCommands\1*4/4 AsIs: s.FileHandle#1/5 AsIs: (/8 AsIs: e.Indent#1/16 HalfReuse: ' '/9 } ' '/20 )/21 Tile{ AsIs: t.Next#1/14 } >/22 </23 & Map@7/24 s.FileHandle#1/5/25 (/26 e.Indent#1/16/27 )/29 Tile{ AsIs: e.Tail#1/18 } Tile{ AsIs: >/1 ]] }
  ...
  do {
    // </0 & Map@7/4 s.FileHandle#1/5 (/8 e.Indent#1/10 )/9 >/1
    context[10] = context[6];
    context[11] = context[7];
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Map@7/4 s.FileHandle#1/5 (/8 e.Indent#1/10 )/9 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & Map@7/4 s.FileHandle#1/5 (/8 e.Indent#1/6 )/9 e.items#0/2 >/1
  // closed e.Indent#1 as range 6
  // closed e.items#0 as range 2
  //DEBUG: s.FileHandle#1: 5
  //DEBUG: e.Indent#1: 6
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </10 & Map@0/11 Tile{ HalfReuse: [*]/0 Reuse: & PutRASLCommands\1@0/4 AsIs: s.FileHandle#1/5 AsIs: (/8 AsIs: e.Indent#1/6 HalfReuse: ' '/9 } ' '/12 )/13 {*}/14 Tile{ AsIs: e.items#0/2 } Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[10]);
...
static refalrts::FnResult func_gen_Map_Z8(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & Map@8/4 s.new#1/5 (/8 e.new#2/6 )/9 e.new#3/2 >/1
  if( ! refalrts::svar_left( context[5], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  context[6] = 0;
  context[7] = 0;
  ...
  // closed e.new#3 as range 2
  do {
    // </0 & Map@8/4 s.new#4/5 (/8 e.new#7/10 )/9 t.new#5/14 e.new#6/12 >/1
    context[10] = context[6];
    context[11] = context[7];
    context[12] = context[2];
    context[13] = context[3];
    ...
    // closed e.new#6 as range 12
    do {
      // </0 & Map@8/4 s.new#8/5 (/8 e.new#12/16 )/9 (/14 s.new#9/22 e.new#10/20 )/15 e.new#11/18 >/1
      context[16] = context[10];
      context[17] = context[11];
      context[18] = context[12];
      context[19] = context[13];
      ...
      // closed e.new#10 as range 20
      do {
        // </0 & Map@8/4 s.FileHandle#1/5 (/8 e.Indent#1/23 )/9 (/14 # CmdSentence/22 e.0#0/25 )/15 e.Tail#1/27 >/1
        context[23] = context[16];
        context[24] = context[17];
        context[25] = context[20];
        context[26] = context[21];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ } </29 & Putout/30 s.FileHandle#1/5/31 e.Indent#1/23/32"(CmdSentence"/34 >/36 </37 & Map@7/38 s.FileHandle#1/5/39 Tile{ AsIs: (/14 } e.Indent#1/23/40 Tile{ HalfReuse: )/22 AsIs: e.0#0/25 HalfReuse: >/15 } </42 & Putout/43 s.FileHandle#1/5/44 e.Indent#1/23/45")  // CmdSentence"/47 >/49 Tile{ AsIs: </0 AsIs: & Map@8/4 AsIs: s.FileHandle#1/5 AsIs: (/8 AsIs: e.Indent#1/23 AsIs: )/9 } Tile{ AsIs: e.Tail#1/27 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_call(vm, context[29]);
        refalrts::alloc_name(vm, context[30], functions[efunc_Putout]);
        refalrts::copy_stvar(vm, context[31], context[5]);
        refalrts::copy_evar(vm, context[32], context[33], context[23], context[24]);
      ...
      do {
        // </0 & Map@8/4 s.FileHandle#1/5 (/8 e.Indent#1/23 )/9 (/14 # CmdOpenELoop/22 # AlgLeft/29 s.BracketNum#2/30 s.VarNumber#2/31 e.3#0/25 )/15 e.Tail#1/27 >/1
        context[23] = context[16];
        context[24] = context[17];
        context[25] = context[20];
        context[26] = context[21];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ } </32 & Putout/33 s.FileHandle#1/5/34 e.Indent#1/23/35"(CmdOpenELoop e."/37 </39 & Symb/40 Tile{ AsIs: s.VarNumber#2/31 } >/41" <- "/42 Tile{ HalfReuse: '['/14 HalfReuse: </22 HalfReuse: & Symb/29 AsIs: s.BracketNum#2/30 } >/44 ']'/45 >/46 </47 & Map@7/48 s.FileHandle#1/5/49 (/50 e.Indent#1/23/51 Tile{ AsIs: )/15 } Tile{ AsIs: e.3#0/25 } >/53 </54 & Putout/55 s.FileHandle#1/5/56 e.Indent#1/23/57")  // CmdOpenELoop"/59 >/61 Tile{ AsIs: </0 AsIs: & Map@8/4 AsIs: s.FileHandle#1/5 AsIs: (/8 AsIs: e.Indent#1/23 AsIs: )/9 } Tile{ AsIs: e.Tail#1/27 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_call(vm, context[32]);
        refalrts::alloc_name(vm, context[33], functions[efunc_Putout]);
        refalrts::copy_stvar(vm, context[34], context[5]);
        refalrts::copy_evar(vm, context[35], context[36], context[23], context[24]);
      ...
      do {
        // </0 & Map@8/4 s.FileHandle#1/5 (/8 e.Indent#1/23 )/9 (/14 # CmdComment/22 e.0#0/25 )/15 e.Tail#1/27 >/1
        context[23] = context[16];
        context[24] = context[17];
        context[25] = context[20];
        context[26] = context[21];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ } </29 & Putout/30 s.FileHandle#1/5/31 e.Indent#1/23/32 '/'/34 Tile{ HalfReuse: '/'/14 HalfReuse: ' '/22 AsIs: e.0#0/25 HalfReuse: >/15 } Tile{ AsIs: </0 AsIs: & Map@8/4 AsIs: s.FileHandle#1/5 AsIs: (/8 AsIs: e.Indent#1/23 AsIs: )/9 } Tile{ AsIs: e.Tail#1/27 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_call(vm, context[29]);
        refalrts::alloc_name(vm, context[30], functions[efunc_Putout]);
        refalrts::copy_stvar(vm, context[31], context[5]);
        refalrts::copy_evar(vm, context[32], context[33], context[23], context[24]);
      ...
      // </0 & Map@8/4 s.FileHandle#1/5 (/8 e.Indent#1/23 )/9 (/14 s.Command#2/22 e.0#0/25 )/15 e.Tail#1/27 >/1
      context[23] = context[16];
      context[24] = context[17];
      context[25] = context[20];
      context[26] = context[21];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </29 & Putout/30 s.FileHandle#1/5/31 e.Indent#1/23/32 Tile{ HalfReuse: '('/14 AsIs: s.Command#2/22 AsIs: e.0#0/25 HalfReuse: ')'/15 } >/34 Tile{ AsIs: </0 AsIs: & Map@8/4 AsIs: s.FileHandle#1/5 AsIs: (/8 AsIs: e.Indent#1/23 AsIs: )/9 } Tile{ AsIs: e.Tail#1/27 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[29]);
      refalrts::alloc_name(vm, context[30], functions[efunc_Putout]);
      refalrts::copy_stvar(vm, context[31], context[5]);
      refalrts::copy_evar(vm, context[32], context[33], context[23], context[24]);
    ...
    // </0 & Map@8/4 s.FileHandle#1/5 (/8 e.Indent#1/16 )/9 t.Next#1/14 e.Tail#1/18 >/1
    context[16] = context[10];
    context[17] = context[11];
    context[18] = context[12];
    context[19] = context[13];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & PutRASLCommands\1*4/4 AsIs: s.FileHandle#1/5 AsIs: (/8 AsIs: e.Indent#1/16 AsIs: )/9 AsIs: t.Next#1/14 } >/20 </21 & Map@8/22 s.FileHandle#1/5/23 (/24 e.Indent#1/16/25 )/27 Tile{ AsIs: e.Tail#1/18 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[20]);
    refalrts::alloc_open_call(vm, context[21]);
  ...
  do {
    // </0 & Map@8/4 s.FileHandle#1/5 (/8 e.Indent#1/10 )/9 >/1
    context[10] = context[6];
    context[11] = context[7];
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Map@8/4 s.FileHandle#1/5 (/8 e.Indent#1/10 )/9 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & Map@8/4 s.FileHandle#1/5 (/8 e.Indent#1/6 )/9 e.items#0/2 >/1
  // closed e.Indent#1 as range 6
  // closed e.items#0 as range 2
  //DEBUG: s.FileHandle#1: 5
  //DEBUG: e.Indent#1: 6
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </10 & Map@0/11 Tile{ HalfReuse: [*]/0 Reuse: & PutRASLCommands\1@0/4 AsIs: s.FileHandle#1/5 AsIs: (/8 AsIs: e.Indent#1/6 AsIs: )/9 } {*}/12 Tile{ AsIs: e.items#0/2 } Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[10]);
  refalrts::alloc_name(vm, context[11], functions[efunc_gen_Map_Z0]);
...
static refalrts::FnResult func_gen_Map_Z9(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // closed e.new#2 as range 2
  do {
    // </0 & Map@9/4 s.X#0/5 t.Next#1/8 e.Tail#1/6 >/1
    context[6] = context[2];
    context[7] = context[3];
    context[9] = refalrts::tvar_left( context[8], context[6], context[7] );
    if( ! context[9] )
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & __Meta_Mu/4 AsIs: s.X#0/5 AsIs: t.Next#1/8 } & $table/10 >/11 </12 & Map@9/13 s.X#0/5/14 Tile{ AsIs: e.Tail#1/6 } Tile{ AsIs: >/1 ]] }
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Map@9/4 s.X#0/5 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & Map@9/4 s.X#0/5 e.items#0/2 >/1
  // closed e.items#0 as range 2
  //DEBUG: s.X#0: 5
  //DEBUG: e.items#0: 2
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@0/4 AsIs: s.X#0/5 AsIs: e.items#0/2 AsIs: >/1 ]] }
  refalrts::update_name(context[4], functions[efunc_gen_Map_Z0]);
  refalrts::push_stack( vm, context[1] );
  refalrts::push_stack( vm, context[0] );
  return refalrts::cSuccess;
...
static refalrts::FnResult func_gen_PutRASLCommands_L1Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[46];
  refalrts::zeros( context, 46 );
  // </0 & PutRASLCommands\1@1/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & PutRASLCommands\1@1/4 s.new#1/5 e.new#2/2 >/1
  if( ! refalrts::svar_left( context[5], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  // closed e.new#2 as range 2
  do {
    // </0 & PutRASLCommands\1@1/4 s.new#3/5 (/10 s.new#4/12 e.new#5/8 )/11 >/1
    context[6] = context[2];
    context[7] = context[3];
    context[8] = 0;
    context[9] = 0;
    ...
    do {
      // </0 & PutRASLCommands\1@1/4 s.FileHandle0#1/5 (/10 # CmdSentence/12 e.SubCommands#2/13 )/11 >/1
      context[13] = context[8];
      context[14] = context[9];
      if( ! refalrts::ident_term( identifiers[ident_CmdSentence], context[12] ) )
        continue;
      // closed e.SubCommands#2 as range 13
      //DEBUG: s.FileHandle0#1: 5
      //DEBUG: e.SubCommands#2: 13

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle0#1/5 HalfReuse: ' '/10 HalfReuse: ' '/12 }"    (CmdSentence"/15 >/17 </18 & Map@9/19 [*]/20 & PutRASLCommands\1@2/21 s.FileHandle0#1/5/22 (/23"  "/24 )/26 {*}/27 Tile{ AsIs: e.SubCommands#2/13 } >/28 </29 & Putout/30 s.FileHandle0#1/5/31"      )  // CmdSentenc"/32 Tile{ HalfReuse: 'e'/11 AsIs: >/1 ]] }
    ...
    do {
      // </0 & PutRASLCommands\1@1/4 s.FileHandle0#1/5 (/10 # CmdOpenELoop/12 # AlgLeft/15 s.BracketNum#2/16 s.VarNumber#2/17 e.SubCommands#2/13 )/11 >/1
      context[13] = context[8];
      context[14] = context[9];
      ...
      // closed e.SubCommands#2 as range 13
      //DEBUG: s.FileHandle0#1: 5
      //DEBUG: s.BracketNum#2: 16
      //DEBUG: s.VarNumber#2: 17
      //DEBUG: e.SubCommands#2: 13

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle0#1/5 HalfReuse: ' '/10 HalfReuse: ' '/12 HalfReuse: ' '/15 }"   (CmdOpenELoop e."/18 </20 & Symb/21 Tile{ AsIs: s.VarNumber#2/17 } >/22" <- ["/23 </25 & Symb/26 Tile{ AsIs: s.BracketNum#2/16 } >/27 ']'/28 >/29 </30 & Map@9/31 [*]/32 & PutRASLCommands\1@2/33 s.FileHandle0#1/5/34 (/35"  "/36 )/38 {*}/39 Tile{ AsIs: e.SubCommands#2/13 } >/40 </41 & Putout/42 s.FileHandle0#1/5/43"      )  // CmdOpenELoo"/44 Tile{ HalfReuse: 'p'/11 AsIs: >/1 ]] }
    ...
    do {
      // </0 & PutRASLCommands\1@1/4 s.FileHandle0#1/5 (/10 # CmdComment/12 e.Message#2/13 )/11 >/1
      context[13] = context[8];
      context[14] = context[9];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle0#1/5 HalfReuse: ' '/10 HalfReuse: ' '/12 }"  "/15 Tile{ HalfReuse: ' '/11 }" // "/17 Tile{ AsIs: e.Message#2/13 } Tile{ AsIs: >/1 ]] }
    ...
    // </0 & PutRASLCommands\1@1/4 s.FileHandle0#1/5 (/10 s.Command#2/12 e.Args#2/13 )/11 >/1
    context[13] = context[8];
    context[14] = context[9];
    // closed e.Args#2 as range 13
    //DEBUG: s.FileHandle0#1: 5
    //DEBUG: s.Command#2: 12
    //DEBUG: e.Args#2: 13

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.FileHandle0#1/5 }"      "/15 Tile{ HalfReuse: '('/10 AsIs: s.Command#2/12 AsIs: e.Args#2/13 HalfReuse: ')'/11 AsIs: >/1 ]] }
  ...
  // </0 & PutRASLCommands\1@1/4 s.FileHandle0#1/5 e.dyn#0/2 >/1
  // closed e.dyn#0 as range 2
  //DEBUG: s.FileHandle0#1: 5
  //DEBUG: e.dyn#0: 2
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & PutRASLCommands\1@0/4 AsIs: s.FileHandle0#1/5 } (/6"      "/7 )/9 Tile{ AsIs: e.dyn#0/2 } Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_bracket(vm, context[6]);
...
static refalrts::FnResult func_gen_PutRASLCommands_L1Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & PutRASLCommands\1@2/4 e.new#0/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new#0 as range 2
  // </0 & PutRASLCommands\1@2/4 s.new#1/5 (/8 e.new#2/6 )/9 e.new#3/2 >/1
  if( ! refalrts::svar_left( context[5], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  context[6] = 0;
  context[7] = 0;
  ...
  // closed e.new#3 as range 2
  do {
    // </0 & PutRASLCommands\1@2/4 s.new#4/5 (/8 e.new#7/10 )/9 (/16 s.new#5/18 e.new#6/14 )/17 >/1
    context[10] = context[6];
    context[11] = context[7];
    context[12] = context[2];
    context[13] = context[3];
    ...
    do {
      // </0 & PutRASLCommands\1@2/4 s.X#0/5 (/8 e.X#0/19 )/9 (/16 # CmdSentence/18 e.SubCommands#2/21 )/17 >/1
      ...
      // closed e.SubCommands#2 as range 21
      //DEBUG: s.X#0: 5
      //DEBUG: e.X#0: 19
      //DEBUG: e.SubCommands#2: 21

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </23 & Putout/24 s.X#0/5/25 e.X#0/19/26"      (CmdSentence"/28 >/30 </31 & Map@9/32 Tile{ HalfReuse: [*]/0 AsIs: & PutRASLCommands\1@2/4 AsIs: s.X#0/5 AsIs: (/8 AsIs: e.X#0/19 HalfReuse: ' '/9 HalfReuse: ' '/16 HalfReuse: )/18 } {*}/33 Tile{ AsIs: e.SubCommands#2/21 } >/34 </35 & Putout/36 s.X#0/5/37 e.X#0/19/38"      )  // CmdSentenc"/40 Tile{ HalfReuse: 'e'/17 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[23]);
      refalrts::alloc_name(vm, context[24], functions[efunc_Putout]);
      refalrts::copy_stvar(vm, context[25], context[5]);
    ...
    do {
      // </0 & PutRASLCommands\1@2/4 s.X#0/5 (/8 e.X#0/19 )/9 (/16 # CmdOpenELoop/18 # AlgLeft/23 s.BracketNum#2/24 s.VarNumber#2/25 e.SubCommands#2/21 )/17 >/1
      context[19] = context[10];
      context[20] = context[11];
      context[21] = context[14];
      context[22] = context[15];
      ...
      //DEBUG: s.X#0: 5
      //DEBUG: e.X#0: 19
      //DEBUG: s.BracketNum#2: 24
      //DEBUG: s.VarNumber#2: 25
      //DEBUG: e.SubCommands#2: 21

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </26 & Putout/27 s.X#0/5/28 e.X#0/19/29"      (CmdOpenELoop e."/31 </33 & Symb/34 Tile{ AsIs: s.VarNumber#2/25 } >/35" <- ["/36 </38 & Symb/39 Tile{ AsIs: s.BracketNum#2/24 } >/40 ']'/41 >/42 </43 & Map@9/44 Tile{ HalfReuse: [*]/0 AsIs: & PutRASLCommands\1@2/4 AsIs: s.X#0/5 AsIs: (/8 AsIs: e.X#0/19 HalfReuse: ' '/9 HalfReuse: ' '/16 HalfReuse: )/18 HalfReuse: {*}/23 } Tile{ AsIs: e.SubCommands#2/21 } >/45 </46 & Putout/47 s.X#0/5/48 e.X#0/19/49"      )  // CmdOpenELoo"/51 Tile{ HalfReuse: 'p'/17 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[26]);
      refalrts::alloc_name(vm, context[27], functions[efunc_Putout]);
      refalrts::copy_stvar(vm, context[28], context[5]);
    ...
    do {
      // </0 & PutRASLCommands\1@2/4 s.X#0/5 (/8 e.X#0/19 )/9 (/16 # CmdComment/18 e.Message#2/21 )/17 >/1
      context[19] = context[10];
      context[20] = context[11];
      context[21] = context[14];
      context[22] = context[15];
      if( ! refalrts::ident_term( identifiers[ident_CmdComment], context[18] ) )
        continue;
      // closed e.X#0 as range 19
      // closed e.Message#2 as range 21
      //DEBUG: s.X#0: 5
      //DEBUG: e.X#0: 19
      //DEBUG: e.Message#2: 21

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.X#0/5 } Tile{ AsIs: e.X#0/19 } Tile{ HalfReuse: ' '/8 }"  "/23 Tile{ HalfReuse: ' '/1 }"  "/25 Tile{ HalfReuse: '/'/9 HalfReuse: '/'/16 HalfReuse: ' '/18 AsIs: e.Message#2/21 HalfReuse: >/17 } Tile{ ]] }
      refalrts::alloc_chars(vm, context[23], context[24], "  ", 2);
    ...
    // </0 & PutRASLCommands\1@2/4 s.X#0/5 (/8 e.X#0/19 )/9 (/16 s.Command#2/18 e.Args#2/21 )/17 >/1
    context[19] = context[10];
    context[20] = context[11];
    context[21] = context[14];
    context[22] = context[15];
    // closed e.X#0 as range 19
    // closed e.Args#2 as range 21
    //DEBUG: s.X#0: 5
    //DEBUG: s.Command#2: 18
    //DEBUG: e.X#0: 19
    //DEBUG: e.Args#2: 21

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Putout/4 AsIs: s.X#0/5 } Tile{ AsIs: e.X#0/19 } ' '/23 Tile{ HalfReuse: ' '/8 }"   "/24 Tile{ HalfReuse: ' '/9 HalfReuse: '('/16 AsIs: s.Command#2/18 AsIs: e.Args#2/21 HalfReuse: ')'/17 AsIs: >/1 ]] }
  ...
  // </0 & PutRASLCommands\1@2/4 s.X#0/5 (/8 e.X#0/6 )/9 e.dyn#0/2 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & PutRASLCommands\1@0/4 AsIs: s.X#0/5 AsIs: (/8 AsIs: e.X#0/6 HalfReuse: ' '/9 }"     "/10 )/12 Tile{ AsIs: e.dyn#0/2 } Tile{ AsIs: >/1 ]] }
