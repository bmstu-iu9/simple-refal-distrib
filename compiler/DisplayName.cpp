  ...
  do {
    ...
    do {
      ...
      if( ! refalrts::svar_right( context[10], context[8], context[9] ) )
        continue;
      context[11] = refalrts::ident_right(  ident_Hash, context[8], context[9] );
      if( ! context[11] )
        continue;
    ...
    context[8] = context[5];
    context[9] = context[6];
    context[10] = refalrts::ident_left(  ident_VAR, context[8], context[9] );
    if( ! context[10] )
      continue;
    ...
    if( ! refalrts::alloc_char( context[12], '#' ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[13], ref_StrFromInt.ref.function ) )
      return refalrts::cNoMemory;
...
static refalrts::FnResult func_CName(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      if( ! refalrts::alloc_close_call( context[15] ) )
        return refalrts::cNoMemory;
      if( ! refalrts::alloc_char( context[16], '_' ) )
        return refalrts::cNoMemory;
      if( ! refalrts::alloc_open_call( context[17] ) )
        return refalrts::cNoMemory;
      if( ! refalrts::alloc_name( context[18], ref_StrFromInt.ref.function ) )
    ...
    if( ! refalrts::alloc_open_call( context[13] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[14], ref_CName.ref.function ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_close_call( context[15] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_char( context[16], '_' ) )
