...
#define cookie_ns cookie_ns_2274433306_2300989623
#define COOKIE1_ 2274433306U
#define COOKIE2_ 2300989623U
...
enum efunc {
  ...
  efunc_gen_DecorateChars_L1S4L1 = 23,
  efunc_gen_Map_Z1 = 24,
  efunc_Mu = 25,
  efunc_Up = 26,
  efunc_Evm_met = 27,
  ...
  efunc_Inc = 33,
  efunc_Dec = 34,
  efunc_DisplayCName = 35,
  efunc_gen_DecorateChars_L1D4 = 36,
  efunc_gen_Map_Z0 = 37,
  efunc_gen_DecorateChars_L1 = 38,
};
...
enum ident {
  ...
  ident_MapAccum = 12,
  ident_DoMapAccum = 13,
  ident_DoMapAccumm_Aux = 14,
  ident_UnBracket = 15,
  ident_DelAccumulator = 16,
  ident_Inc = 17,
  ident_Dec = 18,
  ident_Pipe = 19,
  ident_DisplayName = 20,
  ident_DisplayNameSuf = 21,
  ident_DisplayCName = 22,
  ident_CName = 23,
  ident_DecorateChars = 24,
  ident_AlphaNumber = 25,
  ident_CNameSuf = 26,
};
...
static refalrts::FnResult func_gen_DecorateChars_L1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch/4 } </6 & AlphaNumber/7 >/8 [*]/9 & DecorateChars\1$4\1/10 Tile{ AsIs: s.Other#2/5 } {*}/11 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[6]);
  refalrts::alloc_name(vm, context[7], functions[efunc_AlphaNumber]);
  refalrts::alloc_close_call(vm, context[8]);
  refalrts::alloc_closure_head(vm, context[9]);
  refalrts::alloc_name(vm, context[10], functions[efunc_gen_DecorateChars_L1S4L1]);
...
static refalrts::FnResult func_gen_Map_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch/4 } </13 & AlphaNumber/14 >/15 [*]/16 & DecorateChars\1$4\1/17 Tile{ AsIs: s.Other#2/7 } {*}/18 >/19 </20 & Map@1/21 Tile{ AsIs: e.Tail#1/11 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[13]);
      refalrts::alloc_name(vm, context[14], functions[efunc_AlphaNumber]);
      refalrts::alloc_close_call(vm, context[15]);
      refalrts::alloc_closure_head(vm, context[16]);
      refalrts::alloc_name(vm, context[17], functions[efunc_gen_DecorateChars_L1S4L1]);
