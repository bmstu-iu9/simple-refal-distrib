...
#define cookie_ns cookie_ns_3184341212_1113724776
#define COOKIE1_ 3184341212U
#define COOKIE2_ 1113724776U
...
static refalrts::FnResult func_gen_DoGenSubst_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset#4/5 {REMOVED TILE} s.Num#1/53 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset4 #5/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk1#1/32 HalfReuse: (/35 HalfReuse: # Symbol/39 Reuse: # Char/41 } Tile{ HalfReuse: s.Char1 #54/1 } # NoOffset/55 Tile{ HalfReuse: )/46 AsIs: e.Junk2#1/42 AsIs: )/45 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/56 # AlgLeft/57 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves#4/26 } (/58 Tile{ HalfReuse: # CmdChar/49 Reuse: # AlgTerm/51 HalfReuse: s.Num1 #53/52 AsIs: s.Char#1/54 AsIs: )/50 AsIs: )/40 HalfReuse: >/44 } Tile{ ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset#4/5 {REMOVED TILE} s.Num#1/53 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset4 #5/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk1#1/32 HalfReuse: (/35 HalfReuse: # Symbol/39 Reuse: # Name/41 } e.Name#1/47/54 # NoOffset/56 Tile{ HalfReuse: )/46 AsIs: e.Junk2#1/42 AsIs: )/45 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } Tile{ HalfReuse: # CmdOpenedE/1 } # AlgLeft/57 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves#4/26 } (/58 Tile{ HalfReuse: # CmdName/49 Reuse: # AlgTerm/51 HalfReuse: s.Num1 #53/52 AsIs: e.Name#1/47 AsIs: )/50 AsIs: )/40 HalfReuse: >/44 } Tile{ ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset#4/5 {REMOVED TILE} s.Num#1/53 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset4 #5/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk1#1/32 HalfReuse: (/35 HalfReuse: # Symbol/39 Reuse: # Identifier/41 } e.Ident#1/47/54 # NoOffset/56 Tile{ HalfReuse: )/46 AsIs: e.Junk2#1/42 AsIs: )/45 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } Tile{ HalfReuse: # CmdOpenedE/1 } # AlgLeft/57 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves#4/26 } (/58 Tile{ HalfReuse: # CmdIdent/49 Reuse: # AlgTerm/51 HalfReuse: s.Num1 #53/52 AsIs: e.Ident#1/47 AsIs: )/50 AsIs: )/40 HalfReuse: >/44 } Tile{ ]] }
      refalrts::copy_evar(vm, context[54], context[55], context[47], context[48]);
      refalrts::alloc_ident(vm, context[56], identifiers[ident_NoOffset]);
      refalrts::alloc_ident(vm, context[57], identifiers[ident_AlgLeft]);
      refalrts::alloc_open_bracket(vm, context[58]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset#4/5 {REMOVED TILE} s.Num#1/53 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset4 #5/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk1#1/32 HalfReuse: (/35 HalfReuse: # Symbol/39 Reuse: # Number/41 } Tile{ HalfReuse: s.Value1 #54/1 } # NoOffset/55 Tile{ HalfReuse: )/46 AsIs: e.Junk2#1/42 AsIs: )/45 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/56 # AlgLeft/57 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves#4/26 } (/58 Tile{ HalfReuse: # CmdNumber/49 Reuse: # AlgTerm/51 HalfReuse: s.Num1 #53/52 AsIs: s.Value#1/54 AsIs: )/50 AsIs: )/40 HalfReuse: >/44 } Tile{ ]] }
      refalrts::alloc_ident(vm, context[55], identifiers[ident_NoOffset]);
      refalrts::alloc_ident(vm, context[56], identifiers[ident_CmdOpenedE]);
      refalrts::alloc_ident(vm, context[57], identifiers[ident_AlgLeft]);
      refalrts::alloc_open_bracket(vm, context[58]);
  ...
  do {
    ...
    do {
      ...
      //RESULT: Tile{ [[ } </53 & DoGenSubst/54 Tile{ AsIs: </0 Reuse: & Inc2/4 AsIs: s.ContextOffset#4/5 HalfReuse: >/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk1#1/32 HalfReuse: (/35 HalfReuse: # TkOpenBracket/39 Reuse: # NoOffset/41 } Tile{ AsIs: )/9 } )/55 (/56 Tile{ HalfReuse: # E/49 HalfReuse: s.ContextOffset4 #5/51 AsIs: e.SubRange#1/47 AsIs: )/50 HalfReuse: (/40 HalfReuse: # Junk/44 HalfReuse: (/46 } # TkCloseBracket/57 # NoOffset/58 Tile{ AsIs: )/45 } Tile{ AsIs: e.Junk2#1/42 } )/59 Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/60 # AlgLeft/61 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } )/62 Tile{ AsIs: e.CmdSaves#4/26 } (/63 # CmdBrackets/64 # AlgTerm/65 Tile{ AsIs: s.Num#1/52 } s.ContextOffset#4/5/66 )/67 )/68 Tile{ AsIs: >/1 ]] }
  ...
  do {
    ...
    do {
      ...
      //RESULT: Tile{ [[ } </57 & DoGenSubst/58 Tile{ AsIs: </0 Reuse: & Inc2/4 AsIs: s.ContextOffset#4/5 HalfReuse: >/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk1#1/32 HalfReuse: (/35 HalfReuse: # TkOpenADT/39 Reuse: # NoOffset/41 } Tile{ AsIs: )/9 } Tile{ AsIs: (/49 Reuse: # Symbol/51 HalfReuse: # Name/54 AsIs: e.Name#1/52 HalfReuse: # NoOffset/55 } Tile{ AsIs: )/50 AsIs: )/40 AsIs: (/44 Reuse: # E/46 } s.ContextOffset#4/5/59 Tile{ AsIs: e.SubRange#1/47 } Tile{ AsIs: )/45 } (/60 # Junk/61 (/62 # TkCloseADT/63 # NoOffset/64 )/65 Tile{ AsIs: e.Junk2#1/42 } )/66 Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/67 # AlgLeft/68 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } )/69 Tile{ AsIs: e.CmdSaves#4/26 } (/70 # CmdADT/71 # AlgTerm/72 Tile{ AsIs: s.Num#1/56 } s.ContextOffset#4/5/73 e.Name#1/52/74 )/76 )/77 Tile{ AsIs: >/1 ]] }
  ...
  do {
    ...
    do {
      ...
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset4 #5/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk#1/32 HalfReuse: (/35 HalfReuse: # Symbol/39 Reuse: # Char/41 } s.Char#1/49/50 # NoOffset/51 Tile{ AsIs: )/40 } )/52 (/53 # E/54 Tile{ AsIs: s.Num#1/42 } Tile{ AsIs: e.Range#1/37 } Tile{ AsIs: )/9 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/55 # AlgLeft/56 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } )/57 Tile{ AsIs: e.CmdSaves#4/26 } (/58 Tile{ HalfReuse: # CmdChar/45 Reuse: # AlgLeft/47 HalfReuse: s.Num1 #42/48 AsIs: s.Char#1/49 AsIs: )/46 } )/59 Tile{ AsIs: >/1 ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset#4/5 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset4 #5/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk#1/32 HalfReuse: (/35 HalfReuse: # Symbol/39 Reuse: # Number/41 } s.Number#1/49/50 # NoOffset/51 Tile{ AsIs: )/40 } )/52 (/53 # E/54 Tile{ AsIs: s.Num#1/42 } Tile{ AsIs: e.Range#1/37 } Tile{ AsIs: )/9 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/55 # AlgLeft/56 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } )/57 Tile{ AsIs: e.CmdSaves#4/26 } (/58 Tile{ HalfReuse: # CmdNumber/45 Reuse: # AlgLeft/47 HalfReuse: s.Num1 #42/48 AsIs: s.Number#1/49 AsIs: )/46 } )/59 Tile{ AsIs: >/1 ]] }
      refalrts::copy_stvar(vm, context[50], context[49]);
      refalrts::alloc_ident(vm, context[51], identifiers[ident_NoOffset]);
      refalrts::alloc_close_bracket(vm, context[52]);
      refalrts::alloc_open_bracket(vm, context[53]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} e.Junk#1/32 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 AsIs: s.ContextOffset#4/5 } Tile{ AsIs: e.Substs-B#1/28 } Tile{ AsIs: (/34 AsIs: # Junk/36 } Tile{ AsIs: (/45 AsIs: # Symbol/47 AsIs: # Name/48 AsIs: e.Name#1/43 HalfReuse: # NoOffset/46 } Tile{ AsIs: )/9 } Tile{ AsIs: )/35 AsIs: (/39 AsIs: # E/41 AsIs: s.Num#1/42 } Tile{ AsIs: e.Range#1/37 } Tile{ AsIs: )/40 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/49 # AlgLeft/50 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } )/51 Tile{ AsIs: e.CmdSaves#4/26 } Tile{ AsIs: (/8 } # CmdName/52 # AlgLeft/53 s.Num#1/42/54 e.Name#1/43/55 )/57 )/58 Tile{ AsIs: >/1 ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset#4/5 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset4 #5/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk#1/32 HalfReuse: (/35 HalfReuse: # Symbol/39 Reuse: # Identifier/41 } e.Name#1/43/49 # NoOffset/51 )/52 Tile{ AsIs: )/9 } (/53 # E/54 Tile{ AsIs: s.Num#1/42 } Tile{ AsIs: e.Range#1/37 } Tile{ AsIs: )/40 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/55 # AlgLeft/56 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } )/57 Tile{ AsIs: e.CmdSaves#4/26 } (/58 Tile{ HalfReuse: # CmdIdent/45 Reuse: # AlgLeft/47 HalfReuse: s.Num1 #42/48 AsIs: e.Name#1/43 AsIs: )/46 } )/59 Tile{ AsIs: >/1 ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset#4/5 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset4 #5/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # E/36 AsIs: s.Num#1/48 AsIs: e.Range#1/32 HalfReuse: )/44 HalfReuse: (/46 Reuse: # Junk/47 } (/50 # Symbol/51 Tile{ HalfReuse: # Char/45 HalfReuse: s.Char1 #49/35 HalfReuse: # NoOffset/39 HalfReuse: )/41 AsIs: e.Junk#1/37 AsIs: )/40 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/52 # AlgLeft/53 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves#4/26 } (/54 # CmdChar/55 # AlgRight/56 s.Num#1/48/57 Tile{ AsIs: s.Char#1/49 } )/58 )/59 Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[50]);
      refalrts::alloc_ident(vm, context[51], identifiers[ident_Symbol]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset#4/5 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset4 #5/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # E/36 AsIs: s.Num#1/48 AsIs: e.Range#1/32 HalfReuse: )/44 HalfReuse: (/46 Reuse: # Junk/47 } (/50 # Symbol/51 Tile{ HalfReuse: # Number/45 HalfReuse: s.Number1 #49/35 HalfReuse: # NoOffset/39 HalfReuse: )/41 AsIs: e.Junk#1/37 AsIs: )/40 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/52 # AlgLeft/53 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves#4/26 } (/54 # CmdNumber/55 # AlgRight/56 s.Num#1/48/57 Tile{ AsIs: s.Number#1/49 } )/58 )/59 Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[50]);
      refalrts::alloc_ident(vm, context[51], identifiers[ident_Symbol]);
      refalrts::alloc_ident(vm, context[52], identifiers[ident_CmdOpenedE]);
      refalrts::alloc_ident(vm, context[53], identifiers[ident_AlgLeft]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset#4/5 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset4 #5/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # E/36 AsIs: s.Num#1/48 AsIs: e.Range#1/32 HalfReuse: )/44 HalfReuse: (/46 Reuse: # Junk/47 } (/49 # Symbol/50 # Name/51 e.Name#1/42/52 Tile{ HalfReuse: # NoOffset/39 HalfReuse: )/41 AsIs: e.Junk#1/37 AsIs: )/40 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/54 # AlgLeft/55 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves#4/26 } (/56 # CmdName/57 # AlgRight/58 s.Num#1/48/59 Tile{ AsIs: e.Name#1/42 } Tile{ AsIs: )/45 AsIs: )/35 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[49]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset#4/5 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset4 #5/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # E/36 AsIs: s.Num#1/48 AsIs: e.Range#1/32 HalfReuse: )/44 HalfReuse: (/46 Reuse: # Junk/47 } (/49 # Symbol/50 # Identifier/51 e.Name#1/42/52 Tile{ HalfReuse: # NoOffset/39 HalfReuse: )/41 AsIs: e.Junk#1/37 AsIs: )/40 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/54 # AlgLeft/55 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves#4/26 } (/56 # CmdIdent/57 # AlgRight/58 s.Num#1/48/59 Tile{ AsIs: e.Name#1/42 } Tile{ AsIs: )/45 AsIs: )/35 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[49]);
      refalrts::alloc_ident(vm, context[50], identifiers[ident_Symbol]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </48 & DoGenSubst/49 Tile{ AsIs: </0 Reuse: & Inc2/4 AsIs: s.ContextOffset#4/5 HalfReuse: >/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk#1/32 HalfReuse: (/35 HalfReuse: # TkOpenBracket/39 Reuse: # NoOffset/41 } Tile{ AsIs: )/9 } )/50 (/51 Tile{ HalfReuse: # E/45 HalfReuse: s.ContextOffset4 #5/47 AsIs: e.SubRange#1/43 AsIs: )/46 } (/52 # Junk/53 (/54 # TkCloseBracket/55 # NoOffset/56 Tile{ AsIs: )/40 } )/57 (/58 # E/59 Tile{ AsIs: s.Num#1/42 } Tile{ AsIs: e.Range#1/37 } )/60 Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/61 # AlgLeft/62 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } )/63 Tile{ AsIs: e.CmdSaves#4/26 } (/64 # CmdBrackets/65 # AlgLeft/66 s.Num#1/42/67 s.ContextOffset#4/5/68 )/69 )/70 Tile{ AsIs: >/1 ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </48 & DoGenSubst/49 Tile{ AsIs: </0 Reuse: & Inc2/4 AsIs: s.ContextOffset#4/5 HalfReuse: >/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # E/36 AsIs: s.Num#1/47 AsIs: e.Range#1/32 HalfReuse: )/44 HalfReuse: (/46 } # Junk/50 (/51 # TkOpenBracket/52 # NoOffset/53 Tile{ AsIs: )/45 AsIs: )/35 AsIs: (/39 Reuse: # E/41 } s.ContextOffset#4/5/54 Tile{ AsIs: e.SubRange#1/42 } Tile{ AsIs: )/40 } (/55 # Junk/56 (/57 # TkCloseBracket/58 # NoOffset/59 Tile{ AsIs: )/9 } Tile{ AsIs: e.Junk#1/37 } )/60 Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/61 # AlgLeft/62 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } )/63 Tile{ AsIs: e.CmdSaves#4/26 } (/64 # CmdBrackets/65 # AlgRight/66 s.Num#1/47/67 s.ContextOffset#4/5/68 )/69 )/70 Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[48]);
      refalrts::alloc_name(vm, context[49], functions[efunc_DoGenSubst]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </52 & DoGenSubst/53 Tile{ AsIs: </0 Reuse: & Inc2/4 AsIs: s.ContextOffset#4/5 HalfReuse: >/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk#1/32 HalfReuse: (/35 HalfReuse: # TkOpenADT/39 Reuse: # NoOffset/41 } Tile{ AsIs: )/9 } Tile{ AsIs: (/45 Reuse: # Symbol/47 HalfReuse: # Name/50 AsIs: e.Name#1/48 HalfReuse: # NoOffset/51 } )/54 )/55 (/56 # E/57 s.ContextOffset#4/5/58 Tile{ AsIs: e.SubRange#1/43 } )/59 (/60 # Junk/61 (/62 # TkCloseADT/63 # NoOffset/64 )/65 )/66 (/67 # E/68 Tile{ HalfReuse: s.Num1 #42/46 AsIs: e.Range#1/37 AsIs: )/40 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/69 # AlgLeft/70 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } )/71 Tile{ AsIs: e.CmdSaves#4/26 } (/72 # CmdADT/73 # AlgLeft/74 Tile{ AsIs: s.Num#1/42 } s.ContextOffset#4/5/75 e.Name#1/48/76 )/78 )/79 Tile{ AsIs: >/1 ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </52 & DoGenSubst/53 Tile{ AsIs: </0 Reuse: & Inc2/4 AsIs: s.ContextOffset#4/5 HalfReuse: >/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # E/36 AsIs: s.Num#1/51 AsIs: e.Range#1/32 HalfReuse: )/44 HalfReuse: (/46 HalfReuse: # Junk/49 } (/54 # TkOpenADT/55 # NoOffset/56 Tile{ AsIs: )/50 } (/57 # Symbol/58 # Name/59 Tile{ AsIs: e.Name#1/47 } # NoOffset/60 Tile{ AsIs: )/45 AsIs: )/35 AsIs: (/39 Reuse: # E/41 } s.ContextOffset#4/5/61 Tile{ AsIs: e.SubRange#1/42 } Tile{ AsIs: )/9 } (/62 # Junk/63 (/64 # TkCloseADT/65 # NoOffset/66 Tile{ AsIs: )/40 } Tile{ AsIs: e.Junk#1/37 } )/67 Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars#1/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/68 # AlgLeft/69 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } )/70 Tile{ AsIs: e.CmdSaves#4/26 } (/71 # CmdADT/72 # AlgRight/73 s.Num#1/51/74 s.ContextOffset#4/5/75 e.Name#1/47/76 )/78 )/79 Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[52]);
      refalrts::alloc_name(vm, context[53], functions[efunc_DoGenSubst]);
      refalrts::alloc_open_bracket(vm, context[54]);
  ...
  do {
    ...
    do {
      ...
      do {
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ } </67 & DoGenSubst/68 Tile{ AsIs: </0 Reuse: & IncVarOffset/4 AsIs: s.ContextOffset#4/5 } Tile{ AsIs: s.Mode#1/50 } Tile{ HalfReuse: >/8 AsIs: e.Substs-B#1/28 AsIs: (/36 AsIs: # Junk/38 AsIs: e.Junk#1/34 HalfReuse: (/37 HalfReuse: # TkVariable/41 HalfReuse: s.Mode1 #59/43 } Tile{ AsIs: e.Index#1/45 } s.ContextOffset#4/5/69 )/70 Tile{ AsIs: )/9 } Tile{ AsIs: (/47 Reuse: # E/49 } Tile{ HalfReuse: s.Num1 #44/48 AsIs: e.Range#1/39 AsIs: )/42 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars-B#1/51 AsIs: (/57 AsIs: s.Mode#1/59 AsIs: (/62 AsIs: e.Index#1/64 AsIs: )/63 AsIs: e.Offsets#1/55 AsIs: s.SampleOffset#1/66 HalfReuse: s.ContextOffset4 #5/58 } )/71 Tile{ AsIs: e.Vars-E#1/53 } Tile{ AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/72 # AlgLeft/73 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } )/74 Tile{ AsIs: e.CmdSaves#4/26 } (/75 # CmdRepeated/76 # AlgLeft/77 Tile{ AsIs: s.Num#1/44 } s.Mode#1/59/78 s.ContextOffset#4/5/79 s.SampleOffset#1/66/80 )/81 )/82 Tile{ AsIs: >/1 ]] }
  ...
  do {
    ...
    do {
      ...
      do {
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } </67 & IncVarOffset/68 Tile{ AsIs: s.ContextOffset#4/5 } s.Mode#1/59/69 Tile{ HalfReuse: >/8 AsIs: e.Substs-B#1/28 AsIs: (/36 AsIs: # E/38 AsIs: s.Num#1/49 AsIs: e.Range#1/34 HalfReuse: )/46 HalfReuse: (/48 } # Junk/70 Tile{ AsIs: (/41 Reuse: # TkVariable/43 } Tile{ AsIs: s.Mode#1/50 AsIs: e.Index#1/44 HalfReuse: s.ContextOffset4 #5/47 AsIs: )/37 } Tile{ AsIs: e.Junk#1/39 } Tile{ AsIs: )/42 } Tile{ AsIs: e.Substs-E#1/30 } Tile{ AsIs: (/12 AsIs: e.Vars-B#1/51 AsIs: (/57 AsIs: s.Mode#1/59 AsIs: (/62 AsIs: e.Index#1/64 AsIs: )/63 AsIs: e.Offsets#1/55 AsIs: s.SampleOffset#1/66 HalfReuse: s.ContextOffset4 #5/58 } Tile{ AsIs: )/9 } Tile{ AsIs: e.Vars-E#1/53 } Tile{ AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/71 # AlgLeft/72 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } )/73 Tile{ AsIs: e.CmdSaves#4/26 } (/74 # CmdRepeated/75 # AlgRight/76 s.Num#1/49/77 s.Mode#1/59/78 s.ContextOffset#4/5/79 s.SampleOffset#1/66/80 )/81 )/82 Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_call(vm, context[67]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </49 & DoGenSubst/50 </51 Tile{ HalfReuse: & Add/0 HalfReuse: 1/4 AsIs: s.ContextOffset#4/5 HalfReuse: >/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk#1/32 HalfReuse: (/35 HalfReuse: # TkVariable/39 HalfReuse: 't'/41 } Tile{ AsIs: e.Index#1/43 } s.ContextOffset#4/5/52 )/53 )/54 Tile{ AsIs: (/12 } # E/55 Tile{ HalfReuse: s.Num1 #42/46 AsIs: e.Range#1/37 AsIs: )/40 AsIs: e.Substs-E#1/30 HalfReuse: (/9 } Tile{ AsIs: e.Vars#1/22 } (/56 't'/57 (/58 e.Index#1/43/59 )/61 s.ContextOffset#4/5/62 )/63 Tile{ AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/64 # AlgLeft/65 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } )/66 Tile{ AsIs: e.CmdSaves#4/26 } Tile{ AsIs: (/45 Reuse: # CmdVar/47 HalfReuse: # AlgLeft/48 } Tile{ AsIs: s.Num#1/42 } 't'/67 s.ContextOffset#4/5/68 )/69 )/70 Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[49]);
      refalrts::alloc_name(vm, context[50], functions[efunc_DoGenSubst]);
      refalrts::alloc_open_call(vm, context[51]);
      refalrts::copy_stvar(vm, context[52], context[5]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </49 & DoGenSubst/50 </51 Tile{ HalfReuse: & Add/0 HalfReuse: 1/4 AsIs: s.ContextOffset#4/5 HalfReuse: >/8 AsIs: e.Substs-B#1/28 AsIs: (/34 AsIs: # E/36 AsIs: s.Num#1/48 AsIs: e.Range#1/32 HalfReuse: )/44 HalfReuse: (/46 HalfReuse: # Junk/47 } (/52 # TkVariable/53 't'/54 Tile{ AsIs: e.Index#1/42 } Tile{ HalfReuse: s.ContextOffset4 #5/39 HalfReuse: )/41 AsIs: e.Junk#1/37 AsIs: )/40 AsIs: e.Substs-E#1/30 HalfReuse: (/9 } Tile{ AsIs: e.Vars#1/22 } Tile{ AsIs: (/12 } 't'/55 (/56 e.Index#1/42/57 )/59 s.ContextOffset#4/5/60 )/61 Tile{ AsIs: )/13 AsIs: (/16 AsIs: e.Commands0#1/24 HalfReuse: (/17 } # CmdOpenedE/62 # AlgLeft/63 Tile{ AsIs: s.Num0#1/18 AsIs: s.VarOffset0#2/19 } )/64 Tile{ AsIs: e.CmdSaves#4/26 } (/65 # CmdVar/66 # AlgRight/67 s.Num#1/48/68 't'/69 s.ContextOffset#4/5/70 Tile{ AsIs: )/45 AsIs: )/35 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[49]);
      refalrts::alloc_name(vm, context[50], functions[efunc_DoGenSubst]);
      refalrts::alloc_open_call(vm, context[51]);
      refalrts::alloc_open_bracket(vm, context[52]);
