...
#define cookie_ns cookie_ns_142478646_1471829362
#define COOKIE1_ 142478646U
#define COOKIE2_ 1471829362U
...
enum efunc {
  ...
  efunc_DoGenSubst = 18,
  efunc_Inc2 = 19,
  efunc_IncVarOffset = 20,
  efunc_PrintVar = 21,
  efunc_gen_DoGenSubst_S36A3Z1 = 22,
  efunc_MakeSavers = 23,
  ...
  efunc_Evm_met = 27,
  efunc_Residue = 28,
  efunc_u_u_Metau_Residue = 29,
  efunc_MapAccum = 30,
  efunc_UnBracket = 31,
  efunc_DelAccumulator = 32,
  efunc_Inc = 33,
  efunc_Dec = 34,
  efunc_GenSubstm_Simple = 35,
  efunc_gen_Apply_Z4 = 36,
  efunc_gen_DoGenSubst_Z2 = 37,
  efunc_gen_DoGenSubst_S36A3Z0 = 38,
  efunc_gen_DoGenSubst_S36A3Z3 = 39,
  efunc_gen_DoGenSubst_Z0 = 40,
};
...
enum ident {
  ...
  ident_CmdBrackets = 17,
  ident_ADTm_Brackets = 18,
  ident_TkOpenADT = 19,
  ident_TkCloseADT = 20,
  ident_CmdADT = 21,
  ident_Var = 22,
  ident_CmdRepeated = 23,
  ident_CmdVar = 24,
  ident_S = 25,
  ident_AlgLeft = 26,
  ident_AlgRight = 27,
...
static refalrts::FnResult func_GenSubstm_Simple(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & GenSubst-Simple/4 s.ContextTop/13 e.Substitutes/2 (/11 e.Vars/9 )/12 (/7 e.PrefixCommands/5 )/8 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
...
static refalrts::FnResult func_DoGenSubst(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 } </45 & Inc2/46 Tile{ AsIs: s.ContextOffset/13 } >/47 Tile{ AsIs: e.Substs-B/20 } Tile{ AsIs: (/26 AsIs: # Junk/28 AsIs: e.Junk1/24 HalfReuse: (/27 HalfReuse: # TkOpenBracket/31 Reuse: # NoOffset/33 } )/48 )/49 Tile{ AsIs: (/41 Reuse: # E/43 } s.ContextOffset/13/50 Tile{ AsIs: e.SubRange/39 } )/51 (/52 # Junk/53 Tile{ HalfReuse: (/42 HalfReuse: # TkCloseBracket/32 HalfReuse: # NoOffset/36 HalfReuse: )/38 AsIs: e.Junk2/34 AsIs: )/37 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdBrackets/1 } # AlgTerm/54 Tile{ AsIs: s.Num/44 } s.ContextOffset/13/55 )/56 )/57 >/58 Tile{ ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 } </49 & Inc2/50 Tile{ AsIs: s.ContextOffset/13 } >/51 Tile{ AsIs: e.Substs-B/20 } Tile{ AsIs: (/26 AsIs: # Junk/28 AsIs: e.Junk1/24 HalfReuse: (/27 HalfReuse: # TkOpenADT/31 Reuse: # NoOffset/33 } )/52 Tile{ AsIs: (/41 Reuse: # Symbol/43 HalfReuse: # Name/46 AsIs: e.Name/44 HalfReuse: # NoOffset/47 } )/53 )/54 (/55 # E/56 s.ContextOffset/13/57 Tile{ AsIs: e.SubRange/39 } )/58 (/59 # Junk/60 Tile{ HalfReuse: (/42 HalfReuse: # TkCloseADT/32 HalfReuse: # NoOffset/36 HalfReuse: )/38 AsIs: e.Junk2/34 AsIs: )/37 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdADT/1 } # AlgTerm/61 Tile{ AsIs: s.Num/48 } s.ContextOffset/13/62 e.Name/44/63 )/65 )/66 >/67 Tile{ ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.Num/34 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 AsIs: s.ContextOffset/13 AsIs: e.Substs-B/20 AsIs: (/26 AsIs: # Junk/28 AsIs: e.Junk/24 HalfReuse: (/27 HalfReuse: # Symbol/31 Reuse: # Char/33 } s.Char/41/42 # NoOffset/43 )/44 )/45 Tile{ AsIs: (/37 } # E/46 Tile{ HalfReuse: s.Num34 /38 AsIs: e.Range/29 AsIs: )/32 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdChar/1 } Tile{ Reuse: # AlgLeft/39 HalfReuse: s.Num34 /40 AsIs: s.Char/41 } )/47 )/48 >/49 Tile{ ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.Num/34 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 AsIs: s.ContextOffset/13 AsIs: e.Substs-B/20 AsIs: (/26 AsIs: # Junk/28 AsIs: e.Junk/24 HalfReuse: (/27 HalfReuse: # Symbol/31 Reuse: # Number/33 } s.Number/41/42 # NoOffset/43 )/44 )/45 Tile{ AsIs: (/37 } # E/46 Tile{ HalfReuse: s.Num34 /38 AsIs: e.Range/29 AsIs: )/32 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdNumber/1 } Tile{ Reuse: # AlgLeft/39 HalfReuse: s.Num34 /40 AsIs: s.Number/41 } )/47 )/48 >/49 Tile{ ]] }
      refalrts::copy_stvar(vm, context[42], context[41]);
      refalrts::alloc_ident(vm, context[43], identifiers[ident_NoOffset]);
      refalrts::alloc_close_bracket(vm, context[44]);
      refalrts::alloc_close_bracket(vm, context[45]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} e.Junk/24 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 AsIs: s.ContextOffset/13 AsIs: e.Substs-B/20 AsIs: (/26 AsIs: # Junk/28 } Tile{ AsIs: (/37 AsIs: # Symbol/39 AsIs: # Name/40 } Tile{ AsIs: e.Name/35 } # NoOffset/41 )/42 Tile{ AsIs: )/27 AsIs: (/31 AsIs: # E/33 } Tile{ HalfReuse: s.Num34 /38 AsIs: e.Range/29 AsIs: )/32 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdName/1 } # AlgLeft/43 Tile{ AsIs: s.Num/34 } e.Name/35/44 )/46 )/47 >/48 Tile{ ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 AsIs: s.ContextOffset/13 AsIs: e.Substs-B/20 AsIs: (/26 AsIs: # Junk/28 AsIs: e.Junk/24 HalfReuse: (/27 HalfReuse: # Symbol/31 Reuse: # Identifier/33 } Tile{ AsIs: e.Name/35 } # NoOffset/41 )/42 )/43 Tile{ AsIs: (/37 Reuse: # E/39 } Tile{ HalfReuse: s.Num34 /38 AsIs: e.Range/29 AsIs: )/32 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdIdent/1 } Tile{ Reuse: # AlgLeft/40 } Tile{ AsIs: s.Num/34 } e.Name/35/44 )/46 )/47 >/48 Tile{ ]] }
      refalrts::alloc_ident(vm, context[41], identifiers[ident_NoOffset]);
      refalrts::alloc_close_bracket(vm, context[42]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 AsIs: s.ContextOffset/13 AsIs: e.Substs-B/20 AsIs: (/26 AsIs: # E/28 AsIs: s.Num/40 AsIs: e.Range/24 HalfReuse: )/36 HalfReuse: (/38 Reuse: # Junk/39 } (/42 # Symbol/43 Tile{ HalfReuse: # Char/37 HalfReuse: s.Char41 /27 HalfReuse: # NoOffset/31 HalfReuse: )/33 AsIs: e.Junk/29 AsIs: )/32 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdChar/1 } # AlgRight/44 s.Num/40/45 Tile{ AsIs: s.Char/41 } )/46 )/47 >/48 Tile{ ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 AsIs: s.ContextOffset/13 AsIs: e.Substs-B/20 AsIs: (/26 AsIs: # E/28 AsIs: s.Num/40 AsIs: e.Range/24 HalfReuse: )/36 HalfReuse: (/38 Reuse: # Junk/39 } (/42 # Symbol/43 Tile{ HalfReuse: # Number/37 HalfReuse: s.Number41 /27 HalfReuse: # NoOffset/31 HalfReuse: )/33 AsIs: e.Junk/29 AsIs: )/32 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdNumber/1 } # AlgRight/44 s.Num/40/45 Tile{ AsIs: s.Number/41 } )/46 )/47 >/48 Tile{ ]] }
      refalrts::alloc_open_bracket(vm, context[42]);
      refalrts::alloc_ident(vm, context[43], identifiers[ident_Symbol]);
      refalrts::alloc_ident(vm, context[44], identifiers[ident_AlgRight]);
      refalrts::copy_stvar(vm, context[45], context[40]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 AsIs: s.ContextOffset/13 AsIs: e.Substs-B/20 AsIs: (/26 AsIs: # E/28 AsIs: s.Num/40 AsIs: e.Range/24 HalfReuse: )/36 HalfReuse: (/38 Reuse: # Junk/39 } (/41 # Symbol/42 # Name/43 e.Name/34/44 Tile{ HalfReuse: # NoOffset/31 HalfReuse: )/33 AsIs: e.Junk/29 AsIs: )/32 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdName/1 } # AlgRight/46 s.Num/40/47 Tile{ AsIs: e.Name/34 } Tile{ AsIs: )/37 AsIs: )/27 } >/48 Tile{ ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 AsIs: s.ContextOffset/13 AsIs: e.Substs-B/20 AsIs: (/26 AsIs: # E/28 AsIs: s.Num/40 AsIs: e.Range/24 HalfReuse: )/36 HalfReuse: (/38 Reuse: # Junk/39 } (/41 # Symbol/42 # Identifier/43 e.Name/34/44 Tile{ HalfReuse: # NoOffset/31 HalfReuse: )/33 AsIs: e.Junk/29 AsIs: )/32 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdIdent/1 } # AlgRight/46 s.Num/40/47 Tile{ AsIs: e.Name/34 } Tile{ AsIs: )/37 AsIs: )/27 } >/48 Tile{ ]] }
      refalrts::alloc_open_bracket(vm, context[41]);
      refalrts::alloc_ident(vm, context[42], identifiers[ident_Symbol]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 } </40 & Inc2/41 s.ContextOffset/13/42 >/43 Tile{ AsIs: e.Substs-B/20 } Tile{ AsIs: (/26 AsIs: # Junk/28 AsIs: e.Junk/24 HalfReuse: (/27 HalfReuse: # TkOpenBracket/31 Reuse: # NoOffset/33 } )/44 )/45 Tile{ AsIs: (/37 Reuse: # E/39 } Tile{ AsIs: s.ContextOffset/13 } Tile{ AsIs: e.SubRange/35 } )/46 (/47 # Junk/48 (/49 # TkCloseBracket/50 # NoOffset/51 )/52 )/53 (/54 # E/55 Tile{ HalfReuse: s.Num34 /38 AsIs: e.Range/29 AsIs: )/32 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdBrackets/1 } # AlgLeft/56 Tile{ AsIs: s.Num/34 } s.ContextOffset/13/57 )/58 )/59 >/60 Tile{ ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 } </40 & Inc2/41 Tile{ AsIs: s.ContextOffset/13 } >/42 Tile{ AsIs: e.Substs-B/20 } Tile{ AsIs: (/26 AsIs: # E/28 AsIs: s.Num/39 AsIs: e.Range/24 HalfReuse: )/36 HalfReuse: (/38 } # Junk/43 (/44 # TkOpenBracket/45 # NoOffset/46 )/47 )/48 (/49 # E/50 s.ContextOffset/13/51 Tile{ AsIs: e.SubRange/34 } )/52 (/53 # Junk/54 Tile{ HalfReuse: (/37 HalfReuse: # TkCloseBracket/27 HalfReuse: # NoOffset/31 HalfReuse: )/33 AsIs: e.Junk/29 AsIs: )/32 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdBrackets/1 } # AlgRight/55 s.Num/39/56 s.ContextOffset/13/57 )/58 )/59 >/60 Tile{ ]] }
      refalrts::alloc_open_call(vm, context[40]);
      refalrts::alloc_name(vm, context[41], functions[efunc_Inc2]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 } </44 & Inc2/45 Tile{ AsIs: s.ContextOffset/13 } >/46 Tile{ AsIs: e.Substs-B/20 } Tile{ AsIs: (/26 AsIs: # Junk/28 AsIs: e.Junk/24 HalfReuse: (/27 HalfReuse: # TkOpenADT/31 Reuse: # NoOffset/33 } )/47 Tile{ AsIs: (/37 Reuse: # Symbol/39 HalfReuse: # Name/42 AsIs: e.Name/40 HalfReuse: # NoOffset/43 } )/48 )/49 (/50 # E/51 s.ContextOffset/13/52 Tile{ AsIs: e.SubRange/35 } )/53 (/54 # Junk/55 (/56 # TkCloseADT/57 # NoOffset/58 )/59 )/60 (/61 # E/62 Tile{ HalfReuse: s.Num34 /38 AsIs: e.Range/29 AsIs: )/32 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdADT/1 } # AlgLeft/63 Tile{ AsIs: s.Num/34 } s.ContextOffset/13/64 e.Name/40/65 )/67 )/68 >/69 Tile{ ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 } </44 & Inc2/45 Tile{ AsIs: s.ContextOffset/13 } >/46 Tile{ AsIs: e.Substs-B/20 } Tile{ AsIs: (/26 AsIs: # E/28 AsIs: s.Num/43 AsIs: e.Range/24 HalfReuse: )/36 HalfReuse: (/38 HalfReuse: # Junk/41 } (/47 # TkOpenADT/48 # NoOffset/49 Tile{ AsIs: )/42 } (/50 # Symbol/51 # Name/52 Tile{ AsIs: e.Name/39 } # NoOffset/53 )/54 )/55 (/56 # E/57 s.ContextOffset/13/58 Tile{ AsIs: e.SubRange/34 } )/59 (/60 # Junk/61 Tile{ HalfReuse: (/37 HalfReuse: # TkCloseADT/27 HalfReuse: # NoOffset/31 HalfReuse: )/33 AsIs: e.Junk/29 AsIs: )/32 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdADT/1 } # AlgRight/62 s.Num/43/63 s.ContextOffset/13/64 e.Name/39/65 )/67 )/68 >/69 Tile{ ]] }
      refalrts::alloc_open_call(vm, context[44]);
      refalrts::alloc_name(vm, context[45], functions[efunc_Inc2]);
      refalrts::alloc_close_call(vm, context[46]);
      refalrts::alloc_open_bracket(vm, context[47]);
  ...
  do {
    ...
    do {
      ...
      do {
        ...
        //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 } </59 Tile{ HalfReuse: & IncVarOffset/39 HalfReuse: s.ContextOffset13 /41 AsIs: s.Mode/42 } >/60 Tile{ AsIs: e.Substs-B/20 } Tile{ AsIs: (/28 AsIs: # Junk/30 AsIs: e.Junk/26 HalfReuse: (/29 HalfReuse: # Var/33 HalfReuse: s.Mode51 /35 } Tile{ AsIs: e.Index/37 } Tile{ AsIs: s.ContextOffset/13 } )/61 )/62 (/63 # E/64 Tile{ HalfReuse: s.Num36 /40 AsIs: e.Range/31 AsIs: )/34 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars-B/43 AsIs: (/49 AsIs: s.Mode/51 AsIs: (/54 AsIs: e.Index/56 AsIs: )/55 AsIs: e.Offsets/47 AsIs: s.SampleOffset/58 HalfReuse: s.ContextOffset13 /50 } )/65 Tile{ AsIs: e.Vars-E/45 } Tile{ AsIs: )/12 AsIs: (/7 AsIs: e.Commands/18 HalfReuse: (/8 HalfReuse: # CmdRepeated/1 } # AlgLeft/66 Tile{ AsIs: s.Num/36 } s.Mode/51/67 s.ContextOffset/13/68 s.SampleOffset/58/69 )/70 )/71 >/72 Tile{ ]] }
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 } </41 & Add/42 1/43 Tile{ AsIs: s.ContextOffset/13 } >/44 Tile{ AsIs: e.Substs-B/20 } Tile{ AsIs: (/26 AsIs: # Junk/28 AsIs: e.Junk/24 HalfReuse: (/27 HalfReuse: # Var/31 HalfReuse: 't'/33 } Tile{ AsIs: e.Index/35 } s.ContextOffset/13/45 )/46 )/47 (/48 # E/49 Tile{ HalfReuse: s.Num34 /38 AsIs: e.Range/29 AsIs: )/32 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 HalfReuse: (/12 HalfReuse: 't'/7 } (/50 e.Index/35/51 )/53 s.ContextOffset/13/54 )/55 )/56 (/57 Tile{ AsIs: e.Commands/18 } Tile{ AsIs: (/37 Reuse: # CmdVar/39 HalfReuse: # AlgLeft/40 } Tile{ AsIs: s.Num/34 } 't'/58 s.ContextOffset/13/59 )/60 Tile{ AsIs: )/8 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[41]);
      refalrts::alloc_name(vm, context[42], functions[efunc_Add]);
      refalrts::alloc_number(vm, context[43], 1UL);
      refalrts::alloc_close_call(vm, context[44]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenSubst/4 } </41 & Add/42 1/43 Tile{ AsIs: s.ContextOffset/13 } >/44 Tile{ AsIs: e.Substs-B/20 } Tile{ AsIs: (/26 AsIs: # E/28 AsIs: s.Num/40 AsIs: e.Range/24 HalfReuse: )/36 HalfReuse: (/38 HalfReuse: # Junk/39 } (/45 # Var/46 't'/47 Tile{ AsIs: e.Index/34 } Tile{ HalfReuse: s.ContextOffset13 /31 HalfReuse: )/33 AsIs: e.Junk/29 AsIs: )/32 AsIs: e.Substs-E/22 AsIs: (/11 AsIs: e.Vars/16 HalfReuse: (/12 HalfReuse: 't'/7 } (/48 e.Index/34/49 )/51 s.ContextOffset/13/52 Tile{ AsIs: )/37 AsIs: )/27 } (/53 Tile{ AsIs: e.Commands/18 } (/54 # CmdVar/55 # AlgRight/56 s.Num/40/57 't'/58 s.ContextOffset/13/59 )/60 Tile{ AsIs: )/8 AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[41]);
      refalrts::alloc_name(vm, context[42], functions[efunc_Add]);
      refalrts::alloc_number(vm, context[43], 1UL);
      refalrts::alloc_close_call(vm, context[44]);
...
static refalrts::FnResult func_gen_DoGenSubst_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset$a/5 {REMOVED TILE} s.Num/53 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset$a5 /8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk1/32 HalfReuse: (/35 HalfReuse: # Symbol/39 Reuse: # Char/41 } Tile{ HalfReuse: s.Char54 /1 } # NoOffset/55 Tile{ HalfReuse: )/46 AsIs: e.Junk2/42 AsIs: )/45 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/56 # AlgLeft/57 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves/26 } (/58 Tile{ HalfReuse: # CmdChar/49 Reuse: # AlgTerm/51 HalfReuse: s.Num53 /52 AsIs: s.Char/54 AsIs: )/50 AsIs: )/40 HalfReuse: >/44 } Tile{ ]] }
      refalrts::alloc_ident(vm, context[55], identifiers[ident_NoOffset]);
      ...
      refalrts::reinit_svar( context[1], context[54] );
      ...
      refalrts::link_brackets( context[58], context[50] );
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset$a/5 {REMOVED TILE} s.Num/53 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset$a5 /8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk1/32 HalfReuse: (/35 HalfReuse: # Symbol/39 Reuse: # Name/41 } e.Name/47/54 # NoOffset/56 Tile{ HalfReuse: )/46 AsIs: e.Junk2/42 AsIs: )/45 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } Tile{ HalfReuse: # CmdOpenedE/1 } # AlgLeft/57 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves/26 } (/58 Tile{ HalfReuse: # CmdName/49 Reuse: # AlgTerm/51 HalfReuse: s.Num53 /52 AsIs: e.Name/47 AsIs: )/50 AsIs: )/40 HalfReuse: >/44 } Tile{ ]] }
      refalrts::copy_evar(vm, context[54], context[55], context[47], context[48]);
      refalrts::alloc_ident(vm, context[56], identifiers[ident_NoOffset]);
      refalrts::alloc_ident(vm, context[57], identifiers[ident_AlgLeft]);
      refalrts::alloc_open_bracket(vm, context[58]);
      refalrts::update_name(context[4], functions[efunc_DoGenSubst]);
      refalrts::reinit_svar( context[8], context[5] );
      ...
      refalrts::reinit_close_bracket(context[46]);
      refalrts::reinit_open_bracket(context[17]);
      refalrts::reinit_ident(context[1], identifiers[ident_CmdOpenedE]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset$a/5 {REMOVED TILE} s.Num/53 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset$a5 /8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk1/32 HalfReuse: (/35 HalfReuse: # Symbol/39 Reuse: # Identifier/41 } e.Ident/47/54 # NoOffset/56 Tile{ HalfReuse: )/46 AsIs: e.Junk2/42 AsIs: )/45 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } Tile{ HalfReuse: # CmdOpenedE/1 } # AlgLeft/57 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves/26 } (/58 Tile{ HalfReuse: # CmdIdent/49 Reuse: # AlgTerm/51 HalfReuse: s.Num53 /52 AsIs: e.Ident/47 AsIs: )/50 AsIs: )/40 HalfReuse: >/44 } Tile{ ]] }
      refalrts::copy_evar(vm, context[54], context[55], context[47], context[48]);
      refalrts::alloc_ident(vm, context[56], identifiers[ident_NoOffset]);
      refalrts::alloc_ident(vm, context[57], identifiers[ident_AlgLeft]);
      refalrts::alloc_open_bracket(vm, context[58]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset$a/5 {REMOVED TILE} s.Num/53 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset$a5 /8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk1/32 HalfReuse: (/35 HalfReuse: # Symbol/39 Reuse: # Number/41 } Tile{ HalfReuse: s.Value54 /1 } # NoOffset/55 Tile{ HalfReuse: )/46 AsIs: e.Junk2/42 AsIs: )/45 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/56 # AlgLeft/57 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves/26 } (/58 Tile{ HalfReuse: # CmdNumber/49 Reuse: # AlgTerm/51 HalfReuse: s.Num53 /52 AsIs: s.Value/54 AsIs: )/50 AsIs: )/40 HalfReuse: >/44 } Tile{ ]] }
      refalrts::alloc_ident(vm, context[55], identifiers[ident_NoOffset]);
      refalrts::alloc_ident(vm, context[56], identifiers[ident_CmdOpenedE]);
      refalrts::alloc_ident(vm, context[57], identifiers[ident_AlgLeft]);
      refalrts::alloc_open_bracket(vm, context[58]);
  ...
  do {
    ...
    do {
      ...
      //RESULT: Tile{ [[ } </53 & DoGenSubst/54 Tile{ AsIs: </0 Reuse: & Inc2/4 AsIs: s.ContextOffset$a/5 HalfReuse: >/8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk1/32 HalfReuse: (/35 HalfReuse: # TkOpenBracket/39 Reuse: # NoOffset/41 } Tile{ AsIs: )/9 } )/55 (/56 Tile{ HalfReuse: # E/49 HalfReuse: s.ContextOffset$a5 /51 AsIs: e.SubRange/47 AsIs: )/50 HalfReuse: (/40 HalfReuse: # Junk/44 HalfReuse: (/46 } # TkCloseBracket/57 # NoOffset/58 Tile{ AsIs: )/45 } Tile{ AsIs: e.Junk2/42 } )/59 Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/60 # AlgLeft/61 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } )/62 Tile{ AsIs: e.CmdSaves/26 } (/63 # CmdBrackets/64 # AlgTerm/65 Tile{ AsIs: s.Num/52 } s.ContextOffset$a/5/66 )/67 )/68 Tile{ AsIs: >/1 ]] }
      ...
      refalrts::alloc_close_bracket(vm, context[62]);
      refalrts::alloc_open_bracket(vm, context[63]);
      refalrts::alloc_ident(vm, context[64], identifiers[ident_CmdBrackets]);
      refalrts::alloc_ident(vm, context[65], identifiers[ident_AlgTerm]);
      ...
      refalrts::update_ident(context[41], identifiers[ident_NoOffset]);
      ...
      refalrts::link_brackets( context[12], context[13] );
      refalrts::link_brackets( context[40], context[59] );
  ...
  do {
    ...
    do {
      ...
      //RESULT: Tile{ [[ } </57 & DoGenSubst/58 Tile{ AsIs: </0 Reuse: & Inc2/4 AsIs: s.ContextOffset$a/5 HalfReuse: >/8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk1/32 HalfReuse: (/35 HalfReuse: # TkOpenADT/39 Reuse: # NoOffset/41 } Tile{ AsIs: )/9 } Tile{ AsIs: (/49 Reuse: # Symbol/51 HalfReuse: # Name/54 AsIs: e.Name/52 HalfReuse: # NoOffset/55 } Tile{ AsIs: )/50 AsIs: )/40 AsIs: (/44 Reuse: # E/46 } s.ContextOffset$a/5/59 Tile{ AsIs: e.SubRange/47 } Tile{ AsIs: )/45 } (/60 # Junk/61 (/62 # TkCloseADT/63 # NoOffset/64 )/65 Tile{ AsIs: e.Junk2/42 } )/66 Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/67 # AlgLeft/68 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } )/69 Tile{ AsIs: e.CmdSaves/26 } (/70 # CmdADT/71 # AlgTerm/72 Tile{ AsIs: s.Num/56 } s.ContextOffset$a/5/73 e.Name/52/74 )/76 )/77 Tile{ AsIs: >/1 ]] }
      ...
      refalrts::alloc_ident(vm, context[63], identifiers[ident_TkCloseADT]);
      refalrts::alloc_ident(vm, context[64], identifiers[ident_NoOffset]);
      refalrts::alloc_close_bracket(vm, context[65]);
      refalrts::alloc_close_bracket(vm, context[66]);
      refalrts::alloc_ident(vm, context[67], identifiers[ident_CmdOpenedE]);
      refalrts::alloc_ident(vm, context[68], identifiers[ident_AlgLeft]);
      refalrts::alloc_close_bracket(vm, context[69]);
      refalrts::alloc_open_bracket(vm, context[70]);
      refalrts::alloc_ident(vm, context[71], identifiers[ident_CmdADT]);
      refalrts::alloc_ident(vm, context[72], identifiers[ident_AlgTerm]);
      refalrts::copy_stvar(vm, context[73], context[5]);
      refalrts::copy_evar(vm, context[74], context[75], context[52], context[53]);
  ...
  do {
    ...
    do {
      ...
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset$a5 /8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk/32 HalfReuse: (/35 HalfReuse: # Symbol/39 Reuse: # Char/41 } s.Char/49/50 # NoOffset/51 Tile{ AsIs: )/40 } )/52 (/53 # E/54 Tile{ AsIs: s.Num/42 } Tile{ AsIs: e.Range/37 } Tile{ AsIs: )/9 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/55 # AlgLeft/56 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } )/57 Tile{ AsIs: e.CmdSaves/26 } (/58 Tile{ HalfReuse: # CmdChar/45 Reuse: # AlgLeft/47 HalfReuse: s.Num42 /48 AsIs: s.Char/49 AsIs: )/46 } )/59 Tile{ AsIs: >/1 ]] }
      refalrts::copy_stvar(vm, context[50], context[49]);
      refalrts::alloc_ident(vm, context[51], identifiers[ident_NoOffset]);
      refalrts::alloc_close_bracket(vm, context[52]);
      refalrts::alloc_open_bracket(vm, context[53]);
      ...
      refalrts::update_ident(context[41], identifiers[ident_Char]);
      refalrts::reinit_open_bracket(context[17]);
      refalrts::reinit_ident(context[45], identifiers[ident_CmdChar]);
      refalrts::update_ident(context[47], identifiers[ident_AlgLeft]);
      refalrts::reinit_svar( context[48], context[42] );
      refalrts::push_stack( vm, context[1] );
      refalrts::push_stack( vm, context[0] );
      refalrts::link_brackets( context[16], context[59] );
      refalrts::link_brackets( context[58], context[46] );
      refalrts::link_brackets( context[17], context[57] );
      refalrts::link_brackets( context[12], context[13] );
      refalrts::link_brackets( context[53], context[9] );
      refalrts::link_brackets( context[34], context[52] );
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset$a/5 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset$a5 /8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk/32 HalfReuse: (/35 HalfReuse: # Symbol/39 Reuse: # Number/41 } s.Number/49/50 # NoOffset/51 Tile{ AsIs: )/40 } )/52 (/53 # E/54 Tile{ AsIs: s.Num/42 } Tile{ AsIs: e.Range/37 } Tile{ AsIs: )/9 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/55 # AlgLeft/56 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } )/57 Tile{ AsIs: e.CmdSaves/26 } (/58 Tile{ HalfReuse: # CmdNumber/45 Reuse: # AlgLeft/47 HalfReuse: s.Num42 /48 AsIs: s.Number/49 AsIs: )/46 } )/59 Tile{ AsIs: >/1 ]] }
      refalrts::copy_stvar(vm, context[50], context[49]);
      refalrts::alloc_ident(vm, context[51], identifiers[ident_NoOffset]);
      refalrts::alloc_close_bracket(vm, context[52]);
      refalrts::alloc_open_bracket(vm, context[53]);
      ...
      refalrts::update_ident(context[41], identifiers[ident_Number]);
      refalrts::reinit_open_bracket(context[17]);
      refalrts::reinit_ident(context[45], identifiers[ident_CmdNumber]);
      refalrts::update_ident(context[47], identifiers[ident_AlgLeft]);
      refalrts::reinit_svar( context[48], context[42] );
      refalrts::push_stack( vm, context[1] );
      refalrts::push_stack( vm, context[0] );
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} e.Junk/32 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 AsIs: s.ContextOffset$a/5 } Tile{ AsIs: e.Substs-B/28 } Tile{ AsIs: (/34 AsIs: # Junk/36 } Tile{ AsIs: (/45 AsIs: # Symbol/47 AsIs: # Name/48 AsIs: e.Name/43 HalfReuse: # NoOffset/46 } Tile{ AsIs: )/9 } Tile{ AsIs: )/35 AsIs: (/39 AsIs: # E/41 AsIs: s.Num/42 } Tile{ AsIs: e.Range/37 } Tile{ AsIs: )/40 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/49 # AlgLeft/50 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } )/51 Tile{ AsIs: e.CmdSaves/26 } Tile{ AsIs: (/8 } # CmdName/52 # AlgLeft/53 s.Num/42/54 e.Name/43/55 )/57 )/58 Tile{ AsIs: >/1 ]] }
      refalrts::alloc_ident(vm, context[49], identifiers[ident_CmdOpenedE]);
      refalrts::alloc_ident(vm, context[50], identifiers[ident_AlgLeft]);
      refalrts::alloc_close_bracket(vm, context[51]);
      refalrts::alloc_ident(vm, context[52], identifiers[ident_CmdName]);
      refalrts::alloc_ident(vm, context[53], identifiers[ident_AlgLeft]);
      refalrts::copy_stvar(vm, context[54], context[42]);
      refalrts::copy_evar(vm, context[55], context[56], context[43], context[44]);
      refalrts::alloc_close_bracket(vm, context[57]);
      refalrts::alloc_close_bracket(vm, context[58]);
      refalrts::update_name(context[4], functions[efunc_DoGenSubst]);
      refalrts::reinit_ident(context[46], identifiers[ident_NoOffset]);
      refalrts::reinit_open_bracket(context[17]);
      refalrts::push_stack( vm, context[1] );
      refalrts::push_stack( vm, context[0] );
      refalrts::link_brackets( context[16], context[58] );
      refalrts::link_brackets( context[8], context[57] );
      refalrts::link_brackets( context[17], context[51] );
      refalrts::link_brackets( context[12], context[13] );
      ...
      refalrts::use(trash_prev);
      refalrts::Iter res = context[1];
      res = refalrts::splice_evar( res, context[52], context[58] );
      res = refalrts::splice_elem( res, context[8] );
      res = refalrts::splice_evar( res, context[26], context[27] );
      res = refalrts::splice_elem( res, context[51] );
      res = refalrts::splice_evar( res, context[18], context[19] );
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset$a/5 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset$a5 /8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk/32 HalfReuse: (/35 HalfReuse: # Symbol/39 Reuse: # Identifier/41 } e.Name/43/49 # NoOffset/51 )/52 Tile{ AsIs: )/9 } (/53 # E/54 Tile{ AsIs: s.Num/42 } Tile{ AsIs: e.Range/37 } Tile{ AsIs: )/40 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/55 # AlgLeft/56 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } )/57 Tile{ AsIs: e.CmdSaves/26 } (/58 Tile{ HalfReuse: # CmdIdent/45 Reuse: # AlgLeft/47 HalfReuse: s.Num42 /48 AsIs: e.Name/43 AsIs: )/46 } )/59 Tile{ AsIs: >/1 ]] }
      ...
      refalrts::update_ident(context[41], identifiers[ident_Identifier]);
      refalrts::reinit_open_bracket(context[17]);
      refalrts::reinit_ident(context[45], identifiers[ident_CmdIdent]);
      refalrts::update_ident(context[47], identifiers[ident_AlgLeft]);
      refalrts::reinit_svar( context[48], context[42] );
      refalrts::push_stack( vm, context[1] );
      refalrts::push_stack( vm, context[0] );
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset$a/5 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset$a5 /8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # E/36 AsIs: s.Num/48 AsIs: e.Range/32 HalfReuse: )/44 HalfReuse: (/46 Reuse: # Junk/47 } (/50 # Symbol/51 Tile{ HalfReuse: # Char/45 HalfReuse: s.Char49 /35 HalfReuse: # NoOffset/39 HalfReuse: )/41 AsIs: e.Junk/37 AsIs: )/40 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/52 # AlgLeft/53 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves/26 } (/54 # CmdChar/55 # AlgRight/56 s.Num/48/57 Tile{ AsIs: s.Char/49 } )/58 )/59 Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[50]);
      refalrts::alloc_ident(vm, context[51], identifiers[ident_Symbol]);
      refalrts::alloc_ident(vm, context[52], identifiers[ident_CmdOpenedE]);
      refalrts::alloc_ident(vm, context[53], identifiers[ident_AlgLeft]);
      refalrts::alloc_open_bracket(vm, context[54]);
      refalrts::alloc_ident(vm, context[55], identifiers[ident_CmdChar]);
      refalrts::alloc_ident(vm, context[56], identifiers[ident_AlgRight]);
      refalrts::copy_stvar(vm, context[57], context[48]);
      refalrts::alloc_close_bracket(vm, context[58]);
      refalrts::alloc_close_bracket(vm, context[59]);
      refalrts::update_name(context[4], functions[efunc_DoGenSubst]);
      refalrts::reinit_svar( context[8], context[5] );
      ...
      refalrts::reinit_ident(context[39], identifiers[ident_NoOffset]);
      ...
      refalrts::link_brackets( context[50], context[41] );
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset$a/5 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset$a5 /8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # E/36 AsIs: s.Num/48 AsIs: e.Range/32 HalfReuse: )/44 HalfReuse: (/46 Reuse: # Junk/47 } (/50 # Symbol/51 Tile{ HalfReuse: # Number/45 HalfReuse: s.Number49 /35 HalfReuse: # NoOffset/39 HalfReuse: )/41 AsIs: e.Junk/37 AsIs: )/40 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/52 # AlgLeft/53 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves/26 } (/54 # CmdNumber/55 # AlgRight/56 s.Num/48/57 Tile{ AsIs: s.Number/49 } )/58 )/59 Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[50]);
      refalrts::alloc_ident(vm, context[51], identifiers[ident_Symbol]);
      refalrts::alloc_ident(vm, context[52], identifiers[ident_CmdOpenedE]);
      refalrts::alloc_ident(vm, context[53], identifiers[ident_AlgLeft]);
      refalrts::alloc_open_bracket(vm, context[54]);
      refalrts::alloc_ident(vm, context[55], identifiers[ident_CmdNumber]);
      refalrts::alloc_ident(vm, context[56], identifiers[ident_AlgRight]);
      refalrts::copy_stvar(vm, context[57], context[48]);
      refalrts::alloc_close_bracket(vm, context[58]);
      refalrts::alloc_close_bracket(vm, context[59]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset$a/5 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset$a5 /8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # E/36 AsIs: s.Num/48 AsIs: e.Range/32 HalfReuse: )/44 HalfReuse: (/46 Reuse: # Junk/47 } (/49 # Symbol/50 # Name/51 e.Name/42/52 Tile{ HalfReuse: # NoOffset/39 HalfReuse: )/41 AsIs: e.Junk/37 AsIs: )/40 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/54 # AlgLeft/55 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves/26 } (/56 # CmdName/57 # AlgRight/58 s.Num/48/59 Tile{ AsIs: e.Name/42 } Tile{ AsIs: )/45 AsIs: )/35 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[49]);
      refalrts::alloc_ident(vm, context[50], identifiers[ident_Symbol]);
      refalrts::alloc_ident(vm, context[51], identifiers[ident_Name]);
      refalrts::copy_evar(vm, context[52], context[53], context[42], context[43]);
      refalrts::alloc_ident(vm, context[54], identifiers[ident_CmdOpenedE]);
      refalrts::alloc_ident(vm, context[55], identifiers[ident_AlgLeft]);
      refalrts::alloc_open_bracket(vm, context[56]);
      refalrts::alloc_ident(vm, context[57], identifiers[ident_CmdName]);
      refalrts::alloc_ident(vm, context[58], identifiers[ident_AlgRight]);
      refalrts::copy_stvar(vm, context[59], context[48]);
      refalrts::update_name(context[4], functions[efunc_DoGenSubst]);
      refalrts::reinit_svar( context[8], context[5] );
      refalrts::reinit_close_bracket(context[44]);
      refalrts::reinit_open_bracket(context[46]);
      ...
      refalrts::link_brackets( context[56], context[45] );
      refalrts::link_brackets( context[17], context[9] );
      refalrts::link_brackets( context[12], context[13] );
      refalrts::link_brackets( context[46], context[40] );
      refalrts::link_brackets( context[49], context[41] );
      refalrts::link_brackets( context[34], context[44] );
      refalrts::Iter trash_prev = arg_begin->prev;
      refalrts::use(trash_prev);
      refalrts::Iter res = context[1];
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} s.ContextOffset$a/5 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } Tile{ HalfReuse: s.ContextOffset$a5 /8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # E/36 AsIs: s.Num/48 AsIs: e.Range/32 HalfReuse: )/44 HalfReuse: (/46 Reuse: # Junk/47 } (/49 # Symbol/50 # Identifier/51 e.Name/42/52 Tile{ HalfReuse: # NoOffset/39 HalfReuse: )/41 AsIs: e.Junk/37 AsIs: )/40 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/54 # AlgLeft/55 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } Tile{ AsIs: )/9 } Tile{ AsIs: e.CmdSaves/26 } (/56 # CmdIdent/57 # AlgRight/58 s.Num/48/59 Tile{ AsIs: e.Name/42 } Tile{ AsIs: )/45 AsIs: )/35 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[49]);
      refalrts::alloc_ident(vm, context[50], identifiers[ident_Symbol]);
      refalrts::alloc_ident(vm, context[51], identifiers[ident_Identifier]);
      refalrts::copy_evar(vm, context[52], context[53], context[42], context[43]);
      refalrts::alloc_ident(vm, context[54], identifiers[ident_CmdOpenedE]);
      refalrts::alloc_ident(vm, context[55], identifiers[ident_AlgLeft]);
      refalrts::alloc_open_bracket(vm, context[56]);
      refalrts::alloc_ident(vm, context[57], identifiers[ident_CmdIdent]);
      refalrts::alloc_ident(vm, context[58], identifiers[ident_AlgRight]);
      refalrts::copy_stvar(vm, context[59], context[48]);
      refalrts::update_name(context[4], functions[efunc_DoGenSubst]);
      refalrts::reinit_svar( context[8], context[5] );
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </48 & DoGenSubst/49 Tile{ AsIs: </0 Reuse: & Inc2/4 AsIs: s.ContextOffset$a/5 HalfReuse: >/8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk/32 HalfReuse: (/35 HalfReuse: # TkOpenBracket/39 Reuse: # NoOffset/41 } Tile{ AsIs: )/9 } )/50 (/51 Tile{ HalfReuse: # E/45 HalfReuse: s.ContextOffset$a5 /47 AsIs: e.SubRange/43 AsIs: )/46 } (/52 # Junk/53 (/54 # TkCloseBracket/55 # NoOffset/56 Tile{ AsIs: )/40 } )/57 (/58 # E/59 Tile{ AsIs: s.Num/42 } Tile{ AsIs: e.Range/37 } )/60 Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/61 # AlgLeft/62 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } )/63 Tile{ AsIs: e.CmdSaves/26 } (/64 # CmdBrackets/65 # AlgLeft/66 s.Num/42/67 s.ContextOffset$a/5/68 )/69 )/70 Tile{ AsIs: >/1 ]] }
      ...
      refalrts::alloc_close_bracket(vm, context[57]);
      refalrts::alloc_open_bracket(vm, context[58]);
      refalrts::alloc_ident(vm, context[59], identifiers[ident_E]);
      refalrts::alloc_close_bracket(vm, context[60]);
      ...
      refalrts::alloc_ident(vm, context[65], identifiers[ident_CmdBrackets]);
      refalrts::alloc_ident(vm, context[66], identifiers[ident_AlgLeft]);
      refalrts::copy_stvar(vm, context[67], context[42]);
      ...
      refalrts::link_brackets( context[54], context[40] );
      refalrts::link_brackets( context[51], context[46] );
      refalrts::link_brackets( context[34], context[50] );
      refalrts::link_brackets( context[35], context[9] );
      refalrts::push_stack( vm, context[8] );
      refalrts::push_stack( vm, context[0] );
      refalrts::Iter trash_prev = arg_begin->prev;
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </48 & DoGenSubst/49 Tile{ AsIs: </0 Reuse: & Inc2/4 AsIs: s.ContextOffset$a/5 HalfReuse: >/8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # E/36 AsIs: s.Num/47 AsIs: e.Range/32 HalfReuse: )/44 HalfReuse: (/46 } # Junk/50 (/51 # TkOpenBracket/52 # NoOffset/53 Tile{ AsIs: )/45 AsIs: )/35 AsIs: (/39 Reuse: # E/41 } s.ContextOffset$a/5/54 Tile{ AsIs: e.SubRange/42 } Tile{ AsIs: )/40 } (/55 # Junk/56 (/57 # TkCloseBracket/58 # NoOffset/59 Tile{ AsIs: )/9 } Tile{ AsIs: e.Junk/37 } )/60 Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/61 # AlgLeft/62 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } )/63 Tile{ AsIs: e.CmdSaves/26 } (/64 # CmdBrackets/65 # AlgRight/66 s.Num/47/67 s.ContextOffset$a/5/68 )/69 )/70 Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[48]);
      refalrts::alloc_name(vm, context[49], functions[efunc_DoGenSubst]);
      refalrts::alloc_ident(vm, context[50], identifiers[ident_Junk]);
      refalrts::alloc_open_bracket(vm, context[51]);
      refalrts::alloc_ident(vm, context[52], identifiers[ident_TkOpenBracket]);
      refalrts::alloc_ident(vm, context[53], identifiers[ident_NoOffset]);
      refalrts::copy_stvar(vm, context[54], context[5]);
      refalrts::alloc_open_bracket(vm, context[55]);
      refalrts::alloc_ident(vm, context[56], identifiers[ident_Junk]);
      refalrts::alloc_open_bracket(vm, context[57]);
      refalrts::alloc_ident(vm, context[58], identifiers[ident_TkCloseBracket]);
      refalrts::alloc_ident(vm, context[59], identifiers[ident_NoOffset]);
      refalrts::alloc_close_bracket(vm, context[60]);
      refalrts::alloc_ident(vm, context[61], identifiers[ident_CmdOpenedE]);
      refalrts::alloc_ident(vm, context[62], identifiers[ident_AlgLeft]);
      refalrts::alloc_close_bracket(vm, context[63]);
      ...
      refalrts::copy_stvar(vm, context[67], context[47]);
      refalrts::copy_stvar(vm, context[68], context[5]);
      refalrts::alloc_close_bracket(vm, context[69]);
      refalrts::alloc_close_bracket(vm, context[70]);
      refalrts::update_name(context[4], functions[efunc_Inc2]);
      ...
      refalrts::link_brackets( context[51], context[45] );
      refalrts::link_brackets( context[34], context[44] );
      refalrts::push_stack( vm, context[8] );
      refalrts::push_stack( vm, context[0] );
      refalrts::Iter trash_prev = arg_begin->prev;
      ...
      res = refalrts::splice_evar( res, context[0], context[46] );
      res = refalrts::splice_evar( res, context[48], context[49] );
      refalrts::use( res );
      return refalrts::cSuccess;
    } while ( refalrts::open_evar_advance( context[28], context[29], context[20], context[21] ) );
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </52 & DoGenSubst/53 Tile{ AsIs: </0 Reuse: & Inc2/4 AsIs: s.ContextOffset$a/5 HalfReuse: >/8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk/32 HalfReuse: (/35 HalfReuse: # TkOpenADT/39 Reuse: # NoOffset/41 } Tile{ AsIs: )/9 } Tile{ AsIs: (/45 Reuse: # Symbol/47 HalfReuse: # Name/50 AsIs: e.Name/48 HalfReuse: # NoOffset/51 } )/54 )/55 (/56 # E/57 s.ContextOffset$a/5/58 Tile{ AsIs: e.SubRange/43 } )/59 (/60 # Junk/61 (/62 # TkCloseADT/63 # NoOffset/64 )/65 )/66 (/67 # E/68 Tile{ HalfReuse: s.Num42 /46 AsIs: e.Range/37 AsIs: )/40 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/69 # AlgLeft/70 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } )/71 Tile{ AsIs: e.CmdSaves/26 } (/72 # CmdADT/73 # AlgLeft/74 Tile{ AsIs: s.Num/42 } s.ContextOffset$a/5/75 e.Name/48/76 )/78 )/79 Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[52]);
      refalrts::alloc_name(vm, context[53], functions[efunc_DoGenSubst]);
      refalrts::alloc_close_bracket(vm, context[54]);
      refalrts::alloc_close_bracket(vm, context[55]);
      refalrts::alloc_open_bracket(vm, context[56]);
      refalrts::alloc_ident(vm, context[57], identifiers[ident_E]);
      ...
      refalrts::alloc_ident(vm, context[69], identifiers[ident_CmdOpenedE]);
      refalrts::alloc_ident(vm, context[70], identifiers[ident_AlgLeft]);
      refalrts::alloc_close_bracket(vm, context[71]);
      refalrts::alloc_open_bracket(vm, context[72]);
      refalrts::alloc_ident(vm, context[73], identifiers[ident_CmdADT]);
      refalrts::alloc_ident(vm, context[74], identifiers[ident_AlgLeft]);
      ...
      refalrts::reinit_ident(context[51], identifiers[ident_NoOffset]);
      ...
      refalrts::link_brackets( context[17], context[71] );
      refalrts::link_brackets( context[12], context[13] );
      refalrts::link_brackets( context[67], context[40] );
      refalrts::link_brackets( context[60], context[66] );
      refalrts::link_brackets( context[62], context[65] );
      refalrts::link_brackets( context[56], context[59] );
      refalrts::link_brackets( context[34], context[55] );
      ...
      refalrts::use(trash_prev);
      refalrts::Iter res = context[1];
      res = refalrts::splice_evar( res, context[75], context[79] );
      res = refalrts::splice_elem( res, context[42] );
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </52 & DoGenSubst/53 Tile{ AsIs: </0 Reuse: & Inc2/4 AsIs: s.ContextOffset$a/5 HalfReuse: >/8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # E/36 AsIs: s.Num/51 AsIs: e.Range/32 HalfReuse: )/44 HalfReuse: (/46 HalfReuse: # Junk/49 } (/54 # TkOpenADT/55 # NoOffset/56 Tile{ AsIs: )/50 } (/57 # Symbol/58 # Name/59 Tile{ AsIs: e.Name/47 } # NoOffset/60 Tile{ AsIs: )/45 AsIs: )/35 AsIs: (/39 Reuse: # E/41 } s.ContextOffset$a/5/61 Tile{ AsIs: e.SubRange/42 } Tile{ AsIs: )/9 } (/62 # Junk/63 (/64 # TkCloseADT/65 # NoOffset/66 Tile{ AsIs: )/40 } Tile{ AsIs: e.Junk/37 } )/67 Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars/22 AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/68 # AlgLeft/69 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } )/70 Tile{ AsIs: e.CmdSaves/26 } (/71 # CmdADT/72 # AlgRight/73 s.Num/51/74 s.ContextOffset$a/5/75 e.Name/47/76 )/78 )/79 Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[52]);
      refalrts::alloc_name(vm, context[53], functions[efunc_DoGenSubst]);
      refalrts::alloc_open_bracket(vm, context[54]);
      refalrts::alloc_ident(vm, context[55], identifiers[ident_TkOpenADT]);
      refalrts::alloc_ident(vm, context[56], identifiers[ident_NoOffset]);
      refalrts::alloc_open_bracket(vm, context[57]);
      refalrts::alloc_ident(vm, context[58], identifiers[ident_Symbol]);
      refalrts::alloc_ident(vm, context[59], identifiers[ident_Name]);
      refalrts::alloc_ident(vm, context[60], identifiers[ident_NoOffset]);
      refalrts::copy_stvar(vm, context[61], context[5]);
      refalrts::alloc_open_bracket(vm, context[62]);
      refalrts::alloc_ident(vm, context[63], identifiers[ident_Junk]);
      refalrts::alloc_open_bracket(vm, context[64]);
      refalrts::alloc_ident(vm, context[65], identifiers[ident_TkCloseADT]);
      refalrts::alloc_ident(vm, context[66], identifiers[ident_NoOffset]);
      refalrts::alloc_close_bracket(vm, context[67]);
      refalrts::alloc_ident(vm, context[68], identifiers[ident_CmdOpenedE]);
      refalrts::alloc_ident(vm, context[69], identifiers[ident_AlgLeft]);
      refalrts::alloc_close_bracket(vm, context[70]);
      refalrts::alloc_open_bracket(vm, context[71]);
      refalrts::alloc_ident(vm, context[72], identifiers[ident_CmdADT]);
      refalrts::alloc_ident(vm, context[73], identifiers[ident_AlgRight]);
      refalrts::copy_stvar(vm, context[74], context[51]);
      refalrts::copy_stvar(vm, context[75], context[5]);
      refalrts::copy_evar(vm, context[76], context[77], context[47], context[48]);
      refalrts::alloc_close_bracket(vm, context[78]);
      refalrts::alloc_close_bracket(vm, context[79]);
      refalrts::update_name(context[4], functions[efunc_Inc2]);
      refalrts::reinit_close_call(context[8]);
      ...
      refalrts::link_brackets( context[64], context[40] );
      refalrts::link_brackets( context[39], context[9] );
      refalrts::link_brackets( context[46], context[35] );
      refalrts::link_brackets( context[57], context[45] );
      refalrts::link_brackets( context[54], context[50] );
      refalrts::link_brackets( context[34], context[44] );
      refalrts::push_stack( vm, context[8] );
      refalrts::push_stack( vm, context[0] );
      refalrts::Iter trash_prev = arg_begin->prev;
      ...
      res = refalrts::splice_evar( res, context[0], context[49] );
      res = refalrts::splice_evar( res, context[52], context[53] );
      refalrts::use( res );
      return refalrts::cSuccess;
    } while ( refalrts::open_evar_advance( context[28], context[29], context[20], context[21] ) );
  ...
  do {
    ...
    do {
      ...
      do {
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ } </67 & DoGenSubst/68 Tile{ AsIs: </0 Reuse: & IncVarOffset/4 AsIs: s.ContextOffset$a/5 } Tile{ AsIs: s.Mode/50 } Tile{ HalfReuse: >/8 AsIs: e.Substs-B/28 AsIs: (/36 AsIs: # Junk/38 AsIs: e.Junk/34 HalfReuse: (/37 HalfReuse: # Var/41 HalfReuse: s.Mode59 /43 } Tile{ AsIs: e.Index/45 } s.ContextOffset$a/5/69 )/70 Tile{ AsIs: )/9 } Tile{ AsIs: (/47 Reuse: # E/49 } Tile{ HalfReuse: s.Num44 /48 AsIs: e.Range/39 AsIs: )/42 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars-B/51 AsIs: (/57 AsIs: s.Mode/59 AsIs: (/62 AsIs: e.Index/64 AsIs: )/63 AsIs: e.Offsets/55 AsIs: s.SampleOffset/66 HalfReuse: s.ContextOffset$a5 /58 } )/71 Tile{ AsIs: e.Vars-E/53 } Tile{ AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/72 # AlgLeft/73 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } )/74 Tile{ AsIs: e.CmdSaves/26 } (/75 # CmdRepeated/76 # AlgLeft/77 Tile{ AsIs: s.Num/44 } s.Mode/59/78 s.ContextOffset$a/5/79 s.SampleOffset/66/80 )/81 )/82 Tile{ AsIs: >/1 ]] }
        ...
        refalrts::alloc_ident(vm, context[76], identifiers[ident_CmdRepeated]);
        refalrts::alloc_ident(vm, context[77], identifiers[ident_AlgLeft]);
        refalrts::copy_stvar(vm, context[78], context[59]);
        refalrts::copy_stvar(vm, context[79], context[5]);
        refalrts::copy_stvar(vm, context[80], context[66]);
        refalrts::alloc_close_bracket(vm, context[81]);
        refalrts::alloc_close_bracket(vm, context[82]);
        refalrts::update_name(context[4], functions[efunc_IncVarOffset]);
        refalrts::reinit_close_call(context[8]);
        refalrts::reinit_open_bracket(context[37]);
        ...
        refalrts::push_stack( vm, context[1] );
        refalrts::push_stack( vm, context[67] );
        refalrts::link_brackets( context[16], context[82] );
        refalrts::link_brackets( context[75], context[81] );
        ...
        refalrts::use(trash_prev);
        refalrts::Iter res = context[1];
        res = refalrts::splice_evar( res, context[78], context[82] );
        res = refalrts::splice_elem( res, context[44] );
  ...
  do {
    ...
    do {
      ...
      do {
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenSubst/4 } </67 & IncVarOffset/68 Tile{ AsIs: s.ContextOffset$a/5 } s.Mode/59/69 Tile{ HalfReuse: >/8 AsIs: e.Substs-B/28 AsIs: (/36 AsIs: # E/38 AsIs: s.Num/49 AsIs: e.Range/34 HalfReuse: )/46 HalfReuse: (/48 } # Junk/70 Tile{ AsIs: (/41 Reuse: # Var/43 } Tile{ AsIs: s.Mode/50 AsIs: e.Index/44 HalfReuse: s.ContextOffset$a5 /47 AsIs: )/37 } Tile{ AsIs: e.Junk/39 } Tile{ AsIs: )/42 } Tile{ AsIs: e.Substs-E/30 } Tile{ AsIs: (/12 AsIs: e.Vars-B/51 AsIs: (/57 AsIs: s.Mode/59 AsIs: (/62 AsIs: e.Index/64 AsIs: )/63 AsIs: e.Offsets/55 AsIs: s.SampleOffset/66 HalfReuse: s.ContextOffset$a5 /58 } Tile{ AsIs: )/9 } Tile{ AsIs: e.Vars-E/53 } Tile{ AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/71 # AlgLeft/72 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } )/73 Tile{ AsIs: e.CmdSaves/26 } (/74 # CmdRepeated/75 # AlgRight/76 s.Num/49/77 s.Mode/59/78 s.ContextOffset$a/5/79 s.SampleOffset/66/80 )/81 )/82 Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_call(vm, context[67]);
        refalrts::alloc_name(vm, context[68], functions[efunc_IncVarOffset]);
        ...
        refalrts::alloc_ident(vm, context[75], identifiers[ident_CmdRepeated]);
        refalrts::alloc_ident(vm, context[76], identifiers[ident_AlgRight]);
        refalrts::copy_stvar(vm, context[77], context[49]);
        refalrts::copy_stvar(vm, context[78], context[59]);
        refalrts::copy_stvar(vm, context[79], context[5]);
        refalrts::copy_stvar(vm, context[80], context[66]);
        refalrts::alloc_close_bracket(vm, context[81]);
        ...
        refalrts::push_stack( vm, context[0] );
        refalrts::link_brackets( context[16], context[82] );
        refalrts::link_brackets( context[74], context[81] );
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </49 & DoGenSubst/50 </51 Tile{ HalfReuse: & Add/0 HalfReuse: 1/4 AsIs: s.ContextOffset$a/5 HalfReuse: >/8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # Junk/36 AsIs: e.Junk/32 HalfReuse: (/35 HalfReuse: # Var/39 HalfReuse: 't'/41 } Tile{ AsIs: e.Index/43 } s.ContextOffset$a/5/52 )/53 )/54 Tile{ AsIs: (/12 } # E/55 Tile{ HalfReuse: s.Num42 /46 AsIs: e.Range/37 AsIs: )/40 AsIs: e.Substs-E/30 HalfReuse: (/9 } Tile{ AsIs: e.Vars/22 } (/56 't'/57 (/58 e.Index/43/59 )/61 s.ContextOffset$a/5/62 )/63 Tile{ AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/64 # AlgLeft/65 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } )/66 Tile{ AsIs: e.CmdSaves/26 } Tile{ AsIs: (/45 Reuse: # CmdVar/47 HalfReuse: # AlgLeft/48 } Tile{ AsIs: s.Num/42 } 't'/67 s.ContextOffset$a/5/68 )/69 )/70 Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[49]);
      refalrts::alloc_name(vm, context[50], functions[efunc_DoGenSubst]);
      refalrts::alloc_open_call(vm, context[51]);
      refalrts::copy_stvar(vm, context[52], context[5]);
      ...
      refalrts::alloc_ident(vm, context[65], identifiers[ident_AlgLeft]);
      refalrts::alloc_close_bracket(vm, context[66]);
      refalrts::alloc_char(vm, context[67], 't');
      refalrts::copy_stvar(vm, context[68], context[5]);
      refalrts::alloc_close_bracket(vm, context[69]);
      refalrts::alloc_close_bracket(vm, context[70]);
      refalrts::reinit_name(context[0], functions[efunc_Add]);
  ...
  do {
    ...
    do {
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </49 & DoGenSubst/50 </51 Tile{ HalfReuse: & Add/0 HalfReuse: 1/4 AsIs: s.ContextOffset$a/5 HalfReuse: >/8 AsIs: e.Substs-B/28 AsIs: (/34 AsIs: # E/36 AsIs: s.Num/48 AsIs: e.Range/32 HalfReuse: )/44 HalfReuse: (/46 HalfReuse: # Junk/47 } (/52 # Var/53 't'/54 Tile{ AsIs: e.Index/42 } Tile{ HalfReuse: s.ContextOffset$a5 /39 HalfReuse: )/41 AsIs: e.Junk/37 AsIs: )/40 AsIs: e.Substs-E/30 HalfReuse: (/9 } Tile{ AsIs: e.Vars/22 } Tile{ AsIs: (/12 } 't'/55 (/56 e.Index/42/57 )/59 s.ContextOffset$a/5/60 )/61 Tile{ AsIs: )/13 AsIs: (/16 AsIs: e.Commands0/24 HalfReuse: (/17 } # CmdOpenedE/62 # AlgLeft/63 Tile{ AsIs: s.Num0/18 AsIs: s.VarOffset0/19 } )/64 Tile{ AsIs: e.CmdSaves/26 } (/65 # CmdVar/66 # AlgRight/67 s.Num/48/68 't'/69 s.ContextOffset$a/5/70 Tile{ AsIs: )/45 AsIs: )/35 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_call(vm, context[49]);
      refalrts::alloc_name(vm, context[50], functions[efunc_DoGenSubst]);
      refalrts::alloc_open_call(vm, context[51]);
      refalrts::alloc_open_bracket(vm, context[52]);
      ...
      refalrts::alloc_char(vm, context[55], 't');
      refalrts::alloc_open_bracket(vm, context[56]);
      refalrts::copy_evar(vm, context[57], context[58], context[42], context[43]);
      refalrts::alloc_close_bracket(vm, context[59]);
      refalrts::copy_stvar(vm, context[60], context[5]);
      ...
      refalrts::alloc_ident(vm, context[67], identifiers[ident_AlgRight]);
      refalrts::copy_stvar(vm, context[68], context[48]);
      refalrts::alloc_char(vm, context[69], 't');
      refalrts::copy_stvar(vm, context[70], context[5]);
      refalrts::reinit_name(context[0], functions[efunc_Add]);
      refalrts::reinit_number(context[4], 1UL);
      refalrts::reinit_close_call(context[8]);
