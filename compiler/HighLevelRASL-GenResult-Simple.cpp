...
static refalrts::FnResult func_gen_GenResultm_Simple_B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & GenResult-Simple:1/4 e.new/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & GenResult-Simple:1/4 s.new1/5 (/8 e.new2/6 )/9 e.new3/2 >/1
  ...
  // closed e.new3 as range 2
  do {
    // </0 & GenResult-Simple:1/4 s.ContextOffset$a/5 (/8 e.CommonVars/10 )/9 >/1
    context[10] = context[6];
    context[11] = context[7];
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    // closed e.CommonVars as range 10
    //DEBUG: s.ContextOffset$a: 5
    //DEBUG: e.CommonVars: 10

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: s.ContextOffset$a/5 } Tile{ AsIs: </0 Reuse: & Fetch@1/4 } </12 Tile{ HalfReuse: & Map@5/8 AsIs: e.CommonVars/10 HalfReuse: >/9 AsIs: >/1 } (/13 # CmdSpliceToFreeList/14 )/15 (/16 # CmdNextStep/17 )/18 Tile{ ]] }
  ...
  // </0 & GenResult-Simple:1/4 s.ContextOffset$a/5 (/8 e.CommonVars/6 )/9 e.ResultCommands/2 >/1
  // closed e.CommonVars as range 6
  // closed e.ResultCommands as range 2
  //DEBUG: s.ContextOffset$a: 5
  //DEBUG: e.CommonVars: 6
  //DEBUG: e.ResultCommands: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ AsIs: s.ContextOffset$a/5 } Tile{ AsIs: </0 Reuse: & Fetch@1/4 } </10 & Map@5/11 Tile{ AsIs: e.CommonVars/6 } >/12 >/13 Tile{ AsIs: (/8 } # CmdResetAllocator/14 )/15 (/16 # CmdSetRes/17 # ARG-BEGIN/18 Tile{ AsIs: )/9 AsIs: e.ResultCommands/2 HalfReuse: (/1 } # CmdUseRes/19 )/20 (/21 # CmdSpliceToFreeList/22 )/23 (/24 # CmdNextStep/25 )/26 Tile{ ]] }
...
static refalrts::FnResult func_GenResultm_Simple(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & GenResult-Simple/4 s.ContextOffset/5 (/8 e.PatternVars/6 )/9 (/12 e.MarkedPattern/10 )/13 e.Result/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} e.MarkedPattern/10 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </14 Tile{ HalfReuse: & GenResult-Simple:1/13 } Tile{ AsIs: </0 Reuse: & GenResult=1/4 AsIs: s.ContextOffset/5 AsIs: (/8 } Tile{ AsIs: e.Result/2 } Tile{ AsIs: )/9 HalfReuse: </12 } & Map@3/15 Tile{ AsIs: e.PatternVars/6 } >/16 >/17 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[14]);
...
static refalrts::FnResult func_gen_GenResultm_Condition_A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & GenResult-Condition=1/4 s.ContextOffset$a/5 (/8 e.CommonVars/6 )/9 e.ResultCommands/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ AsIs: s.ContextOffset$a/5 } Tile{ AsIs: </0 Reuse: & Fetch@1/4 } </10 & Map@5/11 Tile{ AsIs: e.CommonVars/6 } >/12 >/13 Tile{ AsIs: (/8 } # CmdResetAllocator/14 )/15 (/16 # CmdSetRes/17 1/18 Tile{ AsIs: )/9 AsIs: e.ResultCommands/2 HalfReuse: (/1 } # CmdUseRes/19 )/20 Tile{ ]] }
  refalrts::alloc_open_call(vm, context[10]);
  refalrts::alloc_name(vm, context[11], functions[efunc_gen_Map_Z5]);
  refalrts::alloc_close_call(vm, context[12]);
  refalrts::alloc_close_call(vm, context[13]);
...
static refalrts::FnResult func_GenResultm_Condition(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & GenResult-Condition/4 s.ContextOffset/5 (/8 e.PatternVars/6 )/9 e.CondResult/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::bracket_pointers(context[8], context[9]);
  // closed e.PatternVars as range 6
  // closed e.CondResult as range 2
  //DEBUG: s.ContextOffset: 5
  //DEBUG: e.PatternVars: 6
  //DEBUG: e.CondResult: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </10 & GenResult-Condition=1/11 Tile{ AsIs: </0 Reuse: & GenResult=1/4 AsIs: s.ContextOffset/5 AsIs: (/8 } Tile{ AsIs: e.CondResult/2 } Tile{ AsIs: )/9 } </12 & Map@4/13 Tile{ AsIs: e.PatternVars/6 } >/14 >/15 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[10]);
...
static refalrts::FnResult func_MakeVarTablem_Simple(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & MakeVarTable-Simple/4 (/7 s.Mode/9 (/12 e.Index/10 )/13 e.Offsets/5 )/8 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: s.Mode/9 AsIs: (/12 AsIs: e.Index/10 AsIs: )/13 } Tile{ HalfReuse: (/4 } Tile{ AsIs: )/8 } Tile{ AsIs: e.Offsets/5 } Tile{ HalfReuse: )/1 ]] }
...
static refalrts::FnResult func_MakeVarTablem_Conditions(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[14];
  refalrts::zeros( context, 14 );
  // </0 & MakeVarTable-Conditions/4 (/7 s.Mode/9 (/12 e.Index/10 )/13 e.Offsets/5 )/8 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: s.Mode/9 AsIs: (/12 AsIs: e.Index/10 AsIs: )/13 } Tile{ HalfReuse: (/4 } Tile{ AsIs: e.Offsets/5 } Tile{ AsIs: )/8 HalfReuse: )/1 ]] }
  refalrts::reinit_open_bracket(context[4]);
  refalrts::reinit_close_bracket(context[1]);
  refalrts::link_brackets( context[7], context[1] );
  refalrts::link_brackets( context[4], context[8] );
...
static refalrts::FnResult func_gen_GenResult_A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[13];
  refalrts::zeros( context, 13 );
  // </0 & GenResult=1/4 s.ContextOffset/5 (/8 e.Result/6 )/9 e.PatternVars$a/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  if( ! context[8] )
    return refalrts::cRecognitionImpossible;
  refalrts::bracket_pointers(context[8], context[9]);
  // closed e.Result as range 6
  // closed e.PatternVars$a as range 2
  //DEBUG: s.ContextOffset: 5
  //DEBUG: e.Result: 6
  //DEBUG: e.PatternVars$a: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult@1/4 } (/10 Tile{ AsIs: e.PatternVars$a/2 } )/11 Tile{ AsIs: s.ContextOffset/5 } </12 Tile{ HalfReuse: & CollectStrings/8 AsIs: e.Result/6 HalfReuse: >/9 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_GenResult(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[15];
  refalrts::zeros( context, 15 );
  // </0 & GenResult/4 s.ContextOffset/5 s.FnMakeVarTable/6 (/9 e.PatternVars/7 )/10 e.Result/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  if( ! context[9] )
    return refalrts::cRecognitionImpossible;
  refalrts::bracket_pointers(context[9], context[10]);
  // closed e.PatternVars as range 7
  // closed e.Result as range 2
  //DEBUG: s.ContextOffset: 5
  //DEBUG: s.FnMakeVarTable: 6
  //DEBUG: e.PatternVars: 7
  //DEBUG: e.Result: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} s.FnMakeVarTable/6 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & GenResult=1/4 AsIs: s.ContextOffset/5 } (/11 Tile{ AsIs: e.Result/2 } )/12 </13 & Map@1/14 Tile{ HalfReuse: s.FnMakeVarTable6 /9 AsIs: e.PatternVars/7 HalfReuse: >/10 } Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_bracket(vm, context[11]);
  refalrts::alloc_close_bracket(vm, context[12]);
  refalrts::alloc_open_call(vm, context[13]);
...
static refalrts::FnResult func_DoGenResult(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & DoGenResult/4 (/7 e.new1/5 )/8 (/11 e.new2/9 )/12 (/15 e.new3/13 )/16 s.new4/17 e.new5/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  do {
    // </0 & DoGenResult/4 (/7 e.new10/18 )/8 (/11 e.new11/20 )/12 (/15 e.new12/22 )/16 s.new6/17 (/28 s.new7/30 e.new8/26 )/29 e.new9/24 >/1
    ...
    do {
      // </0 & DoGenResult/4 (/7 e.new18/31 )/8 (/11 e.new19/33 )/12 (/15 e.new20/35 )/16 s.new13/17 (/28 s.new15/30 s.new16/41 e.new17/37 )/29 e.new14/39 >/1
      ...
      do {
        // </0 & DoGenResult/4 (/7 e.new25/42 )/8 (/11 e.new26/44 )/12 (/15 e.new27/46 )/16 s.new21/17 (/28 s.new23/30 s.new24/41 )/29 e.new22/48 >/1
        ...
        do {
          // </0 & DoGenResult/4 (/7 e.Vars/50 )/8 (/11 e.AllocCommands/52 )/12 (/15 e.Commands/54 )/16 s.Counter/17 (/28 # TkOpenCallCond/30 s.Offset/41 )/29 e.Result/56 >/1
          ...
          if( ! refalrts::ident_term( identifiers[ident_TkOpenCallCond], context[30] ) )
            continue;
          // closed e.Vars as range 50
          // closed e.AllocCommands as range 52
          // closed e.Commands as range 54
          // closed e.Result as range 56
          //DEBUG: s.Counter: 17
          //DEBUG: s.Offset: 41
          //DEBUG: e.Vars: 50
          //DEBUG: e.AllocCommands: 52
          //DEBUG: e.Commands: 54
          //DEBUG: e.Result: 56

          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/50 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/52 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } # Allocate/58 s.Offset/41/59 # ElOpenCall/60 )/61 )/62 (/63 Tile{ AsIs: (/28 Reuse: # CmdInsertElem/30 AsIs: s.Offset/41 AsIs: )/29 } Tile{ AsIs: e.Commands/54 } Tile{ AsIs: )/16 AsIs: s.Counter/17 } Tile{ AsIs: e.Result/56 } Tile{ AsIs: >/1 ]] }
        ...
        // </0 & DoGenResult/4 (/7 e.Vars/50 )/8 (/11 e.AllocCommands/52 )/12 (/15 e.Commands/54 )/16 s.Counter/17 (/28 # TkCloseCallCond/30 s.Offset/41 )/29 e.Result/56 >/1
        context[50] = context[42];
        context[51] = context[43];
        context[52] = context[44];
        context[53] = context[45];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/50 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/52 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } # Allocate/58 s.Offset/41/59 # ElCloseCall/60 )/61 )/62 (/63 Tile{ AsIs: (/28 Reuse: # CmdPushStack/30 AsIs: s.Offset/41 AsIs: )/29 } (/64 # CmdPushStack/65 </66 & Sub/67 s.Offset/41/68 1/69 >/70 )/71 (/72 # CmdInsertElem/73 s.Offset/41/74 )/75 Tile{ AsIs: e.Commands/54 } Tile{ AsIs: )/16 AsIs: s.Counter/17 } Tile{ AsIs: e.Result/56 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_ident(vm, context[58], identifiers[ident_Allocate]);
        refalrts::copy_stvar(vm, context[59], context[41]);
      ...
      // </0 & DoGenResult/4 (/7 e.new25/42 )/8 (/11 e.new26/44 )/12 (/15 e.new27/46 )/16 s.new21/17 (/28 # Symbol/30 s.new23/41 e.new24/48 )/29 e.new22/50 >/1
      context[42] = context[31];
      context[43] = context[32];
      context[44] = context[33];
      context[45] = context[34];
      ...
      // closed e.new22 as range 50
      do {
        // </0 & DoGenResult/4 (/7 e.Vars/52 )/8 (/11 e.AllocCommands/54 )/12 (/15 e.Commands/56 )/16 s.Counter/17 (/28 # Symbol/30 # Char/41 s.Value/62 )/29 e.Result/60 >/1
        ...
        if( ! refalrts::ident_term( identifiers[ident_Char], context[41] ) )
          continue;
        // closed e.Vars as range 52
        // closed e.AllocCommands as range 54
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/52 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/54 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } Tile{ HalfReuse: # Allocate/28 HalfReuse: s.Counter17 /30 Reuse: # ElChar/41 AsIs: s.Value/62 AsIs: )/29 } )/63 (/64 (/65 Tile{ HalfReuse: # CmdInsertElem/16 AsIs: s.Counter/17 } )/66 Tile{ AsIs: e.Commands/56 } )/67 </68 & Add/69 1/70 s.Counter/17/71 >/72 Tile{ AsIs: e.Result/60 } Tile{ AsIs: >/1 ]] }
      ...
      do {
        // </0 & DoGenResult/4 (/7 e.Vars/52 )/8 (/11 e.AllocCommands/54 )/12 (/15 e.Commands/56 )/16 s.Counter/17 (/28 # Symbol/30 # Name/41 e.Name/58 )/29 e.Result/60 >/1
        context[52] = context[42];
        context[53] = context[43];
        context[54] = context[44];
        context[55] = context[45];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/52 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/54 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } Tile{ HalfReuse: # Allocate/28 HalfReuse: s.Counter17 /30 Reuse: # ElName/41 AsIs: e.Name/58 AsIs: )/29 } )/62 (/63 (/64 Tile{ HalfReuse: # CmdInsertElem/16 AsIs: s.Counter/17 } )/65 Tile{ AsIs: e.Commands/56 } )/66 </67 & Add/68 1/69 s.Counter/17/70 >/71 Tile{ AsIs: e.Result/60 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_close_bracket(vm, context[62]);
        refalrts::alloc_open_bracket(vm, context[63]);
        refalrts::alloc_open_bracket(vm, context[64]);
      ...
      do {
        // </0 & DoGenResult/4 (/7 e.Vars/52 )/8 (/11 e.AllocCommands/54 )/12 (/15 e.Commands/56 )/16 s.Counter/17 (/28 # Symbol/30 # Number/41 s.Number/62 )/29 e.Result/60 >/1
        context[52] = context[42];
        context[53] = context[43];
        context[54] = context[44];
        context[55] = context[45];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/52 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/54 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } Tile{ HalfReuse: # Allocate/28 HalfReuse: s.Counter17 /30 Reuse: # ElNumber/41 AsIs: s.Number/62 AsIs: )/29 } )/63 (/64 (/65 Tile{ HalfReuse: # CmdInsertElem/16 AsIs: s.Counter/17 } )/66 Tile{ AsIs: e.Commands/56 } )/67 </68 & Add/69 1/70 s.Counter/17/71 >/72 Tile{ AsIs: e.Result/60 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_close_bracket(vm, context[63]);
        refalrts::alloc_open_bracket(vm, context[64]);
        refalrts::alloc_open_bracket(vm, context[65]);
        refalrts::alloc_close_bracket(vm, context[66]);
      ...
      // </0 & DoGenResult/4 (/7 e.Vars/52 )/8 (/11 e.AllocCommands/54 )/12 (/15 e.Commands/56 )/16 s.Counter/17 (/28 # Symbol/30 # Identifier/41 e.Name/58 )/29 e.Result/60 >/1
      context[52] = context[42];
      context[53] = context[43];
      context[54] = context[44];
      context[55] = context[45];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/52 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/54 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } Tile{ HalfReuse: # Allocate/28 HalfReuse: s.Counter17 /30 Reuse: # ElIdent/41 AsIs: e.Name/58 AsIs: )/29 } )/62 (/63 (/64 Tile{ HalfReuse: # CmdInsertElem/16 AsIs: s.Counter/17 } )/65 Tile{ AsIs: e.Commands/56 } )/66 </67 & Add/68 1/69 s.Counter/17/70 >/71 Tile{ AsIs: e.Result/60 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_close_bracket(vm, context[62]);
      refalrts::alloc_open_bracket(vm, context[63]);
      refalrts::alloc_open_bracket(vm, context[64]);
      refalrts::alloc_close_bracket(vm, context[65]);
    ...
    do {
      // </0 & DoGenResult/4 (/7 e.Vars/31 )/8 (/11 e.AllocCommands/33 )/12 (/15 e.Commands/35 )/16 s.Counter/17 (/28 # TkString/30 e.Chars/37 )/29 e.Result/39 >/1
      context[31] = context[18];
      context[32] = context[19];
      context[33] = context[20];
      context[34] = context[21];
      ...
      if( ! refalrts::ident_term( identifiers[ident_TkString], context[30] ) )
        continue;
      // closed e.Vars as range 31
      // closed e.AllocCommands as range 33
      // closed e.Commands as range 35
      // closed e.Chars as range 37
      // closed e.Result as range 39
      //DEBUG: s.Counter: 17
      //DEBUG: e.Vars: 31
      //DEBUG: e.AllocCommands: 33
      //DEBUG: e.Commands: 35
      //DEBUG: e.Chars: 37
      //DEBUG: e.Result: 39
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/31 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/33 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } Tile{ HalfReuse: # Allocate/16 AsIs: s.Counter/17 HalfReuse: # ElString/28 } Tile{ AsIs: e.Chars/37 } )/41 )/42 (/43 (/44 Tile{ Reuse: # CmdInsertRange/30 } s.Counter/17/45 )/46 Tile{ AsIs: e.Commands/35 } )/47 </48 & Add/49 s.Counter/17/50 2/51 Tile{ HalfReuse: >/29 AsIs: e.Result/39 AsIs: >/1 ]] }
    ...
    do {
      // </0 & DoGenResult/4 (/7 e.Vars/31 )/8 (/11 e.AllocCommands/33 )/12 (/15 e.Commands/35 )/16 s.Counter/17 (/28 # Brackets/30 e.InBrackets/37 )/29 e.Result/39 >/1
      context[31] = context[18];
      context[32] = context[19];
      context[33] = context[20];
      context[34] = context[21];
      ...
      // closed e.AllocCommands as range 33
      // closed e.Commands as range 35
      // closed e.InBrackets as range 37
      // closed e.Result as range 39
      //DEBUG: s.Counter: 17
      //DEBUG: e.Vars: 31
      //DEBUG: e.AllocCommands: 33
      //DEBUG: e.Commands: 35
      //DEBUG: e.InBrackets: 37
      //DEBUG: e.Result: 39

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/31 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/33 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } Tile{ HalfReuse: # Allocate/16 AsIs: s.Counter/17 HalfReuse: # ElOpenBracket/28 HalfReuse: )/30 } )/41 (/42 (/43 # CmdInsertElem/44 s.Counter/17/45 )/46 Tile{ AsIs: e.Commands/35 } )/47 </48 & Add/49 1/50 s.Counter/17/51 >/52 Tile{ AsIs: e.InBrackets/37 } (/53 # TkCloseBracket/54 s.Counter/17/55 Tile{ AsIs: )/29 AsIs: e.Result/39 AsIs: >/1 ]] }
      refalrts::alloc_close_bracket(vm, context[41]);
    ...
    do {
      // </0 & DoGenResult/4 (/7 e.Vars/31 )/8 (/11 e.AllocCommands/33 )/12 (/15 e.Commands/35 )/16 s.Counter/17 (/28 # CallBrackets/30 e.InBrackets/37 )/29 e.Result/39 >/1
      context[31] = context[18];
      context[32] = context[19];
      context[33] = context[20];
      context[34] = context[21];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/31 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/33 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } Tile{ HalfReuse: # Allocate/16 AsIs: s.Counter/17 HalfReuse: # ElOpenCall/28 HalfReuse: )/30 } )/41 (/42 (/43 # CmdInsertElem/44 s.Counter/17/45 )/46 Tile{ AsIs: e.Commands/35 } )/47 </48 & Add/49 1/50 s.Counter/17/51 >/52 Tile{ AsIs: e.InBrackets/37 } (/53 # TkCloseCall/54 s.Counter/17/55 Tile{ AsIs: )/29 AsIs: e.Result/39 AsIs: >/1 ]] }
      refalrts::alloc_close_bracket(vm, context[41]);
      refalrts::alloc_open_bracket(vm, context[42]);
      refalrts::alloc_open_bracket(vm, context[43]);
      refalrts::alloc_ident(vm, context[44], identifiers[ident_CmdInsertElem]);
    ...
    do {
      // </0 & DoGenResult/4 (/7 e.Vars/31 )/8 (/11 e.AllocCommands/33 )/12 (/15 e.Commands/35 )/16 s.Counter/17 (/28 # ADT-Brackets/30 (/43 e.Name/41 )/44 e.InBrackets/37 )/29 e.Result/39 >/1
      context[31] = context[18];
      context[32] = context[19];
      context[33] = context[20];
      context[34] = context[21];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/31 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/33 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } # Allocate/45 s.Counter/17/46 # ElOpenADT/47 )/48 )/49 (/50 (/51 # CmdInsertElem/52 s.Counter/17/53 )/54 Tile{ AsIs: e.Commands/35 } )/55 </56 & Add/57 Tile{ HalfReuse: 1/16 AsIs: s.Counter/17 } >/58 Tile{ AsIs: (/28 Reuse: # Symbol/30 HalfReuse: # Name/43 AsIs: e.Name/41 AsIs: )/44 AsIs: e.InBrackets/37 HalfReuse: (/29 } # TkCloseADT/59 s.Counter/17/60 )/61 Tile{ AsIs: e.Result/39 } Tile{ AsIs: >/1 ]] }
    ...
    do {
      // </0 & DoGenResult/4 (/7 e.Vars/31 )/8 (/11 e.AllocCommands/33 )/12 (/15 e.Commands/35 )/16 s.Counter/17 (/28 # ClosureBrackets/30 e.InBrackets/37 )/29 e.Result/39 >/1
      context[31] = context[18];
      context[32] = context[19];
      context[33] = context[20];
      context[34] = context[21];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/31 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/33 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } Tile{ HalfReuse: # Allocate/16 AsIs: s.Counter/17 HalfReuse: # ElClosureHead/28 HalfReuse: )/30 } )/41 (/42 (/43 # CmdInsertElem/44 s.Counter/17/45 )/46 Tile{ AsIs: e.Commands/35 } )/47 </48 & Add/49 1/50 s.Counter/17/51 >/52 Tile{ AsIs: e.InBrackets/37 } (/53 # TkUnwrappedClosure/54 s.Counter/17/55 Tile{ AsIs: )/29 AsIs: e.Result/39 AsIs: >/1 ]] }
      refalrts::alloc_close_bracket(vm, context[41]);
      refalrts::alloc_open_bracket(vm, context[42]);
      refalrts::alloc_open_bracket(vm, context[43]);
      refalrts::alloc_ident(vm, context[44], identifiers[ident_CmdInsertElem]);
    ...
    do {
      ...
      // closed e.new22 as range 48
      do {
        // </0 & DoGenResult/4 (/7 e.Vars/50 )/8 (/11 e.AllocCommands/52 )/12 (/15 e.Commands/54 )/16 s.Counter/17 (/28 # TkCloseBracket/30 s.OpenCounter/41 )/29 e.Result/56 >/1
        context[50] = context[42];
        context[51] = context[43];
        context[52] = context[44];
        context[53] = context[45];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/50 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/52 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } # Allocate/58 s.Counter/17/59 # ElCloseBracket/60 )/61 )/62 (/63 Tile{ AsIs: (/28 Reuse: # CmdLinkBrackets/30 AsIs: s.OpenCounter/41 } s.Counter/17/64 )/65 (/66 Tile{ HalfReuse: # CmdInsertElem/16 AsIs: s.Counter/17 } )/67 Tile{ AsIs: e.Commands/54 } )/68 </69 & Add/70 1/71 s.Counter/17/72 Tile{ HalfReuse: >/29 AsIs: e.Result/56 AsIs: >/1 ]] }
        refalrts::alloc_ident(vm, context[58], identifiers[ident_Allocate]);
      ...
      do {
        // </0 & DoGenResult/4 (/7 e.Vars/50 )/8 (/11 e.AllocCommands/52 )/12 (/15 e.Commands/54 )/16 s.Counter/17 (/28 # TkCloseADT/30 s.OpenCounter/41 )/29 e.Result/56 >/1
        context[50] = context[42];
        context[51] = context[43];
        context[52] = context[44];
        context[53] = context[45];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/50 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/52 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } # Allocate/58 s.Counter/17/59 # ElCloseADT/60 )/61 )/62 (/63 Tile{ AsIs: (/28 Reuse: # CmdLinkBrackets/30 AsIs: s.OpenCounter/41 } s.Counter/17/64 )/65 (/66 Tile{ HalfReuse: # CmdInsertElem/16 AsIs: s.Counter/17 } )/67 Tile{ AsIs: e.Commands/54 } )/68 </69 & Add/70 1/71 s.Counter/17/72 Tile{ HalfReuse: >/29 AsIs: e.Result/56 AsIs: >/1 ]] }
        refalrts::alloc_ident(vm, context[58], identifiers[ident_Allocate]);
        refalrts::copy_stvar(vm, context[59], context[17]);
      ...
      do {
        // </0 & DoGenResult/4 (/7 e.Vars/50 )/8 (/11 e.AllocCommands/52 )/12 (/15 e.Commands/54 )/16 s.Counter/17 (/28 # TkCloseCall/30 s.OpenCounter/41 )/29 e.Result/56 >/1
        context[50] = context[42];
        context[51] = context[43];
        context[52] = context[44];
        context[53] = context[45];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/50 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/52 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } Tile{ HalfReuse: # Allocate/16 AsIs: s.Counter/17 } # ElCloseCall/58 )/59 )/60 (/61 (/62 # CmdPushStack/63 s.Counter/17/64 )/65 Tile{ AsIs: (/28 Reuse: # CmdPushStack/30 AsIs: s.OpenCounter/41 AsIs: )/29 } (/66 # CmdInsertElem/67 s.Counter/17/68 )/69 Tile{ AsIs: e.Commands/54 } )/70 </71 & Add/72 1/73 s.Counter/17/74 >/75 Tile{ AsIs: e.Result/56 } Tile{ AsIs: >/1 ]] }
      ...
      // </0 & DoGenResult/4 (/7 e.Vars/50 )/8 (/11 e.AllocCommands/52 )/12 (/15 e.Commands/54 )/16 s.Counter/17 (/28 # TkUnwrappedClosure/30 s.HeadCounter/41 )/29 e.Result/56 >/1
      context[50] = context[42];
      context[51] = context[43];
      context[52] = context[44];
      context[53] = context[45];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.HeadCounter/41 {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/50 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/52 HalfReuse: (/12 HalfReuse: # CmdCreateElem/15 } Tile{ HalfReuse: # Allocate/16 AsIs: s.Counter/17 HalfReuse: # ElUnwrappedClosure/28 HalfReuse: s.HeadCounter41 /30 } )/58 )/59 (/60 (/61 # CmdInsertElem/62 s.Counter/17/63 )/64 Tile{ AsIs: e.Commands/54 } (/65 # CmdWrapClosure/66 s.Counter/17/67 )/68 )/69 </70 & Add/71 1/72 s.Counter/17/73 Tile{ HalfReuse: >/29 AsIs: e.Result/56 AsIs: >/1 ]] }
    ...
    // </0 & DoGenResult/4 (/7 e.new25/42 )/8 (/11 e.new26/44 )/12 (/15 e.new27/46 )/16 s.new21/17 (/28 # Var/30 s.new23/41 e.new24/48 )/29 e.new22/50 >/1
    context[42] = context[31];
    context[43] = context[32];
    context[44] = context[33];
    context[45] = context[34];
    ...
    // closed e.new22 as range 50
    do {
      // </0 & DoGenResult/4 (/7 e.Vars-B/62 (/68 s.Mode/70 (/73 e.Index/79 )/74 (/77 e.ResultVars/75 )/78 s.NextPatternVar/81 e.PatternVars/66 )/69 e.Vars-E/64 )/8 (/11 e.AllocCommands/54 )/12 (/15 e.Commands/56 )/16 s.Counter/17 (/28 # Var/30 s.Mode/41 e.Index/58 )/29 e.Result/60 >/1
      context[52] = context[42];
      context[53] = context[43];
      context[54] = context[44];
      context[55] = context[45];
      ...
      do {
        ...
        if( ! refalrts::empty_seq( context[71], context[72] ) )
          continue;
        // closed e.ResultVars as range 75
        // closed e.Vars-E as range 64
        if( ! refalrts::svar_left( context[81], context[66], context[67] ) )
          continue;
        // closed e.PatternVars as range 66
        //DEBUG: s.Counter: 17
        //DEBUG: s.Mode: 41
        //DEBUG: e.AllocCommands: 54
        //DEBUG: e.Commands: 56
        ...
        //DEBUG: e.Result: 60
        //DEBUG: e.Vars-B: 62
        //DEBUG: e.ResultVars: 75
        //DEBUG: e.Vars-E: 64
        //DEBUG: s.NextPatternVar: 81
        //DEBUG: e.PatternVars: 66

        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.Counter/17 {REMOVED TILE} e.Index/58 {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars-B/62 AsIs: (/68 AsIs: s.Mode/70 AsIs: (/73 AsIs: e.Index/79 AsIs: )/74 AsIs: (/77 AsIs: e.ResultVars/75 HalfReuse: s.NextPatternVar81 /78 } Tile{ AsIs: )/16 } Tile{ AsIs: e.PatternVars/66 } Tile{ AsIs: )/69 AsIs: e.Vars-E/64 AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/54 AsIs: )/12 AsIs: (/15 } Tile{ AsIs: (/28 Reuse: # CmdInsertVar/30 AsIs: s.Mode/41 } Tile{ AsIs: s.NextPatternVar/81 } )/82 Tile{ AsIs: e.Commands/56 } )/83 Tile{ HalfReuse: s.Counter17 /29 AsIs: e.Result/60 AsIs: >/1 ]] }
    ...
    // </0 & DoGenResult/4 (/7 e.Vars-B/62 (/68 s.Mode/78 (/76 e.Index/79 )/77 (/72 e.ResultVars/70 s.Sample/81 )/73 )/69 e.Vars-E/64 )/8 (/11 e.AllocCommands/54 )/12 (/15 e.Commands/56 )/16 s.Counter/17 (/28 # Var/30 s.Mode/41 e.Index/58 )/29 e.Result/60 >/1
    context[52] = context[42];
    context[53] = context[43];
    context[54] = context[44];
    context[55] = context[45];
    ...
    do {
      ...
      if( ! refalrts::svar_right( context[81], context[70], context[71] ) )
        continue;
      // closed e.ResultVars as range 70
      //DEBUG: s.Counter: 17
      //DEBUG: s.Mode: 41
      //DEBUG: e.AllocCommands: 54
      //DEBUG: e.Commands: 56
      ...
      //DEBUG: e.Vars-E: 64
      //DEBUG: s.Sample: 81
      //DEBUG: e.ResultVars: 70

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} e.Index/58 {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars-B/62 AsIs: (/68 AsIs: s.Mode/78 AsIs: (/76 AsIs: e.Index/79 AsIs: )/77 AsIs: (/72 AsIs: e.ResultVars/70 AsIs: s.Sample/81 HalfReuse: s.Counter17 /73 AsIs: )/69 } )/82 Tile{ AsIs: e.Vars-E/64 } Tile{ AsIs: )/8 AsIs: (/11 AsIs: e.AllocCommands/54 HalfReuse: (/12 HalfReuse: # CmdCopyVar/15 } Tile{ HalfReuse: s.Mode78 /16 AsIs: s.Counter/17 } s.Sample/81/83 )/84 )/85 (/86 Tile{ AsIs: (/28 Reuse: # CmdInsertVar/30 AsIs: s.Mode/41 } s.Counter/17/87 )/88 Tile{ AsIs: e.Commands/56 } )/89 </90 & IncVarOffset/91 s.Counter/17/92 s.Mode/78/93 Tile{ HalfReuse: >/29 AsIs: e.Result/60 AsIs: >/1 ]] }
      refalrts::alloc_close_bracket(vm, context[82]);
  ...
  // </0 & DoGenResult/4 (/7 e.Vars/5 )/8 (/11 e.AllocCommands/9 )/12 (/15 e.Commands/13 )/16 s.Counter/17 >/1
  if( ! refalrts::empty_seq( context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  // closed e.Vars as range 5
  // closed e.AllocCommands as range 9
  // closed e.Commands as range 13
  //DEBUG: s.Counter: 17
  //DEBUG: e.Vars: 5
  //DEBUG: e.AllocCommands: 9
  //DEBUG: e.Commands: 13

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} </0 {REMOVED TILE} (/11 {REMOVED TILE} )/12 (/15 {REMOVED TILE} )/16 s.Counter/17 >/1 {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ HalfReuse: s.Counter17 /4 AsIs: (/7 AsIs: e.Vars/5 AsIs: )/8 } Tile{ AsIs: e.AllocCommands/9 } Tile{ AsIs: e.Commands/13 } Tile{ ]] }
...
static refalrts::FnResult func_MakeVariableCommentTable(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[8];
  refalrts::zeros( context, 8 );
  // </0 & MakeVariableCommentTable/4 e.Vars/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.Vars as range 2
  //DEBUG: e.Vars: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 & Fetch@1/6 Tile{ AsIs: </0 Reuse: & Map@5/4 AsIs: e.Vars/2 AsIs: >/1 } >/7 Tile{ ]] }
  refalrts::alloc_open_call(vm, context[5]);
...
static refalrts::FnResult func_ReplicateVar(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[18];
  refalrts::zeros( context, 18 );
  // </0 & ReplicateVar/4 (/7 s.Mode/9 (/12 e.Index/10 )/13 (/16 e.ResultOccurences/14 )/17 e.PatternOccurences/5 )/8 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  // closed e.Index as range 10
  // closed e.ResultOccurences as range 14
  // closed e.PatternOccurences as range 5
  //DEBUG: s.Mode: 9
  //DEBUG: e.Index: 10
  //DEBUG: e.ResultOccurences: 14
  //DEBUG: e.PatternOccurences: 5

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} </0 {REMOVED TILE} (/16 {REMOVED TILE} )/17 {REMOVED TILE} )/8 {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ HalfReuse: </4 HalfReuse: & Map@2/7 AsIs: s.Mode/9 AsIs: (/12 AsIs: e.Index/10 AsIs: )/13 } Tile{ AsIs: e.ResultOccurences/14 } Tile{ AsIs: e.PatternOccurences/5 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_MakeVariableComment(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[15];
  refalrts::zeros( context, 15 );
  // </0 & MakeVariableComment/4 (/7 s.Offset/9 s.Mode/10 e.Index/5 )/8 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdComment/4 HalfReuse: # Offset/7 AsIs: s.Offset/9 }": "/11 </13 & PrintVar/14 Tile{ AsIs: s.Mode/10 AsIs: e.Index/5 HalfReuse: >/8 HalfReuse: )/1 ]] }
  refalrts::alloc_chars(vm, context[11], context[12], ": ", 2);
  refalrts::alloc_open_call(vm, context[13]);
  refalrts::alloc_name(vm, context[14], functions[efunc_PrintVar]);
...
static refalrts::FnResult func_gen_DoGenResult_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & DoGenResult@1/4 (/7 e.new1/5 )/8 s.new2/9 e.new3/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new3 as range 2
  do {
    // </0 & DoGenResult@1/4 (/7 e.new8/10 )/8 s.new4/9 (/16 s.new5/18 e.new6/14 )/17 e.new7/12 >/1
    ...
    do {
      // </0 & DoGenResult@1/4 (/7 e.new14/19 )/8 s.new9/9 (/16 s.new11/18 s.new12/25 e.new13/21 )/17 e.new10/23 >/1
      ...
      do {
        // </0 & DoGenResult@1/4 (/7 e.new19/26 )/8 s.new15/9 (/16 s.new17/18 s.new18/25 )/17 e.new16/28 >/1
        ...
        do {
          // </0 & DoGenResult@1/4 (/7 e.Vars/30 )/8 s.ContextOffset/9 (/16 # TkOpenCallCond/18 s.Offset/25 )/17 e.Result/32 >/1
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/30 AsIs: )/8 } (/34 (/35 # CmdCreateElem/36 # Allocate/37 s.Offset/25/38 # ElOpenCall/39 )/40 )/41 (/42 Tile{ AsIs: (/16 Reuse: # CmdInsertElem/18 AsIs: s.Offset/25 AsIs: )/17 } )/43 Tile{ AsIs: s.ContextOffset/9 } Tile{ AsIs: e.Result/32 } Tile{ AsIs: >/1 ]] }
        ...
        // </0 & DoGenResult@1/4 (/7 e.Vars/30 )/8 s.ContextOffset/9 (/16 # TkCloseCallCond/18 s.Offset/25 )/17 e.Result/32 >/1
        context[30] = context[26];
        context[31] = context[27];
        context[32] = context[28];
        context[33] = context[29];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/30 AsIs: )/8 } (/34 (/35 # CmdCreateElem/36 # Allocate/37 s.Offset/25/38 # ElCloseCall/39 )/40 )/41 (/42 Tile{ AsIs: (/16 Reuse: # CmdPushStack/18 AsIs: s.Offset/25 AsIs: )/17 } (/43 # CmdPushStack/44 </45 & Sub/46 s.Offset/25/47 1/48 >/49 )/50 (/51 # CmdInsertElem/52 s.Offset/25/53 )/54 )/55 Tile{ AsIs: s.ContextOffset/9 } Tile{ AsIs: e.Result/32 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_bracket(vm, context[34]);
        refalrts::alloc_open_bracket(vm, context[35]);
        refalrts::alloc_ident(vm, context[36], identifiers[ident_CmdCreateElem]);
        refalrts::alloc_ident(vm, context[37], identifiers[ident_Allocate]);
      ...
      // </0 & DoGenResult@1/4 (/7 e.new19/26 )/8 s.new15/9 (/16 # Symbol/18 s.new17/25 e.new18/28 )/17 e.new16/30 >/1
      context[26] = context[19];
      context[27] = context[20];
      ...
      do {
        // </0 & DoGenResult@1/4 (/7 e.Vars/32 )/8 s.ContextOffset/9 (/16 # Symbol/18 # Char/25 s.Value/38 )/17 e.Result/36 >/1
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/32 AsIs: )/8 } (/39 (/40 # CmdCreateElem/41 Tile{ HalfReuse: # Allocate/16 HalfReuse: s.ContextOffset9 /18 Reuse: # ElChar/25 AsIs: s.Value/38 AsIs: )/17 } )/42 (/43 (/44 # CmdInsertElem/45 Tile{ AsIs: s.ContextOffset/9 } )/46 )/47 </48 & Add/49 1/50 s.ContextOffset/9/51 >/52 Tile{ AsIs: e.Result/36 } Tile{ AsIs: >/1 ]] }
      ...
      do {
        // </0 & DoGenResult@1/4 (/7 e.Vars/32 )/8 s.ContextOffset/9 (/16 # Symbol/18 # Name/25 e.Name/34 )/17 e.Result/36 >/1
        context[32] = context[26];
        context[33] = context[27];
        context[34] = context[28];
        context[35] = context[29];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/32 AsIs: )/8 } (/38 (/39 # CmdCreateElem/40 Tile{ HalfReuse: # Allocate/16 HalfReuse: s.ContextOffset9 /18 Reuse: # ElName/25 AsIs: e.Name/34 AsIs: )/17 } )/41 (/42 (/43 # CmdInsertElem/44 Tile{ AsIs: s.ContextOffset/9 } )/45 )/46 </47 & Add/48 1/49 s.ContextOffset/9/50 >/51 Tile{ AsIs: e.Result/36 } Tile{ AsIs: >/1 ]] }
      ...
      do {
        // </0 & DoGenResult@1/4 (/7 e.Vars/32 )/8 s.ContextOffset/9 (/16 # Symbol/18 # Number/25 s.Number/38 )/17 e.Result/36 >/1
        context[32] = context[26];
        context[33] = context[27];
        context[34] = context[28];
        context[35] = context[29];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/32 AsIs: )/8 } (/39 (/40 # CmdCreateElem/41 Tile{ HalfReuse: # Allocate/16 HalfReuse: s.ContextOffset9 /18 Reuse: # ElNumber/25 AsIs: s.Number/38 AsIs: )/17 } )/42 (/43 (/44 # CmdInsertElem/45 Tile{ AsIs: s.ContextOffset/9 } )/46 )/47 </48 & Add/49 1/50 s.ContextOffset/9/51 >/52 Tile{ AsIs: e.Result/36 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_bracket(vm, context[39]);
        refalrts::alloc_open_bracket(vm, context[40]);
        refalrts::alloc_ident(vm, context[41], identifiers[ident_CmdCreateElem]);
        refalrts::alloc_close_bracket(vm, context[42]);
      ...
      // </0 & DoGenResult@1/4 (/7 e.Vars/32 )/8 s.ContextOffset/9 (/16 # Symbol/18 # Identifier/25 e.Name/34 )/17 e.Result/36 >/1
      context[32] = context[26];
      context[33] = context[27];
      context[34] = context[28];
      context[35] = context[29];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/32 AsIs: )/8 } (/38 (/39 # CmdCreateElem/40 Tile{ HalfReuse: # Allocate/16 HalfReuse: s.ContextOffset9 /18 Reuse: # ElIdent/25 AsIs: e.Name/34 AsIs: )/17 } )/41 (/42 (/43 # CmdInsertElem/44 Tile{ AsIs: s.ContextOffset/9 } )/45 )/46 </47 & Add/48 1/49 s.ContextOffset/9/50 >/51 Tile{ AsIs: e.Result/36 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[38]);
      refalrts::alloc_open_bracket(vm, context[39]);
      refalrts::alloc_ident(vm, context[40], identifiers[ident_CmdCreateElem]);
      refalrts::alloc_close_bracket(vm, context[41]);
    ...
    do {
      // </0 & DoGenResult@1/4 (/7 e.Vars/19 )/8 s.ContextOffset/9 (/16 # TkString/18 e.Chars/21 )/17 e.Result/23 >/1
      context[19] = context[10];
      context[20] = context[11];
      context[21] = context[14];
      context[22] = context[15];
      ...
      // closed e.Chars as range 21
      // closed e.Result as range 23
      //DEBUG: s.ContextOffset: 9
      //DEBUG: e.Vars: 19
      //DEBUG: e.Chars: 21
      //DEBUG: e.Result: 23
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/19 AsIs: )/8 } (/25 Tile{ AsIs: (/16 Reuse: # CmdCreateElem/18 } # Allocate/26 Tile{ AsIs: s.ContextOffset/9 } # ElString/27 Tile{ AsIs: e.Chars/21 } )/28 )/29 (/30 (/31 # CmdInsertRange/32 s.ContextOffset/9/33 )/34 )/35 </36 & Add/37 s.ContextOffset/9/38 2/39 Tile{ HalfReuse: >/17 AsIs: e.Result/23 AsIs: >/1 ]] }
    ...
    do {
      // </0 & DoGenResult@1/4 (/7 e.Vars/19 )/8 s.ContextOffset/9 (/16 # Brackets/18 e.InBrackets/21 )/17 e.Result/23 >/1
      context[19] = context[10];
      context[20] = context[11];
      context[21] = context[14];
      context[22] = context[15];
      ...
      if( ! refalrts::ident_term( identifiers[ident_Brackets], context[18] ) )
        continue;
      // closed e.Vars as range 19
      // closed e.InBrackets as range 21
      // closed e.Result as range 23
      //DEBUG: s.ContextOffset: 9
      //DEBUG: e.Vars: 19
      //DEBUG: e.InBrackets: 21
      //DEBUG: e.Result: 23

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/19 AsIs: )/8 } (/25 (/26 # CmdCreateElem/27 # Allocate/28 Tile{ AsIs: s.ContextOffset/9 HalfReuse: # ElOpenBracket/16 HalfReuse: )/18 } )/29 (/30 (/31 # CmdInsertElem/32 s.ContextOffset/9/33 )/34 )/35 </36 & Add/37 1/38 s.ContextOffset/9/39 >/40 Tile{ AsIs: e.InBrackets/21 } (/41 # TkCloseBracket/42 s.ContextOffset/9/43 Tile{ AsIs: )/17 AsIs: e.Result/23 AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[25]);
    ...
    do {
      // </0 & DoGenResult@1/4 (/7 e.Vars/19 )/8 s.ContextOffset/9 (/16 # CallBrackets/18 e.InBrackets/21 )/17 e.Result/23 >/1
      context[19] = context[10];
      context[20] = context[11];
      context[21] = context[14];
      context[22] = context[15];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/19 AsIs: )/8 } (/25 (/26 # CmdCreateElem/27 # Allocate/28 Tile{ AsIs: s.ContextOffset/9 HalfReuse: # ElOpenCall/16 HalfReuse: )/18 } )/29 (/30 (/31 # CmdInsertElem/32 s.ContextOffset/9/33 )/34 )/35 </36 & Add/37 1/38 s.ContextOffset/9/39 >/40 Tile{ AsIs: e.InBrackets/21 } (/41 # TkCloseCall/42 s.ContextOffset/9/43 Tile{ AsIs: )/17 AsIs: e.Result/23 AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[25]);
      refalrts::alloc_open_bracket(vm, context[26]);
      refalrts::alloc_ident(vm, context[27], identifiers[ident_CmdCreateElem]);
      refalrts::alloc_ident(vm, context[28], identifiers[ident_Allocate]);
    ...
    do {
      // </0 & DoGenResult@1/4 (/7 e.Vars/19 )/8 s.ContextOffset/9 (/16 # ADT-Brackets/18 (/27 e.Name/25 )/28 e.InBrackets/21 )/17 e.Result/23 >/1
      context[19] = context[10];
      context[20] = context[11];
      context[21] = context[14];
      context[22] = context[15];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/19 AsIs: )/8 } (/29 (/30 # CmdCreateElem/31 # Allocate/32 s.ContextOffset/9/33 # ElOpenADT/34 )/35 )/36 (/37 (/38 # CmdInsertElem/39 Tile{ AsIs: s.ContextOffset/9 } )/40 )/41 </42 & Add/43 1/44 s.ContextOffset/9/45 >/46 Tile{ AsIs: (/16 Reuse: # Symbol/18 HalfReuse: # Name/27 AsIs: e.Name/25 AsIs: )/28 AsIs: e.InBrackets/21 HalfReuse: (/17 } # TkCloseADT/47 s.ContextOffset/9/48 )/49 Tile{ AsIs: e.Result/23 } Tile{ AsIs: >/1 ]] }
    ...
    do {
      // </0 & DoGenResult@1/4 (/7 e.Vars/19 )/8 s.ContextOffset/9 (/16 # ClosureBrackets/18 e.InBrackets/21 )/17 e.Result/23 >/1
      context[19] = context[10];
      context[20] = context[11];
      context[21] = context[14];
      context[22] = context[15];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/19 AsIs: )/8 } (/25 (/26 # CmdCreateElem/27 # Allocate/28 Tile{ AsIs: s.ContextOffset/9 HalfReuse: # ElClosureHead/16 HalfReuse: )/18 } )/29 (/30 (/31 # CmdInsertElem/32 s.ContextOffset/9/33 )/34 )/35 </36 & Add/37 1/38 s.ContextOffset/9/39 >/40 Tile{ AsIs: e.InBrackets/21 } (/41 # TkUnwrappedClosure/42 s.ContextOffset/9/43 Tile{ AsIs: )/17 AsIs: e.Result/23 AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[25]);
      refalrts::alloc_open_bracket(vm, context[26]);
      refalrts::alloc_ident(vm, context[27], identifiers[ident_CmdCreateElem]);
      refalrts::alloc_ident(vm, context[28], identifiers[ident_Allocate]);
    ...
    do {
      ...
      // closed e.new16 as range 28
      do {
        // </0 & DoGenResult@1/4 (/7 e.Vars/30 )/8 s.ContextOffset/9 (/16 # TkCloseBracket/18 s.OpenCounter/25 )/17 e.Result/32 >/1
        context[30] = context[26];
        context[31] = context[27];
        context[32] = context[28];
        context[33] = context[29];
        ...
        // closed e.Result as range 32
        //DEBUG: s.ContextOffset: 9
        //DEBUG: s.OpenCounter: 25
        //DEBUG: e.Vars: 30
        //DEBUG: e.Result: 32

        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/30 AsIs: )/8 } (/34 (/35 # CmdCreateElem/36 # Allocate/37 s.ContextOffset/9/38 # ElCloseBracket/39 )/40 )/41 (/42 Tile{ AsIs: (/16 Reuse: # CmdLinkBrackets/18 AsIs: s.OpenCounter/25 } Tile{ AsIs: s.ContextOffset/9 } )/43 (/44 # CmdInsertElem/45 s.ContextOffset/9/46 )/47 )/48 </49 & Add/50 1/51 s.ContextOffset/9/52 Tile{ HalfReuse: >/17 AsIs: e.Result/32 AsIs: >/1 ]] }
        refalrts::alloc_open_bracket(vm, context[34]);
        refalrts::alloc_open_bracket(vm, context[35]);
        refalrts::alloc_ident(vm, context[36], identifiers[ident_CmdCreateElem]);
        refalrts::alloc_ident(vm, context[37], identifiers[ident_Allocate]);
      ...
      do {
        // </0 & DoGenResult@1/4 (/7 e.Vars/30 )/8 s.ContextOffset/9 (/16 # TkCloseADT/18 s.OpenCounter/25 )/17 e.Result/32 >/1
        context[30] = context[26];
        context[31] = context[27];
        context[32] = context[28];
        context[33] = context[29];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/30 AsIs: )/8 } (/34 (/35 # CmdCreateElem/36 # Allocate/37 s.ContextOffset/9/38 # ElCloseADT/39 )/40 )/41 (/42 Tile{ AsIs: (/16 Reuse: # CmdLinkBrackets/18 AsIs: s.OpenCounter/25 } Tile{ AsIs: s.ContextOffset/9 } )/43 (/44 # CmdInsertElem/45 s.ContextOffset/9/46 )/47 )/48 </49 & Add/50 1/51 s.ContextOffset/9/52 Tile{ HalfReuse: >/17 AsIs: e.Result/32 AsIs: >/1 ]] }
        refalrts::alloc_open_bracket(vm, context[34]);
        refalrts::alloc_open_bracket(vm, context[35]);
        refalrts::alloc_ident(vm, context[36], identifiers[ident_CmdCreateElem]);
        refalrts::alloc_ident(vm, context[37], identifiers[ident_Allocate]);
      ...
      do {
        // </0 & DoGenResult@1/4 (/7 e.Vars/30 )/8 s.ContextOffset/9 (/16 # TkCloseCall/18 s.OpenCounter/25 )/17 e.Result/32 >/1
        context[30] = context[26];
        context[31] = context[27];
        context[32] = context[28];
        context[33] = context[29];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/30 AsIs: )/8 } (/34 (/35 # CmdCreateElem/36 # Allocate/37 s.ContextOffset/9/38 # ElCloseCall/39 )/40 )/41 (/42 (/43 # CmdPushStack/44 Tile{ AsIs: s.ContextOffset/9 } )/45 Tile{ AsIs: (/16 Reuse: # CmdPushStack/18 AsIs: s.OpenCounter/25 AsIs: )/17 } (/46 # CmdInsertElem/47 s.ContextOffset/9/48 )/49 )/50 </51 & Add/52 1/53 s.ContextOffset/9/54 >/55 Tile{ AsIs: e.Result/32 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_bracket(vm, context[34]);
        refalrts::alloc_open_bracket(vm, context[35]);
        refalrts::alloc_ident(vm, context[36], identifiers[ident_CmdCreateElem]);
        refalrts::alloc_ident(vm, context[37], identifiers[ident_Allocate]);
      ...
      // </0 & DoGenResult@1/4 (/7 e.Vars/30 )/8 s.ContextOffset/9 (/16 # TkUnwrappedClosure/18 s.HeadCounter/25 )/17 e.Result/32 >/1
      context[30] = context[26];
      context[31] = context[27];
      context[32] = context[28];
      context[33] = context[29];
      ...
      // closed e.Result as range 32
      //DEBUG: s.ContextOffset: 9
      //DEBUG: s.HeadCounter: 25
      //DEBUG: e.Vars: 30
      //DEBUG: e.Result: 32

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/30 AsIs: )/8 } (/34 (/35 # CmdCreateElem/36 # Allocate/37 Tile{ HalfReuse: s.ContextOffset9 /16 Reuse: # ElUnwrappedClosure/18 AsIs: s.HeadCounter/25 } )/38 )/39 (/40 (/41 # CmdInsertElem/42 Tile{ AsIs: s.ContextOffset/9 } )/43 (/44 # CmdWrapClosure/45 s.ContextOffset/9/46 )/47 )/48 </49 & Add/50 1/51 s.ContextOffset/9/52 Tile{ HalfReuse: >/17 AsIs: e.Result/32 AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[34]);
      refalrts::alloc_open_bracket(vm, context[35]);
      refalrts::alloc_ident(vm, context[36], identifiers[ident_CmdCreateElem]);
      refalrts::alloc_ident(vm, context[37], identifiers[ident_Allocate]);
    ...
    // </0 & DoGenResult@1/4 (/7 e.new19/26 )/8 s.new15/9 (/16 # Var/18 s.new17/25 e.new18/28 )/17 e.new16/30 >/1
    context[26] = context[19];
    context[27] = context[20];
    context[28] = context[21];
    context[29] = context[22];
    ...
    // closed e.new16 as range 30
    do {
      // </0 & DoGenResult@1/4 (/7 e.Vars-B/38 (/44 s.Mode/46 (/49 e.Index/55 )/50 (/53 e.ResultVars/51 )/54 s.NextPatternVar/57 e.PatternVars/42 )/45 e.Vars-E/40 )/8 s.ContextOffset/9 (/16 # Var/18 s.Mode/25 e.Index/34 )/17 e.Result/36 >/1
      context[32] = context[26];
      context[33] = context[27];
      context[34] = context[28];
      context[35] = context[29];
      ...
      do {
        ...
        if( ! refalrts::empty_seq( context[47], context[48] ) )
          continue;
        // closed e.ResultVars as range 51
        // closed e.Vars-E as range 40
        if( ! refalrts::svar_left( context[57], context[42], context[43] ) )
          continue;
        // closed e.PatternVars as range 42
        //DEBUG: s.ContextOffset: 9
        //DEBUG: s.Mode: 25
        //DEBUG: e.Index: 34
        //DEBUG: e.Result: 36
        //DEBUG: e.Vars-B: 38
        //DEBUG: e.ResultVars: 51
        //DEBUG: e.Vars-E: 40
        //DEBUG: s.NextPatternVar: 57
        //DEBUG: e.PatternVars: 42

        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.ContextOffset/9 {REMOVED TILE} e.Index/34 {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult@2/4 AsIs: (/7 AsIs: e.Vars-B/38 AsIs: (/44 AsIs: s.Mode/46 AsIs: (/49 AsIs: e.Index/55 AsIs: )/50 AsIs: (/53 AsIs: e.ResultVars/51 HalfReuse: s.NextPatternVar57 /54 } )/58 Tile{ AsIs: e.PatternVars/42 } Tile{ AsIs: )/45 AsIs: e.Vars-E/40 AsIs: )/8 } (/59 Tile{ AsIs: (/16 Reuse: # CmdInsertVar/18 AsIs: s.Mode/25 } Tile{ AsIs: s.NextPatternVar/57 } )/60 )/61 Tile{ HalfReuse: s.ContextOffset9 /17 AsIs: e.Result/36 AsIs: >/1 ]] }
        refalrts::alloc_close_bracket(vm, context[58]);
    ...
    // </0 & DoGenResult@1/4 (/7 e.Vars-B/38 (/44 s.Mode/54 (/52 e.Index/55 )/53 (/48 e.ResultVars/46 s.Sample/57 )/49 )/45 e.Vars-E/40 )/8 s.ContextOffset/9 (/16 # Var/18 s.Mode/25 e.Index/34 )/17 e.Result/36 >/1
    context[32] = context[26];
    context[33] = context[27];
    context[34] = context[28];
    context[35] = context[29];
    ...
    do {
      ...
      if( ! refalrts::svar_right( context[57], context[46], context[47] ) )
        continue;
      // closed e.ResultVars as range 46
      //DEBUG: s.ContextOffset: 9
      //DEBUG: s.Mode: 25
      //DEBUG: e.Index: 34
      //DEBUG: e.Result: 36
      ...
      //DEBUG: e.Vars-E: 40
      //DEBUG: s.Sample: 57
      //DEBUG: e.ResultVars: 46

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} e.Index/34 {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars-B/38 AsIs: (/44 AsIs: s.Mode/54 AsIs: (/52 AsIs: e.Index/55 AsIs: )/53 AsIs: (/48 AsIs: e.ResultVars/46 AsIs: s.Sample/57 HalfReuse: s.ContextOffset9 /49 AsIs: )/45 } )/58 Tile{ AsIs: e.Vars-E/40 } )/59 (/60 (/61 # CmdCopyVar/62 Tile{ HalfReuse: s.Mode54 /8 AsIs: s.ContextOffset/9 } s.Sample/57/63 )/64 )/65 (/66 Tile{ AsIs: (/16 Reuse: # CmdInsertVar/18 AsIs: s.Mode/25 } s.ContextOffset/9/67 )/68 )/69 </70 & IncVarOffset/71 s.ContextOffset/9/72 s.Mode/54/73 Tile{ HalfReuse: >/17 AsIs: e.Result/36 AsIs: >/1 ]] }
      refalrts::alloc_close_bracket(vm, context[58]);
      refalrts::alloc_close_bracket(vm, context[59]);
      refalrts::alloc_open_bracket(vm, context[60]);
      refalrts::alloc_open_bracket(vm, context[61]);
  ...
  do {
    // </0 & DoGenResult@1/4 (/7 e.Vars/10 )/8 s.ContextOffset/9 >/1
    context[10] = context[5];
    context[11] = context[6];
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    // closed e.Vars as range 10
    //DEBUG: s.ContextOffset: 9
    //DEBUG: e.Vars: 10

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 {REMOVED TILE} s.ContextOffset/9 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ HalfReuse: s.ContextOffset9 /4 AsIs: (/7 AsIs: e.Vars/10 AsIs: )/8 } Tile{ ]] }
  ...
  // </0 & DoGenResult@1/4 (/7 e.dyn0/5 )/8 s.ContextOffset/9 e.dyn3/2 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult@0/4 AsIs: (/7 AsIs: e.dyn0/5 AsIs: )/8 } (/10 )/11 (/12 )/13 Tile{ AsIs: s.ContextOffset/9 AsIs: e.dyn3/2 AsIs: >/1 ]] }
  refalrts::alloc_open_bracket(vm, context[10]);
  refalrts::alloc_close_bracket(vm, context[11]);
...
static refalrts::FnResult func_gen_Map_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // closed e.new2 as range 2
  do {
    // </0 & Map@1/4 s.FnMakeVarTable/5 t.Next/8 e.Tail/6 >/1
    context[6] = context[2];
    context[7] = context[3];
    ...
    //DEBUG: s.FnMakeVarTable: 5
    //DEBUG: t.Next: 8
    //DEBUG: e.Tail: 6

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & __Meta_Mu/4 AsIs: s.FnMakeVarTable/5 AsIs: t.Next/8 } & $table/10 >/11 </12 & Map@1/13 s.FnMakeVarTable/5/14 Tile{ AsIs: e.Tail/6 } Tile{ AsIs: >/1 ]] }
  ...
  do {
    // </0 & Map@1/4 s.FnMakeVarTable/5 >/1
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    //DEBUG: s.FnMakeVarTable: 5

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Map@1/4 s.FnMakeVarTable/5 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & Map@1/4 s.FnMakeVarTable/5 e.items/2 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@0/4 AsIs: s.FnMakeVarTable/5 AsIs: e.items/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Map_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Map@2/4 s.new1/5 (/8 e.new2/6 )/9 e.new3/2 >/1
  if( ! refalrts::svar_left( context[5], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  context[6] = 0;
  context[7] = 0;
  ...
  // closed e.new3 as range 2
  do {
    // </0 & Map@2/4 s.new4/5 (/8 e.new7/10 )/9 t.new5/14 e.new6/12 >/1
    context[10] = context[6];
    context[11] = context[7];
    context[12] = context[2];
    context[13] = context[3];
    ...
    do {
      // </0 & Map@2/4 s.Mode/5 (/8 e.Index/16 )/9 s.ContextOffset/14 e.Tail/18 >/1
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } (/20 Tile{ AsIs: s.ContextOffset/14 } s.Mode/5/21 e.Index/16/22 )/24 Tile{ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Mode/5 AsIs: (/8 AsIs: e.Index/16 AsIs: )/9 } Tile{ AsIs: e.Tail/18 } Tile{ AsIs: >/1 ]] }
    ...
    // </0 & Map@2/4 s.Mode/5 (/8 e.Index/16 )/9 t.Next/14 e.Tail/18 >/1
    context[16] = context[10];
    context[17] = context[11];
    context[18] = context[12];
    context[19] = context[13];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & ReplicateVar\1*1/4 AsIs: s.Mode/5 AsIs: (/8 AsIs: e.Index/16 AsIs: )/9 AsIs: t.Next/14 } >/20 </21 & Map@2/22 s.Mode/5/23 (/24 e.Index/16/25 )/27 Tile{ AsIs: e.Tail/18 } Tile{ AsIs: >/1 ]] }
  ...
  do {
    // </0 & Map@2/4 s.Mode/5 (/8 e.Index/10 )/9 >/1
    context[10] = context[6];
    context[11] = context[7];
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Map@2/4 s.Mode/5 (/8 e.Index/10 )/9 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & Map@2/4 s.Mode/5 (/8 e.Index/6 )/9 e.items/2 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </10 & Map@0/11 Tile{ HalfReuse: [*]/0 Reuse: & ReplicateVar\1@0/4 AsIs: s.Mode/5 AsIs: (/8 AsIs: e.Index/6 AsIs: )/9 } {*}/12 Tile{ AsIs: e.items/2 } Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[10]);
...
static refalrts::FnResult func_gen_Map_Z3(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new2 as range 5
    do {
      // </0 & Map@3/4 (/7 s.Mode/13 (/16 e.2/14 )/17 e.1/11 )/8 e.Tail/9 >/1
      context[9] = context[5];
      context[10] = context[6];
      context[11] = 0;
      context[12] = 0;
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: s.Mode/13 AsIs: (/16 AsIs: e.2/14 AsIs: )/17 } Tile{ HalfReuse: (/4 } )/18 Tile{ AsIs: e.1/11 } )/19 Tile{ AsIs: </0 } Tile{ HalfReuse: & Map@3/8 AsIs: e.Tail/9 AsIs: >/1 ]] }
      refalrts::alloc_close_bracket(vm, context[18]);
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & MakeVarTable-Simple*1/4 AsIs: t.Next/7 } >/11 </12 & Map@3/13 Tile{ AsIs: e.Tail/9 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[11]);
    refalrts::alloc_open_call(vm, context[12]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & MakeVarTable-Simple@0/4 AsIs: e.items/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
...
static refalrts::FnResult func_gen_Map_Z4(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new2 as range 5
    do {
      // </0 & Map@4/4 (/7 s.Mode/13 (/16 e.2/14 )/17 e.1/11 )/8 e.Tail/9 >/1
      context[9] = context[5];
      context[10] = context[6];
      context[11] = 0;
      context[12] = 0;
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: s.Mode/13 AsIs: (/16 AsIs: e.2/14 AsIs: )/17 } (/18 Tile{ AsIs: e.1/11 } Tile{ HalfReuse: )/4 } )/19 Tile{ AsIs: </0 } Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail/9 AsIs: >/1 ]] }
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & MakeVarTable-Conditions*1/4 AsIs: t.Next/7 } >/11 </12 & Map@4/13 Tile{ AsIs: e.Tail/9 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[11]);
    refalrts::alloc_open_call(vm, context[12]);
    refalrts::alloc_name(vm, context[13], functions[efunc_gen_Map_Z4]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & MakeVarTable-Conditions@0/4 AsIs: e.items/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Map_Z0]);
...
static refalrts::FnResult func_gen_DoGenResult_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & DoGenResult@2/4 (/7 e.new1/5 )/8 (/11 e.new2/9 )/12 s.new3/13 e.new4/2 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new4 as range 2
  do {
    // </0 & DoGenResult@2/4 (/7 e.new9/14 )/8 (/11 e.new10/16 )/12 s.new5/13 (/22 s.new6/24 e.new7/20 )/23 e.new8/18 >/1
    ...
    do {
      // </0 & DoGenResult@2/4 (/7 e.new16/25 )/8 (/11 e.new17/27 )/12 s.new11/13 (/22 s.new13/24 s.new14/33 e.new15/29 )/23 e.new12/31 >/1
      ...
      do {
        // </0 & DoGenResult@2/4 (/7 e.new22/34 )/8 (/11 e.new23/36 )/12 s.new18/13 (/22 s.new20/24 s.new21/33 )/23 e.new19/38 >/1
        ...
        if( ! refalrts::empty_seq( context[29], context[30] ) )
          continue;
        // closed e.new22 as range 34
        // closed e.new23 as range 36
        // closed e.new19 as range 38
        do {
          // </0 & DoGenResult@2/4 (/7 e.Vars/40 )/8 (/11 e.X/42 )/12 s.X/13 (/22 # TkOpenCallCond/24 s.Offset/33 )/23 e.Result/44 >/1
          ...
          if( ! refalrts::ident_term( identifiers[ident_TkOpenCallCond], context[24] ) )
            continue;
          // closed e.Vars as range 40
          // closed e.X as range 42
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/40 AsIs: )/8 AsIs: (/11 } (/46 # CmdCreateElem/47 # Allocate/48 s.Offset/33/49 # ElOpenCall/50 )/51 )/52 (/53 Tile{ AsIs: (/22 Reuse: # CmdInsertElem/24 AsIs: s.Offset/33 AsIs: )/23 } Tile{ AsIs: e.X/42 } Tile{ AsIs: )/12 AsIs: s.X/13 } Tile{ AsIs: e.Result/44 } Tile{ AsIs: >/1 ]] }
          refalrts::alloc_open_bracket(vm, context[46]);
        ...
        // </0 & DoGenResult@2/4 (/7 e.Vars/40 )/8 (/11 e.X/42 )/12 s.X/13 (/22 # TkCloseCallCond/24 s.Offset/33 )/23 e.Result/44 >/1
        context[40] = context[34];
        context[41] = context[35];
        context[42] = context[36];
        context[43] = context[37];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/40 AsIs: )/8 AsIs: (/11 } (/46 # CmdCreateElem/47 # Allocate/48 s.Offset/33/49 # ElCloseCall/50 )/51 )/52 (/53 Tile{ AsIs: (/22 Reuse: # CmdPushStack/24 AsIs: s.Offset/33 AsIs: )/23 } (/54 # CmdPushStack/55 </56 & Sub/57 s.Offset/33/58 1/59 >/60 )/61 (/62 # CmdInsertElem/63 s.Offset/33/64 )/65 Tile{ AsIs: e.X/42 } Tile{ AsIs: )/12 AsIs: s.X/13 } Tile{ AsIs: e.Result/44 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_bracket(vm, context[46]);
        refalrts::alloc_ident(vm, context[47], identifiers[ident_CmdCreateElem]);
        refalrts::alloc_ident(vm, context[48], identifiers[ident_Allocate]);
        refalrts::copy_stvar(vm, context[49], context[33]);
      ...
      // </0 & DoGenResult@2/4 (/7 e.new22/34 )/8 (/11 e.new23/36 )/12 s.new18/13 (/22 # Symbol/24 s.new20/33 e.new21/38 )/23 e.new19/40 >/1
      context[34] = context[25];
      context[35] = context[26];
      context[36] = context[27];
      context[37] = context[28];
      ...
      do {
        // </0 & DoGenResult@2/4 (/7 e.Vars/42 )/8 (/11 e.X/44 )/12 s.X/13 (/22 # Symbol/24 # Char/33 s.Value/50 )/23 e.Result/48 >/1
        ...
        // closed e.X as range 44
        // closed e.Result as range 48
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/42 AsIs: )/8 AsIs: (/11 } (/51 # CmdCreateElem/52 Tile{ HalfReuse: # Allocate/22 HalfReuse: s.X13 /24 Reuse: # ElChar/33 AsIs: s.Value/50 AsIs: )/23 } )/53 (/54 (/55 Tile{ HalfReuse: # CmdInsertElem/12 AsIs: s.X/13 } )/56 Tile{ AsIs: e.X/44 } )/57 </58 & Add/59 1/60 s.X/13/61 >/62 Tile{ AsIs: e.Result/48 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_bracket(vm, context[51]);
      ...
      do {
        // </0 & DoGenResult@2/4 (/7 e.Vars/42 )/8 (/11 e.X/44 )/12 s.X/13 (/22 # Symbol/24 # Name/33 e.Name/46 )/23 e.Result/48 >/1
        context[42] = context[34];
        context[43] = context[35];
        context[44] = context[36];
        context[45] = context[37];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/42 AsIs: )/8 AsIs: (/11 } (/50 # CmdCreateElem/51 Tile{ HalfReuse: # Allocate/22 HalfReuse: s.X13 /24 Reuse: # ElName/33 AsIs: e.Name/46 AsIs: )/23 } )/52 (/53 (/54 Tile{ HalfReuse: # CmdInsertElem/12 AsIs: s.X/13 } )/55 Tile{ AsIs: e.X/44 } )/56 </57 & Add/58 1/59 s.X/13/60 >/61 Tile{ AsIs: e.Result/48 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_bracket(vm, context[50]);
      ...
      do {
        // </0 & DoGenResult@2/4 (/7 e.Vars/42 )/8 (/11 e.X/44 )/12 s.X/13 (/22 # Symbol/24 # Number/33 s.Number/50 )/23 e.Result/48 >/1
        context[42] = context[34];
        context[43] = context[35];
        context[44] = context[36];
        context[45] = context[37];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/42 AsIs: )/8 AsIs: (/11 } (/51 # CmdCreateElem/52 Tile{ HalfReuse: # Allocate/22 HalfReuse: s.X13 /24 Reuse: # ElNumber/33 AsIs: s.Number/50 AsIs: )/23 } )/53 (/54 (/55 Tile{ HalfReuse: # CmdInsertElem/12 AsIs: s.X/13 } )/56 Tile{ AsIs: e.X/44 } )/57 </58 & Add/59 1/60 s.X/13/61 >/62 Tile{ AsIs: e.Result/48 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_bracket(vm, context[51]);
        refalrts::alloc_ident(vm, context[52], identifiers[ident_CmdCreateElem]);
        refalrts::alloc_close_bracket(vm, context[53]);
        refalrts::alloc_open_bracket(vm, context[54]);
      ...
      // </0 & DoGenResult@2/4 (/7 e.Vars/42 )/8 (/11 e.X/44 )/12 s.X/13 (/22 # Symbol/24 # Identifier/33 e.Name/46 )/23 e.Result/48 >/1
      context[42] = context[34];
      context[43] = context[35];
      context[44] = context[36];
      context[45] = context[37];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/42 AsIs: )/8 AsIs: (/11 } (/50 # CmdCreateElem/51 Tile{ HalfReuse: # Allocate/22 HalfReuse: s.X13 /24 Reuse: # ElIdent/33 AsIs: e.Name/46 AsIs: )/23 } )/52 (/53 (/54 Tile{ HalfReuse: # CmdInsertElem/12 AsIs: s.X/13 } )/55 Tile{ AsIs: e.X/44 } )/56 </57 & Add/58 1/59 s.X/13/60 >/61 Tile{ AsIs: e.Result/48 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[50]);
      refalrts::alloc_ident(vm, context[51], identifiers[ident_CmdCreateElem]);
      refalrts::alloc_close_bracket(vm, context[52]);
      refalrts::alloc_open_bracket(vm, context[53]);
    ...
    do {
      // </0 & DoGenResult@2/4 (/7 e.Vars/25 )/8 (/11 e.X/27 )/12 s.X/13 (/22 # TkString/24 e.Chars/29 )/23 e.Result/31 >/1
      context[25] = context[14];
      context[26] = context[15];
      context[27] = context[16];
      context[28] = context[17];
      ...
      if( ! refalrts::ident_term( identifiers[ident_TkString], context[24] ) )
        continue;
      // closed e.Vars as range 25
      // closed e.X as range 27
      // closed e.Chars as range 29
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/25 AsIs: )/8 AsIs: (/11 } Tile{ AsIs: (/22 Reuse: # CmdCreateElem/24 } Tile{ HalfReuse: # Allocate/12 AsIs: s.X/13 } # ElString/33 Tile{ AsIs: e.Chars/29 } )/34 )/35 (/36 (/37 # CmdInsertRange/38 s.X/13/39 )/40 Tile{ AsIs: e.X/27 } )/41 </42 & Add/43 s.X/13/44 2/45 Tile{ HalfReuse: >/23 AsIs: e.Result/31 AsIs: >/1 ]] }
    ...
    do {
      // </0 & DoGenResult@2/4 (/7 e.Vars/25 )/8 (/11 e.X/27 )/12 s.X/13 (/22 # Brackets/24 e.InBrackets/29 )/23 e.Result/31 >/1
      context[25] = context[14];
      context[26] = context[15];
      context[27] = context[16];
      context[28] = context[17];
      ...
      // closed e.Vars as range 25
      // closed e.X as range 27
      // closed e.InBrackets as range 29
      // closed e.Result as range 31
      //DEBUG: s.X: 13
      //DEBUG: e.Vars: 25
      //DEBUG: e.X: 27
      //DEBUG: e.InBrackets: 29
      //DEBUG: e.Result: 31

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/25 AsIs: )/8 AsIs: (/11 } (/33 # CmdCreateElem/34 Tile{ HalfReuse: # Allocate/12 AsIs: s.X/13 HalfReuse: # ElOpenBracket/22 HalfReuse: )/24 } )/35 (/36 (/37 # CmdInsertElem/38 s.X/13/39 )/40 Tile{ AsIs: e.X/27 } )/41 </42 & Add/43 1/44 s.X/13/45 >/46 Tile{ AsIs: e.InBrackets/29 } (/47 # TkCloseBracket/48 s.X/13/49 Tile{ AsIs: )/23 AsIs: e.Result/31 AsIs: >/1 ]] }
    ...
    do {
      // </0 & DoGenResult@2/4 (/7 e.Vars/25 )/8 (/11 e.X/27 )/12 s.X/13 (/22 # CallBrackets/24 e.InBrackets/29 )/23 e.Result/31 >/1
      context[25] = context[14];
      context[26] = context[15];
      context[27] = context[16];
      context[28] = context[17];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/25 AsIs: )/8 AsIs: (/11 } (/33 # CmdCreateElem/34 Tile{ HalfReuse: # Allocate/12 AsIs: s.X/13 HalfReuse: # ElOpenCall/22 HalfReuse: )/24 } )/35 (/36 (/37 # CmdInsertElem/38 s.X/13/39 )/40 Tile{ AsIs: e.X/27 } )/41 </42 & Add/43 1/44 s.X/13/45 >/46 Tile{ AsIs: e.InBrackets/29 } (/47 # TkCloseCall/48 s.X/13/49 Tile{ AsIs: )/23 AsIs: e.Result/31 AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[33]);
      refalrts::alloc_ident(vm, context[34], identifiers[ident_CmdCreateElem]);
      refalrts::alloc_close_bracket(vm, context[35]);
      refalrts::alloc_open_bracket(vm, context[36]);
    ...
    do {
      // </0 & DoGenResult@2/4 (/7 e.Vars/25 )/8 (/11 e.X/27 )/12 s.X/13 (/22 # ADT-Brackets/24 (/35 e.Name/33 )/36 e.InBrackets/29 )/23 e.Result/31 >/1
      context[25] = context[14];
      context[26] = context[15];
      context[27] = context[16];
      context[28] = context[17];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/25 AsIs: )/8 AsIs: (/11 } (/37 # CmdCreateElem/38 # Allocate/39 s.X/13/40 # ElOpenADT/41 )/42 )/43 (/44 (/45 # CmdInsertElem/46 s.X/13/47 )/48 Tile{ AsIs: e.X/27 } )/49 </50 & Add/51 Tile{ HalfReuse: 1/12 AsIs: s.X/13 } >/52 Tile{ AsIs: (/22 Reuse: # Symbol/24 HalfReuse: # Name/35 AsIs: e.Name/33 AsIs: )/36 AsIs: e.InBrackets/29 HalfReuse: (/23 } # TkCloseADT/53 s.X/13/54 )/55 Tile{ AsIs: e.Result/31 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[37]);
    ...
    do {
      // </0 & DoGenResult@2/4 (/7 e.Vars/25 )/8 (/11 e.X/27 )/12 s.X/13 (/22 # ClosureBrackets/24 e.InBrackets/29 )/23 e.Result/31 >/1
      context[25] = context[14];
      context[26] = context[15];
      context[27] = context[16];
      context[28] = context[17];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/25 AsIs: )/8 AsIs: (/11 } (/33 # CmdCreateElem/34 Tile{ HalfReuse: # Allocate/12 AsIs: s.X/13 HalfReuse: # ElClosureHead/22 HalfReuse: )/24 } )/35 (/36 (/37 # CmdInsertElem/38 s.X/13/39 )/40 Tile{ AsIs: e.X/27 } )/41 </42 & Add/43 1/44 s.X/13/45 >/46 Tile{ AsIs: e.InBrackets/29 } (/47 # TkUnwrappedClosure/48 s.X/13/49 Tile{ AsIs: )/23 AsIs: e.Result/31 AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[33]);
      refalrts::alloc_ident(vm, context[34], identifiers[ident_CmdCreateElem]);
      refalrts::alloc_close_bracket(vm, context[35]);
      refalrts::alloc_open_bracket(vm, context[36]);
    ...
    do {
      ...
      // closed e.new19 as range 38
      do {
        // </0 & DoGenResult@2/4 (/7 e.Vars/40 )/8 (/11 e.X/42 )/12 s.X/13 (/22 # TkCloseBracket/24 s.OpenCounter/33 )/23 e.Result/44 >/1
        context[40] = context[34];
        context[41] = context[35];
        context[42] = context[36];
        context[43] = context[37];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/40 AsIs: )/8 AsIs: (/11 } (/46 # CmdCreateElem/47 # Allocate/48 s.X/13/49 # ElCloseBracket/50 )/51 )/52 (/53 Tile{ AsIs: (/22 Reuse: # CmdLinkBrackets/24 AsIs: s.OpenCounter/33 } s.X/13/54 )/55 (/56 Tile{ HalfReuse: # CmdInsertElem/12 AsIs: s.X/13 } )/57 Tile{ AsIs: e.X/42 } )/58 </59 & Add/60 1/61 s.X/13/62 Tile{ HalfReuse: >/23 AsIs: e.Result/44 AsIs: >/1 ]] }
        refalrts::alloc_open_bracket(vm, context[46]);
        refalrts::alloc_ident(vm, context[47], identifiers[ident_CmdCreateElem]);
        refalrts::alloc_ident(vm, context[48], identifiers[ident_Allocate]);
        refalrts::copy_stvar(vm, context[49], context[13]);
      ...
      do {
        // </0 & DoGenResult@2/4 (/7 e.Vars/40 )/8 (/11 e.X/42 )/12 s.X/13 (/22 # TkCloseADT/24 s.OpenCounter/33 )/23 e.Result/44 >/1
        context[40] = context[34];
        context[41] = context[35];
        context[42] = context[36];
        context[43] = context[37];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/40 AsIs: )/8 AsIs: (/11 } (/46 # CmdCreateElem/47 # Allocate/48 s.X/13/49 # ElCloseADT/50 )/51 )/52 (/53 Tile{ AsIs: (/22 Reuse: # CmdLinkBrackets/24 AsIs: s.OpenCounter/33 } s.X/13/54 )/55 (/56 Tile{ HalfReuse: # CmdInsertElem/12 AsIs: s.X/13 } )/57 Tile{ AsIs: e.X/42 } )/58 </59 & Add/60 1/61 s.X/13/62 Tile{ HalfReuse: >/23 AsIs: e.Result/44 AsIs: >/1 ]] }
        refalrts::alloc_open_bracket(vm, context[46]);
        refalrts::alloc_ident(vm, context[47], identifiers[ident_CmdCreateElem]);
        refalrts::alloc_ident(vm, context[48], identifiers[ident_Allocate]);
        refalrts::copy_stvar(vm, context[49], context[13]);
      ...
      do {
        // </0 & DoGenResult@2/4 (/7 e.Vars/40 )/8 (/11 e.X/42 )/12 s.X/13 (/22 # TkCloseCall/24 s.OpenCounter/33 )/23 e.Result/44 >/1
        context[40] = context[34];
        context[41] = context[35];
        context[42] = context[36];
        context[43] = context[37];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/40 AsIs: )/8 AsIs: (/11 } (/46 # CmdCreateElem/47 Tile{ HalfReuse: # Allocate/12 AsIs: s.X/13 } # ElCloseCall/48 )/49 )/50 (/51 (/52 # CmdPushStack/53 s.X/13/54 )/55 Tile{ AsIs: (/22 Reuse: # CmdPushStack/24 AsIs: s.OpenCounter/33 AsIs: )/23 } (/56 # CmdInsertElem/57 s.X/13/58 )/59 Tile{ AsIs: e.X/42 } )/60 </61 & Add/62 1/63 s.X/13/64 >/65 Tile{ AsIs: e.Result/44 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_open_bracket(vm, context[46]);
        refalrts::alloc_ident(vm, context[47], identifiers[ident_CmdCreateElem]);
      ...
      // </0 & DoGenResult@2/4 (/7 e.Vars/40 )/8 (/11 e.X/42 )/12 s.X/13 (/22 # TkUnwrappedClosure/24 s.HeadCounter/33 )/23 e.Result/44 >/1
      context[40] = context[34];
      context[41] = context[35];
      context[42] = context[36];
      context[43] = context[37];
      ...
      // closed e.Result as range 44
      //DEBUG: s.X: 13
      //DEBUG: s.HeadCounter: 33
      //DEBUG: e.Vars: 40
      //DEBUG: e.X: 42
      //DEBUG: e.Result: 44

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.HeadCounter/33 {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars/40 AsIs: )/8 AsIs: (/11 } (/46 # CmdCreateElem/47 Tile{ HalfReuse: # Allocate/12 AsIs: s.X/13 HalfReuse: # ElUnwrappedClosure/22 HalfReuse: s.HeadCounter33 /24 } )/48 )/49 (/50 (/51 # CmdInsertElem/52 s.X/13/53 )/54 Tile{ AsIs: e.X/42 } (/55 # CmdWrapClosure/56 s.X/13/57 )/58 )/59 </60 & Add/61 1/62 s.X/13/63 Tile{ HalfReuse: >/23 AsIs: e.Result/44 AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[46]);
      refalrts::alloc_ident(vm, context[47], identifiers[ident_CmdCreateElem]);
      refalrts::alloc_close_bracket(vm, context[48]);
      refalrts::alloc_close_bracket(vm, context[49]);
    ...
    // </0 & DoGenResult@2/4 (/7 e.new22/34 )/8 (/11 e.new23/36 )/12 s.new18/13 (/22 # Var/24 s.new20/33 e.new21/38 )/23 e.new19/40 >/1
    context[34] = context[25];
    context[35] = context[26];
    context[36] = context[27];
    context[37] = context[28];
    ...
    // closed e.new19 as range 40
    do {
      // </0 & DoGenResult@2/4 (/7 e.Vars-B/50 (/56 s.Mode/58 (/61 e.Index/67 )/62 (/65 e.ResultVars/63 )/66 s.NextPatternVar/69 e.PatternVars/54 )/57 e.Vars-E/52 )/8 (/11 e.X/44 )/12 s.X/13 (/22 # Var/24 s.Mode/33 e.Index/46 )/23 e.Result/48 >/1
      context[42] = context[34];
      context[43] = context[35];
      context[44] = context[36];
      context[45] = context[37];
      ...
      do {
        ...
        if( ! refalrts::empty_seq( context[59], context[60] ) )
          continue;
        // closed e.ResultVars as range 63
        // closed e.Vars-E as range 52
        if( ! refalrts::svar_left( context[69], context[54], context[55] ) )
          continue;
        // closed e.PatternVars as range 54
        //DEBUG: s.X: 13
        //DEBUG: s.Mode: 33
        //DEBUG: e.X: 44
        //DEBUG: e.Index: 46
        //DEBUG: e.Result: 48
        //DEBUG: e.Vars-B: 50
        //DEBUG: e.ResultVars: 63
        //DEBUG: e.Vars-E: 52
        //DEBUG: s.NextPatternVar: 69
        //DEBUG: e.PatternVars: 54

        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.X/13 {REMOVED TILE} e.Index/46 {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoGenResult@2/4 AsIs: (/7 AsIs: e.Vars-B/50 AsIs: (/56 AsIs: s.Mode/58 AsIs: (/61 AsIs: e.Index/67 AsIs: )/62 AsIs: (/65 AsIs: e.ResultVars/63 HalfReuse: s.NextPatternVar69 /66 } Tile{ AsIs: )/12 } Tile{ AsIs: e.PatternVars/54 } Tile{ AsIs: )/57 AsIs: e.Vars-E/52 AsIs: )/8 AsIs: (/11 } Tile{ AsIs: (/22 Reuse: # CmdInsertVar/24 AsIs: s.Mode/33 } Tile{ AsIs: s.NextPatternVar/69 } )/70 Tile{ AsIs: e.X/44 } )/71 Tile{ HalfReuse: s.X13 /23 AsIs: e.Result/48 AsIs: >/1 ]] }
        refalrts::alloc_close_bracket(vm, context[70]);
        refalrts::alloc_close_bracket(vm, context[71]);
    ...
    // </0 & DoGenResult@2/4 (/7 e.Vars-B/50 (/56 s.Mode/66 (/64 e.Index/67 )/65 (/60 e.ResultVars/58 s.Sample/69 )/61 )/57 e.Vars-E/52 )/8 (/11 e.X/44 )/12 s.X/13 (/22 # Var/24 s.Mode/33 e.Index/46 )/23 e.Result/48 >/1
    context[42] = context[34];
    context[43] = context[35];
    context[44] = context[36];
    context[45] = context[37];
    ...
    do {
      ...
      if( ! refalrts::svar_right( context[69], context[58], context[59] ) )
        continue;
      // closed e.ResultVars as range 58
      //DEBUG: s.X: 13
      //DEBUG: s.Mode: 33
      //DEBUG: e.X: 44
      //DEBUG: e.Index: 46
      ...
      //DEBUG: e.Vars-E: 52
      //DEBUG: s.Sample: 69
      //DEBUG: e.ResultVars: 58

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} e.Index/46 {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult/4 AsIs: (/7 AsIs: e.Vars-B/50 AsIs: (/56 AsIs: s.Mode/66 AsIs: (/64 AsIs: e.Index/67 AsIs: )/65 AsIs: (/60 AsIs: e.ResultVars/58 AsIs: s.Sample/69 HalfReuse: s.X13 /61 AsIs: )/57 } )/70 Tile{ AsIs: e.Vars-E/52 } )/71 (/72 (/73 # CmdCopyVar/74 s.Mode/66/75 Tile{ AsIs: s.X/13 } s.Sample/69/76 )/77 )/78 (/79 Tile{ AsIs: (/22 Reuse: # CmdInsertVar/24 AsIs: s.Mode/33 } Tile{ HalfReuse: s.X13 /8 HalfReuse: )/11 AsIs: e.X/44 AsIs: )/12 } </80 & IncVarOffset/81 s.X/13/82 s.Mode/66/83 Tile{ HalfReuse: >/23 AsIs: e.Result/48 AsIs: >/1 ]] }
      refalrts::alloc_close_bracket(vm, context[70]);
      refalrts::alloc_close_bracket(vm, context[71]);
      refalrts::alloc_open_bracket(vm, context[72]);
  ...
  do {
    // </0 & DoGenResult@2/4 (/7 e.Vars/14 )/8 (/11 e.X/16 )/12 s.X/13 >/1
    context[14] = context[5];
    context[15] = context[6];
    context[16] = context[9];
    context[17] = context[10];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 {REMOVED TILE} (/11 {REMOVED TILE} )/12 s.X/13 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ HalfReuse: s.X13 /4 AsIs: (/7 AsIs: e.Vars/14 AsIs: )/8 } Tile{ AsIs: e.X/16 } Tile{ ]] }
  ...
  // </0 & DoGenResult@2/4 (/7 e.dyn0/5 )/8 (/11 e.X/9 )/12 s.X/13 e.dyn3/2 >/1
  // closed e.dyn0 as range 5
  // closed e.X as range 9
  // closed e.dyn3 as range 2
  //DEBUG: s.X: 13
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & DoGenResult@0/4 AsIs: (/7 } Tile{ AsIs: e.dyn0/5 } )/14 (/15 Tile{ AsIs: )/8 AsIs: (/11 AsIs: e.X/9 AsIs: )/12 AsIs: s.X/13 AsIs: e.dyn3/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Map_Z5(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new2 as range 5
    do {
      // </0 & Map@5/4 (/7 s.Mode/13 (/16 e.2/14 )/17 (/20 e.4/18 )/21 e.3/11 )/8 e.Tail/9 >/1
      context[9] = context[5];
      context[10] = context[6];
      context[11] = 0;
      context[12] = 0;
      ...
      //RESULT: Tile{ [[ } Tile{ HalfReuse: </4 HalfReuse: & Map@2/7 AsIs: s.Mode/13 AsIs: (/16 AsIs: e.2/14 AsIs: )/17 } Tile{ AsIs: e.4/18 } Tile{ AsIs: e.3/11 } Tile{ HalfReuse: >/20 } Tile{ AsIs: </0 } Tile{ HalfReuse: & Map@5/8 AsIs: e.Tail/9 AsIs: >/1 ]] }
      refalrts::reinit_open_call(context[4]);
      refalrts::reinit_name(context[7], functions[efunc_gen_Map_Z2]);
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & ReplicateVar*1/4 AsIs: t.Next/7 } >/11 </12 & Map@5/13 Tile{ AsIs: e.Tail/9 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[11]);
    refalrts::alloc_open_call(vm, context[12]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & ReplicateVar@0/4 AsIs: e.items/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Map_Z0]);
...
static refalrts::FnResult func_gen_Fetch_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </7 & Fetch@2/8 Tile{ AsIs: </0 Reuse: & Sort/4 AsIs: e.Argument/5 AsIs: >/1 } >/9 Tile{ ]] }
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@0/4 AsIs: e.arg/2 HalfReuse: [*]/1 } & Pipe$2\1@0/5 & Sort@0/6 (/7 (/8 & Map@0/9 & MakeVariableComment@0/10 )/11 )/12 {*}/13 >/14 Tile{ ]] }
...
static refalrts::FnResult func_gen_Fetch_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@6/4 AsIs: e.Argument/5 AsIs: >/1 ]] }
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch@0/4 AsIs: e.arg/2 HalfReuse: (/1 } & Map@0/5 & MakeVariableComment@0/6 )/7 >/8 Tile{ ]] }
...
static refalrts::FnResult func_gen_Map_Z6(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new2 as range 5
    do {
      // </0 & Map@6/4 (/7 s.Offset/13 s.Mode/14 e.1/11 )/8 e.Tail/9 >/1
      context[9] = context[5];
      context[10] = context[6];
      context[11] = 0;
      context[12] = 0;
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdComment/4 HalfReuse: # Offset/7 AsIs: s.Offset/13 }": "/15 </17 & PrintVar/18 Tile{ AsIs: s.Mode/14 } Tile{ AsIs: e.1/11 } >/19 )/20 </21 Tile{ HalfReuse: & Map@6/8 AsIs: e.Tail/9 AsIs: >/1 ]] }
      refalrts::alloc_chars(vm, context[15], context[16], ": ", 2);
      refalrts::alloc_open_call(vm, context[17]);
      refalrts::alloc_name(vm, context[18], functions[efunc_PrintVar]);
      refalrts::alloc_close_call(vm, context[19]);
      refalrts::alloc_close_bracket(vm, context[20]);
      refalrts::alloc_open_call(vm, context[21]);
      refalrts::reinit_open_bracket(context[0]);
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & MakeVariableComment*1/4 AsIs: t.Next/7 } >/11 </12 & Map@6/13 Tile{ AsIs: e.Tail/9 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[11]);
    refalrts::alloc_open_call(vm, context[12]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & MakeVariableComment@0/4 AsIs: e.items/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Map_Z0]);
