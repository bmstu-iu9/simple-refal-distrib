...
static refalrts::FnResult func_gen_LowLevelRASLm_Native_B1S2A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & LowLevelRASL-Native:1$2=1/4 e.new/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & LowLevelRASL-Native:1$2=1/4 s.new1/5 s.new2/6 t.new3/7 t.new4/9 e.new5/2 >/1
  ...
  do {
    // </0 & LowLevelRASL-Native:1$2=1/4 s.new6/5 s.new7/6 (/7 s.new8/15 e.new9/13 )/8 t.new10/9 e.new11/11 >/1
    ...
    do {
      // </0 & LowLevelRASL-Native:1$2=1/4 s.new12/5 s.new13/6 (/7 0/15 )/8 t.new14/9 e.new15/16 >/1
      ...
      if( ! refalrts::empty_seq( context[13], context[14] ) )
        continue;
      // closed e.new15 as range 16
      do {
        // </0 & LowLevelRASL-Native:1$2=1/4 s.new16/5 s.new17/6 (/7 0/15 )/8 (/9 s.new18/22 e.new19/20 )/10 e.new20/18 >/1
        ...
        do {
          // </0 & LowLevelRASL-Native:1$2=1/4 s.Hash1/5 s.Hash2/6 (/7 0/15 )/8 (/9 0/22 )/10 e.DefinitionsRASL/23 >/1
          ...
          if( ! refalrts::empty_seq( context[20], context[21] ) )
            continue;
          // closed e.DefinitionsRASL as range 23
          //DEBUG: s.Hash1: 5
          //DEBUG: s.Hash2: 6
          //DEBUG: e.DefinitionsRASL: 23

          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} </0 & LowLevelRASL-Native:1$2=1/4 s.Hash1/5 s.Hash2/6 {REMOVED TILE}
          //RESULT: Tile{ [[ } Tile{ AsIs: (/7 HalfReuse: (/15 HalfReuse: # CmdCookieNS/8 HalfReuse: s.Hash15 /9 HalfReuse: s.Hash26 /22 AsIs: )/10 AsIs: e.DefinitionsRASL/23 HalfReuse: )/1 ]] }
        ...
        // </0 & LowLevelRASL-Native:1$2=1/4 s.Hash1/5 s.Hash2/6 (/7 0/15 )/8 (/9 s.Count/22 e.0/23 )/10 e.DefinitionsRASL/25 >/1
        context[23] = context[20];
        context[24] = context[21];
        context[25] = context[18];
        context[26] = context[19];
        // closed e.0 as range 23
        // closed e.DefinitionsRASL as range 25
        //DEBUG: s.Hash1: 5
        //DEBUG: s.Hash2: 6
        //DEBUG: s.Count: 22
        //DEBUG: e.0: 23
        //DEBUG: e.DefinitionsRASL: 25

        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} s.Count/22 {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ } (/27 Tile{ HalfReuse: (/0 HalfReuse: # CmdCookieNS/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 HalfReuse: )/7 HalfReuse: (/15 HalfReuse: # CmdCEnum-Start/8 HalfReuse: 'i'/9 }"dent"/28 )/30 </31 & Map@3/32 (/33"ident"/34 )/36 Tile{ AsIs: e.0/23 } >/37 (/38 # CmdCEnum-End/39 Tile{ AsIs: )/10 AsIs: e.DefinitionsRASL/25 HalfReuse: )/1 ]] }
      ...
      // </0 & LowLevelRASL-Native:1$2=1/4 s.Hash1/5 s.Hash2/6 (/7 0/15 )/8 t.IdentTable/9 e.DefinitionsRASL/18 >/1
      context[18] = context[16];
      context[19] = context[17];
      // closed e.DefinitionsRASL as range 18
      //DEBUG: t.IdentTable: 9
      //DEBUG: s.Hash1: 5
      //DEBUG: s.Hash2: 6
      //DEBUG: e.DefinitionsRASL: 18

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } (/20 Tile{ HalfReuse: (/0 HalfReuse: # CmdCookieNS/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 HalfReuse: )/7 HalfReuse: </15 HalfReuse: & PrepareTable*2/8 }"ident"/21 Tile{ AsIs: t.IdentTable/9 } >/23 Tile{ AsIs: e.DefinitionsRASL/18 } Tile{ HalfReuse: )/1 ]] }
    ...
    do {
      // </0 & LowLevelRASL-Native:1$2=1/4 s.new12/5 s.new13/6 (/7 s.new14/15 e.new15/16 )/8 (/9 s.new16/22 e.new17/20 )/10 e.new18/18 >/1
      ...
      do {
        // </0 & LowLevelRASL-Native:1$2=1/4 s.Hash1/5 s.Hash2/6 (/7 s.Count/15 e.0/23 )/8 (/9 0/22 )/10 e.DefinitionsRASL/25 >/1
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} s.Count/15 {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ } (/27 Tile{ HalfReuse: (/0 HalfReuse: # CmdCookieNS/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 HalfReuse: )/7 } (/28 # CmdCEnum-Start/29"efunc"/30 )/32 </33 & Map@3/34 (/35"efunc"/36 )/38 Tile{ AsIs: e.0/23 } Tile{ HalfReuse: >/8 AsIs: (/9 HalfReuse: # CmdCEnum-End/22 AsIs: )/10 AsIs: e.DefinitionsRASL/25 HalfReuse: )/1 ]] }
        refalrts::alloc_open_bracket(vm, context[27]);
      ...
      // </0 & LowLevelRASL-Native:1$2=1/4 s.Hash1/5 s.Hash2/6 (/7 s.Count/15 e.0/23 )/8 (/9 s.Count0/22 e.1/25 )/10 e.DefinitionsRASL/27 >/1
      context[23] = context[16];
      context[24] = context[17];
      ...
      // closed e.DefinitionsRASL as range 27
      //DEBUG: s.Hash1: 5
      //DEBUG: s.Hash2: 6
      //DEBUG: s.Count: 15
      //DEBUG: s.Count0: 22
      //DEBUG: e.0: 23
      //DEBUG: e.1: 25
      //DEBUG: e.DefinitionsRASL: 27

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} s.Count/15 {REMOVED TILE} {REMOVED TILE} s.Count0/22 {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } (/29 Tile{ HalfReuse: (/0 HalfReuse: # CmdCookieNS/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 HalfReuse: )/7 } (/30 # CmdCEnum-Start/31"efunc"/32 )/34 </35 & Map@3/36 (/37"efunc"/38 )/40 Tile{ AsIs: e.0/23 } >/41 (/42 # CmdCEnum-End/43 Tile{ AsIs: )/8 AsIs: (/9 } # CmdCEnum-Start/44"ident"/45 )/47 </48 & Map@3/49 (/50"ident"/51 )/53 Tile{ AsIs: e.1/25 } >/54 (/55 # CmdCEnum-End/56 Tile{ AsIs: )/10 AsIs: e.DefinitionsRASL/27 HalfReuse: )/1 ]] }
    ...
    // </0 & LowLevelRASL-Native:1$2=1/4 s.Hash1/5 s.Hash2/6 (/7 s.Count/15 e.0/16 )/8 t.IdentTable/9 e.DefinitionsRASL/18 >/1
    context[16] = context[13];
    context[17] = context[14];
    context[18] = context[11];
    context[19] = context[12];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} s.Count/15 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } (/20 Tile{ HalfReuse: (/0 HalfReuse: # CmdCookieNS/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 HalfReuse: )/7 } (/21 # CmdCEnum-Start/22"efunc"/23 )/25 </26 & Map@3/27 (/28"efunc"/29 )/31 Tile{ AsIs: e.0/16 } >/32 (/33 # CmdCEnum-End/34 )/35 </36 & PrepareTable*2/37"iden"/38 Tile{ HalfReuse: 't'/8 AsIs: t.IdentTable/9 } >/40 Tile{ AsIs: e.DefinitionsRASL/18 } Tile{ HalfReuse: )/1 ]] }
    refalrts::alloc_open_bracket(vm, context[20]);
  ...
  do {
    // </0 & LowLevelRASL-Native:1$2=1/4 s.new6/5 s.new7/6 t.new8/7 (/9 s.new9/15 e.new10/13 )/10 e.new11/11 >/1
    context[11] = context[2];
    context[12] = context[3];
    context[13] = 0;
    context[14] = 0;
    ...
    do {
      // </0 & LowLevelRASL-Native:1$2=1/4 s.Hash1/5 s.Hash2/6 t.FuncTable/7 (/9 0/15 )/10 e.DefinitionsRASL/16 >/1
      context[16] = context[11];
      context[17] = context[12];
      if( ! refalrts::number_term( 0UL, context[15] ) )
        continue;
      if( ! refalrts::empty_seq( context[13], context[14] ) )
        continue;
      // closed e.DefinitionsRASL as range 16
      //DEBUG: t.FuncTable: 7
      //DEBUG: s.Hash1: 5
      //DEBUG: s.Hash2: 6
      //DEBUG: e.DefinitionsRASL: 16

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: (/9 } Tile{ HalfReuse: (/0 HalfReuse: # CmdCookieNS/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } )/18 Tile{ HalfReuse: </15 } & PrepareTable*2/19"efunc"/20 Tile{ AsIs: t.FuncTable/7 } Tile{ HalfReuse: >/10 AsIs: e.DefinitionsRASL/16 HalfReuse: )/1 ]] }
      refalrts::alloc_close_bracket(vm, context[18]);
    ...
    // </0 & LowLevelRASL-Native:1$2=1/4 s.Hash1/5 s.Hash2/6 t.FuncTable/7 (/9 s.Count/15 e.0/16 )/10 e.DefinitionsRASL/18 >/1
    context[16] = context[13];
    context[17] = context[14];
    context[18] = context[11];
    context[19] = context[12];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.Count/15 {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } (/20 Tile{ HalfReuse: (/0 HalfReuse: # CmdCookieNS/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } )/21 </22 & PrepareTable*2/23"efunc"/24 Tile{ AsIs: t.FuncTable/7 HalfReuse: >/9 } (/26 # CmdCEnum-Start/27"ident"/28 )/30 </31 & Map@3/32 (/33"ident"/34 )/36 Tile{ AsIs: e.0/16 } >/37 (/38 # CmdCEnum-End/39 Tile{ AsIs: )/10 AsIs: e.DefinitionsRASL/18 HalfReuse: )/1 ]] }
    refalrts::alloc_open_bracket(vm, context[20]);
  ...
  // </0 & LowLevelRASL-Native:1$2=1/4 s.Hash1/5 s.Hash2/6 t.FuncTable/7 t.IdentTable/9 e.DefinitionsRASL/2 >/1
  // closed e.DefinitionsRASL as range 2
  //DEBUG: t.FuncTable: 7
  //DEBUG: t.IdentTable: 9
  //DEBUG: s.Hash1: 5
  //DEBUG: s.Hash2: 6
  //DEBUG: e.DefinitionsRASL: 2

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } (/11 Tile{ HalfReuse: (/0 HalfReuse: # CmdCookieNS/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } )/12 </13 & PrepareTable*2/14"efunc"/15 Tile{ AsIs: t.FuncTable/7 } >/17 </18 & PrepareTable*2/19"ident"/20 Tile{ AsIs: t.IdentTable/9 } >/22 Tile{ AsIs: e.DefinitionsRASL/2 } Tile{ HalfReuse: )/1 ]] }
  refalrts::alloc_open_bracket(vm, context[11]);
  refalrts::alloc_close_bracket(vm, context[12]);
  refalrts::alloc_open_call(vm, context[13]);
...
static refalrts::FnResult func_gen_LowLevelRASLm_Native_B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & LowLevelRASL-Native:1/4 e.new/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & LowLevelRASL-Native:1/4 s.new1/5 s.new2/6 t.new3/7 t.new4/9 e.new5/2 >/1
  if( ! refalrts::svar_left( context[5], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  if( ! refalrts::svar_left( context[6], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  ...
  // closed e.new5 as range 2
  do {
    // </0 & LowLevelRASL-Native:1/4 s.Hash1/5 s.Hash2/6 t.FuncTable/7 t.IdentTable/9 >/1
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    //DEBUG: t.FuncTable: 7
    //DEBUG: t.IdentTable: 9
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & LowLevelRASL-Native:1/4 s.Hash1/5 s.Hash2/6 t.FuncTable/7 t.IdentTable/9 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & LowLevelRASL-Native:1/4 s.Hash1/5 s.Hash2/6 t.FuncTable/7 t.IdentTable/9 e.Definitions/2 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & LowLevelRASL-Native:1$2=1/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 AsIs: t.FuncTable/7 AsIs: t.IdentTable/9 } </11 & Map@1/12 Tile{ AsIs: e.Definitions/2 } >/13 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[11]);
...
static refalrts::FnResult func_LowLevelRASLm_Native(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & LowLevelRASL-Native/4 s.Hash1/5 s.Hash2/6 (/9 t.FuncTable/11 t.IdentTable/13 )/10 e.Items/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & LowLevelRASL-Native:1/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: t.FuncTable/11 AsIs: t.IdentTable/13 HalfReuse: </10 } Tile{ HalfReuse: & Map@2/9 } s.Hash1/5/15 s.Hash2/6/16 Tile{ AsIs: e.Items/2 } >/17 Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_PrepareTable(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & PrepareTable/4 e.new1/2 (/7 s.new2/9 e.new3/5 )/8 >/1
  context[5] = 0;
  context[6] = 0;
  ...
  do {
    // </0 & PrepareTable/4 e.Prefix/10 (/7 0/9 )/8 >/1
    ...
    if( ! refalrts::empty_seq( context[5], context[6] ) )
      continue;
    // closed e.Prefix as range 10
    //DEBUG: e.Prefix: 10

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & PrepareTable/4 e.Prefix/10 (/7 0/9 )/8 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & PrepareTable/4 e.Prefix/2 (/7 s.Count/9 e.Items/5 )/8 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} s.Count/9 {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdCEnum-Start/4 AsIs: e.Prefix/2 HalfReuse: )/7 } </10 & Map@3/11 (/12 e.Prefix/2/13 )/15 Tile{ AsIs: e.Items/5 } >/16 (/17 Tile{ HalfReuse: # CmdCEnum-End/8 HalfReuse: )/1 ]] }
...
static refalrts::FnResult func_SetCookies(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & SetCookies/4 s.new1/9 s.new2/10 (/7 s.new3/11 e.new4/5 )/8 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_right( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  do {
    // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # UnitName/11 e.SrcName/12 )/8 >/1
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # UnitName/11 e.SrcName/12 )/8 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & SetCookies/4 s.new5/9 s.new6/10 (/7 s.new7/11 t.new8/12 e.new9/5 )/8 >/1
  context[13] = refalrts::tvar_left( context[12], context[5], context[6] );
  if( ! context[13] )
    return refalrts::cRecognitionImpossible;
  // closed e.new9 as range 5
  do {
    // </0 & SetCookies/4 s.new10/9 s.new11/10 (/7 s.new12/11 s.new13/12 e.new14/14 )/8 >/1
    context[14] = context[5];
    context[15] = context[6];
    if( ! refalrts::svar_term( context[12], context[12] ) )
      continue;
    // closed e.new14 as range 14
    do {
      // </0 & SetCookies/4 s.new15/9 s.new16/10 (/7 s.new17/11 s.new18/12 (/20 e.new19/18 )/21 e.new20/16 )/8 >/1
      ...
      // closed e.new19 as range 18
      // closed e.new20 as range 16
      do {
        // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # Function-ToRASL/11 s.ScopeClass/12 (/20 e.Name/22 )/21 e.Commands/24 )/8 >/1
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # Function-ToRASL/11 s.ScopeClass/12 (/20 e.Name/22 )/21 e.Commands/24 )/8 >/1 {REMOVED TILE}
        //RESULT: Tile{ [[ } Tile{ ]] }
        refalrts::Iter trash_prev = arg_begin->prev;
        refalrts::use(trash_prev);
        refalrts::Iter res = arg_end->next;
      ...
      do {
        // </0 & SetCookies/4 s.new21/9 s.new22/10 (/7 # Function-ToNative/11 s.new23/12 (/20 e.new25/22 )/21 e.new24/24 )/8 >/1
        context[22] = context[18];
        context[23] = context[19];
        context[24] = context[16];
        context[25] = context[17];
        if( ! refalrts::ident_term( identifiers[ident_Functionm_ToNative], context[11] ) )
          continue;
        // closed e.new25 as range 22
        // closed e.new24 as range 24
        do {
          // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # Function-ToNative/11 # GN-Entry/12 (/20 e.Name/26 )/21 e.Commands/28 )/8 >/1
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} s.Hash1/9 s.Hash2/10 (/7 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ } Tile{ HalfReuse: (/11 Reuse: # Function-ToNative/12 AsIs: (/20 AsIs: e.Name/26 HalfReuse: # Hash/21 } Tile{ HalfReuse: 0/0 HalfReuse: 0/4 } Tile{ AsIs: )/8 } Tile{ AsIs: e.Commands/28 } Tile{ HalfReuse: )/1 ]] }
        ...
        do {
          // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # Function-ToNative/11 # GN-Local/12 (/20 e.Name/26 )/21 e.Commands/28 )/8 >/1
          context[26] = context[22];
          context[27] = context[23];
          context[28] = context[24];
          context[29] = context[25];
          ...
          //RESULT: Tile{ [[ } Tile{ HalfReuse: (/11 Reuse: # Function-ToNative/12 AsIs: (/20 AsIs: e.Name/26 HalfReuse: # Hash/21 } Tile{ AsIs: s.Hash1/9 AsIs: s.Hash2/10 HalfReuse: )/7 } Tile{ AsIs: e.Commands/28 } Tile{ HalfReuse: )/1 ]] }
          refalrts::reinit_open_bracket(context[11]);
          refalrts::update_ident(context[12], identifiers[ident_Functionm_ToNative]);
          refalrts::reinit_ident(context[21], identifiers[ident_Hash]);
          refalrts::reinit_close_bracket(context[7]);
        ...
        // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # Function-ToNative/11 s.ScopeClass/12 (/20 e.Name/26 )/21 e.Commands/28 )/8 >/1
        context[26] = context[22];
        context[27] = context[23];
        context[28] = context[24];
        context[29] = context[25];
        ...
        //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # Function-ToNative/4 } Tile{ AsIs: (/20 } Tile{ HalfReuse: </1 } Tile{ HalfReuse: & MingleName*2/11 AsIs: s.ScopeClass/12 } Tile{ AsIs: e.Name/26 } Tile{ AsIs: s.Hash1/9 AsIs: s.Hash2/10 HalfReuse: >/7 } Tile{ AsIs: )/21 AsIs: e.Commands/28 AsIs: )/8 } Tile{ ]] }
        refalrts::reinit_open_bracket(context[0]);
      ...
      do {
        // </0 & SetCookies/4 s.new21/9 s.new22/10 (/7 # CmdNativeFunction/11 s.new23/12 (/20 e.new26/22 )/21 t.new24/26 e.new25/24 )/8 >/1
        context[22] = context[18];
        context[23] = context[19];
        context[24] = context[16];
        context[25] = context[17];
        if( ! refalrts::ident_term( identifiers[ident_CmdNativeFunction], context[11] ) )
          continue;
        // closed e.new26 as range 22
        context[27] = refalrts::tvar_left( context[26], context[24], context[25] );
        if( ! context[27] )
          continue;
        // closed e.new25 as range 24
        do {
          // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdNativeFunction/11 # GN-Entry/12 (/20 e.Name/28 )/21 t.SrcPos/26 e.Code/30 )/8 >/1
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} s.Hash1/9 s.Hash2/10 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} >/1 {REMOVED TILE}
          //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: # CmdNativeFunction/11 HalfReuse: (/12 } Tile{ AsIs: e.Name/28 } Tile{ HalfReuse: # Hash/0 HalfReuse: 0/4 } Tile{ HalfReuse: 0/20 } Tile{ AsIs: )/21 AsIs: t.SrcPos/26 AsIs: e.Code/30 AsIs: )/8 } Tile{ ]] }
        ...
        do {
          // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdNativeFunction/11 # GN-Local/12 (/20 e.Name/28 )/21 t.SrcPos/26 e.Code/30 )/8 >/1
          context[28] = context[22];
          context[29] = context[23];
          context[30] = context[24];
          context[31] = context[25];
          ...
          //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: # CmdNativeFunction/11 HalfReuse: (/12 } Tile{ AsIs: e.Name/28 } Tile{ HalfReuse: # Hash/4 AsIs: s.Hash1/9 AsIs: s.Hash2/10 } Tile{ AsIs: )/21 AsIs: t.SrcPos/26 AsIs: e.Code/30 AsIs: )/8 } Tile{ ]] }
          refalrts::reinit_open_bracket(context[12]);
        ...
        // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdNativeFunction/11 s.ScopeClass/12 (/20 e.Name/28 )/21 t.SrcPos/26 e.Code/30 )/8 >/1
        context[28] = context[22];
        context[29] = context[23];
        context[30] = context[24];
        context[31] = context[25];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdNativeFunction/4 } Tile{ AsIs: (/20 } Tile{ HalfReuse: </1 } Tile{ HalfReuse: & MingleName*2/11 AsIs: s.ScopeClass/12 } Tile{ AsIs: e.Name/28 } Tile{ AsIs: s.Hash1/9 AsIs: s.Hash2/10 HalfReuse: >/7 } Tile{ AsIs: )/21 AsIs: t.SrcPos/26 AsIs: e.Code/30 AsIs: )/8 } Tile{ ]] }
        refalrts::reinit_open_bracket(context[0]);
      ...
      // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdMetatable/11 s.ScopeClass/12 (/20 e.Name/22 )/21 e.Metatable/24 )/8 >/1
      context[22] = context[18];
      context[23] = context[19];
      context[24] = context[16];
      context[25] = context[17];
      if( ! refalrts::ident_term( identifiers[ident_CmdMetatable], context[11] ) )
        continue;
      // closed e.Name as range 22
      // closed e.Metatable as range 24
      //DEBUG: s.Hash1: 9
      //DEBUG: s.Hash2: 10
      //DEBUG: s.ScopeClass: 12
      //DEBUG: e.Name: 22
      //DEBUG: e.Metatable: 24

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdMetatable/11 s.ScopeClass/12 (/20 e.Name/22 )/21 e.Metatable/24 )/8 >/1 {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ ]] }
      refalrts::Iter trash_prev = arg_begin->prev;
      refalrts::use(trash_prev);
      refalrts::Iter res = arg_end->next;
    ...
    do {
      // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdEnum/11 s.ScopeClass/12 e.Name/16 )/8 >/1
      context[16] = context[14];
      context[17] = context[15];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdEnum/11 s.ScopeClass/12 e.Name/16 )/8 >/1 {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ ]] }
      refalrts::Iter trash_prev = arg_begin->prev;
      refalrts::use(trash_prev);
      refalrts::Iter res = arg_end->next;
    ...
    do {
      // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdSwap/11 s.ScopeClass/12 e.Name/16 )/8 >/1
      context[16] = context[14];
      context[17] = context[15];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdSwap/11 s.ScopeClass/12 e.Name/16 )/8 >/1 {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ ]] }
      refalrts::Iter trash_prev = arg_begin->prev;
      refalrts::use(trash_prev);
      refalrts::Iter res = arg_end->next;
    ...
    do {
      // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdConditionFunc-ToRASL/11 s.ScopeClass/12 e.Name/16 )/8 >/1
      context[16] = context[14];
      context[17] = context[15];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdConditionFunc-ToRASL/11 s.ScopeClass/12 e.Name/16 )/8 >/1 {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ ]] }
      refalrts::Iter trash_prev = arg_begin->prev;
      refalrts::use(trash_prev);
      refalrts::Iter res = arg_end->next;
    ...
    do {
      // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdConditionFunc-ToNative/11 s.ScopeClass/12 e.Name/16 )/8 >/1
      context[16] = context[14];
      context[17] = context[15];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdConditionFunc-ToNative/11 s.ScopeClass/12 e.Name/16 )/8 >/1 {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ ]] }
      refalrts::Iter trash_prev = arg_begin->prev;
      refalrts::use(trash_prev);
      refalrts::Iter res = arg_end->next;
    ...
    // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdDeclaration/11 s.ScopeClass/12 e.Name/16 )/8 >/1
    context[16] = context[14];
    context[17] = context[15];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdDeclaration/11 s.ScopeClass/12 e.Name/16 )/8 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 (/7 # CmdEmitNativeCode/11 t.SrcPos/12 e.Code/5 )/8 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} </0 & SetCookies/4 s.Hash1/9 s.Hash2/10 {REMOVED TILE} >/1 {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: # CmdEmitNativeCode/11 AsIs: t.SrcPos/12 AsIs: e.Code/5 AsIs: )/8 } Tile{ ]] }
  refalrts::link_brackets( context[7], context[8] );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
  refalrts::Iter res = arg_end->next;
...
static refalrts::FnResult func_MingleName(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & MingleName/4 s.new1/5 e.new2/2 s.new3/7 s.new4/6 >/1
  if( ! refalrts::svar_left( context[5], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  ...
  // closed e.new2 as range 2
  do {
    // </0 & MingleName/4 # GN-Entry/5 e.Name/8 s.Hash1/7 s.Hash2/6 >/1
    context[8] = context[2];
    context[9] = context[3];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.Hash1/7 s.Hash2/6 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: e.Name/8 } Tile{ Reuse: # Hash/5 } Tile{ HalfReuse: 0/4 } Tile{ HalfReuse: 0/1 ]] }
  ...
  // </0 & MingleName/4 # GN-Local/5 e.Name/2 s.Hash1/7 s.Hash2/6 >/1
  ...
  //RESULT: Tile{ [[ } Tile{ AsIs: e.Name/2 } Tile{ Reuse: # Hash/5 } Tile{ AsIs: s.Hash1/7 AsIs: s.Hash2/6 } Tile{ ]] }
  refalrts::update_ident(context[5], identifiers[ident_Hash]);
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
  refalrts::Iter res = arg_end->next;
...
static refalrts::FnResult func_PrepareFunctionsRASL(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & PrepareFunctionsRASL/4 (/7 s.new1/9 t.new2/10 e.new3/5 )/8 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new3 as range 5
  do {
    // </0 & PrepareFunctionsRASL/4 (/7 s.new4/9 (/10 e.new5/14 )/11 e.new6/12 )/8 >/1
    context[12] = context[5];
    context[13] = context[6];
    context[14] = 0;
    context[15] = 0;
    ...
    do {
      // </0 & PrepareFunctionsRASL/4 (/7 # Function-ToNative/9 (/10 e.Name/16 )/11 e.Body/18 )/8 >/1
      context[16] = context[14];
      context[17] = context[15];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } (/20 # CmdFnStart/21 e.Name/16/22 Tile{ AsIs: )/8 HalfReuse: (/1 } # CmdProfileFunction/24 )/25 (/26 # CmdLoadConstants/27 )/28 </29 & ConvertDirectCommands/30 Tile{ AsIs: e.Body/18 } >/31 Tile{ HalfReuse: (/0 HalfReuse: # CmdFnEnd/4 HalfReuse: )/7 HalfReuse: (/9 HalfReuse: # CmdNativeFuncDescr/10 AsIs: e.Name/16 AsIs: )/11 } Tile{ ]] }
      refalrts::alloc_open_bracket(vm, context[20]);
    ...
    // </0 & PrepareFunctionsRASL/4 (/7 # CmdNativeFunction/9 (/10 e.Name/16 )/11 t.SrcPos/20 e.Code/18 )/8 >/1
    context[16] = context[14];
    context[17] = context[15];
    context[18] = context[12];
    context[19] = context[13];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ HalfReuse: (/0 } # CmdFnStart/22 Tile{ AsIs: e.Name/16 } Tile{ HalfReuse: )/4 AsIs: (/7 Reuse: # CmdLoadConstants/9 HalfReuse: )/10 } (/23 Tile{ HalfReuse: # CmdEmitNativeCode/11 AsIs: t.SrcPos/20 AsIs: e.Code/18 AsIs: )/8 HalfReuse: (/1 } # CmdFnEnd/24 )/25 (/26 # CmdNativeFuncDescr/27 e.Name/16/28 )/30 Tile{ ]] }
  ...
  // </0 & PrepareFunctionsRASL/4 (/7 # CmdEmitNativeCode/9 t.SrcPos/10 e.Code/5 )/8 >/1
  ...
  //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: # CmdEmitNativeCode/9 AsIs: t.SrcPos/10 AsIs: e.Code/5 AsIs: )/8 } Tile{ ]] }
  refalrts::link_brackets( context[7], context[8] );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
  refalrts::Iter res = arg_end->next;
...
static refalrts::FnResult func_ConvertDirectCommands(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & ConvertDirectCommands/4 e.new/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  // closed e.new as range 2
  do {
    // </0 & ConvertDirectCommands/4 t.new1/7 e.new2/5 >/1
    context[5] = context[2];
    context[6] = context[3];
    context[8] = refalrts::tvar_left( context[7], context[5], context[6] );
    if( ! context[8] )
    ...
    // closed e.new2 as range 5
    do {
      // </0 & ConvertDirectCommands/4 (/7 s.new3/13 e.new4/11 )/8 e.new5/9 >/1
      context[9] = context[5];
      context[10] = context[6];
      context[11] = 0;
      context[12] = 0;
      ...
      do {
        // </0 & ConvertDirectCommands/4 (/7 # CmdSentence/13 e.SubCommands/14 )/8 e.Tail/16 >/1
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CmdStartSentence/4 HalfReuse: )/7 HalfReuse: </13 } & ConvertDirectCommands/18 Tile{ AsIs: e.SubCommands/14 } >/19 (/20 # CmdEndSentence/21 )/22 </23 Tile{ HalfReuse: & ConvertDirectCommands/8 AsIs: e.Tail/16 AsIs: >/1 ]] }
      ...
      // </0 & ConvertDirectCommands/4 (/7 s.new6/13 s.new7/18 e.new8/14 )/8 e.new9/16 >/1
      context[14] = context[11];
      context[15] = context[12];
      context[16] = context[9];
      context[17] = context[10];
      ...
      do {
        // </0 & ConvertDirectCommands/4 (/7 # CmdOpenELoop/13 # AlgLeft/18 s.BracketNum/23 s.VarNumber/24 e.SubCommands/19 )/8 e.Tail/21 >/1
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ HalfReuse: (/0 } # CmdOpenedE-Start/25 # AlgLeft/26 s.BracketNum/23/27 s.VarNumber/24/28 )/29 </30 & ConvertDirectCommands/31 Tile{ AsIs: e.SubCommands/19 } Tile{ HalfReuse: >/4 AsIs: (/7 Reuse: # CmdOpenedE-End/13 AsIs: # AlgLeft/18 AsIs: s.BracketNum/23 AsIs: s.VarNumber/24 } )/32 </33 Tile{ HalfReuse: & ConvertDirectCommands/8 AsIs: e.Tail/21 AsIs: >/1 ]] }
      ...
      // </0 & ConvertDirectCommands/4 (/7 # CmdVariableDebugTable/13 s.Mode/18 e.Index/19 s.Offset/23 )/8 e.Tail/21 >/1
      context[19] = context[14];
      context[20] = context[15];
      context[21] = context[16];
      context[22] = context[17];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } (/24 # CmdComment/25"DEB"/26 Tile{ HalfReuse: 'U'/0 HalfReuse: 'G'/4 HalfReuse: ':'/7 HalfReuse: ' '/13 AsIs: s.Mode/18 } '.'/28 Tile{ AsIs: e.Index/19 }": "/29 </31 & Symb/32 Tile{ AsIs: s.Offset/23 } >/33 )/34 </35 Tile{ HalfReuse: & ConvertDirectCommands/8 AsIs: e.Tail/21 AsIs: >/1 ]] }
      refalrts::alloc_open_bracket(vm, context[24]);
      refalrts::alloc_ident(vm, context[25], identifiers[ident_CmdComment]);
      refalrts::alloc_chars(vm, context[26], context[27], "DEB", 3);
    ...
    // </0 & ConvertDirectCommands/4 t.Command/7 e.Tail/9 >/1
    context[9] = context[5];
    context[10] = context[6];
    // closed e.Tail as range 9
    //DEBUG: t.Command: 7
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: t.Command/7 } Tile{ AsIs: </0 AsIs: & ConvertDirectCommands/4 } Tile{ AsIs: e.Tail/9 } Tile{ AsIs: >/1 ]] }
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
...
static refalrts::FnResult func_gen_Map_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new2 as range 5
    do {
      // </0 & Map@1/4 (/7 s.new3/13 t.new4/14 e.new5/11 )/8 e.new6/9 >/1
      context[9] = context[5];
      context[10] = context[6];
      context[11] = 0;
      context[12] = 0;
      ...
      do {
        // </0 & Map@1/4 (/7 s.new7/13 (/14 e.new8/20 )/15 e.new9/16 )/8 e.new10/18 >/1
        context[16] = context[11];
        context[17] = context[12];
        ...
        do {
          // </0 & Map@1/4 (/7 # Function-ToNative/13 (/14 e.2/22 )/15 e.1/24 )/8 e.Tail/26 >/1
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ } (/28 # CmdFnStart/29 e.2/22/30 )/32 (/33 # CmdProfileFunction/34 )/35 (/36 # CmdLoadConstants/37 )/38 </39 & ConvertDirectCommands/40 Tile{ AsIs: e.1/24 } >/41 Tile{ HalfReuse: (/0 HalfReuse: # CmdFnEnd/4 HalfReuse: )/7 HalfReuse: (/13 HalfReuse: # CmdNativeFuncDescr/14 AsIs: e.2/22 AsIs: )/15 } </42 Tile{ HalfReuse: & Map@1/8 AsIs: e.Tail/26 AsIs: >/1 ]] }
          refalrts::alloc_open_bracket(vm, context[28]);
        ...
        // </0 & Map@1/4 (/7 # CmdNativeFunction/13 (/14 e.2/22 )/15 t.1/28 e.3/24 )/8 e.Tail/26 >/1
        context[22] = context[20];
        context[23] = context[21];
        context[24] = context[16];
        context[25] = context[17];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ } (/30 # CmdFnStart/31 e.2/22/32 )/34 (/35 # CmdLoadConstants/36 )/37 (/38 # CmdEmitNativeCode/39 Tile{ AsIs: t.1/28 } Tile{ AsIs: e.3/24 } )/40 Tile{ HalfReuse: (/0 HalfReuse: # CmdFnEnd/4 HalfReuse: )/7 HalfReuse: (/13 HalfReuse: # CmdNativeFuncDescr/14 AsIs: e.2/22 AsIs: )/15 } </41 Tile{ HalfReuse: & Map@1/8 AsIs: e.Tail/26 AsIs: >/1 ]] }
        refalrts::alloc_open_bracket(vm, context[30]);
      ...
      // </0 & Map@1/4 (/7 # CmdEmitNativeCode/13 t.0/14 e.1/16 )/8 e.Tail/18 >/1
      context[16] = context[11];
      context[17] = context[12];
      context[18] = context[9];
      context[19] = context[10];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: # CmdEmitNativeCode/13 AsIs: t.0/14 AsIs: e.1/16 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@1/4 } Tile{ AsIs: e.Tail/18 } Tile{ AsIs: >/1 ]] }
      refalrts::push_stack( vm, context[1] );
      refalrts::push_stack( vm, context[0] );
      refalrts::link_brackets( context[7], context[8] );
      refalrts::Iter trash_prev = arg_begin->prev;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & PrepareFunctionsRASL*3/4 AsIs: t.Next/7 } >/11 </12 & Map@1/13 Tile{ AsIs: e.Tail/9 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[11]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & PrepareFunctionsRASL@0/4 AsIs: e.items/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
...
static refalrts::FnResult func_gen_Map_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      // </0 & Map@2/4 s.new8/5 s.new9/6 (/9 s.new10/15 e.new11/13 )/10 e.new12/11 >/1
      context[11] = context[7];
      context[12] = context[8];
      context[13] = 0;
      context[14] = 0;
      ...
      do {
        // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # UnitName/15 e.0/16 )/10 e.Tail/18 >/1
        context[16] = context[13];
        context[17] = context[14];
        context[18] = context[11];
        context[19] = context[12];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} (/9 # UnitName/15 e.0/16 )/10 {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/18 } Tile{ AsIs: >/1 ]] }
        refalrts::push_stack( vm, context[1] );
        refalrts::push_stack( vm, context[0] );
        refalrts::Iter trash_prev = arg_begin->prev;
        refalrts::use(trash_prev);
      ...
      // </0 & Map@2/4 s.new13/5 s.new14/6 (/9 s.new15/15 t.new16/20 e.new17/16 )/10 e.new18/18 >/1
      context[16] = context[13];
      context[17] = context[14];
      context[18] = context[11];
      context[19] = context[12];
      ...
      do {
        // </0 & Map@2/4 s.new19/5 s.new20/6 (/9 s.new21/15 s.new22/20 e.new23/22 )/10 e.new24/24 >/1
        ...
        // closed e.new24 as range 24
        do {
          // </0 & Map@2/4 s.new25/5 s.new26/6 (/9 s.new27/15 s.new28/20 (/32 e.new29/30 )/33 e.new30/26 )/10 e.new31/28 >/1
          context[26] = context[22];
          context[27] = context[23];
          context[28] = context[24];
          context[29] = context[25];
          ...
          // closed e.new29 as range 30
          // closed e.new30 as range 26
          // closed e.new31 as range 28
          do {
            // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # Function-ToRASL/15 s.ScopeClass/20 (/32 e.3/34 )/33 e.2/36 )/10 e.Tail/38 >/1
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} (/9 # Function-ToRASL/15 s.ScopeClass/20 (/32 e.3/34 )/33 e.2/36 )/10 {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/38 } Tile{ AsIs: >/1 ]] }
            refalrts::push_stack( vm, context[1] );
            refalrts::push_stack( vm, context[0] );
            refalrts::Iter trash_prev = arg_begin->prev;
            refalrts::use(trash_prev);
          ...
          do {
            // </0 & Map@2/4 s.new32/5 s.new33/6 (/9 # Function-ToNative/15 s.new34/20 (/32 e.new36/34 )/33 e.new35/36 )/10 e.new37/38 >/1
            context[34] = context[30];
            context[35] = context[31];
            context[36] = context[26];
            context[37] = context[27];
            ...
            // closed e.new37 as range 38
            do {
              // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # Function-ToNative/15 # GN-Entry/20 (/32 e.3/40 )/33 e.2/42 )/10 e.Tail/44 >/1
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ HalfReuse: (/15 Reuse: # Function-ToNative/20 AsIs: (/32 AsIs: e.3/40 HalfReuse: # Hash/33 } 0/46 Tile{ HalfReuse: 0/9 } Tile{ AsIs: )/10 } Tile{ AsIs: e.2/42 } )/47 Tile{ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/44 } Tile{ AsIs: >/1 ]] }
            ...
            do {
              // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # Function-ToNative/15 # GN-Local/20 (/32 e.3/40 )/33 e.2/42 )/10 e.Tail/44 >/1
              context[40] = context[34];
              context[41] = context[35];
              context[42] = context[36];
              context[43] = context[37];
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ HalfReuse: (/15 Reuse: # Function-ToNative/20 AsIs: (/32 AsIs: e.3/40 HalfReuse: # Hash/33 } s.Hash1/5/46 Tile{ HalfReuse: s.Hash26 /9 } Tile{ AsIs: )/10 } Tile{ AsIs: e.2/42 } )/47 Tile{ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/44 } Tile{ AsIs: >/1 ]] }
            ...
            // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # Function-ToNative/15 s.ScopeClass/20 (/32 e.3/40 )/33 e.2/42 )/10 e.Tail/44 >/1
            context[40] = context[34];
            context[41] = context[35];
            context[42] = context[36];
            context[43] = context[37];
            ...
            //RESULT: Tile{ [[ } Tile{ AsIs: (/9 AsIs: # Function-ToNative/15 } Tile{ AsIs: (/32 } </46 & MingleName*2/47 Tile{ AsIs: s.ScopeClass/20 } Tile{ AsIs: e.3/40 } s.Hash1/5/48 s.Hash2/6/49 >/50 Tile{ AsIs: )/33 AsIs: e.2/42 AsIs: )/10 } Tile{ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/44 } Tile{ AsIs: >/1 ]] }
          ...
          do {
            // </0 & Map@2/4 s.new32/5 s.new33/6 (/9 # CmdNativeFunction/15 s.new34/20 (/32 e.new37/34 )/33 t.new35/40 e.new36/36 )/10 e.new38/38 >/1
            context[34] = context[30];
            context[35] = context[31];
            context[36] = context[26];
            context[37] = context[27];
            ...
            // closed e.new38 as range 38
            context[41] = refalrts::tvar_left( context[40], context[36], context[37] );
            if( ! context[41] )
              continue;
            // closed e.new36 as range 36
            do {
              // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # CmdNativeFunction/15 # GN-Entry/20 (/32 e.3/42 )/33 t.2/40 e.4/44 )/10 e.Tail/46 >/1
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ AsIs: (/9 AsIs: # CmdNativeFunction/15 HalfReuse: (/20 } Tile{ AsIs: e.3/42 } Tile{ HalfReuse: # Hash/32 } 0/48 0/49 Tile{ AsIs: )/33 AsIs: t.2/40 AsIs: e.4/44 AsIs: )/10 } Tile{ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/46 } Tile{ AsIs: >/1 ]] }
            ...
            do {
              // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # CmdNativeFunction/15 # GN-Local/20 (/32 e.3/42 )/33 t.2/40 e.4/44 )/10 e.Tail/46 >/1
              context[42] = context[34];
              context[43] = context[35];
              context[44] = context[36];
              context[45] = context[37];
              ...
              refalrts::reset_allocator(vm);
              //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
              //RESULT: Tile{ [[ } Tile{ AsIs: (/9 AsIs: # CmdNativeFunction/15 HalfReuse: (/20 } Tile{ AsIs: e.3/42 } Tile{ HalfReuse: # Hash/32 } s.Hash1/5/48 s.Hash2/6/49 Tile{ AsIs: )/33 AsIs: t.2/40 AsIs: e.4/44 AsIs: )/10 } Tile{ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/46 } Tile{ AsIs: >/1 ]] }
              refalrts::copy_stvar(vm, context[48], context[5]);
              refalrts::copy_stvar(vm, context[49], context[6]);
              refalrts::reinit_open_bracket(context[20]);
              refalrts::reinit_ident(context[32], identifiers[ident_Hash]);
            ...
            // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # CmdNativeFunction/15 s.ScopeClass/20 (/32 e.3/42 )/33 t.2/40 e.4/44 )/10 e.Tail/46 >/1
            context[42] = context[34];
            context[43] = context[35];
            context[44] = context[36];
            context[45] = context[37];
            ...
            refalrts::reset_allocator(vm);
            //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
            //RESULT: Tile{ [[ } Tile{ AsIs: (/9 AsIs: # CmdNativeFunction/15 } Tile{ AsIs: (/32 } </48 & MingleName*2/49 Tile{ AsIs: s.ScopeClass/20 } Tile{ AsIs: e.3/42 } s.Hash1/5/50 s.Hash2/6/51 >/52 Tile{ AsIs: )/33 AsIs: t.2/40 AsIs: e.4/44 AsIs: )/10 } Tile{ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/46 } Tile{ AsIs: >/1 ]] }
            refalrts::alloc_open_call(vm, context[48]);
          ...
          // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # CmdMetatable/15 s.ScopeClass/20 (/32 e.3/34 )/33 e.2/36 )/10 e.Tail/38 >/1
          context[34] = context[30];
          context[35] = context[31];
          context[36] = context[26];
          context[37] = context[27];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} (/9 # CmdMetatable/15 s.ScopeClass/20 (/32 e.3/34 )/33 e.2/36 )/10 {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/38 } Tile{ AsIs: >/1 ]] }
          refalrts::push_stack( vm, context[1] );
          refalrts::push_stack( vm, context[0] );
          refalrts::Iter trash_prev = arg_begin->prev;
        ...
        do {
          // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # CmdEnum/15 s.ScopeClass/20 e.1/26 )/10 e.Tail/28 >/1
          context[26] = context[22];
          context[27] = context[23];
          context[28] = context[24];
          context[29] = context[25];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} (/9 # CmdEnum/15 s.ScopeClass/20 e.1/26 )/10 {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/28 } Tile{ AsIs: >/1 ]] }
          refalrts::push_stack( vm, context[1] );
          refalrts::push_stack( vm, context[0] );
          refalrts::Iter trash_prev = arg_begin->prev;
          refalrts::use(trash_prev);
        ...
        do {
          // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # CmdSwap/15 s.ScopeClass/20 e.1/26 )/10 e.Tail/28 >/1
          context[26] = context[22];
          context[27] = context[23];
          context[28] = context[24];
          context[29] = context[25];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} (/9 # CmdSwap/15 s.ScopeClass/20 e.1/26 )/10 {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/28 } Tile{ AsIs: >/1 ]] }
          refalrts::push_stack( vm, context[1] );
          refalrts::push_stack( vm, context[0] );
          refalrts::Iter trash_prev = arg_begin->prev;
        ...
        do {
          // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # CmdConditionFunc-ToRASL/15 s.ScopeClass/20 e.1/26 )/10 e.Tail/28 >/1
          context[26] = context[22];
          context[27] = context[23];
          context[28] = context[24];
          context[29] = context[25];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} (/9 # CmdConditionFunc-ToRASL/15 s.ScopeClass/20 e.1/26 )/10 {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/28 } Tile{ AsIs: >/1 ]] }
          refalrts::push_stack( vm, context[1] );
          refalrts::push_stack( vm, context[0] );
          refalrts::Iter trash_prev = arg_begin->prev;
        ...
        do {
          // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # CmdConditionFunc-ToNative/15 s.ScopeClass/20 e.1/26 )/10 e.Tail/28 >/1
          context[26] = context[22];
          context[27] = context[23];
          context[28] = context[24];
          context[29] = context[25];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} (/9 # CmdConditionFunc-ToNative/15 s.ScopeClass/20 e.1/26 )/10 {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/28 } Tile{ AsIs: >/1 ]] }
          refalrts::push_stack( vm, context[1] );
          refalrts::push_stack( vm, context[0] );
          refalrts::Iter trash_prev = arg_begin->prev;
        ...
        // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # CmdDeclaration/15 s.ScopeClass/20 e.1/26 )/10 e.Tail/28 >/1
        context[26] = context[22];
        context[27] = context[23];
        context[28] = context[24];
        context[29] = context[25];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} (/9 # CmdDeclaration/15 s.ScopeClass/20 e.1/26 )/10 {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/28 } Tile{ AsIs: >/1 ]] }
        refalrts::push_stack( vm, context[1] );
        refalrts::push_stack( vm, context[0] );
        refalrts::Iter trash_prev = arg_begin->prev;
      ...
      // </0 & Map@2/4 s.Hash1/5 s.Hash2/6 (/9 # CmdEmitNativeCode/15 t.0/20 e.1/22 )/10 e.Tail/24 >/1
      context[22] = context[16];
      context[23] = context[17];
      context[24] = context[18];
      context[25] = context[19];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: (/9 AsIs: # CmdEmitNativeCode/15 AsIs: t.0/20 AsIs: e.1/22 AsIs: )/10 } Tile{ AsIs: </0 AsIs: & Map@2/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } Tile{ AsIs: e.Tail/24 } Tile{ AsIs: >/1 ]] }
      refalrts::push_stack( vm, context[1] );
      refalrts::push_stack( vm, context[0] );
      refalrts::link_brackets( context[9], context[10] );
      refalrts::Iter trash_prev = arg_begin->prev;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & SetCookies*11/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 AsIs: t.Next/9 } >/13 </14 & Map@2/15 s.Hash1/5/16 s.Hash2/6/17 Tile{ AsIs: e.Tail/11 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[13]);
    refalrts::alloc_open_call(vm, context[14]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </7 & Map@0/8 Tile{ HalfReuse: (/0 Reuse: & SetCookies@0/4 AsIs: s.Hash1/5 AsIs: s.Hash2/6 } )/9 Tile{ AsIs: e.items/2 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Map_Z3(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new4 as range 11
    do {
      // </0 & Map@3/4 (/7 e.Prefix/15 )/8 (/13 s.Id/21 e.0/19 )/14 e.Tail/17 >/1
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: (/13 } # CmdCEnum-Item/22 (/23 e.Prefix/15/24 )/26 Tile{ AsIs: e.0/19 } Tile{ AsIs: s.Id/21 } Tile{ AsIs: )/14 } Tile{ AsIs: </0 AsIs: & Map@3/4 AsIs: (/7 AsIs: e.Prefix/15 AsIs: )/8 } Tile{ AsIs: e.Tail/17 } Tile{ AsIs: >/1 ]] }
    ...
    // </0 & Map@3/4 (/7 e.Prefix/15 )/8 t.Next/13 e.Tail/17 >/1
    context[15] = context[9];
    context[16] = context[10];
    context[17] = context[11];
    context[18] = context[12];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & PrepareTable$2\1*1/4 AsIs: (/7 AsIs: e.Prefix/15 AsIs: )/8 AsIs: t.Next/13 } >/19 </20 & Map@3/21 (/22 e.Prefix/15/23 )/25 Tile{ AsIs: e.Tail/17 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[19]);
  ...
  do {
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Map@3/4 (/7 e.Prefix/9 )/8 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & Map@3/4 (/7 e.Prefix/5 )/8 e.items/2 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </9 & Map@0/10 Tile{ HalfReuse: [*]/0 Reuse: & PrepareTable$2\1@0/4 AsIs: (/7 AsIs: e.Prefix/5 AsIs: )/8 } {*}/11 Tile{ AsIs: e.items/2 } Tile{ AsIs: >/1 ]] }
