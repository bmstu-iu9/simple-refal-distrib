...
#define cookie_ns cookie_ns_2887077717_1492355744
#define COOKIE1_ 2887077717U
#define COOKIE2_ 1492355744U
...
enum efunc {
  ...
  efunc_PrepareTable = 23,
  efunc_PrepareFunctionsRASL = 24,
  efunc_gen_LowLevelRASLm_Native_B1S2A1 = 25,
  efunc_SetCookies = 26,
  efunc_gen_LowLevelRASLm_Native_B1 = 27,
  efunc_gen_Map_Z1 = 28,
  efunc_MingleName = 29,
  efunc_ConvertDirectCommands = 30,
  efunc_Symb = 31,
  efunc_gen_PrepareTable_S2L1D1 = 32,
};
...
static refalrts::FnResult func_gen_u_u_Mum_Aux_S13B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::alloc_number(vm, context[9], 1492355744UL);
    refalrts::update_name(context[4], functions[efunc_u_u_FindMuPtr]);
    refalrts::reinit_number(context[5], 2887077717UL);
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
  ...
  refalrts::update_name(context[4], functions[efunc_u_u_FindMuPtr]);
  refalrts::reinit_number(context[5], 2887077717UL);
  refalrts::reinit_number(context[7], 1492355744UL);
  refalrts::push_stack( vm, context[1] );
  refalrts::push_stack( vm, context[0] );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
