...
#define cookie_ns cookie_ns_858433688_2899906390
#define COOKIE1_ 858433688U
#define COOKIE2_ 2899906390U
...
enum efunc {
  ...
  efunc_Inc = 32,
  efunc_Dec = 33,
  efunc_LowLevelRASLm_Native = 34,
  efunc_SetCookies = 35,
  efunc_PrepareFunctionsRASL = 36,
  efunc_gen_Map_Z0 = 37,
  efunc_gen_PrepareTable_S2L1D1 = 38,
  efunc_gen_PrepareTable_S2L1 = 39,
};
...
enum ident {
  ...
  ident_Dec = 46,
  ident_Pipe = 47,
  ident_LowLevelRASLm_Native = 48,
  ident_PrepareTable = 49,
  ident_SetCookies = 50,
  ident_MingleName = 51,
  ident_PrepareFunctionsRASL = 52,
  ident_ConvertDirectCommands = 53,
};
...
static refalrts::FnResult func_gen_Map_Z3(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </9 & Map@0/10 Tile{ HalfReuse: [*]/0 Reuse: & PrepareTable$2\1/4 AsIs: (/7 AsIs: e.Prefix#1/5 AsIs: )/8 } {*}/11 Tile{ AsIs: e.items#0/2 } Tile{ AsIs: >/1 ]] }
  ...
  refalrts::reinit_closure_head(context[0]);
  refalrts::update_name(context[4], functions[efunc_gen_PrepareTable_S2L1]);
  refalrts::push_stack( vm, context[1] );
  refalrts::push_stack( vm, context[9] );
  refalrts::link_brackets( context[7], context[8] );
  refalrts::Iter trash_prev = arg_begin->prev;
