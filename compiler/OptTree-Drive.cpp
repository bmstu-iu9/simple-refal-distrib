...
#define cookie_ns cookie_ns_1379059408_3029951754
...
static refalrts::NativeReference nat_ref_Mu("Mu", 1379059408U, 3029951754U, func_Mu);
...
static refalrts::FnResult func_gen_u_u_Mum_Aux_S13B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::alloc_number(vm, context[9], 3029951754UL);
    refalrts::update_name(context[4], functions[efunc_u_u_FindMuPtr]);
    refalrts::reinit_number(context[5], 1379059408UL);
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
  ...
  refalrts::update_name(context[4], functions[efunc_u_u_FindMuPtr]);
  refalrts::reinit_number(context[5], 1379059408UL);
  refalrts::reinit_number(context[7], 3029951754UL);
  refalrts::push_stack( vm, context[1] );
  refalrts::push_stack( vm, context[0] );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
...
static refalrts::NativeReference nat_ref_gen_u_u_Mum_Aux_S13B1("__Mu-Aux$13:1", 1379059408U, 3029951754U, func_gen_u_u_Mum_Aux_S13B1);
...
static refalrts::NativeReference nat_ref_u_u_Mum_Aux("__Mu-Aux", 1379059408U, 3029951754U, func_u_u_Mum_Aux);
...
static refalrts::NativeReference nat_ref_Residue("Residue", 1379059408U, 3029951754U, func_Residue);
