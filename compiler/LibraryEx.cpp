...
static refalrts::FnResult DoMapReduce(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    //RESULT: Tile{ [[ AsIs: </0 AsIs: & DoMapReduce/4 AsIs: t.Fn#1/5 } </15 & MapReduce_AddScanned/16 </17 & Apply/18 t.Fn#1/5/19 Tile{ AsIs: t.Acc#1/7 } Tile{ AsIs: t.Next#1/13 } >/21 Tile{ AsIs: (/11 AsIs: e.Scanned#1/9 AsIs: )/12 } >/22 Tile{ AsIs: e.Tail#1/23(2) } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult FastIntFromStr_Guard(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icEmpty, 0, 0, 2},
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  </0 & FastIntFromStr_Guard/4 # Success/5 s.Number#1/6 {REMOVED TILE} 
...
static refalrts::FnResult Lexicon(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Lexicon_Aux/4 HalfReuse: </7 } & Compare/17 Tile{ AsIs: t.FirstLeft#1/13 } Tile{ AsIs: t.FirstRight#1/15 } >/18 (/19 Tile{ AsIs: e.Left#1/20(5) } Tile{ AsIs: )/8 AsIs: (/11 } Tile{ AsIs: e.Right#1/22(9) } Tile{ AsIs: )/12 AsIs: >/1 ]] }
...
static refalrts::FnResult Lexicon_Aux(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    //FAST GEN:S (E )(E )
    //GLOBAL GEN:S (E )(E )
    // </0 & Lexicon_Aux/4 s.idx#0/13 (/11 e.idxVB#0/9 )/12 (/7 e.idxVTB#0/5 )/8 >/1
    {refalrts::icInitB0_Lite, 0, 0, 0},
    {refalrts::icCallSaveLeft, 0, 2, 0},
    {refalrts::icBracketRightSave, 0, 5, 2},
    ...
    {refalrts::icOnFailGoTo, +6, 0, 0},
    //'<'(E )(E )
    // </0 & Lexicon_Aux/4 '<'/13 (/11 e.Left#1/9 )/12 (/7 e.Right#1/5 )/8 >/1
    {refalrts::icCharTerm, 0, static_cast<unsigned char>('<'), 13},
    // closed e.Left#1 as range 9
    // closed e.Right#1 as range 5
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  </0 & Lexicon_Aux/4 '<'/13 (/11 e.Left#1/9 )/12 (/7 e.Right#1/5 )/8 {REMOVED TILE} 
    //RESULT: Tile{ [[ } Tile{ HalfReuse: '<'/1 ]] }
    {refalrts::icReinitChar, 0, '<', 1},
    {refalrts::icSetRes, 0, 0, 1},
    {refalrts::icTrashLeftEdge, 0, 0, 0},
...
refalrts::FnResult Compare_T(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    //FAST GEN:T T 
    //GLOBAL GEN:T T 
    // </0 & Compare_T/4 t.idx#0/5 t.idxV#0/7 >/1
    {refalrts::icInitB0_Lite, 0, 0, 0},
    {refalrts::icCallSaveLeft, 0, 2, 0},
    {refalrts::ictVarLeftSave, 0, 5, 2},
    {refalrts::ictVarLeftSave, 0, 7, 2},
    ...
    //(E )(E )
    // </0 & Compare_T/4 (/5 e.Left#1/9 )/6 (/7 e.Right#1/11 )/8 >/1
    {refalrts::icBracketTerm, 0, 9, 5},
    {refalrts::icBracketTerm, 0, 11, 7},
    // closed e.Left#1 as range 9
    // closed e.Right#1 as range 11
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  {REMOVED TILE}  {REMOVED TILE} 
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Lexicon_T/4 AsIs: (/5 } )/13 (/14 Tile{ AsIs: e.Left#1/9 } )/15 (/16 Tile{ AsIs: )/6 AsIs: (/7 AsIs: e.Right#1/11 AsIs: )/8 AsIs: >/1 ]] }
    ...
    {refalrts::icOnFailGoTo, +9, 0, 0},
    //(E )S 
    // </0 & Compare_T/4 (/5 e.Left#1/9 )/6 s.Right#1/7 >/1
    {refalrts::icBracketTerm, 0, 9, 5},
    {refalrts::icsVarTerm, 0, 11, 7},
    // closed e.Left#1 as range 9
    {refalrts::icEmptyResult, 0, 0, 0},
    ...
    {refalrts::icOnFailGoTo, +9, 0, 0},
    //S (E )
    // </0 & Compare_T/4 s.Left#1/5 (/7 e.Right#1/9 )/8 >/1
    {refalrts::icBracketTerm, 0, 9, 7},
    {refalrts::icsVarTerm, 0, 11, 5},
    // closed e.Right#1 as range 9
    {refalrts::icEmptyResult, 0, 0, 0},
    ...
    {refalrts::icReturnResult_NoTrash, 0, 0, 0},
    //S S 
    // </0 & Compare_T/4 s.Left#1/5 s.Right#1/7 >/1
    {refalrts::icsVarTerm, 0, 9, 5},
    {refalrts::icsVarTerm, 0, 9, 7},
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  {REMOVED TILE} 
...
static refalrts::FnResult Lexicon_T(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    //FAST GEN:(E )(E )(E )(E )
    //GLOBAL GEN:(E )(E )(E )(E )
    // </0 & Lexicon_T/4 (/7 e.idxB#0/5 )/8 (/11 e.idxTB#0/9 )/12 (/15 e.idxTTB#0/13 )/16 (/19 e.idxTTTB#0/17 )/20 >/1
    {refalrts::icInitB0_Lite, 0, 0, 0},
    {refalrts::icCallSaveLeft, 0, 2, 0},
    {refalrts::icBracketLeftSave, 0, 5, 2},
    {refalrts::icBracketLeftSave, 0, 9, 2},
    ...
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Lexicon_T_Aux/4 AsIs: (/7 AsIs: e.ScannedLeft#1/5 AsIs: )/8 AsIs: (/11 } Tile{ AsIs: e.ScannedRight#1/13 } )/25 </26 & Compare_T/27 Tile{ AsIs: t.FirstLeft#1/21 } Tile{ AsIs: t.FirstRight#1/23 } Tile{ HalfReuse: >/12 AsIs: (/15 } Tile{ AsIs: e.Left#1/28(9) } Tile{ AsIs: )/16 AsIs: (/19 } Tile{ AsIs: e.Right#1/30(17) } Tile{ AsIs: )/20 AsIs: >/1 ]] }
  ...
  do {
    ...
    if( ! refalrts::alloc_open_call( context[26] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[27], Compare_T, "Compare_T" ) )
      return refalrts::cNoMemory;
...
static refalrts::FnResult Lexicon_T_Aux(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    // </0 & Lexicon_T_Aux/4 (/7 e.idxB#0/5 )/8 (/11 e.idxTB#0/9 )/12 s.idxTT#0/21 t.idxTTV#0/22 t.idxTTVV#0/24 (/19 e.idxTTVVVB#0/17 )/20 (/15 e.idxTTVVVTB#0/13 )/16 >/1
    {refalrts::icInitB0_Lite, 0, 0, 0},
    {refalrts::icCallSaveLeft, 0, 2, 0},
    {refalrts::icBracketLeftSave, 0, 5, 2},
    {refalrts::icBracketLeftSave, 0, 9, 2},
    ...
    //(E )(E )'<'T T (E )(E )
    // </0 & Lexicon_T_Aux/4 (/7 e.ScannedLeft#1/5 )/8 (/11 e.ScannedRight#1/9 )/12 '<'/21 t.NextLeft#1/22 t.NextRight#1/24 (/19 e.Left#1/17 )/20 (/15 e.Right#1/13 )/16 >/1
    ...
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Lexicon_T/4 AsIs: (/7 } Tile{ AsIs: e.ScannedLeft#1/5 } Tile{ AsIs: t.NextLeft#1/22 } Tile{ AsIs: )/8 AsIs: (/11 } Tile{ AsIs: e.Left#1/17 } Tile{ AsIs: )/12 HalfReuse: (/21 } Tile{ AsIs: e.ScannedRight#1/9 } Tile{ AsIs: t.NextRight#1/24 } Tile{ AsIs: )/20 AsIs: (/15 AsIs: e.Right#1/13 AsIs: )/16 AsIs: >/1 ]] }
    {refalrts::icUpdateFunc, 0, 0, 4},
...
refalrts::FnResult Type_T(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icEmpty, 0, 0, 2},
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  </0 & Type_T/4 {REMOVED TILE} 
    //RESULT: Tile{ [[ } Tile{ HalfReuse: '*'/1 ]] }
    {refalrts::icReinitChar, 0, '*', 1},
    {refalrts::icSetRes, 0, 0, 1},
    {refalrts::icTrashLeftEdge, 0, 0, 0},
...
static refalrts::FnResult Trim_R(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  >/1 {REMOVED TILE} 
    //RESULT: Tile{ [[ AsIs: </0 AsIs: & Trim_R/4 AsIs: e.Line#1/6(2) HalfReuse: >/5 } Tile{ ]] }
...
refalrts::FnResult Seq(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  {REMOVED TILE}  {REMOVED TILE}  {REMOVED TILE} 
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & CreateClosure /4 } & lambda_Seq_0/7 Tile{ AsIs: t.Func#1/5 } (/8 Tile{ AsIs: e.Funcs#1/10(2) } )/9 Tile{ AsIs: >/1 ]] }
    {refalrts::icAllocFunc, 0, 2, 7},
    {refalrts::icAllocBracket, 0, refalrts::ibOpenBracket, 8},
    ...
    //RESULT: Tile{ [[ } Tile{ HalfReuse: & lambda_Seq_1/1 ]] }
  ...
  //TRASH: {REMOVED TILE}  </0 & Seq/4 {REMOVED TILE} 
  //RESULT: Tile{ [[ } Tile{ HalfReuse: & lambda_Seq_1/1 ]] }
  refalrts::reinit_name( context[1], lambda_Seq_1, "lambda_Seq_1" );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
  refalrts::Iter res = context[1];
  refalrts::use( res );
...
static refalrts::FnResult lambda_Sort_0(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    //FAST GEN:(E )(E )(E )T S 
    //GLOBAL GEN:(E )(E )(E )T S 
    // </0 & lambda_Sort_0/4 (/7 e.idxB#0/5 )/8 (/11 e.idxTB#0/9 )/12 (/15 e.idxTTB#0/13 )/16 t.idxTTT#0/17 s.idxTTTV#0/19 >/1
    {refalrts::icInitB0_Lite, 0, 0, 0},
    {refalrts::icCallSaveLeft, 0, 2, 0},
    {refalrts::icBracketLeftSave, 0, 5, 2},
    {refalrts::icBracketLeftSave, 0, 9, 2},
    ...
    {refalrts::icOnFailGoTo, +15, 0, 0},
    //(E )(E )(E )T '<'
    // </0 & lambda_Sort_0/4 (/7 e.Less#2/5 )/8 (/11 e.Equal#2/9 )/12 (/15 e.Greater#2/13 )/16 t.Next#2/17 '<'/19 >/1
    {refalrts::icCharTerm, 0, static_cast<unsigned char>('<'), 19},
    // closed e.Less#2 as range 5
    // closed e.Equal#2 as range 9
    // closed e.Greater#2 as range 13
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  (/7 {REMOVED TILE}  {REMOVED TILE}  {REMOVED TILE}  '<'/19 {REMOVED TILE} 
    //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: (/4 } Tile{ AsIs: e.Less#2/5 } Tile{ AsIs: t.Next#2/17 } Tile{ AsIs: )/8 AsIs: (/11 AsIs: e.Equal#2/9 AsIs: )/12 AsIs: (/15 AsIs: e.Greater#2/13 AsIs: )/16 } Tile{ HalfReuse: )/1 ]] }
    ...
    // closed e.Greater#2 as range 13
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  </0 {REMOVED TILE}  {REMOVED TILE}  {REMOVED TILE}  {REMOVED TILE}  '='/19 {REMOVED TILE} 
    //RESULT: Tile{ [[ } Tile{ HalfReuse: (/4 AsIs: (/7 AsIs: e.Less#2/5 AsIs: )/8 AsIs: (/11 } Tile{ AsIs: e.Equal#2/9 } Tile{ AsIs: t.Next#2/17 } Tile{ AsIs: )/12 AsIs: (/15 AsIs: e.Greater#2/13 AsIs: )/16 } Tile{ HalfReuse: )/1 ]] }
    {refalrts::icReinitBracket, 0, refalrts::ibOpenBracket, 4},
    {refalrts::icReinitBracket, 0, refalrts::ibCloseBracket, 1},
    ...
    //RESULT: Tile{ [[ } Tile{ HalfReuse: (/4 AsIs: (/7 AsIs: e.Less#2/5 AsIs: )/8 AsIs: (/11 AsIs: e.Equal#2/9 AsIs: )/12 AsIs: (/15 } Tile{ AsIs: e.Greater#2/13 } Tile{ AsIs: t.Next#2/17 HalfReuse: )/19 HalfReuse: )/1 ]] }
    {refalrts::icReinitBracket, 0, refalrts::ibOpenBracket, 4},
...
static refalrts::FnResult lambda_Sort_1(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  {REMOVED TILE}  {REMOVED TILE}  {REMOVED TILE}  {REMOVED TILE}  {REMOVED TILE} 
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Fetch/4 } </25 & Compare/26 t.Next#2/23/27 Tile{ AsIs: t.Pivot#1/5 } >/29 Tile{ HalfReuse: </10 } & CreateClosure /30 Tile{ HalfReuse: & lambda_Sort_0/9 AsIs: (/13 AsIs: e.Less#2/11 AsIs: )/14 AsIs: (/17 AsIs: e.Equal#2/15 AsIs: )/18 AsIs: (/21 AsIs: e.Greater#2/19 AsIs: )/22 } Tile{ AsIs: t.Next#2/23 AsIs: >/1 } >/31 Tile{ ]] }
    {refalrts::icAllocBracket, 0, refalrts::ibOpenCall, 25},
    {refalrts::icAllocFunc, 0, 3, 26},
    {refalrts::icCopyEVar, 27, 23, 0},
...
static refalrts::FnResult lambda_Min_0(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    //FAST GEN:T T S 
    //GLOBAL GEN:T T S 
    // </0 & lambda_Min_0/4 t.idx#0/5 t.idxV#0/7 s.idxVV#0/9 >/1
    {refalrts::icInitB0_Lite, 0, 0, 0},
    {refalrts::icCallSaveLeft, 0, 2, 0},
    {refalrts::ictVarLeftSave, 0, 5, 2},
    {refalrts::ictVarLeftSave, 0, 7, 2},
    ...
    {refalrts::icOnFailGoTo, +6, 0, 0},
    //T T '<'
    // </0 & lambda_Min_0/4 t.Y#1/5 t.X#1/7 '<'/9 >/1
    {refalrts::icCharTerm, 0, static_cast<unsigned char>('<'), 9},
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  </0 & lambda_Min_0/4 t.Y#1/5 {REMOVED TILE}  '<'/9 >/1 {REMOVED TILE} 
    //RESULT: Tile{ [[ } Tile{ AsIs: t.X#1/7 } Tile{ ]] }
    {refalrts::icSetResRightEdge, 0, 0, 0},
    {refalrts::icSpliceTile, 7, 8, 0},
    {refalrts::icTrashLeftEdge, 0, 0, 0},
    {refalrts::icReturnResult_NoTrash, 0, 0, 0},
    //T T S 
    // </0 & lambda_Min_0/4 t.Y#1/5 t.X#1/7 s.Other#2/9 >/1
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  </0 & lambda_Min_0/4 {REMOVED TILE}  t.X#1/7 s.Other#2/9 >/1 {REMOVED TILE} 
    //RESULT: Tile{ [[ } Tile{ AsIs: t.Y#1/5 } Tile{ ]] }
    {refalrts::icSetResRightEdge, 0, 0, 0},
    {refalrts::icSpliceTile, 5, 6, 0},
    {refalrts::icTrashLeftEdge, 0, 0, 0},
    {refalrts::icReturnResult_NoTrash, 0, 0, 0},
...
refalrts::FnResult Min(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  {REMOVED TILE}  {REMOVED TILE} 
    //RESULT: Tile{ [[ } </9 & Fetch/10 Tile{ AsIs: </0 Reuse: & Compare/4 AsIs: t.X#1/5 AsIs: t.Y#1/7 AsIs: >/1 } </11 & CreateClosure /12 & lambda_Min_0/13 t.Y#1/7/14 t.X#1/5/16 >/18 >/19 Tile{ ]] }
    {refalrts::icAllocBracket, 0, refalrts::ibOpenCall, 9},
    {refalrts::icAllocFunc, 0, 4, 10},
    {refalrts::icAllocBracket, 0, refalrts::ibOpenCall, 11},
    {refalrts::icAllocFunc, 0, 3, 12},
    {refalrts::icAllocFunc, 0, 2, 13},
    {refalrts::icCopyEVar, 14, 7, 0},
  ...
  do {
    ...
    if( ! refalrts::alloc_name( context[12], refalrts::create_closure, "refalrts::create_closure" ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[13], lambda_Min_0, "lambda_Min_0" ) )
      return refalrts::cNoMemory;
...
static refalrts::FnResult lambda_Max_0(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    //FAST GEN:T T S 
    //GLOBAL GEN:T T S 
    // </0 & lambda_Max_0/4 t.idx#0/5 t.idxV#0/7 s.idxVV#0/9 >/1
    {refalrts::icInitB0_Lite, 0, 0, 0},
    {refalrts::icCallSaveLeft, 0, 2, 0},
    {refalrts::ictVarLeftSave, 0, 5, 2},
    {refalrts::ictVarLeftSave, 0, 7, 2},
    ...
    {refalrts::icOnFailGoTo, +6, 0, 0},
    //T T '>'
    // </0 & lambda_Max_0/4 t.Y#1/5 t.X#1/7 '>'/9 >/1
    {refalrts::icCharTerm, 0, static_cast<unsigned char>('>'), 9},
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  </0 & lambda_Max_0/4 t.Y#1/5 {REMOVED TILE}  '>'/9 >/1 {REMOVED TILE} 
    //RESULT: Tile{ [[ } Tile{ AsIs: t.X#1/7 } Tile{ ]] }
    {refalrts::icSetResRightEdge, 0, 0, 0},
    {refalrts::icSpliceTile, 7, 8, 0},
    {refalrts::icTrashLeftEdge, 0, 0, 0},
    {refalrts::icReturnResult_NoTrash, 0, 0, 0},
    //T T S 
    // </0 & lambda_Max_0/4 t.Y#1/5 t.X#1/7 s.Other#2/9 >/1
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  </0 & lambda_Max_0/4 {REMOVED TILE}  t.X#1/7 s.Other#2/9 >/1 {REMOVED TILE} 
    //RESULT: Tile{ [[ } Tile{ AsIs: t.Y#1/5 } Tile{ ]] }
    {refalrts::icSetResRightEdge, 0, 0, 0},
    {refalrts::icSpliceTile, 5, 6, 0},
    {refalrts::icTrashLeftEdge, 0, 0, 0},
...
refalrts::FnResult Max(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icEmptyResult, 0, 0, 0},
    //TRASH: {REMOVED TILE}  {REMOVED TILE}  {REMOVED TILE} 
    //RESULT: Tile{ [[ } </9 & Fetch/10 Tile{ AsIs: </0 Reuse: & Compare/4 AsIs: t.X#1/5 AsIs: t.Y#1/7 AsIs: >/1 } </11 & CreateClosure /12 & lambda_Max_0/13 t.Y#1/7/14 t.X#1/5/16 >/18 >/19 Tile{ ]] }
    {refalrts::icAllocBracket, 0, refalrts::ibOpenCall, 9},
    {refalrts::icAllocFunc, 0, 4, 10},
    {refalrts::icAllocBracket, 0, refalrts::ibOpenCall, 11},
    {refalrts::icAllocFunc, 0, 3, 12},
  ...
  do {
    ...
    if( ! refalrts::alloc_name( context[12], refalrts::create_closure, "refalrts::create_closure" ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[13], lambda_Max_0, "lambda_Max_0" ) )
      return refalrts::cNoMemory;
    if (! refalrts::copy_evar(context[14], context[15], context[7], context[8]))
      return refalrts::cNoMemory;
    if (! refalrts::copy_evar(context[16], context[17], context[5], context[6]))
