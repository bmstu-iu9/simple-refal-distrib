...
static refalrts::FnResult lambda_GenPattern_0(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  if( ! refalrts::alloc_open_call( context[11] ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_name( context[12], SaveBrackets, "SaveBrackets" ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_close_call( context[13] ) )
    return refalrts::cNoMemory;
  refalrts::push_stack( context[13] );
...
static refalrts::FnResult SaveBrackets(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    {refalrts::icInitB0, 0, 0, 0},
    // s.LastBracket#1/2 e.Commands#1/0
    {refalrts::icsVarLeft, 0, 2, 0},
    // closed e.Commands#1 as range 0
    //0: e.Commands#1
    //2: s.LastBracket#1
  ...
  if( ! refalrts::alloc_open_call( context[3] ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_name( context[4], DoSaveBrackets, "DoSaveBrackets" ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_open_bracket( context[5] ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_close_bracket( context[6] ) )
...
static refalrts::FnResult lambda_DoSaveBrackets_0(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    {refalrts::icInitB0, 0, 0, 0},
    // s.LastBracket#1/2 ( e.Commands_E#1/3 ) e.CommandsBeforeEMatch#2/0
    {refalrts::icsVarLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 3, 0},
  ...
  if( ! refalrts::alloc_open_call( context[5] ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_name( context[6], DoSaveBrackets_MakeSavers, "DoSaveBrackets_MakeSavers" ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_open_bracket( context[7] ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_open_call( context[8] ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_name( context[9], ExtractBrackets, "ExtractBrackets" ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_close_call( context[10] ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_close_bracket( context[11] ) )
...
static refalrts::FnResult DoSaveBrackets(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icInitB0, 0, 0, 0},
    // s.LastBracket#1/2 ( e.Scanned#1/3 ) e.Commands_B#1/5 ( # CmdOpenedE # AlgLeft s.Num#1/9 s.ContextOffset#1/10 ) e.Commands_E#1/11
    {refalrts::icsVarLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 3, 0},
    ...
    {refalrts::icReturnResult, 0, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // s.LastBracket#1/2 ( e.Scanned#1/3 ) e.Commands#1/0
    {refalrts::icsVarLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 3, 0},
    // closed e.Scanned#1 as range 3
    // closed e.Commands#1 as range 0
  ...
  do {
    ...
    do {
      ...
      if( ! refalrts::alloc_name( context[20], refalrts::create_closure, "refalrts::create_closure" ) )
        return refalrts::cNoMemory;
      if( ! refalrts::alloc_name( context[21], lambda_DoSaveBrackets_0, "lambda_DoSaveBrackets_0" ) )
        return refalrts::cNoMemory;
      if( ! refalrts::alloc_open_bracket( context[22] ) )
        return refalrts::cNoMemory;
      if( ! refalrts::alloc_close_bracket( context[23] ) )
...
static refalrts::FnResult lambda_DoSaveBrackets_MakeSavers_0(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icInitB0, 0, 0, 0},
    // s.Num#1/4 s.LastBracket#1/5 ( s.Command#2/6 s.Direction#2/7 s.Num#1/8 e.Info#2/2 )
    {refalrts::icBracketRight, 0, 2, 0},
    {refalrts::icsVarLeft, 0, 4, 0},
    ...
    {refalrts::icReturnResult, 0, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // s.Num#1/4 s.LastBracket#1/5 ( s.Command#2/6 s.Direction#2/7 s.OtherNum#2/8 e.Info#2/2 )
    {refalrts::icBracketRight, 0, 2, 0},
    {refalrts::icsVarLeft, 0, 4, 0},
    {refalrts::icsVarLeft, 0, 5, 0},
    {refalrts::icEmpty, 0, 0, 0},
...
static refalrts::FnResult DoSaveBrackets_MakeSavers(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icInitB0, 0, 0, 0},
    // s.LastBracket#1/2 ( e.BoundedBrackets_B#1/7 s.Num#1/9 e.BoundedBrackets_E#1/19 ) ( e.Scanned#1/5 ) e.Commands_B#1/10 ( s.Command#1/14 s.Direction#1/15 s.Num#1/16 e.Args#1/12 ) e.Commands_E#1/21
    {refalrts::icsVarLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 3, 0},
    {refalrts::icBracketLeft, 0, 5, 0},
    ...
    // closed e.BoundedBrackets_E#1 as range 3
    ...
    {refalrts::icReturnResult, 0, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // s.LastBracket#1/2 ( e.UnusedBoundedBrackets#1/3 ) ( e.Scanned#1/5 ) e.Commands#1/0
    {refalrts::icsVarLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 3, 0},
    {refalrts::icBracketLeft, 0, 5, 0},
    // closed e.UnusedBoundedBrackets#1 as range 3
    // closed e.Scanned#1 as range 5
    // closed e.Commands#1 as range 0
    //0: e.Commands#1
    //2: s.LastBracket#1
    //3: e.UnusedBoundedBrackets#1
    //5: e.Scanned#1
    {refalrts::icEmptyResult, 0, 0, 0},
    {refalrts::icBracket, 0, refalrts::ibOpenCall, 7},
    {refalrts::icFunc, 0, 0, 8},
    ...
    do {
      ...
      do {
        ...
        if( ! refalrts::alloc_open_call( context[23] ) )
          return refalrts::cNoMemory;
        if( ! refalrts::alloc_name( context[24], DoSaveBrackets_MakeSavers, "DoSaveBrackets_MakeSavers" ) )
          return refalrts::cNoMemory;
        ...
        if( ! refalrts::alloc_name( context[39], refalrts::create_closure, "refalrts::create_closure" ) )
          return refalrts::cNoMemory;
        if( ! refalrts::alloc_name( context[40], lambda_DoSaveBrackets_MakeSavers_0, "lambda_DoSaveBrackets_MakeSavers_0" ) )
          return refalrts::cNoMemory;
  ...
  if( ! refalrts::alloc_open_call( context[7] ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_name( context[8], DoSaveBrackets, "DoSaveBrackets" ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_open_bracket( context[9] ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_close_bracket( context[10] ) )
  ...
  do {
    ...
    do {
      ...
      do {
        ...
        if( ! refalrts::alloc_open_call( context[12] ) )
          return refalrts::cNoMemory;
        if( ! refalrts::alloc_name( context[13], Brackets_Set, "Brackets_Set" ) )
          return refalrts::cNoMemory;
        if( ! refalrts::alloc_close_call( context[14] ) )
          return refalrts::cNoMemory;
        refalrts::push_stack( context[14] );
