...
#define cookie_ns cookie_ns_1699510235_4214347273
#define COOKIE1_ 1699510235U
#define COOKIE2_ 4214347273U
...
enum efunc {
  ...
  efunc_Mod = 16,
  efunc_Div = 17,
  efunc_TermCompare = 18,
  efunc_Ord = 19,
  efunc_gen_EscapeChar_S7B1 = 20,
  efunc_gen_Map_Z1 = 21,
  efunc_Mul = 22,
  efunc_gen_Reduce_Z1 = 23,
  efunc_gen_Map_Z2 = 24,
  efunc_Chr = 25,
  efunc_gen_DigitFromChar_B1 = 26,
  efunc_DoUnEscapeStringm_SR = 27,
  efunc_HexDigits = 28,
  efunc_DoUnEscapeStringm_SRm_Hex = 29,
  efunc_DecDigits = 30,
  efunc_DoUnEscapeStringm_SRm_DecOct = 31,
  efunc_OctDigits = 32,
  efunc_DoUnEscapeStringm_SRm_Escape = 33,
  efunc_Prefix3 = 34,
  efunc_CharFromNum = 35,
  efunc_SingularEscape = 36,
  efunc_gen_DoUnEscapeStringm_SRm_Escape_S2B1 = 37,
  efunc_Mu = 38,
  efunc_Up = 39,
  efunc_Evm_met = 40,
  efunc_Residue = 41,
  ...
  efunc_DigitFromChar = 50,
  efunc_UnEscapeStringm_SR = 51,
  efunc_gen_EscapeChar_D7 = 52,
  efunc_gen_Map_Z0 = 53,
  efunc_gen_Reduce_S1A1Z1 = 54,
  efunc_gen_CharFromNum_L1D1 = 55,
  efunc_gen_CharFromNum_L1 = 56,
  efunc_gen_Reduce_Z0 = 57,
  efunc_gen_Reduce_S1A1Z0 = 58,
};
...
enum ident {
  ...
  ident_DecDigits = 29,
  ident_HexDigits = 30,
  ident_DoUnEscapeStringm_SR = 31,
  ident_DoUnEscapeStringm_SRm_Hex = 32,
  ident_Prefix3 = 33,
  ident_DoUnEscapeStringm_SRm_DecOct = 34,
  ident_DoUnEscapeStringm_SRm_Escape = 35,
  ident_SingularEscape = 36,
};
...
static refalrts::FnResult func_gen_Reduce_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Reduce@0/4 } [*]/8 & CharFromNum\1/9 Tile{ AsIs: s.Base#1/5 } {*}/10 Tile{ AsIs: t.accum#0/6 AsIs: e.items#0/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Reduce_S1A1Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Reduce$1=1@0/4 } [*]/10 & CharFromNum\1/11 Tile{ AsIs: s.Base#1/5 } {*}/12 Tile{ AsIs: (/8 AsIs: e.Tail0#1/6 AsIs: )/9 AsIs: e.dyn#0/2 AsIs: >/1 ]] }
  refalrts::alloc_closure_head(vm, context[10]);
  refalrts::alloc_name(vm, context[11], functions[efunc_gen_CharFromNum_L1]);
