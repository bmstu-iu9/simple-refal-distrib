...
#define cookie_ns cookie_ns_750565453_1402327548
#define COOKIE1_ 750565453U
#define COOKIE2_ 1402327548U
...
enum efunc {
  ...
  efunc_MakeSavers = 24,
  efunc_Inc2 = 25,
  efunc_gen_DoGenSubst_S36A3 = 26,
  efunc_IncVarOffsetm_Saved = 27,
  efunc_MakeRepeatedSave = 28,
  efunc_PrintVar = 29,
...
static refalrts::FnResult func_gen_u_u_Mum_Aux_S13B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::alloc_number(vm, context[9], 1402327548UL);
    refalrts::update_name(context[4], functions[efunc_u_u_FindMuPtr]);
    refalrts::reinit_number(context[5], 750565453UL);
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
  ...
  refalrts::update_name(context[4], functions[efunc_u_u_FindMuPtr]);
  refalrts::reinit_number(context[5], 750565453UL);
  refalrts::reinit_number(context[7], 1402327548UL);
  refalrts::push_stack( vm, context[1] );
  refalrts::push_stack( vm, context[0] );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
