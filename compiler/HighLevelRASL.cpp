...
enum efunc {
  ...
  efunc_gen_HighLevelRASL_L1S1L1L1 = 17,
  efunc_gen_HighLevelRASL_L1S1L1 = 18,
  efunc_Map = 19,
  efunc_gen_HighLevelRASL_L1 = 20,
  efunc_HighLevelRASLm_Function = 21,
  efunc_GenResultFuncs = 22,
  efunc_GenSentenceFunc = 23,
  efunc_HighLevelRASL = 24,
  efunc_HighLevelRASLm_Functionm_Disjoint = 25,
  efunc_HighLevelRASLm_Functionm_Conjoint = 26,
  efunc_GenSubstm_Simple = 27,
  efunc_GenResultm_Simple = 28,
  efunc_GenSubstm_Save = 29,
  efunc_GenResultm_Opt = 30,
};
    ...
    do {
      ...
      do {
        ...
        if( ! refalrts::alloc_name( vm, context[23], functions[efunc_Map] ) )
          return refalrts::cNoMemory;
        if( ! refalrts::alloc_name( vm, context[24], functions[efunc_HighLevelRASLm_Function] ) )
          return refalrts::cNoMemory;
        if( ! refalrts::alloc_close_call( vm, context[25] ) )
          return refalrts::cNoMemory;
        if( ! refalrts::alloc_open_call( vm, context[26] ) )
          return refalrts::cNoMemory;
        if( ! refalrts::alloc_name( vm, context[27], functions[efunc_GenResultFuncs] ) )
          return refalrts::cNoMemory;
