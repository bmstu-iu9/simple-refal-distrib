...
static refalrts::FnResult func_gen_OptTree_A5(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & OptTree=5/4 s.OptAutoMarkup/5 s.OptDrive/6 s.OptSpec/7 s.Cycles/8 (/11 e.AST/9 )/12 s.OptIntrinsic/13 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int=2/4 } </14 & Int-Code/15 (/16 (/17 # define/18 # main/19 (/20 # if/21 Tile{ AsIs: s.OptAutoMarkup/5 } (/22 # begin/23 (/24 # pass/25 (/26 # trace/27"before Auto markup"/28 )/30 (/31 # call/32 & OptTree-AutoMarkup-Spec/33 )/34 (/35 # call/36 & OptTree-AutoMarkup-Drive/37 )/38 )/39 (/40 # DriveSpecLoop/41 )/42 (/43 # pass/44 (/45 # trace/46"before Driving non-recursive instances"/47 )/49 (/50 # call/51 & OptTree-AutoMarkup-Drive/52 )/53 )/54 (/55 # call/56 & OptTree-Drive-Prepare/57 (/58 Tile{ AsIs: s.OptDrive/6 } s.OptIntrinsic/13/59 )/60 )/61 (/62 # DriveLoop/63 )/64 )/65 (/66 # begin/67 (/68 # when/69 (/70 # or/71 s.OptDrive/6/72 Tile{ AsIs: s.OptIntrinsic/13 } )/73 (/74 # trace/75"before Curing drives"/76 )/78 (/79 # call/80 & OptTree-AutoMarkup-CureDrives/81 )/82 )/83 (/84 # DriveSpecLoop/85 )/86 )/87 )/88 (/89 # trace/90"before Cleanup unused functions"/91 )/93 (/94 # call/95 & OptTree-AutoMarkup-CleanupUnusedFunctions/96 )/97 (/98 # call/99 & OptTree-CleanupMarkup/100 )/101 )/102 (/103 # define/104 # DriveSpecLoop/105 (/106 # if/107 Tile{ AsIs: s.OptSpec/7 } (/108 # begin/109 (/110 # call/111 & OptTree-Drive-Prepare/112 (/113 s.OptDrive/6/114 s.OptIntrinsic/13/115 )/116 )/117 (/118 # call/119 & OptTree-Spec-Prepare/120 s.OptSpec/7/121 )/122 (/123 # loop-for-warm-functions/124 (/125 # DriveLoop/126 )/127 (/128 # pass/129 (/130 # trace/131"before Spec"/132 )/134 (/135 # call/136 & OptTree-Spec/137 s.OptSpec/7/138 )/139 )/140 )/141 (/142 # call/143 & WarmColdFunctions/144 # SPEC/145 )/146 )/147 (/148 # begin/149 (/150 # call/151 & OptTree-Drive-Prepare/152 (/153 s.OptDrive/6/154 s.OptIntrinsic/13/155 )/156 )/157 (/158 # DriveLoop/159 )/160 )/161 )/162 )/163 (/164 # define/165 # DriveLoop/166 (/167 # if/168 (/169 # or/170 s.OptDrive/6/171 s.OptIntrinsic/13/172 )/173 (/174 # begin/175 (/176 # loop-for-warm-functions/177 (/178 # pass/179 (/180 # trace/181"before Drive"/182 )/184 (/185 # call/186 & ExpandClosures/187 )/188 (/189 # call/190 & OptTree-Drive/191 (/192 s.OptDrive/6/193 s.OptIntrinsic/13/194 )/195 )/196 )/197 )/198 (/199 # call/200 & WarmColdFunctions/201 # DRIVE/202 )/203 (/204 # call/205 & OptTree-Drive-CleanupColdCalls/206 )/207 )/208 (/209 # call/210 & ExpandClosures/211 )/212 )/213 )/214 )/215 (/216 # main/217 )/218 Tile{ AsIs: s.Cycles/8 AsIs: (/11 AsIs: e.AST/9 AsIs: )/12 } >/219 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[14]);
...
static refalrts::FnResult func_gen_OptTree_A4(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & OptTree=4/4 s.OptDrive/5 s.OptSpec/6 s.Cycles/7 (/10 e.AST/8 )/11 t.Config/12 s.OptAutoMarkup/14 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  //DEBUG: e.AST: 8
  //DEBUG: t.Config: 12
  //DEBUG: s.OptAutoMarkup: 14

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.OptAutoMarkup/14 {REMOVED TILE}
  //RESULT: Tile{ [[ } </15 Tile{ HalfReuse: & OptTree=5/0 HalfReuse: s.OptAutoMarkup14 /4 AsIs: s.OptDrive/5 AsIs: s.OptSpec/6 AsIs: s.Cycles/7 AsIs: (/10 AsIs: e.AST/8 AsIs: )/11 } </16 & Config-GetOptIntrinsic/17 Tile{ AsIs: t.Config/12 } >/18 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[15]);
...
static refalrts::FnResult func_gen_OptTree_A3(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[19];
  refalrts::zeros( context, 19 );
  // </0 & OptTree=3/4 s.OptDrive/5 s.Cycles/6 (/9 e.AST/7 )/10 t.Config/11 s.OptSpec/13 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & OptTree=4/4 AsIs: s.OptDrive/5 } Tile{ AsIs: s.OptSpec/13 } Tile{ AsIs: s.Cycles/6 AsIs: (/9 AsIs: e.AST/7 AsIs: )/10 AsIs: t.Config/11 } </14 & Config-GetOptAutoMarkup/15 t.Config/11/16 >/18 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[14]);
...
static refalrts::FnResult func_gen_OptTree_A2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[19];
  refalrts::zeros( context, 19 );
  // </0 & OptTree=2/4 s.Cycles/5 (/8 e.AST/6 )/9 t.Config/10 s.OptDrive/12 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} s.OptDrive/12 {REMOVED TILE}
  //RESULT: Tile{ [[ } </13 Tile{ HalfReuse: & OptTree=3/0 HalfReuse: s.OptDrive12 /4 AsIs: s.Cycles/5 AsIs: (/8 AsIs: e.AST/6 AsIs: )/9 AsIs: t.Config/10 } </14 & Config-GetOptSpec/15 t.Config/10/16 >/18 Tile{ AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[13]);
  refalrts::alloc_open_call(vm, context[14]);
...
static refalrts::FnResult func_gen_OptTree_A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & OptTree=1/4 (/7 e.AST/5 )/8 t.Config/9 s.Cycles/11 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} s.Cycles/11 {REMOVED TILE}
  //RESULT: Tile{ [[ } </12 Tile{ HalfReuse: & OptTree=2/0 HalfReuse: s.Cycles11 /4 AsIs: (/7 AsIs: e.AST/5 AsIs: )/8 AsIs: t.Config/9 } </13 & Config-GetOptDrive/14 t.Config/9/15 >/17 Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_OptTree(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & OptTree/4 t.Config/5 e.AST/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & OptTree=1/4 } (/7 Tile{ AsIs: e.AST/2 } )/8 Tile{ AsIs: t.Config/5 } </9 & Config-GetTreeOptCycles/10 t.Config/5/11 >/13 Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_OptTreem_CleanupMarkup(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[5];
  refalrts::zeros( context, 5 );
  // </0 & OptTree-CleanupMarkup/4 e.AST/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
...
static refalrts::FnResult func_WarmColdFunctions(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[6];
  refalrts::zeros( context, 6 );
  // </0 & WarmColdFunctions/4 s.ColdBy/5 e.AST/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@2/4 AsIs: s.ColdBy/5 AsIs: e.AST/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_ExpandClosures(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@4/4 AsIs: e.AST/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_ExpandClosuresm_Body(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[5];
  refalrts::zeros( context, 5 );
  // </0 & ExpandClosures-Body/4 e.Sentences/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@3/4 AsIs: e.Sentences/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_ExpandClosuresm_Sentence(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[20];
  refalrts::zeros( context, 20 );
  // </0 & ExpandClosures-Sentence/4 (/7 (/11 e.Pattern/9 )/12 e.Conditions/5 (/15 e.Result/13 )/16 )/8 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: (/11 AsIs: e.Pattern/9 AsIs: )/12 } Tile{ AsIs: </0 Reuse: & Map@6/4 } Tile{ AsIs: e.Conditions/5 } >/17 (/18 </19 Tile{ HalfReuse: & Map@5/15 AsIs: e.Result/13 HalfReuse: >/16 AsIs: )/8 HalfReuse: )/1 ]] }
  refalrts::alloc_close_call(vm, context[17]);
...
static refalrts::FnResult func_ExpandClosuresm_Result(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[5];
  refalrts::zeros( context, 5 );
  // </0 & ExpandClosures-Result/4 e.Result/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@5/4 AsIs: e.Result/2 AsIs: >/1 ]] }
...
static refalrts::FnResult func_ExpandClosuresm_ResultTerm(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & ExpandClosures-ResultTerm/4 e.new/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & ExpandClosures-ResultTerm/4 t.new1/5 >/1
  context[6] = refalrts::tvar_left( context[5], context[2], context[3] );
  if( ! context[6] )
    return refalrts::cRecognitionImpossible;
  if( ! refalrts::empty_seq( context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  do {
    // </0 & ExpandClosures-ResultTerm/4 (/5 s.new2/9 e.new3/7 )/6 >/1
    context[7] = 0;
    context[8] = 0;
    if( ! refalrts::brackets_term( context[7], context[8], context[5] ) )
      continue;
    ...
    do {
      // </0 & ExpandClosures-ResultTerm/4 (/5 # Brackets/9 e.Expr/10 )/6 >/1
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE}
      //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # Brackets/4 HalfReuse: </5 HalfReuse: & Map@5/9 AsIs: e.Expr/10 HalfReuse: >/6 HalfReuse: )/1 ]] }
    ...
    do {
      // </0 & ExpandClosures-ResultTerm/4 (/5 s.new4/9 (/14 e.new5/12 )/15 e.new6/10 )/6 >/1
      context[10] = context[7];
      context[11] = context[8];
      context[12] = 0;
      context[13] = 0;
      ...
      do {
        // </0 & ExpandClosures-ResultTerm/4 (/5 # ADT-Brackets/9 (/14 e.Name/16 )/15 e.Expr/18 )/6 >/1
        ...
        // closed e.Expr as range 18
        //DEBUG: e.Name: 16
        //DEBUG: e.Expr: 18

        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ } Tile{ AsIs: (/5 AsIs: # ADT-Brackets/9 AsIs: (/14 AsIs: e.Name/16 AsIs: )/15 } Tile{ AsIs: </0 Reuse: & Map@5/4 } Tile{ AsIs: e.Expr/18 } Tile{ HalfReuse: >/6 HalfReuse: )/1 ]] }
        refalrts::update_name(context[4], functions[efunc_gen_Map_Z5]);
        refalrts::reinit_close_call(context[6]);
        refalrts::reinit_close_bracket(context[1]);
      ...
      // </0 & ExpandClosures-ResultTerm/4 (/5 # CallBrackets/9 (/14 # ClosureBrackets/20 e.Content/16 )/15 e.Expr/18 )/6 >/1
      context[16] = context[12];
      context[17] = context[13];
      context[18] = context[10];
      context[19] = context[11];
      ...
      //RESULT: Tile{ [[ } Tile{ AsIs: (/5 AsIs: # CallBrackets/9 HalfReuse: </14 HalfReuse: & Map@5/20 } Tile{ AsIs: e.Content/16 } Tile{ AsIs: e.Expr/18 } Tile{ HalfReuse: >/6 HalfReuse: )/1 ]] }
    ...
    // </0 & ExpandClosures-ResultTerm/4 (/5 # CallBrackets/9 e.Expr/10 )/6 >/1
    context[10] = context[7];
    context[11] = context[8];
    if( ! refalrts::ident_term( identifiers[ident_CallBrackets], context[9] ) )
      continue;
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE}
    //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CallBrackets/4 HalfReuse: </5 HalfReuse: & Map@5/9 AsIs: e.Expr/10 HalfReuse: >/6 HalfReuse: )/1 ]] }
    refalrts::reinit_open_bracket(context[0]);
  ...
  // </0 & ExpandClosures-ResultTerm/4 t.OtherTerm/5 >/1
  //DEBUG: t.OtherTerm: 5
...
static refalrts::FnResult func_gen_Int_A2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[6];
  refalrts::zeros( context, 6 );
  // </0 & Int=2/4 s.Cycles$a/5 e.AST$a/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} </0 & Int=2/4 s.Cycles$a/5 {REMOVED TILE} >/1 {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ AsIs: e.AST$a/2 } Tile{ ]] }
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
  refalrts::Iter res = arg_end->next;
  res = refalrts::splice_evar( res, context[2], context[3] );
...
static refalrts::FnResult func_Int(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Int/4 e.new1/2 s.new2/9 (/7 e.new3/5 )/8 >/1
  context[5] = 0;
  context[6] = 0;
  ...
  do {
    // </0 & Int/4 (/16 # define/18 s.StartPoint/19 e.2/14 )/17 e./10 s.Cycles/9 (/7 e.AST/12 )/8 >/1
    ...
    //DEBUG: e.: 10
    //DEBUG: e.AST: 12
    //DEBUG: s.StartPoint: 19
    //DEBUG: e.2: 14

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } </20 & Int=2/21 </22 Tile{ HalfReuse: & Int-Code/0 HalfReuse: (/4 AsIs: (/16 AsIs: # define/18 AsIs: s.StartPoint/19 AsIs: e.2/14 AsIs: )/17 } Tile{ AsIs: e./10 } )/23 (/24 s.StartPoint/19/25 )/26 Tile{ AsIs: s.Cycles/9 AsIs: (/7 AsIs: e.AST/12 AsIs: )/8 AsIs: >/1 } >/27 Tile{ ]] }
  ...
  // </0 & Int/4 e.Defines/2 s.Cycles/9 (/7 e.AST/5 )/8 >/1
  // closed e.Defines as range 2
  // closed e.AST as range 5
  //DEBUG: s.Cycles: 9
  //DEBUG: e.Defines: 2
  //DEBUG: e.AST: 5
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int=1*1/4 } (/10 Tile{ AsIs: e.Defines/2 } )/11 Tile{ AsIs: s.Cycles/9 AsIs: (/7 AsIs: e.AST/5 AsIs: )/8 } e.Defines/2/12 Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Intm_Code_B1S1A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[14];
  refalrts::zeros( context, 14 );
  // </0 & Int-Code:1$1=1/4 (/7 e.Defines/5 )/8 (/11 e.Code$a/9 )/12 s.Cycles$a/13 e.AST$a/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  if( ! context[11] )
    return refalrts::cRecognitionImpossible;
  refalrts::bracket_pointers(context[11], context[12]);
  // closed e.Defines as range 5
  // closed e.Code$a as range 9
  if( ! refalrts::svar_left( context[13], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  // closed e.AST$a as range 2
  //DEBUG: e.Defines: 5
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Code/4 AsIs: (/7 AsIs: e.Defines/5 AsIs: )/8 } Tile{ AsIs: e.Code$a/9 } Tile{ AsIs: s.Cycles$a/13 } Tile{ AsIs: (/11 } Tile{ AsIs: e.AST$a/2 } Tile{ AsIs: )/12 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_Intm_Code(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Int-Code/4 (/7 e.new1/5 )/8 e.new2/2 s.new3/13 (/11 e.new4/9 )/12 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new2 as range 2
  do {
    // </0 & Int-Code/4 (/7 e.Defines/14 )/8 t./20 e./16 s.Cycles/13 (/11 e.AST/18 )/12 >/1
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Code:1$1=1/4 AsIs: (/7 AsIs: e.Defines/14 AsIs: )/8 } (/22 Tile{ AsIs: e./16 } )/23 </24 & Int-Command/25 (/26 e.Defines/14/27 )/29 Tile{ AsIs: t./20 } Tile{ AsIs: s.Cycles/13 AsIs: (/11 AsIs: e.AST/18 AsIs: )/12 AsIs: >/1 } >/30 Tile{ ]] }
    refalrts::alloc_open_bracket(vm, context[22]);
    refalrts::alloc_close_bracket(vm, context[23]);
  ...
  do {
    // </0 & Int-Code/4 (/7 e.Defines/14 )/8 s.Cycles/13 (/11 e.AST/16 )/12 >/1
    context[14] = context[5];
    context[15] = context[6];
    ...
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    // closed e.Defines as range 14
    // closed e.AST as range 16
    //DEBUG: s.Cycles: 13
    //DEBUG: e.Defines: 14
    //DEBUG: e.AST: 16

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} & Int-Code/4 (/7 e.Defines/14 )/8 s.Cycles/13 (/11 {REMOVED TILE} )/12 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ HalfReuse: s.Cycles13 /0 } Tile{ AsIs: e.AST/16 } Tile{ ]] }
  ...
  // </0 & Int-Code/4 (/7 e.Defines/5 )/8 e.Code/2 s.Cycles/13 (/11 e.AST/9 )/12 >/1
  // closed e.Defines as range 5
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Code:1*2/4 AsIs: (/7 AsIs: e.Defines/5 AsIs: )/8 } Tile{ AsIs: s.Cycles/13 AsIs: (/11 AsIs: e.AST/9 AsIs: )/12 } Tile{ AsIs: e.Code/2 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Intm_Command_B1S1B1S2A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[7];
  refalrts::zeros( context, 7 );
  // </0 & Int-Command:1$1:1$2=1/4 s.Cycles$a/5 e.AST$a/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Sub/4 AsIs: s.Cycles$a/5 } 1/6 Tile{ AsIs: >/1 } Tile{ AsIs: e.AST$a/2 } Tile{ ]] }
...
static refalrts::FnResult func_gen_Intm_Command_B1S2B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & Int-Command:1$2:1/4 e.new/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Int-Command:1$2:1/4 (/7 e.new1/5 )/8 t.new2/9 s.new3/11 (/14 e.new4/12 )/15 t.new5/16 s.new6/18 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  if( ! refalrts::empty_seq( context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  do {
    // </0 & Int-Command:1$2:1/4 (/7 e.Defines/19 )/8 t.Then/9 s.Cycles/11 (/14 e.AST/21 )/15 t.Else/16 # True/18 >/1
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} t.Else/16 # True/18 {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Command/4 AsIs: (/7 AsIs: e.Defines/19 AsIs: )/8 AsIs: t.Then/9 AsIs: s.Cycles/11 AsIs: (/14 AsIs: e.AST/21 AsIs: )/15 } Tile{ AsIs: >/1 ]] }
  ...
  // </0 & Int-Command:1$2:1/4 (/7 e.Defines/5 )/8 t.Then/9 s.Cycles/11 (/14 e.AST/12 )/15 t.Else/16 # False/18 >/1
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} t.Then/9 {REMOVED TILE} {REMOVED TILE} # False/18 {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Command/4 AsIs: (/7 AsIs: e.Defines/5 AsIs: )/8 } Tile{ AsIs: t.Else/16 } Tile{ AsIs: s.Cycles/11 AsIs: (/14 AsIs: e.AST/12 AsIs: )/15 } Tile{ AsIs: >/1 ]] }
  refalrts::update_name(context[4], functions[efunc_Intm_Command]);
  refalrts::push_stack( vm, context[1] );
  refalrts::push_stack( vm, context[0] );
  refalrts::link_brackets( context[14], context[15] );
...
static refalrts::FnResult func_gen_Intm_Command_B1S3B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & Int-Command:1$3:1/4 e.new/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Int-Command:1$3:1/4 (/7 e.new1/5 )/8 (/11 e.new2/9 )/12 s.new3/13 (/16 e.new4/14 )/17 s.new5/18 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  if( ! refalrts::empty_seq( context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  do {
    // </0 & Int-Command:1$3:1/4 (/7 e.Defines/19 )/8 (/11 e.Then/21 )/12 s.Cycles/13 (/16 e.AST/23 )/17 # True/18 >/1
    context[19] = context[5];
    context[20] = context[6];
    ...
    if( ! refalrts::ident_term( identifiers[ident_True], context[18] ) )
      continue;
    // closed e.Defines as range 19
    // closed e.Then as range 21
    // closed e.AST as range 23
    //DEBUG: s.Cycles: 13
    //DEBUG: e.Defines: 19
    //DEBUG: e.Then: 21
    //DEBUG: e.AST: 23
    ...
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Code/4 AsIs: (/7 AsIs: e.Defines/19 AsIs: )/8 } Tile{ AsIs: e.Then/21 } Tile{ AsIs: s.Cycles/13 AsIs: (/16 AsIs: e.AST/23 AsIs: )/17 HalfReuse: >/18 } Tile{ ]] }
    refalrts::update_name(context[4], functions[efunc_Intm_Code]);
  ...
  // </0 & Int-Command:1$3:1/4 (/7 e.Defines/5 )/8 (/11 e.Then/9 )/12 s.Cycles/13 (/16 e.AST/14 )/17 # False/18 >/1
  if( ! refalrts::ident_term( identifiers[ident_False], context[18] ) )
    return refalrts::cRecognitionImpossible;
  // closed e.Defines as range 5
  // closed e.Then as range 9
  // closed e.AST as range 14
  //DEBUG: s.Cycles: 13
  //DEBUG: e.Defines: 5
  //DEBUG: e.Then: 9
  //DEBUG: e.AST: 14
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} & Int-Command:1$3:1/4 (/7 e.Defines/5 )/8 (/11 e.Then/9 )/12 s.Cycles/13 (/16 {REMOVED TILE} )/17 # False/18 >/1 {REMOVED TILE}
  //RESULT: Tile{ [[ HalfReuse: s.Cycles13 /0 } Tile{ AsIs: e.AST/14 } Tile{ ]] }
  refalrts::reinit_svar( context[0], context[13] );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
  refalrts::Iter res = arg_end->next;
...
static refalrts::FnResult func_gen_Intm_Command_B1S6A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[6];
  refalrts::zeros( context, 6 );
  // </0 & Int-Command:1$6=1/4 s.Cycles/5 e.AST$a/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} & Int-Command:1$6=1/4 s.Cycles/5 {REMOVED TILE} >/1 {REMOVED TILE}
  //RESULT: Tile{ [[ HalfReuse: s.Cycles5 /0 } Tile{ AsIs: e.AST$a/2 } Tile{ ]] }
...
static refalrts::FnResult func_gen_Intm_Command_B1S8A1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[14];
  refalrts::zeros( context, 14 );
  // </0 & Int-Command:1$8=1/4 (/7 e.Defines/5 )/8 s.Cycles/9 (/12 e.AST/10 )/13 e.Code/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Code/4 AsIs: (/7 AsIs: e.Defines/5 AsIs: )/8 } Tile{ AsIs: e.Code/2 } Tile{ AsIs: s.Cycles/9 AsIs: (/12 AsIs: e.AST/10 AsIs: )/13 } Tile{ AsIs: >/1 ]] }
  refalrts::update_name(context[4], functions[efunc_Intm_Code]);
  refalrts::push_stack( vm, context[1] );
  refalrts::push_stack( vm, context[0] );
...
static refalrts::FnResult func_Intm_Command(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Int-Command/4 (/7 e.new1/5 )/8 (/11 e.new2/9 )/12 s.new3/17 (/15 e.new4/13 )/16 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  if( ! refalrts::empty_seq( context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  do {
    // </0 & Int-Command/4 (/7 e.new6/18 )/8 (/11 s.new7/24 e.new8/20 )/12 s.new5/17 (/15 e.new9/22 )/16 >/1
    ...
    do {
      // </0 & Int-Command/4 (/7 e.new11/25 )/8 (/11 # pass/24 e.new12/27 )/12 s.new10/17 (/15 e.new13/29 )/16 >/1
      ...
      do {
        // </0 & Int-Command/4 (/7 e.Defines/31 )/8 (/11 # pass/24 e./33 )/12 0/17 (/15 e.AST/35 )/16 >/1
        ...
        if( ! refalrts::number_term( 0UL, context[17] ) )
          continue;
        // closed e.Defines as range 31
        // closed e. as range 33
        // closed e.AST as range 35
        //DEBUG: e.Defines: 31
        //DEBUG: e.: 33
        //DEBUG: e.AST: 35

        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} & Int-Command/4 (/7 e.Defines/31 )/8 (/11 # pass/24 e./33 )/12 0/17 (/15 {REMOVED TILE} )/16 >/1 {REMOVED TILE}
        //RESULT: Tile{ [[ HalfReuse: 0/0 } Tile{ AsIs: e.AST/35 } Tile{ ]] }
      ...
      // </0 & Int-Command/4 (/7 e.Defines/31 )/8 (/11 # pass/24 e./33 )/12 s.Cycles/17 (/15 e.AST/35 )/16 >/1
      context[31] = context[25];
      context[32] = context[26];
      context[33] = context[27];
      context[34] = context[28];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ HalfReuse: </11 HalfReuse: & Int-Command:1$1:1$2=1/24 } Tile{ AsIs: </0 Reuse: & Int-Code/4 AsIs: (/7 AsIs: e.Defines/31 AsIs: )/8 } Tile{ AsIs: e./33 } Tile{ AsIs: s.Cycles/17 AsIs: (/15 AsIs: e.AST/35 AsIs: )/16 AsIs: >/1 } Tile{ HalfReuse: >/12 } Tile{ ]] }
    ...
    do {
      // </0 & Int-Command/4 (/7 e.new11/25 )/8 (/11 s.new12/24 t.new13/31 e.new14/27 )/12 s.new10/17 (/15 e.new15/29 )/16 >/1
      context[25] = context[18];
      context[26] = context[19];
      context[27] = context[20];
      context[28] = context[21];
      ...
      do {
        // </0 & Int-Command/4 (/7 e.Defines/33 )/8 (/11 # if/24 t.0/31 t.1/39 t.2/41 )/12 s.Cycles/17 (/15 e.AST/37 )/16 >/1
        ...
        if( ! refalrts::ident_term( identifiers[ident_if], context[24] ) )
          continue;
        // closed e.Defines as range 33
        // closed e.AST as range 37
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Command:1$2:1/4 AsIs: (/7 AsIs: e.Defines/33 AsIs: )/8 } Tile{ AsIs: t.1/39 } Tile{ AsIs: s.Cycles/17 AsIs: (/15 AsIs: e.AST/37 AsIs: )/16 } Tile{ AsIs: t.2/41 } Tile{ HalfReuse: </11 HalfReuse: & Int-Cond/24 AsIs: t.0/31 } Tile{ HalfReuse: >/12 } Tile{ AsIs: >/1 ]] }
      ...
      // </0 & Int-Command/4 (/7 e.Defines/33 )/8 (/11 # when/24 t.0/31 e.0/35 )/12 s.Cycles/17 (/15 e.AST/37 )/16 >/1
      context[33] = context[25];
      context[34] = context[26];
      context[35] = context[27];
      context[36] = context[28];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Command:1$3:1/4 AsIs: (/7 AsIs: e.Defines/33 AsIs: )/8 AsIs: (/11 } Tile{ AsIs: e.0/35 } Tile{ AsIs: )/12 AsIs: s.Cycles/17 AsIs: (/15 AsIs: e.AST/37 AsIs: )/16 HalfReuse: </1 } Tile{ HalfReuse: & Int-Cond/24 AsIs: t.0/31 } >/39 >/40 Tile{ ]] }
    ...
    do {
      // </0 & Int-Command/4 (/7 e.Defines/25 )/8 (/11 # begin/24 e./27 )/12 s.Cycles/17 (/15 e.AST/29 )/16 >/1
      context[25] = context[18];
      context[26] = context[19];
      context[27] = context[20];
      context[28] = context[21];
      ...
      if( ! refalrts::ident_term( identifiers[ident_begin], context[24] ) )
        continue;
      // closed e.Defines as range 25
      // closed e. as range 27
      // closed e.AST as range 29
      //DEBUG: s.Cycles: 17
      //DEBUG: e.Defines: 25
      //DEBUG: e.: 27
      //DEBUG: e.AST: 29
      ...
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Code/4 AsIs: (/7 AsIs: e.Defines/25 AsIs: )/8 } Tile{ AsIs: e./27 } Tile{ AsIs: s.Cycles/17 AsIs: (/15 AsIs: e.AST/29 AsIs: )/16 AsIs: >/1 ]] }
      refalrts::update_name(context[4], functions[efunc_Intm_Code]);
      refalrts::push_stack( vm, context[1] );
      refalrts::push_stack( vm, context[0] );
      refalrts::link_brackets( context[15], context[16] );
    ...
    do {
      // </0 & Int-Command/4 (/7 e.Defines/25 )/8 (/11 # call/24 s.Func/31 e.0/27 )/12 s.Cycles/17 (/15 e.AST/29 )/16 >/1
      context[25] = context[18];
      context[26] = context[19];
      context[27] = context[20];
      context[28] = context[21];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} e.Defines/25 )/8 (/11 # call/24 s.Func/31 {REMOVED TILE} )/12 s.Cycles/17 (/15 {REMOVED TILE} )/16 {REMOVED TILE}
      //RESULT: Tile{ [[ HalfReuse: s.Cycles17 /0 HalfReuse: </4 HalfReuse: s.Func31 /7 } Tile{ AsIs: e.0/27 } Tile{ AsIs: e.AST/29 } Tile{ AsIs: >/1 ]] }
    ...
    do {
      // </0 & Int-Command/4 (/7 e.Defines/25 )/8 (/11 # trace/24 e./27 )/12 s.Cycles/17 (/15 e.AST/29 )/16 >/1
      context[25] = context[18];
      context[26] = context[19];
      context[27] = context[20];
      context[28] = context[21];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} e.Defines/25 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Command:1$6=1/4 HalfReuse: s.Cycles17 /7 } </31 & Log-AST/32 (/33"Pass "/34 </36 & Symb/37 Tile{ AsIs: s.Cycles/17 } Tile{ HalfReuse: >/8 HalfReuse: ' '/11 HalfReuse: '('/24 AsIs: e./27 HalfReuse: ')'/12 } Tile{ HalfReuse: )/15 AsIs: e.AST/29 HalfReuse: >/16 AsIs: >/1 ]] }
    ...
    do {
      // </0 & Int-Command/4 (/7 e.Defines/25 )/8 (/11 # loop-for-warm-functions/24 e./27 )/12 s.Cycles/17 (/15 e.AST/29 )/16 >/1
      context[25] = context[18];
      context[26] = context[19];
      context[27] = context[20];
      context[28] = context[21];
      ...
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-LoopForWarmFunctions/4 AsIs: (/7 AsIs: e.Defines/25 AsIs: )/8 } Tile{ AsIs: e./27 } Tile{ AsIs: s.Cycles/17 AsIs: (/15 AsIs: e.AST/29 AsIs: )/16 AsIs: >/1 ]] }
    ...
    // </0 & Int-Command/4 (/7 e.Defines/25 )/8 (/11 s.Proc/24 )/12 s.Cycles/17 (/15 e.AST/27 )/16 >/1
    context[25] = context[18];
    context[26] = context[19];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.Cycles/17 {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Command:1$8=1/4 AsIs: (/7 AsIs: e.Defines/25 AsIs: )/8 HalfReuse: s.Cycles17 /11 } Tile{ AsIs: (/15 AsIs: e.AST/27 AsIs: )/16 HalfReuse: </1 } Tile{ HalfReuse: & Int-Lookup/12 } Tile{ AsIs: s.Proc/24 } e.Defines/25/29 >/31 >/32 Tile{ ]] }
  ...
  // </0 & Int-Command/4 (/7 e.Defines/5 )/8 (/11 e.Command/9 )/12 s.Cycles/17 (/15 e.AST/13 )/16 >/1
  // closed e.Defines as range 5
  // closed e.Command as range 9
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} s.Cycles/17 {REMOVED TILE} {REMOVED TILE} )/16 {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 } Tile{ HalfReuse: & Int-Command:1*8/1 } Tile{ AsIs: (/15 } Tile{ AsIs: e.AST/13 } Tile{ HalfReuse: )/4 AsIs: (/7 AsIs: e.Defines/5 AsIs: )/8 HalfReuse: s.Cycles17 /11 AsIs: e.Command/9 HalfReuse: >/12 } Tile{ ]] }
...
static refalrts::FnResult func_Intm_Cond(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  if( ! refalrts::empty_seq( context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  do {
    // </0 & Int-Cond/4 (/5 s.new2/9 e.new3/7 )/6 >/1
    context[7] = 0;
    context[8] = 0;
    if( ! refalrts::brackets_term( context[7], context[8], context[5] ) )
      continue;
    ...
    // closed e.new3 as range 7
    do {
      // </0 & Int-Cond/4 (/5 # or/9 e.Flags/10 )/6 >/1
      context[10] = context[7];
      context[11] = context[8];
      if( ! refalrts::ident_term( identifiers[ident_or], context[9] ) )
        continue;
      // closed e.Flags as range 10
      //DEBUG: e.Flags: 10

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} (/5 # or/9 {REMOVED TILE} )/6 {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Cond-Or/4 } Tile{ AsIs: e.Flags/10 } Tile{ AsIs: >/1 ]] }
    ...
    // </0 & Int-Cond/4 (/5 # and/9 e.Flags/10 )/6 >/1
    context[10] = context[7];
    context[11] = context[8];
    ...
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Cond-And/4 } Tile{ AsIs: e.Flags/10 } Tile{ AsIs: >/1 ]] }
  ...
  // </0 & Int-Cond/4 s.Opt/5 >/1
  //DEBUG: s.Opt: 5

  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} </0 & Int-Cond/4 s.Opt/5 {REMOVED TILE}
...
static refalrts::FnResult func_gen_Intm_Condm_Or_S1B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Int-Cond-Or$1:1/4 (/7 e.new1/5 )/8 s.new2/9 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  if( ! refalrts::empty_seq( context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  do {
    // </0 & Int-Cond-Or$1:1/4 (/7 e.Flags/10 )/8 # True/9 >/1
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Int-Cond-Or$1:1/4 (/7 e.Flags/10 )/8 # True/9 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ HalfReuse: # True/1 ]] }
    refalrts::reinit_ident(context[1], identifiers[ident_True]);
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
  ...
  // </0 & Int-Cond-Or$1:1/4 (/7 e.Flags/5 )/8 # False/9 >/1
  ...
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Cond-Or/4 } Tile{ AsIs: e.Flags/5 } Tile{ AsIs: >/1 ]] }
  refalrts::update_name(context[4], functions[efunc_Intm_Condm_Or]);
  refalrts::push_stack( vm, context[1] );
  refalrts::push_stack( vm, context[0] );
  refalrts::Iter trash_prev = arg_begin->prev;
...
static refalrts::FnResult func_Intm_Condm_Or(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // closed e.new as range 2
  do {
    // </0 & Int-Cond-Or/4 t.Cond/7 e.Flags/5 >/1
    context[5] = context[2];
    context[6] = context[3];
    context[8] = refalrts::tvar_left( context[7], context[5], context[6] );
    if( ! context[8] )
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Cond-Or$1:1/4 } (/9 Tile{ AsIs: e.Flags/5 } )/10 </11 & Int-Cond/12 Tile{ AsIs: t.Cond/7 } >/13 Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_bracket(vm, context[9]);
    refalrts::alloc_close_bracket(vm, context[10]);
    refalrts::alloc_open_call(vm, context[11]);
...
static refalrts::FnResult func_gen_Intm_Condm_And_S1B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[12];
  refalrts::zeros( context, 12 );
  // </0 & Int-Cond-And$1:1/4 e.new/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Int-Cond-And$1:1/4 (/7 e.new1/5 )/8 s.new2/9 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  if( ! refalrts::empty_seq( context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  do {
    // </0 & Int-Cond-And$1:1/4 (/7 e.Flags/10 )/8 # True/9 >/1
    context[10] = context[5];
    context[11] = context[6];
    if( ! refalrts::ident_term( identifiers[ident_True], context[9] ) )
      continue;
  ...
  // </0 & Int-Cond-And$1:1/4 (/7 e.Flags/5 )/8 # False/9 >/1
  if( ! refalrts::ident_term( identifiers[ident_False], context[9] ) )
    return refalrts::cRecognitionImpossible;
  // closed e.Flags as range 5
  //DEBUG: e.Flags: 5
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} </0 & Int-Cond-And$1:1/4 (/7 e.Flags/5 )/8 # False/9 {REMOVED TILE}
  //RESULT: Tile{ [[ } Tile{ HalfReuse: # False/1 ]] }
  refalrts::reinit_ident(context[1], identifiers[ident_False]);
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
...
static refalrts::FnResult func_Intm_Condm_And(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // closed e.new as range 2
  do {
    // </0 & Int-Cond-And/4 t.Cond/7 e.Flags/5 >/1
    context[5] = context[2];
    context[6] = context[3];
    context[8] = refalrts::tvar_left( context[7], context[5], context[6] );
    if( ! context[8] )
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-Cond-And$1:1/4 } (/9 Tile{ AsIs: e.Flags/5 } )/10 </11 & Int-Cond/12 Tile{ AsIs: t.Cond/7 } >/13 Tile{ AsIs: >/1 ]] }
    refalrts::alloc_open_bracket(vm, context[9]);
    refalrts::alloc_close_bracket(vm, context[10]);
    refalrts::alloc_open_call(vm, context[11]);
    refalrts::alloc_name(vm, context[12], functions[efunc_Intm_Cond]);
...
static refalrts::FnResult func_gen_Intm_LoopForWarmFunctions_S2A2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  refalrts::Iter context[14];
  refalrts::zeros( context, 14 );
  // </0 & Int-LoopForWarmFunctions$2=2/4 (/7 e.Defines/5 )/8 (/11 e.Code/9 )/12 s.Cycles$a/13 e.AST$a/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Int-LoopForWarmFunctions/4 AsIs: (/7 AsIs: e.Defines/5 AsIs: )/8 } Tile{ AsIs: e.Code/9 } Tile{ AsIs: s.Cycles$a/13 } Tile{ AsIs: (/11 } Tile{ AsIs: e.AST$a/2 } Tile{ AsIs: )/12 } Tile{ AsIs: >/1 ]] }
  refalrts::update_name(context[4], functions[efunc_Intm_LoopForWarmFunctions]);
  refalrts::push_stack( vm, context[1] );
  refalrts::push_stack( vm, context[0] );
  refalrts::link_brackets( context[11], context[12] );
...
static refalrts::FnResult func_Intm_LoopForWarmFunctions(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  // </0 & Int-LoopForWarmFunctions/4 e.new/2 >/1
  context[0] = arg_begin;
  context[1] = arg_end;
  context[2] = 0;
  context[3] = 0;
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Int-LoopForWarmFunctions/4 (/7 e.new1/5 )/8 e.new2/2 s.new3/13 (/11 e.new4/9 )/12 >/1
  context[5] = 0;
  context[6] = 0;
  context[7] = refalrts::brackets_left( context[5], context[6], context[2], context[3] );
  if( ! context[7] )
  ...
  // closed e.new2 as range 2
  do {
    // </0 & Int-LoopForWarmFunctions/4 (/7 e.Defines/14 )/8 e.Code/16 0/13 (/11 e.AST/18 )/12 >/1
    context[14] = context[5];
    context[15] = context[6];
    context[16] = context[2];
    context[17] = context[3];
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} & Int-LoopForWarmFunctions/4 (/7 e.Defines/14 )/8 e.Code/16 0/13 (/11 {REMOVED TILE} )/12 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ HalfReuse: 0/0 } Tile{ AsIs: e.AST/18 } Tile{ ]] }
    refalrts::reinit_number(context[0], 0UL);
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  do {
    // </0 & Int-LoopForWarmFunctions/4 (/7 e.Defines/14 )/8 e.Code/16 s.Cycles/13 (/11 e.AST-B/20 (/26 # Function/28 s.Scope/29 (/32 e.Name/30 )/33 # Sentences/34 e.Sentences/24 )/27 e.AST-E/22 )/12 >/1
    context[14] = context[5];
    context[15] = context[6];
    context[16] = context[2];
    context[17] = context[3];
    ...
    do {
      ...
      // closed e.Sentences as range 24
      //DEBUG: s.Cycles: 13
      //DEBUG: e.Defines: 14
      //DEBUG: e.Code: 16
      //DEBUG: e.AST-B: 20
      ...
      //DEBUG: s.Scope: 29
      //DEBUG: e.Name: 30
      //DEBUG: e.Sentences: 24

      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } </35 & Int-LoopForWarmFunctions$2=2/36 (/37 e.Defines/14/38 )/40 (/41 e.Code/16/42 )/44 Tile{ AsIs: </0 Reuse: & Int-Code/4 AsIs: (/7 AsIs: e.Defines/14 AsIs: )/8 AsIs: e.Code/16 AsIs: s.Cycles/13 AsIs: (/11 AsIs: e.AST-B/20 AsIs: (/26 AsIs: # Function/28 AsIs: s.Scope/29 AsIs: (/32 AsIs: e.Name/30 AsIs: )/33 AsIs: # Sentences/34 AsIs: e.Sentences/24 AsIs: )/27 AsIs: e.AST-E/22 AsIs: )/12 AsIs: >/1 } >/45 Tile{ ]] }
  ...
  // </0 & Int-LoopForWarmFunctions/4 (/7 e.Defines/5 )/8 e.Code/2 s.Cycles/13 (/11 e.AST/9 )/12 >/1
  // closed e.Defines as range 5
  // closed e.Code as range 2
  // closed e.AST as range 9
  //DEBUG: s.Cycles: 13
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} & Int-LoopForWarmFunctions/4 (/7 e.Defines/5 )/8 e.Code/2 s.Cycles/13 (/11 {REMOVED TILE} )/12 >/1 {REMOVED TILE}
  //RESULT: Tile{ [[ HalfReuse: s.Cycles13 /0 } Tile{ AsIs: e.AST/9 } Tile{ ]] }
  refalrts::reinit_svar( context[0], context[13] );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
  refalrts::Iter res = arg_end->next;
...
static refalrts::FnResult func_Intm_Lookup(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  context[4] = refalrts::call_left( context[2], context[3], context[0], context[1] );
  // closed e.new as range 2
  // </0 & Int-Lookup/4 s.new1/5 t.new2/6 e.new3/2 >/1
  if( ! refalrts::svar_left( context[5], context[2], context[3] ) )
    return refalrts::cRecognitionImpossible;
  ...
  // closed e.new3 as range 2
  do {
    // </0 & Int-Lookup/4 s.ProcName/5 (/6 # define/12 s.ProcName/13 e.Body/10 )/7 e._/8 >/1
    context[8] = context[2];
    context[9] = context[3];
    context[10] = 0;
    context[11] = 0;
    ...
    // closed e._ as range 8
    //DEBUG: s.ProcName: 5
    //DEBUG: e.Body: 10
    //DEBUG: e._: 8

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Int-Lookup/4 s.ProcName/5 (/6 # define/12 s.ProcName/13 {REMOVED TILE} )/7 e._/8 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: e.Body/10 } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
    res = refalrts::splice_evar( res, context[10], context[11] );
  ...
  // </0 & Int-Lookup/4 s.ProcName/5 t._/6 e.Defines/2 >/1
  // closed e.Defines as range 2
  //DEBUG: t._: 6
  //DEBUG: s.ProcName: 5
  //DEBUG: e.Defines: 2
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} t._/6 {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 AsIs: & Int-Lookup/4 AsIs: s.ProcName/5 } Tile{ AsIs: e.Defines/2 } Tile{ AsIs: >/1 ]] }
  refalrts::push_stack( vm, context[1] );
  refalrts::push_stack( vm, context[0] );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
...
static refalrts::FnResult func_gen_Map_Z1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      do {
        // </0 & Map@1/4 (/7 # Drive/13 e.0/14 )/8 e.Tail/16 >/1
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} & Map@1/4 (/7 # Drive/13 e.0/14 {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 } Tile{ HalfReuse: & Map@1/8 AsIs: e.Tail/16 AsIs: >/1 ]] }
      ...
      do {
        // </0 & Map@1/4 (/7 # Inline/13 e.0/14 )/8 e.Tail/16 >/1
        context[14] = context[11];
        context[15] = context[12];
        context[16] = context[9];
        context[17] = context[10];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} & Map@1/4 (/7 # Inline/13 e.0/14 {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 } Tile{ HalfReuse: & Map@1/8 AsIs: e.Tail/16 AsIs: >/1 ]] }
        refalrts::reinit_name(context[8], functions[efunc_gen_Map_Z1]);
        refalrts::push_stack( vm, context[1] );
        refalrts::push_stack( vm, context[0] );
      ...
      do {
        // </0 & Map@1/4 (/7 # Intrinsic/13 e.0/14 )/8 e.Tail/16 >/1
        context[14] = context[11];
        context[15] = context[12];
        context[16] = context[9];
        context[17] = context[10];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} & Map@1/4 (/7 # Intrinsic/13 e.0/14 {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 } Tile{ HalfReuse: & Map@1/8 AsIs: e.Tail/16 AsIs: >/1 ]] }
        refalrts::reinit_name(context[8], functions[efunc_gen_Map_Z1]);
        refalrts::push_stack( vm, context[1] );
        refalrts::push_stack( vm, context[0] );
      ...
      do {
        // </0 & Map@1/4 (/7 # Spec/13 (/20 e.2/18 )/21 e.1/14 )/8 e.Tail/16 >/1
        context[14] = context[11];
        context[15] = context[12];
        context[16] = context[9];
        context[17] = context[10];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} & Map@1/4 (/7 # Spec/13 (/20 e.2/18 )/21 e.1/14 {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 } Tile{ HalfReuse: & Map@1/8 AsIs: e.Tail/16 AsIs: >/1 ]] }
        refalrts::reinit_name(context[8], functions[efunc_gen_Map_Z1]);
        refalrts::push_stack( vm, context[1] );
        refalrts::push_stack( vm, context[0] );
      ...
      do {
        // </0 & Map@1/4 (/7 # DriveInfo/13 e.0/14 )/8 e.Tail/16 >/1
        context[14] = context[11];
        context[15] = context[12];
        context[16] = context[9];
        context[17] = context[10];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} & Map@1/4 (/7 # DriveInfo/13 e.0/14 {REMOVED TILE}
        //RESULT: Tile{ [[ AsIs: </0 } Tile{ HalfReuse: & Map@1/8 AsIs: e.Tail/16 AsIs: >/1 ]] }
        refalrts::reinit_name(context[8], functions[efunc_gen_Map_Z1]);
        refalrts::push_stack( vm, context[1] );
        refalrts::push_stack( vm, context[0] );
      ...
      // </0 & Map@1/4 (/7 # SpecInfo/13 e.0/14 )/8 e.Tail/16 >/1
      context[14] = context[11];
      context[15] = context[12];
      context[16] = context[9];
      context[17] = context[10];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} & Map@1/4 (/7 # SpecInfo/13 e.0/14 {REMOVED TILE}
      //RESULT: Tile{ [[ AsIs: </0 } Tile{ HalfReuse: & Map@1/8 AsIs: e.Tail/16 AsIs: >/1 ]] }
      refalrts::reinit_name(context[8], functions[efunc_gen_Map_Z1]);
      refalrts::push_stack( vm, context[1] );
      refalrts::push_stack( vm, context[0] );
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & OptTree-CleanupMarkup\1@0/4 AsIs: e.items/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
...
static refalrts::FnResult func_gen_Map_Z2(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      // </0 & Map@2/4 s.ColdBy/5 (/8 # ColdFunction/14 s.ColdBy/15 s.ScopeClass/16 (/19 e.4/17 )/20 e.3/12 )/9 e.Tail/10 >/1
      context[10] = context[6];
      context[11] = context[7];
      context[12] = 0;
      context[13] = 0;
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} s.ColdBy/15 {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: (/8 Reuse: # Function/14 } Tile{ AsIs: s.ScopeClass/16 AsIs: (/19 AsIs: e.4/17 AsIs: )/20 AsIs: e.3/12 AsIs: )/9 } Tile{ AsIs: </0 AsIs: & Map@2/4 AsIs: s.ColdBy/5 } Tile{ AsIs: e.Tail/10 } Tile{ AsIs: >/1 ]] }
    ...
    // </0 & Map@2/4 s.ColdBy/5 t.Next/8 e.Tail/10 >/1
    context[10] = context[6];
    context[11] = context[7];
    // closed e.Tail as range 10
    //DEBUG: t.Next: 8
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: t.Next/8 } Tile{ AsIs: </0 AsIs: & Map@2/4 AsIs: s.ColdBy/5 } Tile{ AsIs: e.Tail/10 } Tile{ AsIs: >/1 ]] }
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
  ...
  do {
    // </0 & Map@2/4 s.ColdBy/5 >/1
    if( ! refalrts::empty_seq( context[2], context[3] ) )
      continue;
    //DEBUG: s.ColdBy: 5

    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} </0 & Map@2/4 s.ColdBy/5 >/1 {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ ]] }
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
    refalrts::Iter res = arg_end->next;
  ...
  // </0 & Map@2/4 s.ColdBy/5 e.items/2 >/1
  // closed e.items as range 2
  //DEBUG: s.ColdBy: 5
  //DEBUG: e.items: 2
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ AsIs: </0 Reuse: & Map@0/4 } [*]/6 & WarmColdFunctions\1@0/7 Tile{ AsIs: s.ColdBy/5 } {*}/8 Tile{ AsIs: e.items/2 } Tile{ AsIs: >/1 ]] }
...
static refalrts::FnResult func_gen_Map_Z3(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new2 as range 5
    do {
      // </0 & Map@3/4 (/7 (/15 e.1/13 )/16 e.2/11 (/19 e.3/17 )/20 )/8 e.Tail/9 >/1
      context[9] = context[5];
      context[10] = context[6];
      context[11] = 0;
      context[12] = 0;
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: (/15 AsIs: e.1/13 AsIs: )/16 } Tile{ AsIs: </0 Reuse: & Map@6/4 } Tile{ AsIs: e.2/11 } >/21 Tile{ AsIs: (/19 } </22 & Map@5/23 Tile{ AsIs: e.3/17 } >/24 )/25 )/26 Tile{ HalfReuse: </20 HalfReuse: & Map@3/8 AsIs: e.Tail/9 AsIs: >/1 ]] }
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & ExpandClosures-Sentence*1/4 AsIs: t.Next/7 } >/11 </12 & Map@3/13 Tile{ AsIs: e.Tail/9 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[11]);
    refalrts::alloc_open_call(vm, context[12]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & ExpandClosures-Sentence@0/4 AsIs: e.items/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Map_Z0]);
...
static refalrts::FnResult func_gen_Map_Z4(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new2 as range 5
    do {
      // </0 & Map@4/4 (/7 # Function/13 s.ScopeClass/14 (/17 e.3/15 )/18 # Sentences/19 e.4/11 )/8 e.Tail/9 >/1
      context[9] = context[5];
      context[10] = context[6];
      context[11] = 0;
      context[12] = 0;
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: # Function/13 AsIs: s.ScopeClass/14 AsIs: (/17 AsIs: e.3/15 AsIs: )/18 AsIs: # Sentences/19 } Tile{ AsIs: </0 Reuse: & Map@3/4 } Tile{ AsIs: e.4/11 } >/20 )/21 </22 Tile{ HalfReuse: & Map@4/8 AsIs: e.Tail/9 AsIs: >/1 ]] }
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ } Tile{ AsIs: t.Next/7 } Tile{ AsIs: </0 AsIs: & Map@4/4 } Tile{ AsIs: e.Tail/9 } Tile{ AsIs: >/1 ]] }
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & ExpandClosures\1@0/4 AsIs: e.items/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Map_Z0]);
...
static refalrts::FnResult func_gen_Map_Z5(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    do {
      ...
      // closed e.new4 as range 11
      do {
        // </0 & Map@5/4 (/7 # Brackets/13 e.0/14 )/8 e.Tail/16 >/1
        context[14] = context[11];
        context[15] = context[12];
        context[16] = context[9];
        context[17] = context[10];
        ...
        refalrts::reset_allocator(vm);
        //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
        //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # Brackets/4 HalfReuse: </7 HalfReuse: & Map@5/13 AsIs: e.0/14 HalfReuse: >/8 } )/18 </19 & Map@5/20 Tile{ AsIs: e.Tail/16 } Tile{ AsIs: >/1 ]] }
        refalrts::alloc_close_bracket(vm, context[18]);
        refalrts::alloc_open_call(vm, context[19]);
      ...
      do {
        // </0 & Map@5/4 (/7 s.new6/13 (/20 e.new7/18 )/21 e.new8/14 )/8 e.new9/16 >/1
        context[14] = context[11];
        context[15] = context[12];
        context[16] = context[9];
        context[17] = context[10];
        ...
        do {
          // </0 & Map@5/4 (/7 # ADT-Brackets/13 (/20 e.2/22 )/21 e.1/24 )/8 e.Tail/26 >/1
          context[22] = context[18];
          context[23] = context[19];
          ...
          refalrts::reset_allocator(vm);
          //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
          //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: # ADT-Brackets/13 AsIs: (/20 AsIs: e.2/22 AsIs: )/21 } Tile{ AsIs: </0 AsIs: & Map@5/4 } Tile{ AsIs: e.1/24 } >/28 )/29 </30 Tile{ HalfReuse: & Map@5/8 AsIs: e.Tail/26 AsIs: >/1 ]] }
        ...
        // </0 & Map@5/4 (/7 # CallBrackets/13 (/20 # ClosureBrackets/28 e.3/22 )/21 e.1/24 )/8 e.Tail/26 >/1
        context[22] = context[18];
        context[23] = context[19];
        context[24] = context[14];
        context[25] = context[15];
        ...
        //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: # CallBrackets/13 HalfReuse: </20 HalfReuse: & Map@5/28 } Tile{ AsIs: e.3/22 } Tile{ AsIs: e.1/24 } Tile{ HalfReuse: >/4 } Tile{ AsIs: )/21 } Tile{ AsIs: </0 } Tile{ HalfReuse: & Map@5/8 AsIs: e.Tail/26 AsIs: >/1 ]] }
        refalrts::reinit_open_call(context[20]);
      ...
      // </0 & Map@5/4 (/7 # CallBrackets/13 e.0/14 )/8 e.Tail/16 >/1
      context[14] = context[11];
      context[15] = context[12];
      context[16] = context[9];
      context[17] = context[10];
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ HalfReuse: (/0 HalfReuse: # CallBrackets/4 HalfReuse: </7 HalfReuse: & Map@5/13 AsIs: e.0/14 HalfReuse: >/8 } )/18 </19 & Map@5/20 Tile{ AsIs: e.Tail/16 } Tile{ AsIs: >/1 ]] }
      refalrts::alloc_close_bracket(vm, context[18]);
      refalrts::alloc_open_call(vm, context[19]);
      refalrts::alloc_name(vm, context[20], functions[efunc_gen_Map_Z5]);
      refalrts::reinit_open_bracket(context[0]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & ExpandClosures-ResultTerm@0/4 AsIs: e.items/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Map_Z0]);
...
static refalrts::FnResult func_gen_Map_Z6(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    // closed e.new2 as range 5
    do {
      // </0 & Map@6/4 (/7 # Condition/13 (/16 e.2/14 )/17 (/20 e.4/18 )/21 (/24 e.6/22 )/25 )/8 e.Tail/9 >/1
      context[9] = context[5];
      context[10] = context[6];
      context[11] = 0;
      context[12] = 0;
      ...
      refalrts::reset_allocator(vm);
      //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
      //RESULT: Tile{ [[ } Tile{ AsIs: (/7 AsIs: # Condition/13 AsIs: (/16 AsIs: e.2/14 AsIs: )/17 AsIs: (/20 } </26 & Map@5/27 Tile{ AsIs: e.4/18 } >/28 Tile{ AsIs: )/21 AsIs: (/24 AsIs: e.6/22 AsIs: )/25 AsIs: )/8 } Tile{ AsIs: </0 AsIs: & Map@6/4 } Tile{ AsIs: e.Tail/9 } Tile{ AsIs: >/1 ]] }
    ...
    refalrts::reset_allocator(vm);
    //TRASH: {REMOVED TILE} {REMOVED TILE} {REMOVED TILE}
    //RESULT: Tile{ [[ AsIs: </0 Reuse: & ExpandClosures-Sentence\1*1/4 AsIs: t.Next/7 } >/11 </12 & Map@6/13 Tile{ AsIs: e.Tail/9 } Tile{ AsIs: >/1 ]] }
    refalrts::alloc_close_call(vm, context[11]);
    refalrts::alloc_open_call(vm, context[12]);
  ...
  refalrts::reset_allocator(vm);
  //TRASH: {REMOVED TILE} {REMOVED TILE}
  //RESULT: Tile{ [[ } </5 Tile{ HalfReuse: & Map@0/0 Reuse: & ExpandClosures-Sentence\1@0/4 AsIs: e.items/2 AsIs: >/1 ]] }
  refalrts::alloc_open_call(vm, context[5]);
  refalrts::reinit_name(context[0], functions[efunc_gen_Map_Z0]);
