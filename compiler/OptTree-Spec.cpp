...
#define cookie_ns cookie_ns_3898331902_3944952427
...
static refalrts::NativeReference nat_ref_Mu("Mu", 3898331902U, 3944952427U, func_Mu);
...
static refalrts::FnResult func_gen_u_u_Mum_Aux_S13B1(refalrts::VM *vm, refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  do {
    ...
    refalrts::alloc_number(vm, context[9], 3944952427UL);
    refalrts::update_name(context[4], functions[efunc_u_u_FindMuPtr]);
    refalrts::reinit_number(context[5], 3898331902UL);
    refalrts::push_stack( vm, context[1] );
    refalrts::push_stack( vm, context[0] );
    refalrts::Iter trash_prev = arg_begin->prev;
    refalrts::use(trash_prev);
  ...
  refalrts::update_name(context[4], functions[efunc_u_u_FindMuPtr]);
  refalrts::reinit_number(context[5], 3898331902UL);
  refalrts::reinit_number(context[7], 3944952427UL);
  refalrts::push_stack( vm, context[1] );
  refalrts::push_stack( vm, context[0] );
  refalrts::Iter trash_prev = arg_begin->prev;
  refalrts::use(trash_prev);
...
static refalrts::NativeReference nat_ref_gen_u_u_Mum_Aux_S13B1("__Mu-Aux$13:1", 3898331902U, 3944952427U, func_gen_u_u_Mum_Aux_S13B1);
...
static refalrts::NativeReference nat_ref_u_u_Mum_Aux("__Mu-Aux", 3898331902U, 3944952427U, func_u_u_Mum_Aux);
...
static refalrts::NativeReference nat_ref_Residue("Residue", 3898331902U, 3944952427U, func_Residue);
