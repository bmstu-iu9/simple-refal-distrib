...
static refalrts::FnResult DoParseCommandLine(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icOnFailGoTo, +28, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // s.Collector#1/2 ( '-e' ) ( e.ErrorFile#1/5 ) e.Arguments#1/0
    {refalrts::icsVarLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 3, 0},
    {refalrts::icCharLeft, 0, static_cast<unsigned char>('-'), 3},
    {refalrts::icCharLeft, 0, static_cast<unsigned char>('e'), 3},
    {refalrts::icBracketLeft, 0, 5, 0},
    {refalrts::icEmpty, 0, 0, 3},
    // closed e.ErrorFile#1 as range 5
    // closed e.Arguments#1 as range 0
    //0: e.Arguments#1
    //2: s.Collector#1
    //5: e.ErrorFile#1
    ...
    {refalrts::icOnFailGoTo, +28, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // s.Collector#1/2 ( '-d' ) ( e.Directory#1/5 ) e.Arguments#1/0
    {refalrts::icsVarLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 3, 0},
    {refalrts::icCharLeft, 0, static_cast<unsigned char>('-'), 3},
    {refalrts::icCharLeft, 0, static_cast<unsigned char>('d'), 3},
    {refalrts::icBracketLeft, 0, 5, 0},
    {refalrts::icEmpty, 0, 0, 3},
    // closed e.Directory#1 as range 5
    // closed e.Arguments#1 as range 0
    //0: e.Arguments#1
    //2: s.Collector#1
    //5: e.Directory#1
    ...
    {refalrts::icOnFailGoTo, +28, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // s.Collector#1/2 ( '-o' ) ( e.OutputFile#1/5 ) e.Arguments#1/0
    {refalrts::icsVarLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 3, 0},
    {refalrts::icCharLeft, 0, static_cast<unsigned char>('-'), 3},
    {refalrts::icCharLeft, 0, static_cast<unsigned char>('o'), 3},
    {refalrts::icBracketLeft, 0, 5, 0},
    {refalrts::icEmpty, 0, 0, 3},
    // closed e.OutputFile#1 as range 5
    // closed e.Arguments#1 as range 0
    //0: e.Arguments#1
    //2: s.Collector#1
    //5: e.OutputFile#1
    ...
    {refalrts::icOnFailGoTo, +18, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // s.Collector#1/2 ( '--' ) e.Arguments#1/0
    {refalrts::icsVarLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 3, 0},
    {refalrts::icCharLeft, 0, static_cast<unsigned char>('-'), 3},
    {refalrts::icCharLeft, 0, static_cast<unsigned char>('-'), 3},
    ...
    {refalrts::icInitB0, 0, 0, 0},
    // s.Collector#1/2 ( e.NextFileName#1/3 ) e.Arguments#1/0
    {refalrts::icsVarLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 3, 0},
    // closed e.NextFileName#1 as range 3
    // closed e.Arguments#1 as range 0
    //0: e.Arguments#1
    //2: s.Collector#1
    //3: e.NextFileName#1
  ...
  do {
    ...
    if( ! refalrts::char_left( '-', context[3], context[4] ) )
      continue;
    if( ! refalrts::char_left( 'c', context[3], context[4] ) )
      continue;
    context[5] = 0;
    context[6] = 0;
    ...
    if( ! refalrts::alloc_open_call( context[7] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[8], DoParseCommandLine, "DoParseCommandLine" ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_open_call( context[9] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_ident( context[10], & ident_AddCompileCommand<int>::name ) )
      return refalrts::cNoMemory;
  ...
  do {
    ...
    if( ! refalrts::alloc_open_bracket( context[5] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_ident( context[6], & ident_CmdLineError<int>::name ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_chars( context[7], context[8], "After option \'-c\' expected C++ compiler command line", 52 ) )
      return refalrts::cNoMemory;
  ...
  do {
    ...
    if( ! refalrts::char_left( '-', context[3], context[4] ) )
      continue;
    if( ! refalrts::char_left( 'e', context[3], context[4] ) )
      continue;
    context[5] = 0;
    context[6] = 0;
    if( ! refalrts::brackets_left( context[5], context[6], context[0], context[1] ) )
    ...
    if( ! refalrts::alloc_open_call( context[9] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_ident( context[10], & ident_AddErrorFile<int>::name ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_close_call( context[11] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_close_call( context[12] ) )
  ...
  do {
    ...
    if( ! refalrts::alloc_ident( context[6], & ident_CmdLineError<int>::name ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_chars( context[7], context[8], "After option \'-e\' expected name of error flag file", 50 ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_close_bracket( context[9] ) )
      return refalrts::cNoMemory;
    refalrts::link_brackets( context[5], context[9] );
  ...
  do {
    ...
    if( ! refalrts::char_left( '-', context[3], context[4] ) )
      continue;
    if( ! refalrts::char_left( 'd', context[3], context[4] ) )
      continue;
    context[5] = 0;
    context[6] = 0;
    if( ! refalrts::brackets_left( context[5], context[6], context[0], context[1] ) )
    ...
    if( ! refalrts::alloc_open_call( context[9] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_ident( context[10], & ident_AddFolder<int>::name ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_close_call( context[11] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_close_call( context[12] ) )
  ...
  do {
    ...
    if( ! refalrts::alloc_ident( context[6], & ident_CmdLineError<int>::name ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_chars( context[7], context[8], "After option \'-d\' expected find directory", 41 ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_close_bracket( context[9] ) )
      return refalrts::cNoMemory;
    refalrts::link_brackets( context[5], context[9] );
  ...
  do {
    ...
    if( ! refalrts::char_left( '-', context[3], context[4] ) )
      continue;
    if( ! refalrts::char_left( 'o', context[3], context[4] ) )
      continue;
    context[5] = 0;
    context[6] = 0;
    if( ! refalrts::brackets_left( context[5], context[6], context[0], context[1] ) )
    ...
    if( ! refalrts::alloc_open_call( context[9] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_ident( context[10], & ident_SetOutput<int>::name ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_close_call( context[11] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_close_call( context[12] ) )
  ...
  do {
    ...
    if( ! refalrts::alloc_open_call( context[5] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[6], DoParseFileNamesOnly, "DoParseFileNamesOnly" ) )
      return refalrts::cNoMemory;
  ...
  do {
    ...
    if( ! refalrts::alloc_open_call( context[5] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_name( context[6], DoParseCommandLine, "DoParseCommandLine" ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_open_call( context[7] ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_ident( context[8], & ident_AddFile<int>::name ) )
      return refalrts::cNoMemory;
    if( ! refalrts::alloc_close_call( context[9] ) )
      return refalrts::cNoMemory;
  ...
  if( ! refalrts::alloc_open_call( context[3] ) )
    return refalrts::cNoMemory;
  if( ! refalrts::alloc_ident( context[4], & ident_GetInfo<int>::name ) )
    return refalrts::cNoMemory;
...
static refalrts::FnResult DoParseFileNamesOnly(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    {refalrts::icOnFailGoTo, +24, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // s.Collector#1/2 ( e.NextFileName#1/3 ) e.Files#1/0
    {refalrts::icsVarLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 3, 0},
    // closed e.NextFileName#1 as range 3
...
static refalrts::FnResult lambda_CollectorObject_1(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Folders#1/2 ) ( e.Files#1/4 ) # AddCompileCommand e.Command#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icIdentLeft, 0, 5, 0},
    // closed e.Folders#1 as range 2
    // closed e.Files#1 as range 4
    // closed e.Command#2 as range 0
    //0: e.Command#2
    //2: e.Folders#1
    //4: e.Files#1
    {refalrts::icEmptyResult, 0, 0, 0},
    ...
    {refalrts::icOnFailGoTo, +27, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Folders#1/2 ) ( e.Files#1/4 ) # AddErrorFile e.ErrorFile#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icIdentLeft, 0, 4, 0},
    // closed e.Folders#1 as range 2
    // closed e.Files#1 as range 4
    // closed e.ErrorFile#2 as range 0
    //0: e.ErrorFile#2
    //2: e.Folders#1
    //4: e.Files#1
    {refalrts::icEmptyResult, 0, 0, 0},
    ...
    {refalrts::icOnFailGoTo, +27, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Folders#1/2 ) ( e.Files#1/4 ) # AddFile e.FileName#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icIdentLeft, 0, 3, 0},
    // closed e.Folders#1 as range 2
    // closed e.Files#1 as range 4
    // closed e.FileName#2 as range 0
    //0: e.FileName#2
    //2: e.Folders#1
    //4: e.Files#1
    {refalrts::icEmptyResult, 0, 0, 0},
    ...
    {refalrts::icOnFailGoTo, +27, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Folders#1/2 ) ( e.Files#1/4 ) # AddFolder e.FolderName#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icIdentLeft, 0, 2, 0},
    // closed e.Folders#1 as range 2
    // closed e.Files#1 as range 4
    // closed e.FolderName#2 as range 0
    //0: e.FolderName#2
    //2: e.Folders#1
    //4: e.Files#1
    {refalrts::icEmptyResult, 0, 0, 0},
    ...
    {refalrts::icReturnResult, 0, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Folders#1/2 ) ( e.Files#1/4 ) # GetInfo
...
static refalrts::FnResult lambda_Collector_Compiler_0(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    {refalrts::icOnFailGoTo, +7, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Command#1/2 ) # CompileCommand
    {refalrts::icIdentRight, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icEmpty, 0, 0, 0},
    // closed e.Command#1 as range 2
    //2: e.Command#1
    {refalrts::icEmptyResult, 0, 0, 0},
    {refalrts::icSpliceEVar, 0, 0, 2},
    {refalrts::icReturnResult, 0, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Command#1/2 ) # ErrorFile
    {refalrts::icIdentRight, 0, 1, 0},
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icEmpty, 0, 0, 0},
    // closed e.Command#1 as range 2
...
static refalrts::FnResult lambda_Collector_Compiler_1(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Command#1/2 ) ( e.Folders#1/4 ) ( e.Files#1/6 ) # AddCompileCommand e.NewCommand#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    ...
    // closed e.NewCommand#2 as range 0
    //0: e.NewCommand#2
    //2: e.Command#1
    //4: e.Folders#1
    //6: e.Files#1
    ...
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Command#1/2 ) ( e.Folders#1/4 ) ( e.Files#1/6 ) # AddErrorFile e.ErrorFile#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
    {refalrts::icIdentLeft, 0, 4, 0},
    ...
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Command#1/2 ) ( e.Folders#1/4 ) ( e.Files#1/6 ) # AddFile e.FileName#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
    {refalrts::icIdentLeft, 0, 3, 0},
    ...
    {refalrts::icOnFailGoTo, +34, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Command#1/2 ) ( e.Folders#1/4 ) ( e.Files#1/6 ) # AddFolder e.FolderName#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
    {refalrts::icIdentLeft, 0, 2, 0},
    ...
    {refalrts::icReturnResult, 0, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Command#1/2 ) ( e.Folders#1/4 ) ( e.Files#1/6 ) # GetInfo
    {refalrts::icIdentRight, 0, 1, 0},
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
...
static refalrts::FnResult Collector_Compiler(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Folders#1/2 ) ( e.Files#1/4 ) e.Command#1/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    // closed e.Folders#1 as range 2
    // closed e.Files#1 as range 4
    // closed e.Command#1 as range 0
    //0: e.Command#1
    //2: e.Folders#1
    //4: e.Files#1
    {refalrts::icEmptyResult, 0, 0, 0},
...
static refalrts::FnResult lambda_Collector_ErrorFile_0(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.ErrorFile#1/2 ) # CompileCommand
    {refalrts::icIdentRight, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icEmpty, 0, 0, 0},
    // closed e.ErrorFile#1 as range 2
    //2: e.ErrorFile#1
    {refalrts::icEmptyResult, 0, 0, 0},
...
static refalrts::FnResult lambda_Collector_ErrorFile_1(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    {refalrts::icOnFailGoTo, +39, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.ErrorFile#1/2 ) ( e.Folders#1/4 ) ( e.Files#1/6 ) # AddCompileCommand e.Command#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
    {refalrts::icIdentLeft, 0, 5, 0},
    ...
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.ErrorFile#1/2 ) ( e.Folders#1/4 ) ( e.Files#1/6 ) # AddErrorFile e.ErrorFile#1/8
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
    {refalrts::icIdentLeft, 0, 4, 0},
    // closed e.ErrorFile#1 as range 2
    {refalrts::iceRepeatLeft, 8, 2, 0},
    {refalrts::icEmpty, 0, 0, 0},
    // closed e.Folders#1 as range 4
    // closed e.Files#1 as range 6
    //2: e.ErrorFile#1
    ...
    {refalrts::icOnFailGoTo, +34, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.ErrorFile#1/2 ) ( e.Folders#1/4 ) ( e.Files#1/6 ) # AddFile e.FileName#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
    {refalrts::icIdentLeft, 0, 3, 0},
    ...
    {refalrts::icOnFailGoTo, +34, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.ErrorFile#1/2 ) ( e.Folders#1/4 ) ( e.Files#1/6 ) # AddFolder e.FolderName#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
    {refalrts::icIdentLeft, 0, 2, 0},
    ...
    {refalrts::icReturnResult, 0, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.ErrorFile#1/2 ) ( e.Folders#1/4 ) ( e.Files#1/6 ) # GetInfo
    {refalrts::icIdentRight, 0, 1, 0},
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
  ...
  do {
    ...
    if( ! refalrts::ident_left(  & ident_AddErrorFile<int>::name, context[0], context[1] ) )
      continue;
    // closed e.ErrorFile#1 as range 2
    if( ! refalrts::repeated_evar_left( context[8], context[9], context[2], context[3], context[0], context[1] ) )
      continue;
    if( ! refalrts::empty_seq( context[0], context[1] ) )
      continue;
    // closed e.Folders#1 as range 4
...
static refalrts::FnResult Collector_ErrorFile(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Folders#1/2 ) ( e.Files#1/4 ) e.ErrorFile#1/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    // closed e.Folders#1 as range 2
    // closed e.Files#1 as range 4
    // closed e.ErrorFile#1 as range 0
    //0: e.ErrorFile#1
    //2: e.Folders#1
    //4: e.Files#1
    {refalrts::icEmptyResult, 0, 0, 0},
...
static refalrts::FnResult lambda_Collector_Compiler_ErrorFile_0(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    {refalrts::icOnFailGoTo, +8, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.ErrorFile#1/2 ) ( e.Command#1/4 ) # CompileCommand
    {refalrts::icIdentRight, 0, 1, 0},
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icEmpty, 0, 0, 0},
    ...
    {refalrts::icReturnResult, 0, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.ErrorFile#1/2 ) ( e.Command#1/4 ) # ErrorFile
    {refalrts::icIdentRight, 0, 0, 0},
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icEmpty, 0, 0, 0},
...
static refalrts::FnResult lambda_Collector_Compiler_ErrorFile_1(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Command#1/2 ) ( e.ErrorFile#1/4 ) ( e.Folders#1/6 ) ( e.Files#1/8 ) # AddCompileCommand e.NewCommand#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
    ...
    {refalrts::icIdentLeft, 0, 5, 0},
    // closed e.Command#1 as range 2
    // closed e.ErrorFile#1 as range 4
    ...
    {refalrts::icOnFailGoTo, +16, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Command#1/2 ) ( e.ErrorFile#1/4 ) ( e.Folders#1/6 ) ( e.Files#1/8 ) # AddErrorFile e.NewFile#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
    {refalrts::icBracketLeft, 0, 8, 0},
    ...
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Command#1/2 ) ( e.ErrorFile#1/4 ) ( e.Folders#1/6 ) ( e.Files#1/8 ) # AddFile e.FileName#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
    {refalrts::icBracketLeft, 0, 8, 0},
    ...
    {refalrts::icOnFailGoTo, +46, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Command#1/2 ) ( e.ErrorFile#1/4 ) ( e.Folders#1/6 ) ( e.Files#1/8 ) # AddFolder e.FolderName#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
    {refalrts::icBracketLeft, 0, 8, 0},
    ...
    {refalrts::icReturnResult, 0, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Command#1/2 ) ( e.ErrorFile#1/4 ) ( e.Folders#1/6 ) ( e.Files#1/8 ) # GetInfo
    {refalrts::icIdentRight, 0, 1, 0},
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
...
static refalrts::FnResult Collector_Compiler_ErrorFile(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Folders#1/2 ) ( e.Files#1/4 ) ( e.Command#1/6 ) ( e.ErrorFile#1/8 )
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    {refalrts::icBracketLeft, 0, 6, 0},
    {refalrts::icBracketLeft, 0, 8, 0},
    ...
    // closed e.Folders#1 as range 2
    // closed e.Files#1 as range 4
    // closed e.Command#1 as range 6
    // closed e.ErrorFile#1 as range 8
    //2: e.Folders#1
    //4: e.Files#1
    //6: e.Command#1
    //8: e.ErrorFile#1
...
static refalrts::FnResult lambda_Collector_Error_0(refalrts::Iter arg_begin, refalrts::Iter arg_end) {
  ...
  static const refalrts::RASLCommand raa[] = {
    ...
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Message#1/2 ) # AddCompileCommand e.Command#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icIdentLeft, 0, 5, 0},
    ...
    {refalrts::icOnFailGoTo, +14, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Message#1/2 ) # AddErrorFile e.ErrorFile#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icIdentLeft, 0, 4, 0},
    // closed e.Message#1 as range 2
    // closed e.ErrorFile#2 as range 0
    ...
    {refalrts::icOnFailGoTo, +14, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Message#1/2 ) # AddFile e.FileName#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icIdentLeft, 0, 3, 0},
    // closed e.Message#1 as range 2
    // closed e.FileName#2 as range 0
    ...
    {refalrts::icOnFailGoTo, +14, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Message#1/2 ) # AddFolder e.FolderName#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icIdentLeft, 0, 2, 0},
    // closed e.Message#1 as range 2
    // closed e.FolderName#2 as range 0
    ...
    {refalrts::icReturnResult, 0, 0, 0},
    {refalrts::icInitB0, 0, 0, 0},
    // ( e.Message#1/2 ) # GetInfo ( e.Folders#2/4 ) e.Files#2/0
    {refalrts::icBracketLeft, 0, 2, 0},
    {refalrts::icIdentLeft, 0, 1, 0},
    {refalrts::icBracketLeft, 0, 4, 0},
    // closed e.Message#1 as range 2
    // closed e.Folders#2 as range 4
    // closed e.Files#2 as range 0
    //0: e.Files#2
    //2: e.Message#1
    //4: e.Folders#2
    {refalrts::icEmptyResult, 0, 0, 0},
